 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.DeviceComponent#getType <em>Type</em>}</li>
 *   <li>{@link fhir.DeviceComponent#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link fhir.DeviceComponent#getLastSystemChange <em>Last System Change</em>}</li>
 *   <li>{@link fhir.DeviceComponent#getSource <em>Source</em>}</li>
 *   <li>{@link fhir.DeviceComponent#getParent <em>Parent</em>}</li>
 *   <li>{@link fhir.DeviceComponent#getOperationalStatus <em>Operational Status</em>}</li>
 *   <li>{@link fhir.DeviceComponent#getParameterGroup <em>Parameter Group</em>}</li>
 *   <li>{@link fhir.DeviceComponent#getMeasurementPrinciple <em>Measurement Principle</em>}</li>
 *   <li>{@link fhir.DeviceComponent#getProductionSpecification <em>Production Specification</em>}</li>
 *   <li>{@link fhir.DeviceComponent#getLanguageCode <em>Language Code</em>}</li>
 * </ul>
 *
 * @see fhir.FhirPackage#getDeviceComponent()
...
public interface DeviceComponent extends DomainResource {
	 ...
	 * @see fhir.FhirPackage#getDeviceComponent_Type()
	...
	/**
	 * Sets the value of the '{@link fhir.DeviceComponent#getType <em>Type</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getDeviceComponent_Identifier()
	 * @model containment="true" required="true"
	...
	/**
	 * Sets the value of the '{@link fhir.DeviceComponent#getIdentifier <em>Identifier</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getDeviceComponent_LastSystemChange()
	 * @model containment="true" required="true"
	...
	/**
	 * Sets the value of the '{@link fhir.DeviceComponent#getLastSystemChange <em>Last System Change</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getDeviceComponent_Source()
	...
	/**
	 * Sets the value of the '{@link fhir.DeviceComponent#getSource <em>Source</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getDeviceComponent_Parent()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.DeviceComponent#getParent <em>Parent</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getDeviceComponent_OperationalStatus()
	 * @model containment="true"
	 ...
	 * @see fhir.FhirPackage#getDeviceComponent_ParameterGroup()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.DeviceComponent#getParameterGroup <em>Parameter Group</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getDeviceComponent_MeasurementPrinciple()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.DeviceComponent#getMeasurementPrinciple <em>Measurement Principle</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The list contents are of type {@link fhir.DeviceComponentProductionSpecification}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 ...
	 * @see fhir.FhirPackage#getDeviceComponent_ProductionSpecification()
	 * @model containment="true"
	 ...
	 * @see fhir.FhirPackage#getDeviceComponent_LanguageCode()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.DeviceComponent#getLanguageCode <em>Language Code</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
