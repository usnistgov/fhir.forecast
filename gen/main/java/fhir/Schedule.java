 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.Schedule#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link fhir.Schedule#getType <em>Type</em>}</li>
 *   <li>{@link fhir.Schedule#getActor <em>Actor</em>}</li>
 *   <li>{@link fhir.Schedule#getPlanningHorizon <em>Planning Horizon</em>}</li>
 *   <li>{@link fhir.Schedule#getComment <em>Comment</em>}</li>
 * </ul>
 *
 * @see fhir.FhirPackage#getSchedule()
...
public interface Schedule extends DomainResource {
	 ...
	 * @see fhir.FhirPackage#getSchedule_Identifier()
	 ...
	 * @see fhir.FhirPackage#getSchedule_Type()
	 * @model containment="true"
	 ...
	 * @see fhir.FhirPackage#getSchedule_Actor()
	...
	/**
	 * Sets the value of the '{@link fhir.Schedule#getActor <em>Actor</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getSchedule_PlanningHorizon()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.Schedule#getPlanningHorizon <em>Planning Horizon</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getSchedule_Comment()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.Schedule#getComment <em>Comment</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
