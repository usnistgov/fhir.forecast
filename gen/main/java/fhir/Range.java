 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.Range#getLow <em>Low</em>}</li>
 *   <li>{@link fhir.Range#getHigh <em>High</em>}</li>
 * </ul>
 *
 * @see fhir.FhirPackage#getRange()
...
public interface Range extends Element {
	 ...
	 * @see fhir.FhirPackage#getRange_Low()
	...
	/**
	 * Sets the value of the '{@link fhir.Range#getLow <em>Low</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getRange_High()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.Range#getHigh <em>High</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
