 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.Specimen#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link fhir.Specimen#getStatus <em>Status</em>}</li>
 *   <li>{@link fhir.Specimen#getType <em>Type</em>}</li>
 *   <li>{@link fhir.Specimen#getParent <em>Parent</em>}</li>
 *   <li>{@link fhir.Specimen#getSubject <em>Subject</em>}</li>
 *   <li>{@link fhir.Specimen#getAccessionIdentifier <em>Accession Identifier</em>}</li>
 *   <li>{@link fhir.Specimen#getReceivedTime <em>Received Time</em>}</li>
 *   <li>{@link fhir.Specimen#getCollection <em>Collection</em>}</li>
 *   <li>{@link fhir.Specimen#getTreatment <em>Treatment</em>}</li>
 *   <li>{@link fhir.Specimen#getContainer <em>Container</em>}</li>
 * </ul>
 *
 * @see fhir.FhirPackage#getSpecimen()
...
public interface Specimen extends DomainResource {
	 ...
	 * @see fhir.FhirPackage#getSpecimen_Identifier()
	 ...
	 * @see fhir.FhirPackage#getSpecimen_Status()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.Specimen#getStatus <em>Status</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getSpecimen_Type()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.Specimen#getType <em>Type</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getSpecimen_Parent()
	 * @model containment="true"
	 ...
	 * @see fhir.FhirPackage#getSpecimen_Subject()
	...
	/**
	 * Sets the value of the '{@link fhir.Specimen#getSubject <em>Subject</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getSpecimen_AccessionIdentifier()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.Specimen#getAccessionIdentifier <em>Accession Identifier</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getSpecimen_ReceivedTime()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.Specimen#getReceivedTime <em>Received Time</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getSpecimen_Collection()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.Specimen#getCollection <em>Collection</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The list contents are of type {@link fhir.SpecimenTreatment}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 ...
	 * @see fhir.FhirPackage#getSpecimen_Treatment()
	 * @model containment="true"
	 ...
	 * The list contents are of type {@link fhir.SpecimenContainer}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 ...
	 * @see fhir.FhirPackage#getSpecimen_Container()
	 * @model containment="true"
