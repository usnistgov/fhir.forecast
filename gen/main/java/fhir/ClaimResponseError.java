 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.ClaimResponseError#getSequenceLinkId <em>Sequence Link Id</em>}</li>
 *   <li>{@link fhir.ClaimResponseError#getDetailSequenceLinkId <em>Detail Sequence Link Id</em>}</li>
 *   <li>{@link fhir.ClaimResponseError#getSubdetailSequenceLinkId <em>Subdetail Sequence Link Id</em>}</li>
 *   <li>{@link fhir.ClaimResponseError#getCode <em>Code</em>}</li>
 * </ul>
 *
 * @see fhir.FhirPackage#getClaimResponseError()
...
public interface ClaimResponseError extends BackboneElement {
	 ...
	 * @see fhir.FhirPackage#getClaimResponseError_SequenceLinkId()
	...
	/**
	 * Sets the value of the '{@link fhir.ClaimResponseError#getSequenceLinkId <em>Sequence Link Id</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getClaimResponseError_DetailSequenceLinkId()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.ClaimResponseError#getDetailSequenceLinkId <em>Detail Sequence Link Id</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getClaimResponseError_SubdetailSequenceLinkId()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.ClaimResponseError#getSubdetailSequenceLinkId <em>Subdetail Sequence Link Id</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setCode(Coding)
	 * @see fhir.FhirPackage#getClaimResponseError_Code()
	...
	/**
	 * Sets the value of the '{@link fhir.ClaimResponseError#getCode <em>Code</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
