 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.Markdown#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @see fhir.FhirPackage#getMarkdown()
...
public interface Markdown extends Element {
	 ...
	 * @see #setValue(String)
	 * @see fhir.FhirPackage#getMarkdown_Value()
	 * @model dataType="fhir.MarkdownPrimitive"
	...
	/**
	 * Sets the value of the '{@link fhir.Markdown#getValue <em>Value</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
