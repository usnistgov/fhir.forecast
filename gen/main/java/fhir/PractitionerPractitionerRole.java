 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.PractitionerPractitionerRole#getManagingOrganization <em>Managing Organization</em>}</li>
 *   <li>{@link fhir.PractitionerPractitionerRole#getRole <em>Role</em>}</li>
 *   <li>{@link fhir.PractitionerPractitionerRole#getSpecialty <em>Specialty</em>}</li>
 *   <li>{@link fhir.PractitionerPractitionerRole#getPeriod <em>Period</em>}</li>
 *   <li>{@link fhir.PractitionerPractitionerRole#getLocation <em>Location</em>}</li>
 *   <li>{@link fhir.PractitionerPractitionerRole#getHealthcareService <em>Healthcare Service</em>}</li>
 * </ul>
 *
 * @see fhir.FhirPackage#getPractitionerPractitionerRole()
...
public interface PractitionerPractitionerRole extends BackboneElement {
	 ...
	 * @see fhir.FhirPackage#getPractitionerPractitionerRole_ManagingOrganization()
	...
	/**
	 * Sets the value of the '{@link fhir.PractitionerPractitionerRole#getManagingOrganization <em>Managing Organization</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getPractitionerPractitionerRole_Role()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.PractitionerPractitionerRole#getRole <em>Role</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getPractitionerPractitionerRole_Specialty()
	 * @model containment="true"
	 ...
	 * @see fhir.FhirPackage#getPractitionerPractitionerRole_Period()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.PractitionerPractitionerRole#getPeriod <em>Period</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getPractitionerPractitionerRole_Location()
	 * @model containment="true"
	 ...
	 * @see fhir.FhirPackage#getPractitionerPractitionerRole_HealthcareService()
	 * @model containment="true"
