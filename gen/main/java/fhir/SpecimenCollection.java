 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.SpecimenCollection#getCollector <em>Collector</em>}</li>
 *   <li>{@link fhir.SpecimenCollection#getComment <em>Comment</em>}</li>
 *   <li>{@link fhir.SpecimenCollection#getCollectedDateTime <em>Collected Date Time</em>}</li>
 *   <li>{@link fhir.SpecimenCollection#getCollectedPeriod <em>Collected Period</em>}</li>
 *   <li>{@link fhir.SpecimenCollection#getQuantity <em>Quantity</em>}</li>
 *   <li>{@link fhir.SpecimenCollection#getMethod <em>Method</em>}</li>
 *   <li>{@link fhir.SpecimenCollection#getBodySite <em>Body Site</em>}</li>
 * </ul>
 *
 * @see fhir.FhirPackage#getSpecimenCollection()
...
public interface SpecimenCollection extends BackboneElement {
	 ...
	 * @see fhir.FhirPackage#getSpecimenCollection_Collector()
	...
	/**
	 * Sets the value of the '{@link fhir.SpecimenCollection#getCollector <em>Collector</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getSpecimenCollection_Comment()
	 * @model containment="true"
	 *        extendedMetaData="kind='element' name='comment' namespace='##targetNamespace'"
	 * @generated
	 */
	EList<fhir.String> getComment();
	 ...
	 * @see fhir.FhirPackage#getSpecimenCollection_CollectedDateTime()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.SpecimenCollection#getCollectedDateTime <em>Collected Date Time</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getSpecimenCollection_CollectedPeriod()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.SpecimenCollection#getCollectedPeriod <em>Collected Period</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getSpecimenCollection_Quantity()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.SpecimenCollection#getQuantity <em>Quantity</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getSpecimenCollection_Method()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.SpecimenCollection#getMethod <em>Method</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getSpecimenCollection_BodySite()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.SpecimenCollection#getBodySite <em>Body Site</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
