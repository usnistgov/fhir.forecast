 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.Questionnaire#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link fhir.Questionnaire#getVersion <em>Version</em>}</li>
 *   <li>{@link fhir.Questionnaire#getStatus <em>Status</em>}</li>
 *   <li>{@link fhir.Questionnaire#getDate <em>Date</em>}</li>
 *   <li>{@link fhir.Questionnaire#getPublisher <em>Publisher</em>}</li>
 *   <li>{@link fhir.Questionnaire#getTelecom <em>Telecom</em>}</li>
 *   <li>{@link fhir.Questionnaire#getSubjectType <em>Subject Type</em>}</li>
 *   <li>{@link fhir.Questionnaire#getGroup <em>Group</em>}</li>
 * </ul>
 *
 * @see fhir.FhirPackage#getQuestionnaire()
...
public interface Questionnaire extends DomainResource {
	 ...
	 * @see fhir.FhirPackage#getQuestionnaire_Identifier()
	 ...
	 * @see fhir.FhirPackage#getQuestionnaire_Version()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.Questionnaire#getVersion <em>Version</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getQuestionnaire_Status()
	...
	/**
	 * Sets the value of the '{@link fhir.Questionnaire#getStatus <em>Status</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getQuestionnaire_Date()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.Questionnaire#getDate <em>Date</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getQuestionnaire_Publisher()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.Questionnaire#getPublisher <em>Publisher</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getQuestionnaire_Telecom()
	 * @model containment="true"
	 ...
	 * @see fhir.FhirPackage#getQuestionnaire_SubjectType()
	 * @model containment="true"
	 ...
	 * @see fhir.FhirPackage#getQuestionnaire_Group()
	 * @model containment="true" required="true"
	...
	/**
	 * Sets the value of the '{@link fhir.Questionnaire#getGroup <em>Group</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
