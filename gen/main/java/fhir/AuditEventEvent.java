 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.AuditEventEvent#getType <em>Type</em>}</li>
 *   <li>{@link fhir.AuditEventEvent#getSubtype <em>Subtype</em>}</li>
 *   <li>{@link fhir.AuditEventEvent#getAction <em>Action</em>}</li>
 *   <li>{@link fhir.AuditEventEvent#getDateTime <em>Date Time</em>}</li>
 *   <li>{@link fhir.AuditEventEvent#getOutcome <em>Outcome</em>}</li>
 *   <li>{@link fhir.AuditEventEvent#getOutcomeDesc <em>Outcome Desc</em>}</li>
 *   <li>{@link fhir.AuditEventEvent#getPurposeOfEvent <em>Purpose Of Event</em>}</li>
 * </ul>
 *
 * @see fhir.FhirPackage#getAuditEventEvent()
...
public interface AuditEventEvent extends BackboneElement {
	 ...
	 * @see #setType(Coding)
	 * @see fhir.FhirPackage#getAuditEventEvent_Type()
	...
	/**
	 * Sets the value of the '{@link fhir.AuditEventEvent#getType <em>Type</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getAuditEventEvent_Subtype()
	 ...
	 * @see fhir.FhirPackage#getAuditEventEvent_Action()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.AuditEventEvent#getAction <em>Action</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getAuditEventEvent_DateTime()
	 * @model containment="true" required="true"
	...
	/**
	 * Sets the value of the '{@link fhir.AuditEventEvent#getDateTime <em>Date Time</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getAuditEventEvent_Outcome()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.AuditEventEvent#getOutcome <em>Outcome</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setOutcomeDesc(fhir.String)
	 * @see fhir.FhirPackage#getAuditEventEvent_OutcomeDesc()
	 * @model containment="true"
	 *        extendedMetaData="kind='element' name='outcomeDesc' namespace='##targetNamespace'"
	 * @generated
	 */
	fhir.String getOutcomeDesc();

	/**
	 * Sets the value of the '{@link fhir.AuditEventEvent#getOutcomeDesc <em>Outcome Desc</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	void setOutcomeDesc(fhir.String value);
	 ...
	 * @see fhir.FhirPackage#getAuditEventEvent_PurposeOfEvent()
	 * @model containment="true"
