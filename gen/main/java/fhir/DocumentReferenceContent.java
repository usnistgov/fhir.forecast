 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.DocumentReferenceContent#getAttachment <em>Attachment</em>}</li>
 *   <li>{@link fhir.DocumentReferenceContent#getFormat <em>Format</em>}</li>
 * </ul>
 *
 * @see fhir.FhirPackage#getDocumentReferenceContent()
...
public interface DocumentReferenceContent extends BackboneElement {
	 ...
	 * @see fhir.FhirPackage#getDocumentReferenceContent_Attachment()
	...
	/**
	 * Sets the value of the '{@link fhir.DocumentReferenceContent#getAttachment <em>Attachment</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getDocumentReferenceContent_Format()
