 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.OperationOutcomeIssue#getSeverity <em>Severity</em>}</li>
 *   <li>{@link fhir.OperationOutcomeIssue#getCode <em>Code</em>}</li>
 *   <li>{@link fhir.OperationOutcomeIssue#getDetails <em>Details</em>}</li>
 *   <li>{@link fhir.OperationOutcomeIssue#getDiagnostics <em>Diagnostics</em>}</li>
 *   <li>{@link fhir.OperationOutcomeIssue#getLocation <em>Location</em>}</li>
 * </ul>
 *
 * @see fhir.FhirPackage#getOperationOutcomeIssue()
...
public interface OperationOutcomeIssue extends BackboneElement {
	 ...
	 * @see fhir.FhirPackage#getOperationOutcomeIssue_Severity()
	...
	/**
	 * Sets the value of the '{@link fhir.OperationOutcomeIssue#getSeverity <em>Severity</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getOperationOutcomeIssue_Code()
	 * @model containment="true" required="true"
	...
	/**
	 * Sets the value of the '{@link fhir.OperationOutcomeIssue#getCode <em>Code</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getOperationOutcomeIssue_Details()
	...
	/**
	 * Sets the value of the '{@link fhir.OperationOutcomeIssue#getDetails <em>Details</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setDiagnostics(fhir.String)
	 * @see fhir.FhirPackage#getOperationOutcomeIssue_Diagnostics()
	 * @model containment="true"
	 *        extendedMetaData="kind='element' name='diagnostics' namespace='##targetNamespace'"
	 * @generated
	 */
	fhir.String getDiagnostics();

	/**
	 * Sets the value of the '{@link fhir.OperationOutcomeIssue#getDiagnostics <em>Diagnostics</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	void setDiagnostics(fhir.String value);
	 ...
	 * @see fhir.FhirPackage#getOperationOutcomeIssue_Location()
	 * @model containment="true"
	 *        extendedMetaData="kind='element' name='location' namespace='##targetNamespace'"
	 * @generated
	 */
	EList<fhir.String> getLocation();
