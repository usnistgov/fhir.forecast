 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.ClinicalImpressionFinding#getItem <em>Item</em>}</li>
 *   <li>{@link fhir.ClinicalImpressionFinding#getCause <em>Cause</em>}</li>
 * </ul>
 *
 * @see fhir.FhirPackage#getClinicalImpressionFinding()
...
public interface ClinicalImpressionFinding extends BackboneElement {
	 ...
	 * @see fhir.FhirPackage#getClinicalImpressionFinding_Item()
	...
	/**
	 * Sets the value of the '{@link fhir.ClinicalImpressionFinding#getItem <em>Item</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setCause(fhir.String)
	 * @see fhir.FhirPackage#getClinicalImpressionFinding_Cause()
	 * @model containment="true"
	 *        extendedMetaData="kind='element' name='cause' namespace='##targetNamespace'"
	 * @generated
	 */
	fhir.String getCause();

	/**
	 * Sets the value of the '{@link fhir.ClinicalImpressionFinding#getCause <em>Cause</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	void setCause(fhir.String value);
