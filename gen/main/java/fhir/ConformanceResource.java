 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.ConformanceResource#getType <em>Type</em>}</li>
 *   <li>{@link fhir.ConformanceResource#getProfile <em>Profile</em>}</li>
 *   <li>{@link fhir.ConformanceResource#getInteraction <em>Interaction</em>}</li>
 *   <li>{@link fhir.ConformanceResource#getVersioning <em>Versioning</em>}</li>
 *   <li>{@link fhir.ConformanceResource#getReadHistory <em>Read History</em>}</li>
 *   <li>{@link fhir.ConformanceResource#getUpdateCreate <em>Update Create</em>}</li>
 *   <li>{@link fhir.ConformanceResource#getConditionalCreate <em>Conditional Create</em>}</li>
 *   <li>{@link fhir.ConformanceResource#getConditionalUpdate <em>Conditional Update</em>}</li>
 *   <li>{@link fhir.ConformanceResource#getConditionalDelete <em>Conditional Delete</em>}</li>
 *   <li>{@link fhir.ConformanceResource#getSearchInclude <em>Search Include</em>}</li>
 *   <li>{@link fhir.ConformanceResource#getSearchRevInclude <em>Search Rev Include</em>}</li>
 *   <li>{@link fhir.ConformanceResource#getSearchParam <em>Search Param</em>}</li>
 * </ul>
 *
 * @see fhir.FhirPackage#getConformanceResource()
...
public interface ConformanceResource extends BackboneElement {
	 ...
	 * @see #setType(Code)
	 * @see fhir.FhirPackage#getConformanceResource_Type()
	...
	/**
	 * Sets the value of the '{@link fhir.ConformanceResource#getType <em>Type</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getConformanceResource_Profile()
	...
	/**
	 * Sets the value of the '{@link fhir.ConformanceResource#getProfile <em>Profile</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The list contents are of type {@link fhir.ConformanceInteraction}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 ...
	 * @see fhir.FhirPackage#getConformanceResource_Interaction()
	 * @model containment="true" required="true"
	 ...
	 * @see fhir.FhirPackage#getConformanceResource_Versioning()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.ConformanceResource#getVersioning <em>Versioning</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setReadHistory(fhir.Boolean)
	 * @see fhir.FhirPackage#getConformanceResource_ReadHistory()
	 * @model containment="true"
	 *        extendedMetaData="kind='element' name='readHistory' namespace='##targetNamespace'"
	 * @generated
	 */
	fhir.Boolean getReadHistory();

	/**
	 * Sets the value of the '{@link fhir.ConformanceResource#getReadHistory <em>Read History</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	void setReadHistory(fhir.Boolean value);
	 ...
	 * @see #setUpdateCreate(fhir.Boolean)
	 * @see fhir.FhirPackage#getConformanceResource_UpdateCreate()
	 * @model containment="true"
	 *        extendedMetaData="kind='element' name='updateCreate' namespace='##targetNamespace'"
	 * @generated
	 */
	fhir.Boolean getUpdateCreate();

	/**
	 * Sets the value of the '{@link fhir.ConformanceResource#getUpdateCreate <em>Update Create</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	void setUpdateCreate(fhir.Boolean value);
	 ...
	 * @see #setConditionalCreate(fhir.Boolean)
	 * @see fhir.FhirPackage#getConformanceResource_ConditionalCreate()
	 * @model containment="true"
	 *        extendedMetaData="kind='element' name='conditionalCreate' namespace='##targetNamespace'"
	 * @generated
	 */
	fhir.Boolean getConditionalCreate();

	/**
	 * Sets the value of the '{@link fhir.ConformanceResource#getConditionalCreate <em>Conditional Create</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	void setConditionalCreate(fhir.Boolean value);
	 ...
	 * @see #setConditionalUpdate(fhir.Boolean)
	 * @see fhir.FhirPackage#getConformanceResource_ConditionalUpdate()
	 * @model containment="true"
	 *        extendedMetaData="kind='element' name='conditionalUpdate' namespace='##targetNamespace'"
	 * @generated
	 */
	fhir.Boolean getConditionalUpdate();

	/**
	 * Sets the value of the '{@link fhir.ConformanceResource#getConditionalUpdate <em>Conditional Update</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	void setConditionalUpdate(fhir.Boolean value);
	 ...
	 * @see fhir.FhirPackage#getConformanceResource_ConditionalDelete()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.ConformanceResource#getConditionalDelete <em>Conditional Delete</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getConformanceResource_SearchInclude()
	 * @model containment="true"
	 *        extendedMetaData="kind='element' name='searchInclude' namespace='##targetNamespace'"
	 * @generated
	 */
	EList<fhir.String> getSearchInclude();
	 ...
	 * @see fhir.FhirPackage#getConformanceResource_SearchRevInclude()
	 * @model containment="true"
	 *        extendedMetaData="kind='element' name='searchRevInclude' namespace='##targetNamespace'"
	 * @generated
	 */
	EList<fhir.String> getSearchRevInclude();

	/**
	 * Returns the value of the '<em><b>Search Param</b></em>' containment reference list.
	 * The list contents are of type {@link fhir.ConformanceSearchParam}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 ...
	 * @see fhir.FhirPackage#getConformanceResource_SearchParam()
	 * @model containment="true"
