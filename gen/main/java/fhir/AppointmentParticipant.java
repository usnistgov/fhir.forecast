 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.AppointmentParticipant#getType <em>Type</em>}</li>
 *   <li>{@link fhir.AppointmentParticipant#getActor <em>Actor</em>}</li>
 *   <li>{@link fhir.AppointmentParticipant#getRequired <em>Required</em>}</li>
 *   <li>{@link fhir.AppointmentParticipant#getStatus <em>Status</em>}</li>
 * </ul>
 *
 * @see fhir.FhirPackage#getAppointmentParticipant()
...
public interface AppointmentParticipant extends BackboneElement {
	 ...
	 * @see fhir.FhirPackage#getAppointmentParticipant_Type()
	 ...
	 * @see fhir.FhirPackage#getAppointmentParticipant_Actor()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.AppointmentParticipant#getActor <em>Actor</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getAppointmentParticipant_Required()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.AppointmentParticipant#getRequired <em>Required</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getAppointmentParticipant_Status()
	...
	/**
	 * Sets the value of the '{@link fhir.AppointmentParticipant#getStatus <em>Status</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
