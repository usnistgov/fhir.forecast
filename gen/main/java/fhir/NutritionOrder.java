 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.NutritionOrder#getPatient <em>Patient</em>}</li>
 *   <li>{@link fhir.NutritionOrder#getOrderer <em>Orderer</em>}</li>
 *   <li>{@link fhir.NutritionOrder#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link fhir.NutritionOrder#getEncounter <em>Encounter</em>}</li>
 *   <li>{@link fhir.NutritionOrder#getDateTime <em>Date Time</em>}</li>
 *   <li>{@link fhir.NutritionOrder#getStatus <em>Status</em>}</li>
 *   <li>{@link fhir.NutritionOrder#getAllergyIntolerance <em>Allergy Intolerance</em>}</li>
 *   <li>{@link fhir.NutritionOrder#getFoodPreferenceModifier <em>Food Preference Modifier</em>}</li>
 *   <li>{@link fhir.NutritionOrder#getExcludeFoodModifier <em>Exclude Food Modifier</em>}</li>
 *   <li>{@link fhir.NutritionOrder#getOralDiet <em>Oral Diet</em>}</li>
 *   <li>{@link fhir.NutritionOrder#getSupplement <em>Supplement</em>}</li>
 *   <li>{@link fhir.NutritionOrder#getEnteralFormula <em>Enteral Formula</em>}</li>
 * </ul>
 *
 * @see fhir.FhirPackage#getNutritionOrder()
...
public interface NutritionOrder extends DomainResource {
	 ...
	 * @see fhir.FhirPackage#getNutritionOrder_Patient()
	...
	/**
	 * Sets the value of the '{@link fhir.NutritionOrder#getPatient <em>Patient</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getNutritionOrder_Orderer()
	...
	/**
	 * Sets the value of the '{@link fhir.NutritionOrder#getOrderer <em>Orderer</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getNutritionOrder_Identifier()
	 * @model containment="true"
	 ...
	 * @see fhir.FhirPackage#getNutritionOrder_Encounter()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.NutritionOrder#getEncounter <em>Encounter</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getNutritionOrder_DateTime()
	 * @model containment="true" required="true"
	...
	/**
	 * Sets the value of the '{@link fhir.NutritionOrder#getDateTime <em>Date Time</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getNutritionOrder_Status()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.NutritionOrder#getStatus <em>Status</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getNutritionOrder_AllergyIntolerance()
	 * @model containment="true"
	 ...
	 * @see fhir.FhirPackage#getNutritionOrder_FoodPreferenceModifier()
	 * @model containment="true"
	 ...
	 * @see fhir.FhirPackage#getNutritionOrder_ExcludeFoodModifier()
	 * @model containment="true"
	 ...
	 * @see fhir.FhirPackage#getNutritionOrder_OralDiet()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.NutritionOrder#getOralDiet <em>Oral Diet</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The list contents are of type {@link fhir.NutritionOrderSupplement}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 ...
	 * @see fhir.FhirPackage#getNutritionOrder_Supplement()
	 * @model containment="true"
	 ...
	 * @see fhir.FhirPackage#getNutritionOrder_EnteralFormula()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.NutritionOrder#getEnteralFormula <em>Enteral Formula</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
