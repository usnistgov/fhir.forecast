 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.HealthcareService#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link fhir.HealthcareService#getProvidedBy <em>Provided By</em>}</li>
 *   <li>{@link fhir.HealthcareService#getServiceCategory <em>Service Category</em>}</li>
 *   <li>{@link fhir.HealthcareService#getServiceType <em>Service Type</em>}</li>
 *   <li>{@link fhir.HealthcareService#getLocation <em>Location</em>}</li>
 *   <li>{@link fhir.HealthcareService#getServiceName <em>Service Name</em>}</li>
 *   <li>{@link fhir.HealthcareService#getComment <em>Comment</em>}</li>
 *   <li>{@link fhir.HealthcareService#getExtraDetails <em>Extra Details</em>}</li>
 *   <li>{@link fhir.HealthcareService#getPhoto <em>Photo</em>}</li>
 *   <li>{@link fhir.HealthcareService#getTelecom <em>Telecom</em>}</li>
 *   <li>{@link fhir.HealthcareService#getCoverageArea <em>Coverage Area</em>}</li>
 *   <li>{@link fhir.HealthcareService#getServiceProvisionCode <em>Service Provision Code</em>}</li>
 *   <li>{@link fhir.HealthcareService#getEligibility <em>Eligibility</em>}</li>
 *   <li>{@link fhir.HealthcareService#getEligibilityNote <em>Eligibility Note</em>}</li>
 *   <li>{@link fhir.HealthcareService#getProgramName <em>Program Name</em>}</li>
 *   <li>{@link fhir.HealthcareService#getCharacteristic <em>Characteristic</em>}</li>
 *   <li>{@link fhir.HealthcareService#getReferralMethod <em>Referral Method</em>}</li>
 *   <li>{@link fhir.HealthcareService#getPublicKey <em>Public Key</em>}</li>
 *   <li>{@link fhir.HealthcareService#getAppointmentRequired <em>Appointment Required</em>}</li>
 *   <li>{@link fhir.HealthcareService#getAvailableTime <em>Available Time</em>}</li>
 *   <li>{@link fhir.HealthcareService#getNotAvailable <em>Not Available</em>}</li>
 *   <li>{@link fhir.HealthcareService#getAvailabilityExceptions <em>Availability Exceptions</em>}</li>
 * </ul>
 *
 * @see fhir.FhirPackage#getHealthcareService()
...
public interface HealthcareService extends DomainResource {
	 ...
	 * @see fhir.FhirPackage#getHealthcareService_Identifier()
	 ...
	 * @see fhir.FhirPackage#getHealthcareService_ProvidedBy()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.HealthcareService#getProvidedBy <em>Provided By</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getHealthcareService_ServiceCategory()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.HealthcareService#getServiceCategory <em>Service Category</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The list contents are of type {@link fhir.HealthcareServiceServiceType}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 ...
	 * @see fhir.FhirPackage#getHealthcareService_ServiceType()
	 * @model containment="true"
	 ...
	 * @see fhir.FhirPackage#getHealthcareService_Location()
	...
	/**
	 * Sets the value of the '{@link fhir.HealthcareService#getLocation <em>Location</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setServiceName(fhir.String)
	 * @see fhir.FhirPackage#getHealthcareService_ServiceName()
	 * @model containment="true"
	 *        extendedMetaData="kind='element' name='serviceName' namespace='##targetNamespace'"
	 * @generated
	 */
	fhir.String getServiceName();

	/**
	 * Sets the value of the '{@link fhir.HealthcareService#getServiceName <em>Service Name</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	void setServiceName(fhir.String value);
	 ...
	 * @see fhir.FhirPackage#getHealthcareService_Comment()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.HealthcareService#getComment <em>Comment</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setExtraDetails(fhir.String)
	 * @see fhir.FhirPackage#getHealthcareService_ExtraDetails()
	 * @model containment="true"
	 *        extendedMetaData="kind='element' name='extraDetails' namespace='##targetNamespace'"
	 * @generated
	 */
	fhir.String getExtraDetails();

	/**
	 * Sets the value of the '{@link fhir.HealthcareService#getExtraDetails <em>Extra Details</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	void setExtraDetails(fhir.String value);
	 ...
	 * @see fhir.FhirPackage#getHealthcareService_Photo()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.HealthcareService#getPhoto <em>Photo</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getHealthcareService_Telecom()
	 * @model containment="true"
	 ...
	 * @see fhir.FhirPackage#getHealthcareService_CoverageArea()
	 * @model containment="true"
	 ...
	 * @see fhir.FhirPackage#getHealthcareService_ServiceProvisionCode()
	 * @model containment="true"
	 ...
	 * @see fhir.FhirPackage#getHealthcareService_Eligibility()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.HealthcareService#getEligibility <em>Eligibility</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setEligibilityNote(fhir.String)
	 * @see fhir.FhirPackage#getHealthcareService_EligibilityNote()
	 * @model containment="true"
	 *        extendedMetaData="kind='element' name='eligibilityNote' namespace='##targetNamespace'"
	 * @generated
	 */
	fhir.String getEligibilityNote();

	/**
	 * Sets the value of the '{@link fhir.HealthcareService#getEligibilityNote <em>Eligibility Note</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	void setEligibilityNote(fhir.String value);
	 ...
	 * @see fhir.FhirPackage#getHealthcareService_ProgramName()
	 * @model containment="true"
	 *        extendedMetaData="kind='element' name='programName' namespace='##targetNamespace'"
	 * @generated
	 */
	EList<fhir.String> getProgramName();
	 ...
	 * @see fhir.FhirPackage#getHealthcareService_Characteristic()
	 * @model containment="true"
	 ...
	 * @see fhir.FhirPackage#getHealthcareService_ReferralMethod()
	 * @model containment="true"
	 ...
	 * @see #setPublicKey(fhir.String)
	 * @see fhir.FhirPackage#getHealthcareService_PublicKey()
	 * @model containment="true"
	 *        extendedMetaData="kind='element' name='publicKey' namespace='##targetNamespace'"
	 * @generated
	 */
	fhir.String getPublicKey();

	/**
	 * Sets the value of the '{@link fhir.HealthcareService#getPublicKey <em>Public Key</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	void setPublicKey(fhir.String value);
	 ...
	 * @see #setAppointmentRequired(fhir.Boolean)
	 * @see fhir.FhirPackage#getHealthcareService_AppointmentRequired()
	 * @model containment="true"
	 *        extendedMetaData="kind='element' name='appointmentRequired' namespace='##targetNamespace'"
	 * @generated
	 */
	fhir.Boolean getAppointmentRequired();

	/**
	 * Sets the value of the '{@link fhir.HealthcareService#getAppointmentRequired <em>Appointment Required</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	void setAppointmentRequired(fhir.Boolean value);

	/**
	 * Returns the value of the '<em><b>Available Time</b></em>' containment reference list.
	 * The list contents are of type {@link fhir.HealthcareServiceAvailableTime}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 ...
	 * @see fhir.FhirPackage#getHealthcareService_AvailableTime()
	 * @model containment="true"
	 ...
	 * The list contents are of type {@link fhir.HealthcareServiceNotAvailable}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 ...
	 * @see fhir.FhirPackage#getHealthcareService_NotAvailable()
	 * @model containment="true"
	 ...
	 * @see #setAvailabilityExceptions(fhir.String)
	 * @see fhir.FhirPackage#getHealthcareService_AvailabilityExceptions()
	 * @model containment="true"
	 *        extendedMetaData="kind='element' name='availabilityExceptions' namespace='##targetNamespace'"
	 * @generated
	 */
	fhir.String getAvailabilityExceptions();

	/**
	 * Sets the value of the '{@link fhir.HealthcareService#getAvailabilityExceptions <em>Availability Exceptions</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	void setAvailabilityExceptions(fhir.String value);
