 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.Procedure#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link fhir.Procedure#getSubject <em>Subject</em>}</li>
 *   <li>{@link fhir.Procedure#getStatus <em>Status</em>}</li>
 *   <li>{@link fhir.Procedure#getCategory <em>Category</em>}</li>
 *   <li>{@link fhir.Procedure#getCode <em>Code</em>}</li>
 *   <li>{@link fhir.Procedure#getNotPerformed <em>Not Performed</em>}</li>
 *   <li>{@link fhir.Procedure#getReasonNotPerformed <em>Reason Not Performed</em>}</li>
 *   <li>{@link fhir.Procedure#getBodySite <em>Body Site</em>}</li>
 *   <li>{@link fhir.Procedure#getReasonCodeableConcept <em>Reason Codeable Concept</em>}</li>
 *   <li>{@link fhir.Procedure#getReasonReference <em>Reason Reference</em>}</li>
 *   <li>{@link fhir.Procedure#getPerformer <em>Performer</em>}</li>
 *   <li>{@link fhir.Procedure#getPerformedDateTime <em>Performed Date Time</em>}</li>
 *   <li>{@link fhir.Procedure#getPerformedPeriod <em>Performed Period</em>}</li>
 *   <li>{@link fhir.Procedure#getEncounter <em>Encounter</em>}</li>
 *   <li>{@link fhir.Procedure#getLocation <em>Location</em>}</li>
 *   <li>{@link fhir.Procedure#getOutcome <em>Outcome</em>}</li>
 *   <li>{@link fhir.Procedure#getReport <em>Report</em>}</li>
 *   <li>{@link fhir.Procedure#getComplication <em>Complication</em>}</li>
 *   <li>{@link fhir.Procedure#getFollowUp <em>Follow Up</em>}</li>
 *   <li>{@link fhir.Procedure#getRequest <em>Request</em>}</li>
 *   <li>{@link fhir.Procedure#getNotes <em>Notes</em>}</li>
 *   <li>{@link fhir.Procedure#getFocalDevice <em>Focal Device</em>}</li>
 *   <li>{@link fhir.Procedure#getUsed <em>Used</em>}</li>
 * </ul>
 *
 * @see fhir.FhirPackage#getProcedure()
...
public interface Procedure extends DomainResource {
	 ...
	 * @see fhir.FhirPackage#getProcedure_Identifier()
	 ...
	 * @see fhir.FhirPackage#getProcedure_Subject()
	...
	/**
	 * Sets the value of the '{@link fhir.Procedure#getSubject <em>Subject</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getProcedure_Status()
	 * @model containment="true" required="true"
	...
	/**
	 * Sets the value of the '{@link fhir.Procedure#getStatus <em>Status</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getProcedure_Category()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.Procedure#getCategory <em>Category</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getProcedure_Code()
	 * @model containment="true" required="true"
	...
	/**
	 * Sets the value of the '{@link fhir.Procedure#getCode <em>Code</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setNotPerformed(fhir.Boolean)
	 * @see fhir.FhirPackage#getProcedure_NotPerformed()
	 * @model containment="true"
	 *        extendedMetaData="kind='element' name='notPerformed' namespace='##targetNamespace'"
	 * @generated
	 */
	fhir.Boolean getNotPerformed();

	/**
	 * Sets the value of the '{@link fhir.Procedure#getNotPerformed <em>Not Performed</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	void setNotPerformed(fhir.Boolean value);
	 ...
	 * @see fhir.FhirPackage#getProcedure_ReasonNotPerformed()
	 * @model containment="true"
	 ...
	 * @see fhir.FhirPackage#getProcedure_BodySite()
	 * @model containment="true"
	 ...
	 * @see fhir.FhirPackage#getProcedure_ReasonCodeableConcept()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.Procedure#getReasonCodeableConcept <em>Reason Codeable Concept</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getProcedure_ReasonReference()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.Procedure#getReasonReference <em>Reason Reference</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The list contents are of type {@link fhir.ProcedurePerformer}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 ...
	 * @see fhir.FhirPackage#getProcedure_Performer()
	 * @model containment="true"
	 ...
	 * @see fhir.FhirPackage#getProcedure_PerformedDateTime()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.Procedure#getPerformedDateTime <em>Performed Date Time</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getProcedure_PerformedPeriod()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.Procedure#getPerformedPeriod <em>Performed Period</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getProcedure_Encounter()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.Procedure#getEncounter <em>Encounter</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getProcedure_Location()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.Procedure#getLocation <em>Location</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getProcedure_Outcome()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.Procedure#getOutcome <em>Outcome</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getProcedure_Report()
	 * @model containment="true"
	 ...
	 * @see fhir.FhirPackage#getProcedure_Complication()
	 * @model containment="true"
	 ...
	 * @see fhir.FhirPackage#getProcedure_FollowUp()
	 * @model containment="true"
	 ...
	 * @see fhir.FhirPackage#getProcedure_Request()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.Procedure#getRequest <em>Request</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getProcedure_Notes()
	 * @model containment="true"
	 ...
	 * The list contents are of type {@link fhir.ProcedureFocalDevice}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 ...
	 * @see fhir.FhirPackage#getProcedure_FocalDevice()
	 * @model containment="true"
	 ...
	 * @see fhir.FhirPackage#getProcedure_Used()
	 * @model containment="true"
