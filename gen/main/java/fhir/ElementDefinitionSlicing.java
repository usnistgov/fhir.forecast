 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.ElementDefinitionSlicing#getDiscriminator <em>Discriminator</em>}</li>
 *   <li>{@link fhir.ElementDefinitionSlicing#getDescription <em>Description</em>}</li>
 *   <li>{@link fhir.ElementDefinitionSlicing#getOrdered <em>Ordered</em>}</li>
 *   <li>{@link fhir.ElementDefinitionSlicing#getRules <em>Rules</em>}</li>
 * </ul>
 *
 * @see fhir.FhirPackage#getElementDefinitionSlicing()
...
public interface ElementDefinitionSlicing extends Element {
	 ...
	 * @see fhir.FhirPackage#getElementDefinitionSlicing_Discriminator()
	 * @model containment="true"
	 *        extendedMetaData="kind='element' name='discriminator' namespace='##targetNamespace'"
	 * @generated
	 */
	EList<fhir.String> getDiscriminator();
	 ...
	 * @see fhir.FhirPackage#getElementDefinitionSlicing_Description()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.ElementDefinitionSlicing#getDescription <em>Description</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setOrdered(fhir.Boolean)
	 * @see fhir.FhirPackage#getElementDefinitionSlicing_Ordered()
	 * @model containment="true"
	 *        extendedMetaData="kind='element' name='ordered' namespace='##targetNamespace'"
	 * @generated
	 */
	fhir.Boolean getOrdered();

	/**
	 * Sets the value of the '{@link fhir.ElementDefinitionSlicing#getOrdered <em>Ordered</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	void setOrdered(fhir.Boolean value);
	 ...
	 * @see fhir.FhirPackage#getElementDefinitionSlicing_Rules()
	...
	/**
	 * Sets the value of the '{@link fhir.ElementDefinitionSlicing#getRules <em>Rules</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
