 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.impl.DeviceUseStatementImpl#getBodySiteCodeableConcept <em>Body Site Codeable Concept</em>}</li>
 *   <li>{@link fhir.impl.DeviceUseStatementImpl#getBodySiteReference <em>Body Site Reference</em>}</li>
 *   <li>{@link fhir.impl.DeviceUseStatementImpl#getWhenUsed <em>When Used</em>}</li>
 *   <li>{@link fhir.impl.DeviceUseStatementImpl#getDevice <em>Device</em>}</li>
 *   <li>{@link fhir.impl.DeviceUseStatementImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link fhir.impl.DeviceUseStatementImpl#getIndication <em>Indication</em>}</li>
 *   <li>{@link fhir.impl.DeviceUseStatementImpl#getNotes <em>Notes</em>}</li>
 *   <li>{@link fhir.impl.DeviceUseStatementImpl#getRecordedOn <em>Recorded On</em>}</li>
 *   <li>{@link fhir.impl.DeviceUseStatementImpl#getSubject <em>Subject</em>}</li>
 *   <li>{@link fhir.impl.DeviceUseStatementImpl#getTimingTiming <em>Timing Timing</em>}</li>
 *   <li>{@link fhir.impl.DeviceUseStatementImpl#getTimingPeriod <em>Timing Period</em>}</li>
 *   <li>{@link fhir.impl.DeviceUseStatementImpl#getTimingDateTime <em>Timing Date Time</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DeviceUseStatementImpl extends DomainResourceImpl implements DeviceUseStatement {
	...
	public EList<fhir.String> getNotes() {
		if (notes == null) {
			notes = new EObjectContainmentEList<fhir.String>(fhir.String.class, this, FhirPackage.DEVICE_USE_STATEMENT__NOTES);
		}
		return notes;
	}
