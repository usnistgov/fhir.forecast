 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.impl.VisionPrescriptionImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link fhir.impl.VisionPrescriptionImpl#getDateWritten <em>Date Written</em>}</li>
 *   <li>{@link fhir.impl.VisionPrescriptionImpl#getPatient <em>Patient</em>}</li>
 *   <li>{@link fhir.impl.VisionPrescriptionImpl#getPrescriber <em>Prescriber</em>}</li>
 *   <li>{@link fhir.impl.VisionPrescriptionImpl#getEncounter <em>Encounter</em>}</li>
 *   <li>{@link fhir.impl.VisionPrescriptionImpl#getReasonCodeableConcept <em>Reason Codeable Concept</em>}</li>
 *   <li>{@link fhir.impl.VisionPrescriptionImpl#getReasonReference <em>Reason Reference</em>}</li>
 *   <li>{@link fhir.impl.VisionPrescriptionImpl#getDispense <em>Dispense</em>}</li>
 * </ul>
 *
 * @generated
 */
