 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.impl.ClaimResponseAddItemImpl#getSequenceLinkId <em>Sequence Link Id</em>}</li>
 *   <li>{@link fhir.impl.ClaimResponseAddItemImpl#getService <em>Service</em>}</li>
 *   <li>{@link fhir.impl.ClaimResponseAddItemImpl#getFee <em>Fee</em>}</li>
 *   <li>{@link fhir.impl.ClaimResponseAddItemImpl#getNoteNumberLinkId <em>Note Number Link Id</em>}</li>
 *   <li>{@link fhir.impl.ClaimResponseAddItemImpl#getAdjudication <em>Adjudication</em>}</li>
 *   <li>{@link fhir.impl.ClaimResponseAddItemImpl#getDetail <em>Detail</em>}</li>
 * </ul>
 *
 * @generated
 */
