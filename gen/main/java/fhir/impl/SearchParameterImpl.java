 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.impl.SearchParameterImpl#getUrl <em>Url</em>}</li>
 *   <li>{@link fhir.impl.SearchParameterImpl#getName <em>Name</em>}</li>
 *   <li>{@link fhir.impl.SearchParameterImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link fhir.impl.SearchParameterImpl#getExperimental <em>Experimental</em>}</li>
 *   <li>{@link fhir.impl.SearchParameterImpl#getPublisher <em>Publisher</em>}</li>
 *   <li>{@link fhir.impl.SearchParameterImpl#getContact <em>Contact</em>}</li>
 *   <li>{@link fhir.impl.SearchParameterImpl#getDate <em>Date</em>}</li>
 *   <li>{@link fhir.impl.SearchParameterImpl#getRequirements <em>Requirements</em>}</li>
 *   <li>{@link fhir.impl.SearchParameterImpl#getCode <em>Code</em>}</li>
 *   <li>{@link fhir.impl.SearchParameterImpl#getBase <em>Base</em>}</li>
 *   <li>{@link fhir.impl.SearchParameterImpl#getType <em>Type</em>}</li>
 *   <li>{@link fhir.impl.SearchParameterImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link fhir.impl.SearchParameterImpl#getXpath <em>Xpath</em>}</li>
 *   <li>{@link fhir.impl.SearchParameterImpl#getXpathUsage <em>Xpath Usage</em>}</li>
 *   <li>{@link fhir.impl.SearchParameterImpl#getTarget <em>Target</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SearchParameterImpl extends DomainResourceImpl implements SearchParameter {
	 ...
	 * @generated
	 */
	public NotificationChain basicSetXpath(fhir.String newXpath, NotificationChain msgs) {
		fhir.String oldXpath = xpath;
		xpath = newXpath;
		if (eNotificationRequired()) {
	 ...
	 * @generated
	 */
	public void setXpath(fhir.String newXpath) {
		if (newXpath != xpath) {
			NotificationChain msgs = null;
			if (xpath != null)
