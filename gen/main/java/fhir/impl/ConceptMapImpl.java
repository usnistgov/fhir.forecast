 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.impl.ConceptMapImpl#getUrl <em>Url</em>}</li>
 *   <li>{@link fhir.impl.ConceptMapImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link fhir.impl.ConceptMapImpl#getVersion <em>Version</em>}</li>
 *   <li>{@link fhir.impl.ConceptMapImpl#getName <em>Name</em>}</li>
 *   <li>{@link fhir.impl.ConceptMapImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link fhir.impl.ConceptMapImpl#getExperimental <em>Experimental</em>}</li>
 *   <li>{@link fhir.impl.ConceptMapImpl#getPublisher <em>Publisher</em>}</li>
 *   <li>{@link fhir.impl.ConceptMapImpl#getContact <em>Contact</em>}</li>
 *   <li>{@link fhir.impl.ConceptMapImpl#getDate <em>Date</em>}</li>
 *   <li>{@link fhir.impl.ConceptMapImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link fhir.impl.ConceptMapImpl#getUseContext <em>Use Context</em>}</li>
 *   <li>{@link fhir.impl.ConceptMapImpl#getRequirements <em>Requirements</em>}</li>
 *   <li>{@link fhir.impl.ConceptMapImpl#getCopyright <em>Copyright</em>}</li>
 *   <li>{@link fhir.impl.ConceptMapImpl#getSourceUri <em>Source Uri</em>}</li>
 *   <li>{@link fhir.impl.ConceptMapImpl#getSourceReference <em>Source Reference</em>}</li>
 *   <li>{@link fhir.impl.ConceptMapImpl#getTargetUri <em>Target Uri</em>}</li>
 *   <li>{@link fhir.impl.ConceptMapImpl#getTargetReference <em>Target Reference</em>}</li>
 *   <li>{@link fhir.impl.ConceptMapImpl#getElement <em>Element</em>}</li>
 * </ul>
 *
 * @generated
 */
