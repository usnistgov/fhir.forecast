 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.impl.AppointmentImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link fhir.impl.AppointmentImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link fhir.impl.AppointmentImpl#getType <em>Type</em>}</li>
 *   <li>{@link fhir.impl.AppointmentImpl#getReason <em>Reason</em>}</li>
 *   <li>{@link fhir.impl.AppointmentImpl#getPriority <em>Priority</em>}</li>
 *   <li>{@link fhir.impl.AppointmentImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link fhir.impl.AppointmentImpl#getStart <em>Start</em>}</li>
 *   <li>{@link fhir.impl.AppointmentImpl#getEnd <em>End</em>}</li>
 *   <li>{@link fhir.impl.AppointmentImpl#getMinutesDuration <em>Minutes Duration</em>}</li>
 *   <li>{@link fhir.impl.AppointmentImpl#getSlot <em>Slot</em>}</li>
 *   <li>{@link fhir.impl.AppointmentImpl#getComment <em>Comment</em>}</li>
 *   <li>{@link fhir.impl.AppointmentImpl#getParticipant <em>Participant</em>}</li>
 * </ul>
 *
 * @generated
 */
