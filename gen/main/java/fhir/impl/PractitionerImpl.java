 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.impl.PractitionerImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link fhir.impl.PractitionerImpl#getActive <em>Active</em>}</li>
 *   <li>{@link fhir.impl.PractitionerImpl#getName <em>Name</em>}</li>
 *   <li>{@link fhir.impl.PractitionerImpl#getTelecom <em>Telecom</em>}</li>
 *   <li>{@link fhir.impl.PractitionerImpl#getAddress <em>Address</em>}</li>
 *   <li>{@link fhir.impl.PractitionerImpl#getGender <em>Gender</em>}</li>
 *   <li>{@link fhir.impl.PractitionerImpl#getBirthDate <em>Birth Date</em>}</li>
 *   <li>{@link fhir.impl.PractitionerImpl#getPhoto <em>Photo</em>}</li>
 *   <li>{@link fhir.impl.PractitionerImpl#getPractitionerRole <em>Practitioner Role</em>}</li>
 *   <li>{@link fhir.impl.PractitionerImpl#getQualification <em>Qualification</em>}</li>
 *   <li>{@link fhir.impl.PractitionerImpl#getCommunication <em>Communication</em>}</li>
 * </ul>
 *
 * @generated
 */
