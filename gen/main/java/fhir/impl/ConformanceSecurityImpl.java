 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.impl.ConformanceSecurityImpl#getCors <em>Cors</em>}</li>
 *   <li>{@link fhir.impl.ConformanceSecurityImpl#getService <em>Service</em>}</li>
 *   <li>{@link fhir.impl.ConformanceSecurityImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link fhir.impl.ConformanceSecurityImpl#getCertificate <em>Certificate</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ConformanceSecurityImpl extends BackboneElementImpl implements ConformanceSecurity {
	 ...
	 * @generated
	 */
	public NotificationChain basicSetCors(fhir.Boolean newCors, NotificationChain msgs) {
		fhir.Boolean oldCors = cors;
		cors = newCors;
	 ...
	 * @generated
	 */
	public void setCors(fhir.Boolean newCors) {
		if (newCors != cors) {
