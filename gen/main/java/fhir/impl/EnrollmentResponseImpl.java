 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.impl.EnrollmentResponseImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link fhir.impl.EnrollmentResponseImpl#getRequest <em>Request</em>}</li>
 *   <li>{@link fhir.impl.EnrollmentResponseImpl#getOutcome <em>Outcome</em>}</li>
 *   <li>{@link fhir.impl.EnrollmentResponseImpl#getDisposition <em>Disposition</em>}</li>
 *   <li>{@link fhir.impl.EnrollmentResponseImpl#getRuleset <em>Ruleset</em>}</li>
 *   <li>{@link fhir.impl.EnrollmentResponseImpl#getOriginalRuleset <em>Original Ruleset</em>}</li>
 *   <li>{@link fhir.impl.EnrollmentResponseImpl#getCreated <em>Created</em>}</li>
 *   <li>{@link fhir.impl.EnrollmentResponseImpl#getOrganization <em>Organization</em>}</li>
 *   <li>{@link fhir.impl.EnrollmentResponseImpl#getRequestProvider <em>Request Provider</em>}</li>
 *   <li>{@link fhir.impl.EnrollmentResponseImpl#getRequestOrganization <em>Request Organization</em>}</li>
 * </ul>
 *
 * @generated
 */
