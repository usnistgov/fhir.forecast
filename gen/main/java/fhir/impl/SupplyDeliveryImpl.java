 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.impl.SupplyDeliveryImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link fhir.impl.SupplyDeliveryImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link fhir.impl.SupplyDeliveryImpl#getPatient <em>Patient</em>}</li>
 *   <li>{@link fhir.impl.SupplyDeliveryImpl#getType <em>Type</em>}</li>
 *   <li>{@link fhir.impl.SupplyDeliveryImpl#getQuantity <em>Quantity</em>}</li>
 *   <li>{@link fhir.impl.SupplyDeliveryImpl#getSuppliedItem <em>Supplied Item</em>}</li>
 *   <li>{@link fhir.impl.SupplyDeliveryImpl#getSupplier <em>Supplier</em>}</li>
 *   <li>{@link fhir.impl.SupplyDeliveryImpl#getWhenPrepared <em>When Prepared</em>}</li>
 *   <li>{@link fhir.impl.SupplyDeliveryImpl#getTime <em>Time</em>}</li>
 *   <li>{@link fhir.impl.SupplyDeliveryImpl#getDestination <em>Destination</em>}</li>
 *   <li>{@link fhir.impl.SupplyDeliveryImpl#getReceiver <em>Receiver</em>}</li>
 * </ul>
 *
 * @generated
 */
