 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.impl.SpecimenContainerImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link fhir.impl.SpecimenContainerImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link fhir.impl.SpecimenContainerImpl#getType <em>Type</em>}</li>
 *   <li>{@link fhir.impl.SpecimenContainerImpl#getCapacity <em>Capacity</em>}</li>
 *   <li>{@link fhir.impl.SpecimenContainerImpl#getSpecimenQuantity <em>Specimen Quantity</em>}</li>
 *   <li>{@link fhir.impl.SpecimenContainerImpl#getAdditiveCodeableConcept <em>Additive Codeable Concept</em>}</li>
 *   <li>{@link fhir.impl.SpecimenContainerImpl#getAdditiveReference <em>Additive Reference</em>}</li>
 * </ul>
 *
 * @generated
 */
