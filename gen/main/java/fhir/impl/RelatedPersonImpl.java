 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.impl.RelatedPersonImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link fhir.impl.RelatedPersonImpl#getPatient <em>Patient</em>}</li>
 *   <li>{@link fhir.impl.RelatedPersonImpl#getRelationship <em>Relationship</em>}</li>
 *   <li>{@link fhir.impl.RelatedPersonImpl#getName <em>Name</em>}</li>
 *   <li>{@link fhir.impl.RelatedPersonImpl#getTelecom <em>Telecom</em>}</li>
 *   <li>{@link fhir.impl.RelatedPersonImpl#getGender <em>Gender</em>}</li>
 *   <li>{@link fhir.impl.RelatedPersonImpl#getBirthDate <em>Birth Date</em>}</li>
 *   <li>{@link fhir.impl.RelatedPersonImpl#getAddress <em>Address</em>}</li>
 *   <li>{@link fhir.impl.RelatedPersonImpl#getPhoto <em>Photo</em>}</li>
 *   <li>{@link fhir.impl.RelatedPersonImpl#getPeriod <em>Period</em>}</li>
 * </ul>
 *
 * @generated
 */
