 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.impl.MedicationStatementDosageImpl#getText <em>Text</em>}</li>
 *   <li>{@link fhir.impl.MedicationStatementDosageImpl#getTiming <em>Timing</em>}</li>
 *   <li>{@link fhir.impl.MedicationStatementDosageImpl#getAsNeededBoolean <em>As Needed Boolean</em>}</li>
 *   <li>{@link fhir.impl.MedicationStatementDosageImpl#getAsNeededCodeableConcept <em>As Needed Codeable Concept</em>}</li>
 *   <li>{@link fhir.impl.MedicationStatementDosageImpl#getSiteCodeableConcept <em>Site Codeable Concept</em>}</li>
 *   <li>{@link fhir.impl.MedicationStatementDosageImpl#getSiteReference <em>Site Reference</em>}</li>
 *   <li>{@link fhir.impl.MedicationStatementDosageImpl#getRoute <em>Route</em>}</li>
 *   <li>{@link fhir.impl.MedicationStatementDosageImpl#getMethod <em>Method</em>}</li>
 *   <li>{@link fhir.impl.MedicationStatementDosageImpl#getQuantityQuantity <em>Quantity Quantity</em>}</li>
 *   <li>{@link fhir.impl.MedicationStatementDosageImpl#getQuantityRange <em>Quantity Range</em>}</li>
 *   <li>{@link fhir.impl.MedicationStatementDosageImpl#getRateRatio <em>Rate Ratio</em>}</li>
 *   <li>{@link fhir.impl.MedicationStatementDosageImpl#getRateRange <em>Rate Range</em>}</li>
 *   <li>{@link fhir.impl.MedicationStatementDosageImpl#getMaxDosePerPeriod <em>Max Dose Per Period</em>}</li>
 * </ul>
 *
 * @generated
 */
