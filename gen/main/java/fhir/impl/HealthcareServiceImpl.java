 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.impl.HealthcareServiceImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link fhir.impl.HealthcareServiceImpl#getProvidedBy <em>Provided By</em>}</li>
 *   <li>{@link fhir.impl.HealthcareServiceImpl#getServiceCategory <em>Service Category</em>}</li>
 *   <li>{@link fhir.impl.HealthcareServiceImpl#getServiceType <em>Service Type</em>}</li>
 *   <li>{@link fhir.impl.HealthcareServiceImpl#getLocation <em>Location</em>}</li>
 *   <li>{@link fhir.impl.HealthcareServiceImpl#getServiceName <em>Service Name</em>}</li>
 *   <li>{@link fhir.impl.HealthcareServiceImpl#getComment <em>Comment</em>}</li>
 *   <li>{@link fhir.impl.HealthcareServiceImpl#getExtraDetails <em>Extra Details</em>}</li>
 *   <li>{@link fhir.impl.HealthcareServiceImpl#getPhoto <em>Photo</em>}</li>
 *   <li>{@link fhir.impl.HealthcareServiceImpl#getTelecom <em>Telecom</em>}</li>
 *   <li>{@link fhir.impl.HealthcareServiceImpl#getCoverageArea <em>Coverage Area</em>}</li>
 *   <li>{@link fhir.impl.HealthcareServiceImpl#getServiceProvisionCode <em>Service Provision Code</em>}</li>
 *   <li>{@link fhir.impl.HealthcareServiceImpl#getEligibility <em>Eligibility</em>}</li>
 *   <li>{@link fhir.impl.HealthcareServiceImpl#getEligibilityNote <em>Eligibility Note</em>}</li>
 *   <li>{@link fhir.impl.HealthcareServiceImpl#getProgramName <em>Program Name</em>}</li>
 *   <li>{@link fhir.impl.HealthcareServiceImpl#getCharacteristic <em>Characteristic</em>}</li>
 *   <li>{@link fhir.impl.HealthcareServiceImpl#getReferralMethod <em>Referral Method</em>}</li>
 *   <li>{@link fhir.impl.HealthcareServiceImpl#getPublicKey <em>Public Key</em>}</li>
 *   <li>{@link fhir.impl.HealthcareServiceImpl#getAppointmentRequired <em>Appointment Required</em>}</li>
 *   <li>{@link fhir.impl.HealthcareServiceImpl#getAvailableTime <em>Available Time</em>}</li>
 *   <li>{@link fhir.impl.HealthcareServiceImpl#getNotAvailable <em>Not Available</em>}</li>
 *   <li>{@link fhir.impl.HealthcareServiceImpl#getAvailabilityExceptions <em>Availability Exceptions</em>}</li>
 * </ul>
 *
 * @generated
 */
public class HealthcareServiceImpl extends DomainResourceImpl implements HealthcareService {
	 ...
	 * @ordered
	 */
	protected fhir.String serviceName;
	 ...
	 * @ordered
	 */
	protected fhir.String extraDetails;
	 ...
	 * @ordered
	 */
	protected fhir.String eligibilityNote;
	 ...
	 * @ordered
	 */
	protected EList<fhir.String> programName;
	 ...
	 * @ordered
	 */
	protected fhir.String publicKey;
	 ...
	 * @ordered
	 */
	protected fhir.Boolean appointmentRequired;
	 ...
	 * @ordered
	 */
	protected fhir.String availabilityExceptions;
	 ...
	 * @generated
	 */
	public fhir.String getServiceName() {
		return serviceName;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetServiceName(fhir.String newServiceName, NotificationChain msgs) {
		fhir.String oldServiceName = serviceName;
	 ...
	 * @generated
	 */
	public void setServiceName(fhir.String newServiceName) {
	 ...
	 * @generated
	 */
	public NotificationChain basicSetComment(fhir.String newComment, NotificationChain msgs) {
		fhir.String oldComment = comment;
		comment = newComment;
		if (eNotificationRequired()) {
	 ...
	 * @generated
	 */
	public void setComment(fhir.String newComment) {
	 ...
	 * @generated
	 */
	public fhir.String getExtraDetails() {
		return extraDetails;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetExtraDetails(fhir.String newExtraDetails, NotificationChain msgs) {
		fhir.String oldExtraDetails = extraDetails;
	 ...
	 * @generated
	 */
	public void setExtraDetails(fhir.String newExtraDetails) {
	 ...
	 * @generated
	 */
	public fhir.String getEligibilityNote() {
	 ...
	 * @generated
	 */
	public NotificationChain basicSetEligibilityNote(fhir.String newEligibilityNote, NotificationChain msgs) {
		fhir.String oldEligibilityNote = eligibilityNote;
	 ...
	 * @generated
	 */
	public void setEligibilityNote(fhir.String newEligibilityNote) {
	 ...
	 * @generated
	 */
	public EList<fhir.String> getProgramName() {
		if (programName == null) {
			programName = new EObjectContainmentEList<fhir.String>(fhir.String.class, this, FhirPackage.HEALTHCARE_SERVICE__PROGRAM_NAME);
		}
		return programName;
	}
	 ...
	 * @generated
	 */
	public fhir.String getPublicKey() {
		return publicKey;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetPublicKey(fhir.String newPublicKey, NotificationChain msgs) {
		fhir.String oldPublicKey = publicKey;
	 ...
	 * @generated
	 */
	public void setPublicKey(fhir.String newPublicKey) {
	 ...
	 * @generated
	 */
	public fhir.Boolean getAppointmentRequired() {
	 ...
	 * @generated
	 */
	public NotificationChain basicSetAppointmentRequired(fhir.Boolean newAppointmentRequired, NotificationChain msgs) {
		fhir.Boolean oldAppointmentRequired = appointmentRequired;
	 ...
	 * @generated
	 */
	public void setAppointmentRequired(fhir.Boolean newAppointmentRequired) {
	 ...
	 * @generated
	 */
	public fhir.String getAvailabilityExceptions() {
	 ...
	 * @generated
	 */
	public NotificationChain basicSetAvailabilityExceptions(fhir.String newAvailabilityExceptions, NotificationChain msgs) {
		fhir.String oldAvailabilityExceptions = availabilityExceptions;
	 ...
	 * @generated
	 */
	public void setAvailabilityExceptions(fhir.String newAvailabilityExceptions) {
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case FhirPackage.HEALTHCARE_SERVICE__LOCATION:
				...
				return;
			case FhirPackage.HEALTHCARE_SERVICE__SERVICE_NAME:
				setServiceName((fhir.String)newValue);
				return;
			case FhirPackage.HEALTHCARE_SERVICE__COMMENT:
				setComment((fhir.String)newValue);
				return;
			case FhirPackage.HEALTHCARE_SERVICE__EXTRA_DETAILS:
				setExtraDetails((fhir.String)newValue);
				return;
			case FhirPackage.HEALTHCARE_SERVICE__PHOTO:
			...
			case FhirPackage.HEALTHCARE_SERVICE__ELIGIBILITY:
				...
				return;
			case FhirPackage.HEALTHCARE_SERVICE__ELIGIBILITY_NOTE:
				setEligibilityNote((fhir.String)newValue);
				return;
			case FhirPackage.HEALTHCARE_SERVICE__PROGRAM_NAME:
				getProgramName().clear();
				getProgramName().addAll((Collection<? extends fhir.String>)newValue);
				return;
			case FhirPackage.HEALTHCARE_SERVICE__CHARACTERISTIC:
			...
			case FhirPackage.HEALTHCARE_SERVICE__REFERRAL_METHOD:
				...
				return;
			case FhirPackage.HEALTHCARE_SERVICE__PUBLIC_KEY:
				setPublicKey((fhir.String)newValue);
				return;
			case FhirPackage.HEALTHCARE_SERVICE__APPOINTMENT_REQUIRED:
				setAppointmentRequired((fhir.Boolean)newValue);
				return;
			case FhirPackage.HEALTHCARE_SERVICE__AVAILABLE_TIME:
			...
			case FhirPackage.HEALTHCARE_SERVICE__NOT_AVAILABLE:
				...
				return;
			case FhirPackage.HEALTHCARE_SERVICE__AVAILABILITY_EXCEPTIONS:
				setAvailabilityExceptions((fhir.String)newValue);
				return;
		}
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			...
			case FhirPackage.HEALTHCARE_SERVICE__LOCATION:
				...
				return;
			case FhirPackage.HEALTHCARE_SERVICE__SERVICE_NAME:
				setServiceName((fhir.String)null);
				return;
			case FhirPackage.HEALTHCARE_SERVICE__COMMENT:
				setComment((fhir.String)null);
				return;
			case FhirPackage.HEALTHCARE_SERVICE__EXTRA_DETAILS:
				setExtraDetails((fhir.String)null);
				return;
			case FhirPackage.HEALTHCARE_SERVICE__PHOTO:
			...
			case FhirPackage.HEALTHCARE_SERVICE__ELIGIBILITY:
				...
				return;
			case FhirPackage.HEALTHCARE_SERVICE__ELIGIBILITY_NOTE:
				setEligibilityNote((fhir.String)null);
				return;
			case FhirPackage.HEALTHCARE_SERVICE__PROGRAM_NAME:
				getProgramName().clear();
				return;
			...
			case FhirPackage.HEALTHCARE_SERVICE__REFERRAL_METHOD:
				...
				return;
			case FhirPackage.HEALTHCARE_SERVICE__PUBLIC_KEY:
				setPublicKey((fhir.String)null);
				return;
			case FhirPackage.HEALTHCARE_SERVICE__APPOINTMENT_REQUIRED:
				setAppointmentRequired((fhir.Boolean)null);
				return;
			case FhirPackage.HEALTHCARE_SERVICE__AVAILABLE_TIME:
				getAvailableTime().clear();
				return;
			case FhirPackage.HEALTHCARE_SERVICE__NOT_AVAILABLE:
				...
				return;
			case FhirPackage.HEALTHCARE_SERVICE__AVAILABILITY_EXCEPTIONS:
				setAvailabilityExceptions((fhir.String)null);
				return;
		}
