 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.impl.SubstanceImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link fhir.impl.SubstanceImpl#getCategory <em>Category</em>}</li>
 *   <li>{@link fhir.impl.SubstanceImpl#getCode <em>Code</em>}</li>
 *   <li>{@link fhir.impl.SubstanceImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link fhir.impl.SubstanceImpl#getInstance <em>Instance</em>}</li>
 *   <li>{@link fhir.impl.SubstanceImpl#getIngredient <em>Ingredient</em>}</li>
 * </ul>
 *
 * @generated
 */
