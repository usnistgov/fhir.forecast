 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.impl.DeviceUseRequestImpl#getBodySiteCodeableConcept <em>Body Site Codeable Concept</em>}</li>
 *   <li>{@link fhir.impl.DeviceUseRequestImpl#getBodySiteReference <em>Body Site Reference</em>}</li>
 *   <li>{@link fhir.impl.DeviceUseRequestImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link fhir.impl.DeviceUseRequestImpl#getDevice <em>Device</em>}</li>
 *   <li>{@link fhir.impl.DeviceUseRequestImpl#getEncounter <em>Encounter</em>}</li>
 *   <li>{@link fhir.impl.DeviceUseRequestImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link fhir.impl.DeviceUseRequestImpl#getIndication <em>Indication</em>}</li>
 *   <li>{@link fhir.impl.DeviceUseRequestImpl#getNotes <em>Notes</em>}</li>
 *   <li>{@link fhir.impl.DeviceUseRequestImpl#getPrnReason <em>Prn Reason</em>}</li>
 *   <li>{@link fhir.impl.DeviceUseRequestImpl#getOrderedOn <em>Ordered On</em>}</li>
 *   <li>{@link fhir.impl.DeviceUseRequestImpl#getRecordedOn <em>Recorded On</em>}</li>
 *   <li>{@link fhir.impl.DeviceUseRequestImpl#getSubject <em>Subject</em>}</li>
 *   <li>{@link fhir.impl.DeviceUseRequestImpl#getTimingTiming <em>Timing Timing</em>}</li>
 *   <li>{@link fhir.impl.DeviceUseRequestImpl#getTimingPeriod <em>Timing Period</em>}</li>
 *   <li>{@link fhir.impl.DeviceUseRequestImpl#getTimingDateTime <em>Timing Date Time</em>}</li>
 *   <li>{@link fhir.impl.DeviceUseRequestImpl#getPriority <em>Priority</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DeviceUseRequestImpl extends DomainResourceImpl implements DeviceUseRequest {
	 ...
	 * @ordered
	 */
	protected EList<fhir.String> notes;
	 ...
	 * @generated
	 */
	public EList<fhir.String> getNotes() {
		if (notes == null) {
			notes = new EObjectContainmentEList<fhir.String>(fhir.String.class, this, FhirPackage.DEVICE_USE_REQUEST__NOTES);
		}
		return notes;
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case FhirPackage.DEVICE_USE_REQUEST__NOTES:
				getNotes().clear();
				getNotes().addAll((Collection<? extends fhir.String>)newValue);
				return;
			case FhirPackage.DEVICE_USE_REQUEST__PRN_REASON:
				getPrnReason().clear();
