 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.impl.HealthcareServiceAvailableTimeImpl#getDaysOfWeek <em>Days Of Week</em>}</li>
 *   <li>{@link fhir.impl.HealthcareServiceAvailableTimeImpl#getAllDay <em>All Day</em>}</li>
 *   <li>{@link fhir.impl.HealthcareServiceAvailableTimeImpl#getAvailableStartTime <em>Available Start Time</em>}</li>
 *   <li>{@link fhir.impl.HealthcareServiceAvailableTimeImpl#getAvailableEndTime <em>Available End Time</em>}</li>
 * </ul>
 *
 * @generated
 */
public class HealthcareServiceAvailableTimeImpl extends BackboneElementImpl implements HealthcareServiceAvailableTime {
	 ...
	 * @generated
	 */
	public NotificationChain basicSetAllDay(fhir.Boolean newAllDay, NotificationChain msgs) {
		fhir.Boolean oldAllDay = allDay;
		allDay = newAllDay;
	 ...
	 * @generated
	 */
	public void setAllDay(fhir.Boolean newAllDay) {
		if (newAllDay != allDay) {
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case FhirPackage.HEALTHCARE_SERVICE_AVAILABLE_TIME__DAYS_OF_WEEK:
				...
				return;
			case FhirPackage.HEALTHCARE_SERVICE_AVAILABLE_TIME__ALL_DAY:
				setAllDay((fhir.Boolean)newValue);
				return;
			case FhirPackage.HEALTHCARE_SERVICE_AVAILABLE_TIME__AVAILABLE_START_TIME:
