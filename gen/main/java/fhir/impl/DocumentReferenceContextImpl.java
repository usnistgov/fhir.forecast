 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.impl.DocumentReferenceContextImpl#getEncounter <em>Encounter</em>}</li>
 *   <li>{@link fhir.impl.DocumentReferenceContextImpl#getEvent <em>Event</em>}</li>
 *   <li>{@link fhir.impl.DocumentReferenceContextImpl#getPeriod <em>Period</em>}</li>
 *   <li>{@link fhir.impl.DocumentReferenceContextImpl#getFacilityType <em>Facility Type</em>}</li>
 *   <li>{@link fhir.impl.DocumentReferenceContextImpl#getPracticeSetting <em>Practice Setting</em>}</li>
 *   <li>{@link fhir.impl.DocumentReferenceContextImpl#getSourcePatientInfo <em>Source Patient Info</em>}</li>
 *   <li>{@link fhir.impl.DocumentReferenceContextImpl#getRelated <em>Related</em>}</li>
 * </ul>
 *
 * @generated
 */
