 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.impl.AuditEventNetworkImpl#getAddress <em>Address</em>}</li>
 *   <li>{@link fhir.impl.AuditEventNetworkImpl#getType <em>Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AuditEventNetworkImpl extends BackboneElementImpl implements AuditEventNetwork {
	 ...
	 * @generated
	 */
	public NotificationChain basicSetAddress(fhir.String newAddress, NotificationChain msgs) {
		fhir.String oldAddress = address;
		address = newAddress;
	 ...
	 * @generated
	 */
	public void setAddress(fhir.String newAddress) {
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case FhirPackage.AUDIT_EVENT_NETWORK__ADDRESS:
				setAddress((fhir.String)newValue);
				return;
			case FhirPackage.AUDIT_EVENT_NETWORK__TYPE:
