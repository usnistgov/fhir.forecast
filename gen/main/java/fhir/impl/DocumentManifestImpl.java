 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.impl.DocumentManifestImpl#getMasterIdentifier <em>Master Identifier</em>}</li>
 *   <li>{@link fhir.impl.DocumentManifestImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link fhir.impl.DocumentManifestImpl#getSubject <em>Subject</em>}</li>
 *   <li>{@link fhir.impl.DocumentManifestImpl#getRecipient <em>Recipient</em>}</li>
 *   <li>{@link fhir.impl.DocumentManifestImpl#getType <em>Type</em>}</li>
 *   <li>{@link fhir.impl.DocumentManifestImpl#getAuthor <em>Author</em>}</li>
 *   <li>{@link fhir.impl.DocumentManifestImpl#getCreated <em>Created</em>}</li>
 *   <li>{@link fhir.impl.DocumentManifestImpl#getSource <em>Source</em>}</li>
 *   <li>{@link fhir.impl.DocumentManifestImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link fhir.impl.DocumentManifestImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link fhir.impl.DocumentManifestImpl#getContent <em>Content</em>}</li>
 *   <li>{@link fhir.impl.DocumentManifestImpl#getRelated <em>Related</em>}</li>
 * </ul>
 *
 * @generated
 */
