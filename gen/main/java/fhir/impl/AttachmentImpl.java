 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.impl.AttachmentImpl#getContentType <em>Content Type</em>}</li>
 *   <li>{@link fhir.impl.AttachmentImpl#getLanguage <em>Language</em>}</li>
 *   <li>{@link fhir.impl.AttachmentImpl#getData <em>Data</em>}</li>
 *   <li>{@link fhir.impl.AttachmentImpl#getUrl <em>Url</em>}</li>
 *   <li>{@link fhir.impl.AttachmentImpl#getSize <em>Size</em>}</li>
 *   <li>{@link fhir.impl.AttachmentImpl#getHash <em>Hash</em>}</li>
 *   <li>{@link fhir.impl.AttachmentImpl#getTitle <em>Title</em>}</li>
 *   <li>{@link fhir.impl.AttachmentImpl#getCreation <em>Creation</em>}</li>
 * </ul>
 *
 * @generated
 */
