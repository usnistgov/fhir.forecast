 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.impl.EpisodeOfCareImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link fhir.impl.EpisodeOfCareImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link fhir.impl.EpisodeOfCareImpl#getStatusHistory <em>Status History</em>}</li>
 *   <li>{@link fhir.impl.EpisodeOfCareImpl#getType <em>Type</em>}</li>
 *   <li>{@link fhir.impl.EpisodeOfCareImpl#getCondition <em>Condition</em>}</li>
 *   <li>{@link fhir.impl.EpisodeOfCareImpl#getPatient <em>Patient</em>}</li>
 *   <li>{@link fhir.impl.EpisodeOfCareImpl#getManagingOrganization <em>Managing Organization</em>}</li>
 *   <li>{@link fhir.impl.EpisodeOfCareImpl#getPeriod <em>Period</em>}</li>
 *   <li>{@link fhir.impl.EpisodeOfCareImpl#getReferralRequest <em>Referral Request</em>}</li>
 *   <li>{@link fhir.impl.EpisodeOfCareImpl#getCareManager <em>Care Manager</em>}</li>
 *   <li>{@link fhir.impl.EpisodeOfCareImpl#getCareTeam <em>Care Team</em>}</li>
 * </ul>
 *
 * @generated
 */
