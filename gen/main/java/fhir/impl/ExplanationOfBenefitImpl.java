 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.impl.ExplanationOfBenefitImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link fhir.impl.ExplanationOfBenefitImpl#getRequest <em>Request</em>}</li>
 *   <li>{@link fhir.impl.ExplanationOfBenefitImpl#getOutcome <em>Outcome</em>}</li>
 *   <li>{@link fhir.impl.ExplanationOfBenefitImpl#getDisposition <em>Disposition</em>}</li>
 *   <li>{@link fhir.impl.ExplanationOfBenefitImpl#getRuleset <em>Ruleset</em>}</li>
 *   <li>{@link fhir.impl.ExplanationOfBenefitImpl#getOriginalRuleset <em>Original Ruleset</em>}</li>
 *   <li>{@link fhir.impl.ExplanationOfBenefitImpl#getCreated <em>Created</em>}</li>
 *   <li>{@link fhir.impl.ExplanationOfBenefitImpl#getOrganization <em>Organization</em>}</li>
 *   <li>{@link fhir.impl.ExplanationOfBenefitImpl#getRequestProvider <em>Request Provider</em>}</li>
 *   <li>{@link fhir.impl.ExplanationOfBenefitImpl#getRequestOrganization <em>Request Organization</em>}</li>
 * </ul>
 *
 * @generated
 */
