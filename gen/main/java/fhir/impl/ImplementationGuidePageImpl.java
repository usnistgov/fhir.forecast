 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.impl.ImplementationGuidePageImpl#getSource <em>Source</em>}</li>
 *   <li>{@link fhir.impl.ImplementationGuidePageImpl#getName <em>Name</em>}</li>
 *   <li>{@link fhir.impl.ImplementationGuidePageImpl#getKind <em>Kind</em>}</li>
 *   <li>{@link fhir.impl.ImplementationGuidePageImpl#getType <em>Type</em>}</li>
 *   <li>{@link fhir.impl.ImplementationGuidePageImpl#getPackage <em>Package</em>}</li>
 *   <li>{@link fhir.impl.ImplementationGuidePageImpl#getFormat <em>Format</em>}</li>
 *   <li>{@link fhir.impl.ImplementationGuidePageImpl#getPage <em>Page</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ImplementationGuidePageImpl extends BackboneElementImpl implements ImplementationGuidePage {
	 ...
	 * @ordered
	 */
	protected EList<fhir.String> package_;
	 ...
	 * @generated
	 */
	public EList<fhir.String> getPackage() {
		if (package_ == null) {
			package_ = new EObjectContainmentEList<fhir.String>(fhir.String.class, this, FhirPackage.IMPLEMENTATION_GUIDE_PAGE__PACKAGE);
		}
		return package_;
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case FhirPackage.IMPLEMENTATION_GUIDE_PAGE__PACKAGE:
				getPackage().clear();
				getPackage().addAll((Collection<? extends fhir.String>)newValue);
				return;
			case FhirPackage.IMPLEMENTATION_GUIDE_PAGE__FORMAT:
