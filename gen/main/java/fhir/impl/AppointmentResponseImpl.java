 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.impl.AppointmentResponseImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link fhir.impl.AppointmentResponseImpl#getAppointment <em>Appointment</em>}</li>
 *   <li>{@link fhir.impl.AppointmentResponseImpl#getStart <em>Start</em>}</li>
 *   <li>{@link fhir.impl.AppointmentResponseImpl#getEnd <em>End</em>}</li>
 *   <li>{@link fhir.impl.AppointmentResponseImpl#getParticipantType <em>Participant Type</em>}</li>
 *   <li>{@link fhir.impl.AppointmentResponseImpl#getActor <em>Actor</em>}</li>
 *   <li>{@link fhir.impl.AppointmentResponseImpl#getParticipantStatus <em>Participant Status</em>}</li>
 *   <li>{@link fhir.impl.AppointmentResponseImpl#getComment <em>Comment</em>}</li>
 * </ul>
 *
 * @generated
 */
