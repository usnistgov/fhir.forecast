 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.impl.QuestionnaireImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link fhir.impl.QuestionnaireImpl#getVersion <em>Version</em>}</li>
 *   <li>{@link fhir.impl.QuestionnaireImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link fhir.impl.QuestionnaireImpl#getDate <em>Date</em>}</li>
 *   <li>{@link fhir.impl.QuestionnaireImpl#getPublisher <em>Publisher</em>}</li>
 *   <li>{@link fhir.impl.QuestionnaireImpl#getTelecom <em>Telecom</em>}</li>
 *   <li>{@link fhir.impl.QuestionnaireImpl#getSubjectType <em>Subject Type</em>}</li>
 *   <li>{@link fhir.impl.QuestionnaireImpl#getGroup <em>Group</em>}</li>
 * </ul>
 *
 * @generated
 */
