 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.impl.DeviceMetricImpl#getType <em>Type</em>}</li>
 *   <li>{@link fhir.impl.DeviceMetricImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link fhir.impl.DeviceMetricImpl#getUnit <em>Unit</em>}</li>
 *   <li>{@link fhir.impl.DeviceMetricImpl#getSource <em>Source</em>}</li>
 *   <li>{@link fhir.impl.DeviceMetricImpl#getParent <em>Parent</em>}</li>
 *   <li>{@link fhir.impl.DeviceMetricImpl#getOperationalStatus <em>Operational Status</em>}</li>
 *   <li>{@link fhir.impl.DeviceMetricImpl#getColor <em>Color</em>}</li>
 *   <li>{@link fhir.impl.DeviceMetricImpl#getCategory <em>Category</em>}</li>
 *   <li>{@link fhir.impl.DeviceMetricImpl#getMeasurementPeriod <em>Measurement Period</em>}</li>
 *   <li>{@link fhir.impl.DeviceMetricImpl#getCalibration <em>Calibration</em>}</li>
 * </ul>
 *
 * @generated
 */
