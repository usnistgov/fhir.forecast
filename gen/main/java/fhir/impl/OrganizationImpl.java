 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.impl.OrganizationImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link fhir.impl.OrganizationImpl#getActive <em>Active</em>}</li>
 *   <li>{@link fhir.impl.OrganizationImpl#getType <em>Type</em>}</li>
 *   <li>{@link fhir.impl.OrganizationImpl#getName <em>Name</em>}</li>
 *   <li>{@link fhir.impl.OrganizationImpl#getTelecom <em>Telecom</em>}</li>
 *   <li>{@link fhir.impl.OrganizationImpl#getAddress <em>Address</em>}</li>
 *   <li>{@link fhir.impl.OrganizationImpl#getPartOf <em>Part Of</em>}</li>
 *   <li>{@link fhir.impl.OrganizationImpl#getContact <em>Contact</em>}</li>
 * </ul>
 *
 * @generated
 */
