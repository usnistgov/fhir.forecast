 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.impl.MedicationDispenseImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link fhir.impl.MedicationDispenseImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link fhir.impl.MedicationDispenseImpl#getPatient <em>Patient</em>}</li>
 *   <li>{@link fhir.impl.MedicationDispenseImpl#getDispenser <em>Dispenser</em>}</li>
 *   <li>{@link fhir.impl.MedicationDispenseImpl#getAuthorizingPrescription <em>Authorizing Prescription</em>}</li>
 *   <li>{@link fhir.impl.MedicationDispenseImpl#getType <em>Type</em>}</li>
 *   <li>{@link fhir.impl.MedicationDispenseImpl#getQuantity <em>Quantity</em>}</li>
 *   <li>{@link fhir.impl.MedicationDispenseImpl#getDaysSupply <em>Days Supply</em>}</li>
 *   <li>{@link fhir.impl.MedicationDispenseImpl#getMedicationCodeableConcept <em>Medication Codeable Concept</em>}</li>
 *   <li>{@link fhir.impl.MedicationDispenseImpl#getMedicationReference <em>Medication Reference</em>}</li>
 *   <li>{@link fhir.impl.MedicationDispenseImpl#getWhenPrepared <em>When Prepared</em>}</li>
 *   <li>{@link fhir.impl.MedicationDispenseImpl#getWhenHandedOver <em>When Handed Over</em>}</li>
 *   <li>{@link fhir.impl.MedicationDispenseImpl#getDestination <em>Destination</em>}</li>
 *   <li>{@link fhir.impl.MedicationDispenseImpl#getReceiver <em>Receiver</em>}</li>
 *   <li>{@link fhir.impl.MedicationDispenseImpl#getNote <em>Note</em>}</li>
 *   <li>{@link fhir.impl.MedicationDispenseImpl#getDosageInstruction <em>Dosage Instruction</em>}</li>
 *   <li>{@link fhir.impl.MedicationDispenseImpl#getSubstitution <em>Substitution</em>}</li>
 * </ul>
 *
 * @generated
 */
