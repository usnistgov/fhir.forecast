 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.impl.ContractImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link fhir.impl.ContractImpl#getIssued <em>Issued</em>}</li>
 *   <li>{@link fhir.impl.ContractImpl#getApplies <em>Applies</em>}</li>
 *   <li>{@link fhir.impl.ContractImpl#getSubject <em>Subject</em>}</li>
 *   <li>{@link fhir.impl.ContractImpl#getAuthority <em>Authority</em>}</li>
 *   <li>{@link fhir.impl.ContractImpl#getDomain <em>Domain</em>}</li>
 *   <li>{@link fhir.impl.ContractImpl#getType <em>Type</em>}</li>
 *   <li>{@link fhir.impl.ContractImpl#getSubType <em>Sub Type</em>}</li>
 *   <li>{@link fhir.impl.ContractImpl#getAction <em>Action</em>}</li>
 *   <li>{@link fhir.impl.ContractImpl#getActionReason <em>Action Reason</em>}</li>
 *   <li>{@link fhir.impl.ContractImpl#getActor <em>Actor</em>}</li>
 *   <li>{@link fhir.impl.ContractImpl#getValuedItem <em>Valued Item</em>}</li>
 *   <li>{@link fhir.impl.ContractImpl#getSigner <em>Signer</em>}</li>
 *   <li>{@link fhir.impl.ContractImpl#getTerm <em>Term</em>}</li>
 *   <li>{@link fhir.impl.ContractImpl#getBindingAttachment <em>Binding Attachment</em>}</li>
 *   <li>{@link fhir.impl.ContractImpl#getBindingReference <em>Binding Reference</em>}</li>
 *   <li>{@link fhir.impl.ContractImpl#getFriendly <em>Friendly</em>}</li>
 *   <li>{@link fhir.impl.ContractImpl#getLegal <em>Legal</em>}</li>
 *   <li>{@link fhir.impl.ContractImpl#getRule <em>Rule</em>}</li>
 * </ul>
 *
 * @generated
 */
