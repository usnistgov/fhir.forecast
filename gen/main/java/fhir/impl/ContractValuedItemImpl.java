 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.impl.ContractValuedItemImpl#getEntityCodeableConcept <em>Entity Codeable Concept</em>}</li>
 *   <li>{@link fhir.impl.ContractValuedItemImpl#getEntityReference <em>Entity Reference</em>}</li>
 *   <li>{@link fhir.impl.ContractValuedItemImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link fhir.impl.ContractValuedItemImpl#getEffectiveTime <em>Effective Time</em>}</li>
 *   <li>{@link fhir.impl.ContractValuedItemImpl#getQuantity <em>Quantity</em>}</li>
 *   <li>{@link fhir.impl.ContractValuedItemImpl#getUnitPrice <em>Unit Price</em>}</li>
 *   <li>{@link fhir.impl.ContractValuedItemImpl#getFactor <em>Factor</em>}</li>
 *   <li>{@link fhir.impl.ContractValuedItemImpl#getPoints <em>Points</em>}</li>
 *   <li>{@link fhir.impl.ContractValuedItemImpl#getNet <em>Net</em>}</li>
 * </ul>
 *
 * @generated
 */
