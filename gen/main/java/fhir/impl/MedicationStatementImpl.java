 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.impl.MedicationStatementImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link fhir.impl.MedicationStatementImpl#getPatient <em>Patient</em>}</li>
 *   <li>{@link fhir.impl.MedicationStatementImpl#getInformationSource <em>Information Source</em>}</li>
 *   <li>{@link fhir.impl.MedicationStatementImpl#getDateAsserted <em>Date Asserted</em>}</li>
 *   <li>{@link fhir.impl.MedicationStatementImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link fhir.impl.MedicationStatementImpl#getWasNotTaken <em>Was Not Taken</em>}</li>
 *   <li>{@link fhir.impl.MedicationStatementImpl#getReasonNotTaken <em>Reason Not Taken</em>}</li>
 *   <li>{@link fhir.impl.MedicationStatementImpl#getReasonForUseCodeableConcept <em>Reason For Use Codeable Concept</em>}</li>
 *   <li>{@link fhir.impl.MedicationStatementImpl#getReasonForUseReference <em>Reason For Use Reference</em>}</li>
 *   <li>{@link fhir.impl.MedicationStatementImpl#getEffectiveDateTime <em>Effective Date Time</em>}</li>
 *   <li>{@link fhir.impl.MedicationStatementImpl#getEffectivePeriod <em>Effective Period</em>}</li>
 *   <li>{@link fhir.impl.MedicationStatementImpl#getNote <em>Note</em>}</li>
 *   <li>{@link fhir.impl.MedicationStatementImpl#getSupportingInformation <em>Supporting Information</em>}</li>
 *   <li>{@link fhir.impl.MedicationStatementImpl#getMedicationCodeableConcept <em>Medication Codeable Concept</em>}</li>
 *   <li>{@link fhir.impl.MedicationStatementImpl#getMedicationReference <em>Medication Reference</em>}</li>
 *   <li>{@link fhir.impl.MedicationStatementImpl#getDosage <em>Dosage</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MedicationStatementImpl extends DomainResourceImpl implements MedicationStatement {
	 ...
	 * @ordered
	 */
	protected fhir.Boolean wasNotTaken;
	 ...
	 * @generated
	 */
	public fhir.Boolean getWasNotTaken() {
		return wasNotTaken;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetWasNotTaken(fhir.Boolean newWasNotTaken, NotificationChain msgs) {
		fhir.Boolean oldWasNotTaken = wasNotTaken;
	 ...
	 * @generated
	 */
	public void setWasNotTaken(fhir.Boolean newWasNotTaken) {
	 ...
	 * @generated
	 */
	public NotificationChain basicSetNote(fhir.String newNote, NotificationChain msgs) {
		fhir.String oldNote = note;
		note = newNote;
		if (eNotificationRequired()) {
	 ...
	 * @generated
	 */
	public void setNote(fhir.String newNote) {
		if (newNote != note) {
			NotificationChain msgs = null;
			if (note != null)
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case FhirPackage.MEDICATION_STATEMENT__STATUS:
				...
				return;
			case FhirPackage.MEDICATION_STATEMENT__WAS_NOT_TAKEN:
				setWasNotTaken((fhir.Boolean)newValue);
				return;
			case FhirPackage.MEDICATION_STATEMENT__REASON_NOT_TAKEN:
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			...
			case FhirPackage.MEDICATION_STATEMENT__STATUS:
				...
				return;
			case FhirPackage.MEDICATION_STATEMENT__WAS_NOT_TAKEN:
				setWasNotTaken((fhir.Boolean)null);
				return;
			case FhirPackage.MEDICATION_STATEMENT__REASON_NOT_TAKEN:
				getReasonNotTaken().clear();
				return;
