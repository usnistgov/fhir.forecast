 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.impl.ContractSignerImpl#getType <em>Type</em>}</li>
 *   <li>{@link fhir.impl.ContractSignerImpl#getParty <em>Party</em>}</li>
 *   <li>{@link fhir.impl.ContractSignerImpl#getSignature <em>Signature</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ContractSignerImpl extends BackboneElementImpl implements ContractSigner {
	 ...
	 * @ordered
	 */
	protected fhir.String signature;
	 ...
	 * @generated
	 */
	public fhir.String getSignature() {
		return signature;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetSignature(fhir.String newSignature, NotificationChain msgs) {
		fhir.String oldSignature = signature;
	 ...
	 * @generated
	 */
	public void setSignature(fhir.String newSignature) {
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case FhirPackage.CONTRACT_SIGNER__PARTY:
				...
				return;
			case FhirPackage.CONTRACT_SIGNER__SIGNATURE:
				setSignature((fhir.String)newValue);
				return;
		}
