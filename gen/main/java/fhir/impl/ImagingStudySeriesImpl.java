 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.impl.ImagingStudySeriesImpl#getNumber <em>Number</em>}</li>
 *   <li>{@link fhir.impl.ImagingStudySeriesImpl#getModality <em>Modality</em>}</li>
 *   <li>{@link fhir.impl.ImagingStudySeriesImpl#getUid <em>Uid</em>}</li>
 *   <li>{@link fhir.impl.ImagingStudySeriesImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link fhir.impl.ImagingStudySeriesImpl#getNumberOfInstances <em>Number Of Instances</em>}</li>
 *   <li>{@link fhir.impl.ImagingStudySeriesImpl#getAvailability <em>Availability</em>}</li>
 *   <li>{@link fhir.impl.ImagingStudySeriesImpl#getUrl <em>Url</em>}</li>
 *   <li>{@link fhir.impl.ImagingStudySeriesImpl#getBodySite <em>Body Site</em>}</li>
 *   <li>{@link fhir.impl.ImagingStudySeriesImpl#getLaterality <em>Laterality</em>}</li>
 *   <li>{@link fhir.impl.ImagingStudySeriesImpl#getStarted <em>Started</em>}</li>
 *   <li>{@link fhir.impl.ImagingStudySeriesImpl#getInstance <em>Instance</em>}</li>
 * </ul>
 *
 * @generated
 */
