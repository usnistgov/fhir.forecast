 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.impl.DiagnosticOrderImpl#getSubject <em>Subject</em>}</li>
 *   <li>{@link fhir.impl.DiagnosticOrderImpl#getOrderer <em>Orderer</em>}</li>
 *   <li>{@link fhir.impl.DiagnosticOrderImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link fhir.impl.DiagnosticOrderImpl#getEncounter <em>Encounter</em>}</li>
 *   <li>{@link fhir.impl.DiagnosticOrderImpl#getReason <em>Reason</em>}</li>
 *   <li>{@link fhir.impl.DiagnosticOrderImpl#getSupportingInformation <em>Supporting Information</em>}</li>
 *   <li>{@link fhir.impl.DiagnosticOrderImpl#getSpecimen <em>Specimen</em>}</li>
 *   <li>{@link fhir.impl.DiagnosticOrderImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link fhir.impl.DiagnosticOrderImpl#getPriority <em>Priority</em>}</li>
 *   <li>{@link fhir.impl.DiagnosticOrderImpl#getEvent <em>Event</em>}</li>
 *   <li>{@link fhir.impl.DiagnosticOrderImpl#getItem <em>Item</em>}</li>
 *   <li>{@link fhir.impl.DiagnosticOrderImpl#getNote <em>Note</em>}</li>
 * </ul>
 *
 * @generated
 */
