 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.impl.CompositionImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link fhir.impl.CompositionImpl#getDate <em>Date</em>}</li>
 *   <li>{@link fhir.impl.CompositionImpl#getType <em>Type</em>}</li>
 *   <li>{@link fhir.impl.CompositionImpl#getClass_ <em>Class</em>}</li>
 *   <li>{@link fhir.impl.CompositionImpl#getTitle <em>Title</em>}</li>
 *   <li>{@link fhir.impl.CompositionImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link fhir.impl.CompositionImpl#getConfidentiality <em>Confidentiality</em>}</li>
 *   <li>{@link fhir.impl.CompositionImpl#getSubject <em>Subject</em>}</li>
 *   <li>{@link fhir.impl.CompositionImpl#getAuthor <em>Author</em>}</li>
 *   <li>{@link fhir.impl.CompositionImpl#getAttester <em>Attester</em>}</li>
 *   <li>{@link fhir.impl.CompositionImpl#getCustodian <em>Custodian</em>}</li>
 *   <li>{@link fhir.impl.CompositionImpl#getEvent <em>Event</em>}</li>
 *   <li>{@link fhir.impl.CompositionImpl#getEncounter <em>Encounter</em>}</li>
 *   <li>{@link fhir.impl.CompositionImpl#getSection <em>Section</em>}</li>
 * </ul>
 *
 * @generated
 */
