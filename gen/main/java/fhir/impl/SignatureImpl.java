 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.impl.SignatureImpl#getType <em>Type</em>}</li>
 *   <li>{@link fhir.impl.SignatureImpl#getWhen <em>When</em>}</li>
 *   <li>{@link fhir.impl.SignatureImpl#getWhoUri <em>Who Uri</em>}</li>
 *   <li>{@link fhir.impl.SignatureImpl#getWhoReference <em>Who Reference</em>}</li>
 *   <li>{@link fhir.impl.SignatureImpl#getContentType <em>Content Type</em>}</li>
 *   <li>{@link fhir.impl.SignatureImpl#getBlob <em>Blob</em>}</li>
 * </ul>
 *
 * @generated
 */
