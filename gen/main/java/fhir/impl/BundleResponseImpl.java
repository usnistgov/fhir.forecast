 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.impl.BundleResponseImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link fhir.impl.BundleResponseImpl#getLocation <em>Location</em>}</li>
 *   <li>{@link fhir.impl.BundleResponseImpl#getEtag <em>Etag</em>}</li>
 *   <li>{@link fhir.impl.BundleResponseImpl#getLastModified <em>Last Modified</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BundleResponseImpl extends BackboneElementImpl implements BundleResponse {
	 ...
	 * @generated
	 */
	public NotificationChain basicSetStatus(fhir.String newStatus, NotificationChain msgs) {
		fhir.String oldStatus = status;
		status = newStatus;
	 ...
	 * @generated
	 */
	public void setStatus(fhir.String newStatus) {
		if (newStatus != status) {
	 ...
	 * @generated
	 */
	public NotificationChain basicSetEtag(fhir.String newEtag, NotificationChain msgs) {
		fhir.String oldEtag = etag;
		etag = newEtag;
		if (eNotificationRequired()) {
	 ...
	 * @generated
	 */
	public void setEtag(fhir.String newEtag) {
		if (newEtag != etag) {
			NotificationChain msgs = null;
			if (etag != null)
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case FhirPackage.BUNDLE_RESPONSE__STATUS:
				setStatus((fhir.String)newValue);
				return;
			case FhirPackage.BUNDLE_RESPONSE__LOCATION:
				setLocation((Uri)newValue);
				return;
			case FhirPackage.BUNDLE_RESPONSE__ETAG:
				setEtag((fhir.String)newValue);
				return;
			case FhirPackage.BUNDLE_RESPONSE__LAST_MODIFIED:
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			case FhirPackage.BUNDLE_RESPONSE__STATUS:
				setStatus((fhir.String)null);
				return;
			case FhirPackage.BUNDLE_RESPONSE__LOCATION:
				setLocation((Uri)null);
				return;
			case FhirPackage.BUNDLE_RESPONSE__ETAG:
				setEtag((fhir.String)null);
				return;
			case FhirPackage.BUNDLE_RESPONSE__LAST_MODIFIED:
