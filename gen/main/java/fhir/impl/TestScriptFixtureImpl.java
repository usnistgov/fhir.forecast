 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.impl.TestScriptFixtureImpl#getAutocreate <em>Autocreate</em>}</li>
 *   <li>{@link fhir.impl.TestScriptFixtureImpl#getAutodelete <em>Autodelete</em>}</li>
 *   <li>{@link fhir.impl.TestScriptFixtureImpl#getResource <em>Resource</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TestScriptFixtureImpl extends BackboneElementImpl implements TestScriptFixture {
	 ...
	 * @ordered
	 */
	protected fhir.Boolean autocreate;
	 ...
	 * @ordered
	 */
	protected fhir.Boolean autodelete;
	 ...
	 * @generated
	 */
	public fhir.Boolean getAutocreate() {
		return autocreate;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetAutocreate(fhir.Boolean newAutocreate, NotificationChain msgs) {
		fhir.Boolean oldAutocreate = autocreate;
	 ...
	 * @generated
	 */
	public void setAutocreate(fhir.Boolean newAutocreate) {
	 ...
	 * @generated
	 */
	public fhir.Boolean getAutodelete() {
		return autodelete;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetAutodelete(fhir.Boolean newAutodelete, NotificationChain msgs) {
		fhir.Boolean oldAutodelete = autodelete;
	 ...
	 * @generated
	 */
	public void setAutodelete(fhir.Boolean newAutodelete) {
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case FhirPackage.TEST_SCRIPT_FIXTURE__AUTOCREATE:
				setAutocreate((fhir.Boolean)newValue);
				return;
			case FhirPackage.TEST_SCRIPT_FIXTURE__AUTODELETE:
				setAutodelete((fhir.Boolean)newValue);
				return;
			case FhirPackage.TEST_SCRIPT_FIXTURE__RESOURCE:
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			case FhirPackage.TEST_SCRIPT_FIXTURE__AUTOCREATE:
				setAutocreate((fhir.Boolean)null);
				return;
			case FhirPackage.TEST_SCRIPT_FIXTURE__AUTODELETE:
				setAutodelete((fhir.Boolean)null);
				return;
			case FhirPackage.TEST_SCRIPT_FIXTURE__RESOURCE:
