 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.impl.SpecimenCollectionImpl#getCollector <em>Collector</em>}</li>
 *   <li>{@link fhir.impl.SpecimenCollectionImpl#getComment <em>Comment</em>}</li>
 *   <li>{@link fhir.impl.SpecimenCollectionImpl#getCollectedDateTime <em>Collected Date Time</em>}</li>
 *   <li>{@link fhir.impl.SpecimenCollectionImpl#getCollectedPeriod <em>Collected Period</em>}</li>
 *   <li>{@link fhir.impl.SpecimenCollectionImpl#getQuantity <em>Quantity</em>}</li>
 *   <li>{@link fhir.impl.SpecimenCollectionImpl#getMethod <em>Method</em>}</li>
 *   <li>{@link fhir.impl.SpecimenCollectionImpl#getBodySite <em>Body Site</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SpecimenCollectionImpl extends BackboneElementImpl implements SpecimenCollection {
	 ...
	 * @ordered
	 */
	protected EList<fhir.String> comment;
	 ...
	 * @generated
	 */
	public EList<fhir.String> getComment() {
		if (comment == null) {
			comment = new EObjectContainmentEList<fhir.String>(fhir.String.class, this, FhirPackage.SPECIMEN_COLLECTION__COMMENT);
		}
		return comment;
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case FhirPackage.SPECIMEN_COLLECTION__COMMENT:
				getComment().clear();
				getComment().addAll((Collection<? extends fhir.String>)newValue);
				return;
			case FhirPackage.SPECIMEN_COLLECTION__COLLECTED_DATE_TIME:
