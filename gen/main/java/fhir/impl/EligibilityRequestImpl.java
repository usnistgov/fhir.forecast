 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.impl.EligibilityRequestImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link fhir.impl.EligibilityRequestImpl#getRuleset <em>Ruleset</em>}</li>
 *   <li>{@link fhir.impl.EligibilityRequestImpl#getOriginalRuleset <em>Original Ruleset</em>}</li>
 *   <li>{@link fhir.impl.EligibilityRequestImpl#getCreated <em>Created</em>}</li>
 *   <li>{@link fhir.impl.EligibilityRequestImpl#getTarget <em>Target</em>}</li>
 *   <li>{@link fhir.impl.EligibilityRequestImpl#getProvider <em>Provider</em>}</li>
 *   <li>{@link fhir.impl.EligibilityRequestImpl#getOrganization <em>Organization</em>}</li>
 * </ul>
 *
 * @generated
 */
