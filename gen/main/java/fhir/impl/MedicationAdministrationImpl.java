 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.impl.MedicationAdministrationImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link fhir.impl.MedicationAdministrationImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link fhir.impl.MedicationAdministrationImpl#getPatient <em>Patient</em>}</li>
 *   <li>{@link fhir.impl.MedicationAdministrationImpl#getPractitioner <em>Practitioner</em>}</li>
 *   <li>{@link fhir.impl.MedicationAdministrationImpl#getEncounter <em>Encounter</em>}</li>
 *   <li>{@link fhir.impl.MedicationAdministrationImpl#getPrescription <em>Prescription</em>}</li>
 *   <li>{@link fhir.impl.MedicationAdministrationImpl#getWasNotGiven <em>Was Not Given</em>}</li>
 *   <li>{@link fhir.impl.MedicationAdministrationImpl#getReasonNotGiven <em>Reason Not Given</em>}</li>
 *   <li>{@link fhir.impl.MedicationAdministrationImpl#getReasonGiven <em>Reason Given</em>}</li>
 *   <li>{@link fhir.impl.MedicationAdministrationImpl#getEffectiveTimeDateTime <em>Effective Time Date Time</em>}</li>
 *   <li>{@link fhir.impl.MedicationAdministrationImpl#getEffectiveTimePeriod <em>Effective Time Period</em>}</li>
 *   <li>{@link fhir.impl.MedicationAdministrationImpl#getMedicationCodeableConcept <em>Medication Codeable Concept</em>}</li>
 *   <li>{@link fhir.impl.MedicationAdministrationImpl#getMedicationReference <em>Medication Reference</em>}</li>
 *   <li>{@link fhir.impl.MedicationAdministrationImpl#getDevice <em>Device</em>}</li>
 *   <li>{@link fhir.impl.MedicationAdministrationImpl#getNote <em>Note</em>}</li>
 *   <li>{@link fhir.impl.MedicationAdministrationImpl#getDosage <em>Dosage</em>}</li>
 * </ul>
 *
 * @generated
 */
