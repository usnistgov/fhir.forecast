 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.impl.NutritionOrderSupplementImpl#getType <em>Type</em>}</li>
 *   <li>{@link fhir.impl.NutritionOrderSupplementImpl#getProductName <em>Product Name</em>}</li>
 *   <li>{@link fhir.impl.NutritionOrderSupplementImpl#getSchedule <em>Schedule</em>}</li>
 *   <li>{@link fhir.impl.NutritionOrderSupplementImpl#getQuantity <em>Quantity</em>}</li>
 *   <li>{@link fhir.impl.NutritionOrderSupplementImpl#getInstruction <em>Instruction</em>}</li>
 * </ul>
 *
 * @generated
 */
public class NutritionOrderSupplementImpl extends BackboneElementImpl implements NutritionOrderSupplement {
	 ...
	 * @ordered
	 */
	protected fhir.String productName;
	 ...
	 * @ordered
	 */
	protected fhir.String instruction;
	 ...
	 * @generated
	 */
	public fhir.String getProductName() {
		return productName;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetProductName(fhir.String newProductName, NotificationChain msgs) {
		fhir.String oldProductName = productName;
	 ...
	 * @generated
	 */
	public void setProductName(fhir.String newProductName) {
	 ...
	 * @generated
	 */
	public fhir.String getInstruction() {
		return instruction;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetInstruction(fhir.String newInstruction, NotificationChain msgs) {
		fhir.String oldInstruction = instruction;
	 ...
	 * @generated
	 */
	public void setInstruction(fhir.String newInstruction) {
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case FhirPackage.NUTRITION_ORDER_SUPPLEMENT__TYPE:
				...
				return;
			case FhirPackage.NUTRITION_ORDER_SUPPLEMENT__PRODUCT_NAME:
				setProductName((fhir.String)newValue);
				return;
			case FhirPackage.NUTRITION_ORDER_SUPPLEMENT__SCHEDULE:
				getSchedule().clear();
			...
			case FhirPackage.NUTRITION_ORDER_SUPPLEMENT__QUANTITY:
				...
				return;
			case FhirPackage.NUTRITION_ORDER_SUPPLEMENT__INSTRUCTION:
				setInstruction((fhir.String)newValue);
				return;
		}
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			case FhirPackage.NUTRITION_ORDER_SUPPLEMENT__TYPE:
				...
				return;
			case FhirPackage.NUTRITION_ORDER_SUPPLEMENT__PRODUCT_NAME:
				setProductName((fhir.String)null);
				return;
			case FhirPackage.NUTRITION_ORDER_SUPPLEMENT__SCHEDULE:
				getSchedule().clear();
				return;
			case FhirPackage.NUTRITION_ORDER_SUPPLEMENT__QUANTITY:
				...
				return;
			case FhirPackage.NUTRITION_ORDER_SUPPLEMENT__INSTRUCTION:
				setInstruction((fhir.String)null);
				return;
		}
