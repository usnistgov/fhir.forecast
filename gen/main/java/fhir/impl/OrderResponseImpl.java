 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.impl.OrderResponseImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link fhir.impl.OrderResponseImpl#getRequest <em>Request</em>}</li>
 *   <li>{@link fhir.impl.OrderResponseImpl#getDate <em>Date</em>}</li>
 *   <li>{@link fhir.impl.OrderResponseImpl#getWho <em>Who</em>}</li>
 *   <li>{@link fhir.impl.OrderResponseImpl#getOrderStatus <em>Order Status</em>}</li>
 *   <li>{@link fhir.impl.OrderResponseImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link fhir.impl.OrderResponseImpl#getFulfillment <em>Fulfillment</em>}</li>
 * </ul>
 *
 * @generated
 */
