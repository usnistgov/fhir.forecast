 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.impl.DeviceComponentImpl#getType <em>Type</em>}</li>
 *   <li>{@link fhir.impl.DeviceComponentImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link fhir.impl.DeviceComponentImpl#getLastSystemChange <em>Last System Change</em>}</li>
 *   <li>{@link fhir.impl.DeviceComponentImpl#getSource <em>Source</em>}</li>
 *   <li>{@link fhir.impl.DeviceComponentImpl#getParent <em>Parent</em>}</li>
 *   <li>{@link fhir.impl.DeviceComponentImpl#getOperationalStatus <em>Operational Status</em>}</li>
 *   <li>{@link fhir.impl.DeviceComponentImpl#getParameterGroup <em>Parameter Group</em>}</li>
 *   <li>{@link fhir.impl.DeviceComponentImpl#getMeasurementPrinciple <em>Measurement Principle</em>}</li>
 *   <li>{@link fhir.impl.DeviceComponentImpl#getProductionSpecification <em>Production Specification</em>}</li>
 *   <li>{@link fhir.impl.DeviceComponentImpl#getLanguageCode <em>Language Code</em>}</li>
 * </ul>
 *
 * @generated
 */
