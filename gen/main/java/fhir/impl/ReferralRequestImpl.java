 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.impl.ReferralRequestImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link fhir.impl.ReferralRequestImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link fhir.impl.ReferralRequestImpl#getDate <em>Date</em>}</li>
 *   <li>{@link fhir.impl.ReferralRequestImpl#getType <em>Type</em>}</li>
 *   <li>{@link fhir.impl.ReferralRequestImpl#getSpecialty <em>Specialty</em>}</li>
 *   <li>{@link fhir.impl.ReferralRequestImpl#getPriority <em>Priority</em>}</li>
 *   <li>{@link fhir.impl.ReferralRequestImpl#getPatient <em>Patient</em>}</li>
 *   <li>{@link fhir.impl.ReferralRequestImpl#getRequester <em>Requester</em>}</li>
 *   <li>{@link fhir.impl.ReferralRequestImpl#getRecipient <em>Recipient</em>}</li>
 *   <li>{@link fhir.impl.ReferralRequestImpl#getEncounter <em>Encounter</em>}</li>
 *   <li>{@link fhir.impl.ReferralRequestImpl#getDateSent <em>Date Sent</em>}</li>
 *   <li>{@link fhir.impl.ReferralRequestImpl#getReason <em>Reason</em>}</li>
 *   <li>{@link fhir.impl.ReferralRequestImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link fhir.impl.ReferralRequestImpl#getServiceRequested <em>Service Requested</em>}</li>
 *   <li>{@link fhir.impl.ReferralRequestImpl#getSupportingInformation <em>Supporting Information</em>}</li>
 *   <li>{@link fhir.impl.ReferralRequestImpl#getFulfillmentTime <em>Fulfillment Time</em>}</li>
 * </ul>
 *
 * @generated
 */
