 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.impl.ResourceContainerImpl#getAccount <em>Account</em>}</li>
 *   <li>{@link fhir.impl.ResourceContainerImpl#getAllergyIntolerance <em>Allergy Intolerance</em>}</li>
 *   <li>{@link fhir.impl.ResourceContainerImpl#getAppointment <em>Appointment</em>}</li>
 *   <li>{@link fhir.impl.ResourceContainerImpl#getAppointmentResponse <em>Appointment Response</em>}</li>
 *   <li>{@link fhir.impl.ResourceContainerImpl#getAuditEvent <em>Audit Event</em>}</li>
 *   <li>{@link fhir.impl.ResourceContainerImpl#getBasic <em>Basic</em>}</li>
 *   <li>{@link fhir.impl.ResourceContainerImpl#getBinary <em>Binary</em>}</li>
 *   <li>{@link fhir.impl.ResourceContainerImpl#getBodySite <em>Body Site</em>}</li>
 *   <li>{@link fhir.impl.ResourceContainerImpl#getBundle <em>Bundle</em>}</li>
 *   <li>{@link fhir.impl.ResourceContainerImpl#getCarePlan <em>Care Plan</em>}</li>
 *   <li>{@link fhir.impl.ResourceContainerImpl#getClaim <em>Claim</em>}</li>
 *   <li>{@link fhir.impl.ResourceContainerImpl#getClaimResponse <em>Claim Response</em>}</li>
 *   <li>{@link fhir.impl.ResourceContainerImpl#getClinicalImpression <em>Clinical Impression</em>}</li>
 *   <li>{@link fhir.impl.ResourceContainerImpl#getCommunication <em>Communication</em>}</li>
 *   <li>{@link fhir.impl.ResourceContainerImpl#getCommunicationRequest <em>Communication Request</em>}</li>
 *   <li>{@link fhir.impl.ResourceContainerImpl#getComposition <em>Composition</em>}</li>
 *   <li>{@link fhir.impl.ResourceContainerImpl#getConceptMap <em>Concept Map</em>}</li>
 *   <li>{@link fhir.impl.ResourceContainerImpl#getCondition <em>Condition</em>}</li>
 *   <li>{@link fhir.impl.ResourceContainerImpl#getConformance <em>Conformance</em>}</li>
 *   <li>{@link fhir.impl.ResourceContainerImpl#getContract <em>Contract</em>}</li>
 *   <li>{@link fhir.impl.ResourceContainerImpl#getCoverage <em>Coverage</em>}</li>
 *   <li>{@link fhir.impl.ResourceContainerImpl#getDataElement <em>Data Element</em>}</li>
 *   <li>{@link fhir.impl.ResourceContainerImpl#getDetectedIssue <em>Detected Issue</em>}</li>
 *   <li>{@link fhir.impl.ResourceContainerImpl#getDevice <em>Device</em>}</li>
 *   <li>{@link fhir.impl.ResourceContainerImpl#getDeviceComponent <em>Device Component</em>}</li>
 *   <li>{@link fhir.impl.ResourceContainerImpl#getDeviceMetric <em>Device Metric</em>}</li>
 *   <li>{@link fhir.impl.ResourceContainerImpl#getDeviceUseRequest <em>Device Use Request</em>}</li>
 *   <li>{@link fhir.impl.ResourceContainerImpl#getDeviceUseStatement <em>Device Use Statement</em>}</li>
 *   <li>{@link fhir.impl.ResourceContainerImpl#getDiagnosticOrder <em>Diagnostic Order</em>}</li>
 *   <li>{@link fhir.impl.ResourceContainerImpl#getDiagnosticReport <em>Diagnostic Report</em>}</li>
 *   <li>{@link fhir.impl.ResourceContainerImpl#getDocumentManifest <em>Document Manifest</em>}</li>
 *   <li>{@link fhir.impl.ResourceContainerImpl#getDocumentReference <em>Document Reference</em>}</li>
 *   <li>{@link fhir.impl.ResourceContainerImpl#getEligibilityRequest <em>Eligibility Request</em>}</li>
 *   <li>{@link fhir.impl.ResourceContainerImpl#getEligibilityResponse <em>Eligibility Response</em>}</li>
 *   <li>{@link fhir.impl.ResourceContainerImpl#getEncounter <em>Encounter</em>}</li>
 *   <li>{@link fhir.impl.ResourceContainerImpl#getEnrollmentRequest <em>Enrollment Request</em>}</li>
 *   <li>{@link fhir.impl.ResourceContainerImpl#getEnrollmentResponse <em>Enrollment Response</em>}</li>
 *   <li>{@link fhir.impl.ResourceContainerImpl#getEpisodeOfCare <em>Episode Of Care</em>}</li>
 *   <li>{@link fhir.impl.ResourceContainerImpl#getExplanationOfBenefit <em>Explanation Of Benefit</em>}</li>
 *   <li>{@link fhir.impl.ResourceContainerImpl#getFamilyMemberHistory <em>Family Member History</em>}</li>
 *   <li>{@link fhir.impl.ResourceContainerImpl#getFlag <em>Flag</em>}</li>
 *   <li>{@link fhir.impl.ResourceContainerImpl#getGoal <em>Goal</em>}</li>
 *   <li>{@link fhir.impl.ResourceContainerImpl#getGroup <em>Group</em>}</li>
 *   <li>{@link fhir.impl.ResourceContainerImpl#getHealthcareService <em>Healthcare Service</em>}</li>
 *   <li>{@link fhir.impl.ResourceContainerImpl#getImagingObjectSelection <em>Imaging Object Selection</em>}</li>
 *   <li>{@link fhir.impl.ResourceContainerImpl#getImagingStudy <em>Imaging Study</em>}</li>
 *   <li>{@link fhir.impl.ResourceContainerImpl#getImmunization <em>Immunization</em>}</li>
 *   <li>{@link fhir.impl.ResourceContainerImpl#getImmunizationRecommendation <em>Immunization Recommendation</em>}</li>
 *   <li>{@link fhir.impl.ResourceContainerImpl#getImplementationGuide <em>Implementation Guide</em>}</li>
 *   <li>{@link fhir.impl.ResourceContainerImpl#getList <em>List</em>}</li>
 *   <li>{@link fhir.impl.ResourceContainerImpl#getLocation <em>Location</em>}</li>
 *   <li>{@link fhir.impl.ResourceContainerImpl#getMedia <em>Media</em>}</li>
 *   <li>{@link fhir.impl.ResourceContainerImpl#getMedication <em>Medication</em>}</li>
 *   <li>{@link fhir.impl.ResourceContainerImpl#getMedicationAdministration <em>Medication Administration</em>}</li>
 *   <li>{@link fhir.impl.ResourceContainerImpl#getMedicationDispense <em>Medication Dispense</em>}</li>
 *   <li>{@link fhir.impl.ResourceContainerImpl#getMedicationOrder <em>Medication Order</em>}</li>
 *   <li>{@link fhir.impl.ResourceContainerImpl#getMedicationStatement <em>Medication Statement</em>}</li>
 *   <li>{@link fhir.impl.ResourceContainerImpl#getMessageHeader <em>Message Header</em>}</li>
 *   <li>{@link fhir.impl.ResourceContainerImpl#getNamingSystem <em>Naming System</em>}</li>
 *   <li>{@link fhir.impl.ResourceContainerImpl#getNutritionOrder <em>Nutrition Order</em>}</li>
 *   <li>{@link fhir.impl.ResourceContainerImpl#getObservation <em>Observation</em>}</li>
 *   <li>{@link fhir.impl.ResourceContainerImpl#getOperationDefinition <em>Operation Definition</em>}</li>
 *   <li>{@link fhir.impl.ResourceContainerImpl#getOperationOutcome <em>Operation Outcome</em>}</li>
 *   <li>{@link fhir.impl.ResourceContainerImpl#getOrder <em>Order</em>}</li>
 *   <li>{@link fhir.impl.ResourceContainerImpl#getOrderResponse <em>Order Response</em>}</li>
 *   <li>{@link fhir.impl.ResourceContainerImpl#getOrganization <em>Organization</em>}</li>
 *   <li>{@link fhir.impl.ResourceContainerImpl#getPatient <em>Patient</em>}</li>
 *   <li>{@link fhir.impl.ResourceContainerImpl#getPaymentNotice <em>Payment Notice</em>}</li>
 *   <li>{@link fhir.impl.ResourceContainerImpl#getPaymentReconciliation <em>Payment Reconciliation</em>}</li>
 *   <li>{@link fhir.impl.ResourceContainerImpl#getPerson <em>Person</em>}</li>
 *   <li>{@link fhir.impl.ResourceContainerImpl#getPractitioner <em>Practitioner</em>}</li>
 *   <li>{@link fhir.impl.ResourceContainerImpl#getProcedure <em>Procedure</em>}</li>
 *   <li>{@link fhir.impl.ResourceContainerImpl#getProcedureRequest <em>Procedure Request</em>}</li>
 *   <li>{@link fhir.impl.ResourceContainerImpl#getProcessRequest <em>Process Request</em>}</li>
 *   <li>{@link fhir.impl.ResourceContainerImpl#getProcessResponse <em>Process Response</em>}</li>
 *   <li>{@link fhir.impl.ResourceContainerImpl#getProvenance <em>Provenance</em>}</li>
 *   <li>{@link fhir.impl.ResourceContainerImpl#getQuestionnaire <em>Questionnaire</em>}</li>
 *   <li>{@link fhir.impl.ResourceContainerImpl#getQuestionnaireResponse <em>Questionnaire Response</em>}</li>
 *   <li>{@link fhir.impl.ResourceContainerImpl#getReferralRequest <em>Referral Request</em>}</li>
 *   <li>{@link fhir.impl.ResourceContainerImpl#getRelatedPerson <em>Related Person</em>}</li>
 *   <li>{@link fhir.impl.ResourceContainerImpl#getRiskAssessment <em>Risk Assessment</em>}</li>
 *   <li>{@link fhir.impl.ResourceContainerImpl#getSchedule <em>Schedule</em>}</li>
 *   <li>{@link fhir.impl.ResourceContainerImpl#getSearchParameter <em>Search Parameter</em>}</li>
 *   <li>{@link fhir.impl.ResourceContainerImpl#getSlot <em>Slot</em>}</li>
 *   <li>{@link fhir.impl.ResourceContainerImpl#getSpecimen <em>Specimen</em>}</li>
 *   <li>{@link fhir.impl.ResourceContainerImpl#getStructureDefinition <em>Structure Definition</em>}</li>
 *   <li>{@link fhir.impl.ResourceContainerImpl#getSubscription <em>Subscription</em>}</li>
 *   <li>{@link fhir.impl.ResourceContainerImpl#getSubstance <em>Substance</em>}</li>
 *   <li>{@link fhir.impl.ResourceContainerImpl#getSupplyDelivery <em>Supply Delivery</em>}</li>
 *   <li>{@link fhir.impl.ResourceContainerImpl#getSupplyRequest <em>Supply Request</em>}</li>
 *   <li>{@link fhir.impl.ResourceContainerImpl#getTestScript <em>Test Script</em>}</li>
 *   <li>{@link fhir.impl.ResourceContainerImpl#getValueSet <em>Value Set</em>}</li>
 *   <li>{@link fhir.impl.ResourceContainerImpl#getVisionPrescription <em>Vision Prescription</em>}</li>
 *   <li>{@link fhir.impl.ResourceContainerImpl#getParameters <em>Parameters</em>}</li>
 * </ul>
 *
 * @generated
 */
