 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.impl.ClinicalImpressionFindingImpl#getItem <em>Item</em>}</li>
 *   <li>{@link fhir.impl.ClinicalImpressionFindingImpl#getCause <em>Cause</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ClinicalImpressionFindingImpl extends BackboneElementImpl implements ClinicalImpressionFinding {
	 ...
	 * @generated
	 */
	public NotificationChain basicSetCause(fhir.String newCause, NotificationChain msgs) {
		fhir.String oldCause = cause;
		cause = newCause;
		if (eNotificationRequired()) {
	 ...
	 * @generated
	 */
	public void setCause(fhir.String newCause) {
		if (newCause != cause) {
			NotificationChain msgs = null;
			if (cause != null)
