 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.impl.DocumentRootImpl#getMixed <em>Mixed</em>}</li>
 *   <li>{@link fhir.impl.DocumentRootImpl#getXMLNSPrefixMap <em>XMLNS Prefix Map</em>}</li>
 *   <li>{@link fhir.impl.DocumentRootImpl#getXSISchemaLocation <em>XSI Schema Location</em>}</li>
 *   <li>{@link fhir.impl.DocumentRootImpl#getAllergyIntolerance <em>Allergy Intolerance</em>}</li>
 *   <li>{@link fhir.impl.DocumentRootImpl#getAppointment <em>Appointment</em>}</li>
 *   <li>{@link fhir.impl.DocumentRootImpl#getAppointmentResponse <em>Appointment Response</em>}</li>
 *   <li>{@link fhir.impl.DocumentRootImpl#getAuditEvent <em>Audit Event</em>}</li>
 *   <li>{@link fhir.impl.DocumentRootImpl#getBasic <em>Basic</em>}</li>
 *   <li>{@link fhir.impl.DocumentRootImpl#getBinary <em>Binary</em>}</li>
 *   <li>{@link fhir.impl.DocumentRootImpl#getBodySite <em>Body Site</em>}</li>
 *   <li>{@link fhir.impl.DocumentRootImpl#getBundle <em>Bundle</em>}</li>
 *   <li>{@link fhir.impl.DocumentRootImpl#getCarePlan <em>Care Plan</em>}</li>
 *   <li>{@link fhir.impl.DocumentRootImpl#getClaim <em>Claim</em>}</li>
 *   <li>{@link fhir.impl.DocumentRootImpl#getClaimResponse <em>Claim Response</em>}</li>
 *   <li>{@link fhir.impl.DocumentRootImpl#getClinicalImpression <em>Clinical Impression</em>}</li>
 *   <li>{@link fhir.impl.DocumentRootImpl#getCommunication <em>Communication</em>}</li>
 *   <li>{@link fhir.impl.DocumentRootImpl#getCommunicationRequest <em>Communication Request</em>}</li>
 *   <li>{@link fhir.impl.DocumentRootImpl#getComposition <em>Composition</em>}</li>
 *   <li>{@link fhir.impl.DocumentRootImpl#getConceptMap <em>Concept Map</em>}</li>
 *   <li>{@link fhir.impl.DocumentRootImpl#getCondition <em>Condition</em>}</li>
 *   <li>{@link fhir.impl.DocumentRootImpl#getConformance <em>Conformance</em>}</li>
 *   <li>{@link fhir.impl.DocumentRootImpl#getContract <em>Contract</em>}</li>
 *   <li>{@link fhir.impl.DocumentRootImpl#getContraindication <em>Contraindication</em>}</li>
 *   <li>{@link fhir.impl.DocumentRootImpl#getCoverage <em>Coverage</em>}</li>
 *   <li>{@link fhir.impl.DocumentRootImpl#getDataElement <em>Data Element</em>}</li>
 *   <li>{@link fhir.impl.DocumentRootImpl#getDevice <em>Device</em>}</li>
 *   <li>{@link fhir.impl.DocumentRootImpl#getDeviceComponent <em>Device Component</em>}</li>
 *   <li>{@link fhir.impl.DocumentRootImpl#getDeviceMetric <em>Device Metric</em>}</li>
 *   <li>{@link fhir.impl.DocumentRootImpl#getDeviceUseRequest <em>Device Use Request</em>}</li>
 *   <li>{@link fhir.impl.DocumentRootImpl#getDeviceUseStatement <em>Device Use Statement</em>}</li>
 *   <li>{@link fhir.impl.DocumentRootImpl#getDiagnosticOrder <em>Diagnostic Order</em>}</li>
 *   <li>{@link fhir.impl.DocumentRootImpl#getDiagnosticReport <em>Diagnostic Report</em>}</li>
 *   <li>{@link fhir.impl.DocumentRootImpl#getDocumentManifest <em>Document Manifest</em>}</li>
 *   <li>{@link fhir.impl.DocumentRootImpl#getDocumentReference <em>Document Reference</em>}</li>
 *   <li>{@link fhir.impl.DocumentRootImpl#getEligibilityRequest <em>Eligibility Request</em>}</li>
 *   <li>{@link fhir.impl.DocumentRootImpl#getEligibilityResponse <em>Eligibility Response</em>}</li>
 *   <li>{@link fhir.impl.DocumentRootImpl#getEncounter <em>Encounter</em>}</li>
 *   <li>{@link fhir.impl.DocumentRootImpl#getEnrollmentRequest <em>Enrollment Request</em>}</li>
 *   <li>{@link fhir.impl.DocumentRootImpl#getEnrollmentResponse <em>Enrollment Response</em>}</li>
 *   <li>{@link fhir.impl.DocumentRootImpl#getEpisodeOfCare <em>Episode Of Care</em>}</li>
 *   <li>{@link fhir.impl.DocumentRootImpl#getExplanationOfBenefit <em>Explanation Of Benefit</em>}</li>
 *   <li>{@link fhir.impl.DocumentRootImpl#getFamilyMemberHistory <em>Family Member History</em>}</li>
 *   <li>{@link fhir.impl.DocumentRootImpl#getFlag <em>Flag</em>}</li>
 *   <li>{@link fhir.impl.DocumentRootImpl#getGoal <em>Goal</em>}</li>
 *   <li>{@link fhir.impl.DocumentRootImpl#getGroup <em>Group</em>}</li>
 *   <li>{@link fhir.impl.DocumentRootImpl#getHealthcareService <em>Healthcare Service</em>}</li>
 *   <li>{@link fhir.impl.DocumentRootImpl#getImagingObjectSelection <em>Imaging Object Selection</em>}</li>
 ...
 *   <li>{@link fhir.impl.DocumentRootImpl#getMedication <em>Medication</em>}</li>
 *   <li>{@link fhir.impl.DocumentRootImpl#getMedicationAdministration <em>Medication Administration</em>}</li>
 *   <li>{@link fhir.impl.DocumentRootImpl#getMedicationDispense <em>Medication Dispense</em>}</li>
 *   <li>{@link fhir.impl.DocumentRootImpl#getMedicationPrescription <em>Medication Prescription</em>}</li>
 *   <li>{@link fhir.impl.DocumentRootImpl#getMedicationStatement <em>Medication Statement</em>}</li>
 *   <li>{@link fhir.impl.DocumentRootImpl#getMessageHeader <em>Message Header</em>}</li>
 *   <li>{@link fhir.impl.DocumentRootImpl#getNamingSystem <em>Naming System</em>}</li>
 *   <li>{@link fhir.impl.DocumentRootImpl#getNutritionOrder <em>Nutrition Order</em>}</li>
 *   <li>{@link fhir.impl.DocumentRootImpl#getObservation <em>Observation</em>}</li>
 *   <li>{@link fhir.impl.DocumentRootImpl#getOperationDefinition <em>Operation Definition</em>}</li>
 *   <li>{@link fhir.impl.DocumentRootImpl#getOperationOutcome <em>Operation Outcome</em>}</li>
 *   <li>{@link fhir.impl.DocumentRootImpl#getOrder <em>Order</em>}</li>
 *   <li>{@link fhir.impl.DocumentRootImpl#getOrderResponse <em>Order Response</em>}</li>
 *   <li>{@link fhir.impl.DocumentRootImpl#getOrganization <em>Organization</em>}</li>
 *   <li>{@link fhir.impl.DocumentRootImpl#getPatient <em>Patient</em>}</li>
 *   <li>{@link fhir.impl.DocumentRootImpl#getPaymentNotice <em>Payment Notice</em>}</li>
 *   <li>{@link fhir.impl.DocumentRootImpl#getPaymentReconciliation <em>Payment Reconciliation</em>}</li>
 *   <li>{@link fhir.impl.DocumentRootImpl#getPerson <em>Person</em>}</li>
 *   <li>{@link fhir.impl.DocumentRootImpl#getPractitioner <em>Practitioner</em>}</li>
 *   <li>{@link fhir.impl.DocumentRootImpl#getProcedure <em>Procedure</em>}</li>
 *   <li>{@link fhir.impl.DocumentRootImpl#getProcedureRequest <em>Procedure Request</em>}</li>
 *   <li>{@link fhir.impl.DocumentRootImpl#getProcessRequest <em>Process Request</em>}</li>
 *   <li>{@link fhir.impl.DocumentRootImpl#getProcessResponse <em>Process Response</em>}</li>
 *   <li>{@link fhir.impl.DocumentRootImpl#getProvenance <em>Provenance</em>}</li>
 *   <li>{@link fhir.impl.DocumentRootImpl#getQuestionnaire <em>Questionnaire</em>}</li>
 *   <li>{@link fhir.impl.DocumentRootImpl#getQuestionnaireAnswers <em>Questionnaire Answers</em>}</li>
 *   <li>{@link fhir.impl.DocumentRootImpl#getReferralRequest <em>Referral Request</em>}</li>
 *   <li>{@link fhir.impl.DocumentRootImpl#getRelatedPerson <em>Related Person</em>}</li>
 *   <li>{@link fhir.impl.DocumentRootImpl#getRiskAssessment <em>Risk Assessment</em>}</li>
 *   <li>{@link fhir.impl.DocumentRootImpl#getSchedule <em>Schedule</em>}</li>
 *   <li>{@link fhir.impl.DocumentRootImpl#getSearchParameter <em>Search Parameter</em>}</li>
 *   <li>{@link fhir.impl.DocumentRootImpl#getSlot <em>Slot</em>}</li>
 *   <li>{@link fhir.impl.DocumentRootImpl#getSpecimen <em>Specimen</em>}</li>
 *   <li>{@link fhir.impl.DocumentRootImpl#getStructureDefinition <em>Structure Definition</em>}</li>
 *   <li>{@link fhir.impl.DocumentRootImpl#getSubscription <em>Subscription</em>}</li>
 *   <li>{@link fhir.impl.DocumentRootImpl#getSubstance <em>Substance</em>}</li>
 *   <li>{@link fhir.impl.DocumentRootImpl#getSupply <em>Supply</em>}</li>
 *   <li>{@link fhir.impl.DocumentRootImpl#getSupplyDelivery <em>Supply Delivery</em>}</li>
 *   <li>{@link fhir.impl.DocumentRootImpl#getSupplyRequest <em>Supply Request</em>}</li>
 *   <li>{@link fhir.impl.DocumentRootImpl#getTestScript <em>Test Script</em>}</li>
 *   <li>{@link fhir.impl.DocumentRootImpl#getValueSet <em>Value Set</em>}</li>
 *   <li>{@link fhir.impl.DocumentRootImpl#getVisionPrescription <em>Vision Prescription</em>}</li>
 * </ul>
 *
 * @generated
 */
