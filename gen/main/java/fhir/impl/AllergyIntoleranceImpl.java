 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.impl.AllergyIntoleranceImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link fhir.impl.AllergyIntoleranceImpl#getOnset <em>Onset</em>}</li>
 *   <li>{@link fhir.impl.AllergyIntoleranceImpl#getRecordedDate <em>Recorded Date</em>}</li>
 *   <li>{@link fhir.impl.AllergyIntoleranceImpl#getRecorder <em>Recorder</em>}</li>
 *   <li>{@link fhir.impl.AllergyIntoleranceImpl#getPatient <em>Patient</em>}</li>
 *   <li>{@link fhir.impl.AllergyIntoleranceImpl#getReporter <em>Reporter</em>}</li>
 *   <li>{@link fhir.impl.AllergyIntoleranceImpl#getSubstance <em>Substance</em>}</li>
 *   <li>{@link fhir.impl.AllergyIntoleranceImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link fhir.impl.AllergyIntoleranceImpl#getCriticality <em>Criticality</em>}</li>
 *   <li>{@link fhir.impl.AllergyIntoleranceImpl#getType <em>Type</em>}</li>
 *   <li>{@link fhir.impl.AllergyIntoleranceImpl#getCategory <em>Category</em>}</li>
 *   <li>{@link fhir.impl.AllergyIntoleranceImpl#getLastOccurence <em>Last Occurence</em>}</li>
 *   <li>{@link fhir.impl.AllergyIntoleranceImpl#getNote <em>Note</em>}</li>
 *   <li>{@link fhir.impl.AllergyIntoleranceImpl#getReaction <em>Reaction</em>}</li>
 * </ul>
 *
 * @generated
 */
