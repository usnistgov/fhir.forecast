 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.impl.CarePlanImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link fhir.impl.CarePlanImpl#getSubject <em>Subject</em>}</li>
 *   <li>{@link fhir.impl.CarePlanImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link fhir.impl.CarePlanImpl#getContext <em>Context</em>}</li>
 *   <li>{@link fhir.impl.CarePlanImpl#getPeriod <em>Period</em>}</li>
 *   <li>{@link fhir.impl.CarePlanImpl#getAuthor <em>Author</em>}</li>
 *   <li>{@link fhir.impl.CarePlanImpl#getModified <em>Modified</em>}</li>
 *   <li>{@link fhir.impl.CarePlanImpl#getCategory <em>Category</em>}</li>
 *   <li>{@link fhir.impl.CarePlanImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link fhir.impl.CarePlanImpl#getAddresses <em>Addresses</em>}</li>
 *   <li>{@link fhir.impl.CarePlanImpl#getSupport <em>Support</em>}</li>
 *   <li>{@link fhir.impl.CarePlanImpl#getRelatedPlan <em>Related Plan</em>}</li>
 *   <li>{@link fhir.impl.CarePlanImpl#getParticipant <em>Participant</em>}</li>
 *   <li>{@link fhir.impl.CarePlanImpl#getGoal <em>Goal</em>}</li>
 *   <li>{@link fhir.impl.CarePlanImpl#getActivity <em>Activity</em>}</li>
 *   <li>{@link fhir.impl.CarePlanImpl#getNote <em>Note</em>}</li>
 * </ul>
 *
 * @generated
 */
