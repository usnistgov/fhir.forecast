 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.impl.ValueSetExpansionImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link fhir.impl.ValueSetExpansionImpl#getTimestamp <em>Timestamp</em>}</li>
 *   <li>{@link fhir.impl.ValueSetExpansionImpl#getTotal <em>Total</em>}</li>
 *   <li>{@link fhir.impl.ValueSetExpansionImpl#getOffset <em>Offset</em>}</li>
 *   <li>{@link fhir.impl.ValueSetExpansionImpl#getParameter <em>Parameter</em>}</li>
 *   <li>{@link fhir.impl.ValueSetExpansionImpl#getContains <em>Contains</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ValueSetExpansionImpl extends BackboneElementImpl implements ValueSetExpansion {
	 ...
	 * @generated
	 */
	public NotificationChain basicSetTotal(fhir.Integer newTotal, NotificationChain msgs) {
		fhir.Integer oldTotal = total;
		total = newTotal;
		if (eNotificationRequired()) {
	 ...
	 * @generated
	 */
	public void setTotal(fhir.Integer newTotal) {
		if (newTotal != total) {
			NotificationChain msgs = null;
			if (total != null)
	 ...
	 * @generated
	 */
	public NotificationChain basicSetOffset(fhir.Integer newOffset, NotificationChain msgs) {
		fhir.Integer oldOffset = offset;
		offset = newOffset;
		if (eNotificationRequired()) {
	 ...
	 * @generated
	 */
	public void setOffset(fhir.Integer newOffset) {
		if (newOffset != offset) {
			NotificationChain msgs = null;
			if (offset != null)
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case FhirPackage.VALUE_SET_EXPANSION__TIMESTAMP:
				...
				return;
			case FhirPackage.VALUE_SET_EXPANSION__TOTAL:
				setTotal((fhir.Integer)newValue);
				return;
			case FhirPackage.VALUE_SET_EXPANSION__OFFSET:
				setOffset((fhir.Integer)newValue);
				return;
			case FhirPackage.VALUE_SET_EXPANSION__PARAMETER:
				getParameter().clear();
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			...
			case FhirPackage.VALUE_SET_EXPANSION__TIMESTAMP:
				...
				return;
			case FhirPackage.VALUE_SET_EXPANSION__TOTAL:
				setTotal((fhir.Integer)null);
				return;
			case FhirPackage.VALUE_SET_EXPANSION__OFFSET:
				setOffset((fhir.Integer)null);
				return;
			case FhirPackage.VALUE_SET_EXPANSION__PARAMETER:
				getParameter().clear();
				return;
