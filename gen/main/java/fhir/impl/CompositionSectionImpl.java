 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.impl.CompositionSectionImpl#getTitle <em>Title</em>}</li>
 *   <li>{@link fhir.impl.CompositionSectionImpl#getCode <em>Code</em>}</li>
 *   <li>{@link fhir.impl.CompositionSectionImpl#getText <em>Text</em>}</li>
 *   <li>{@link fhir.impl.CompositionSectionImpl#getMode <em>Mode</em>}</li>
 *   <li>{@link fhir.impl.CompositionSectionImpl#getOrderedBy <em>Ordered By</em>}</li>
 *   <li>{@link fhir.impl.CompositionSectionImpl#getEntry <em>Entry</em>}</li>
 *   <li>{@link fhir.impl.CompositionSectionImpl#getEmptyReason <em>Empty Reason</em>}</li>
 *   <li>{@link fhir.impl.CompositionSectionImpl#getSection <em>Section</em>}</li>
 * </ul>
 *
 * @generated
 */
