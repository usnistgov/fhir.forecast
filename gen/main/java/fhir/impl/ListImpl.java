 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.impl.ListImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link fhir.impl.ListImpl#getTitle <em>Title</em>}</li>
 *   <li>{@link fhir.impl.ListImpl#getCode <em>Code</em>}</li>
 *   <li>{@link fhir.impl.ListImpl#getSubject <em>Subject</em>}</li>
 *   <li>{@link fhir.impl.ListImpl#getSource <em>Source</em>}</li>
 *   <li>{@link fhir.impl.ListImpl#getEncounter <em>Encounter</em>}</li>
 *   <li>{@link fhir.impl.ListImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link fhir.impl.ListImpl#getDate <em>Date</em>}</li>
 *   <li>{@link fhir.impl.ListImpl#getOrderedBy <em>Ordered By</em>}</li>
 *   <li>{@link fhir.impl.ListImpl#getMode <em>Mode</em>}</li>
 *   <li>{@link fhir.impl.ListImpl#getNote <em>Note</em>}</li>
 *   <li>{@link fhir.impl.ListImpl#getEntry <em>Entry</em>}</li>
 *   <li>{@link fhir.impl.ListImpl#getEmptyReason <em>Empty Reason</em>}</li>
 * </ul>
 *
 * @generated
 */
