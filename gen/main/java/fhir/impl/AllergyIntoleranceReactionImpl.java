 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.impl.AllergyIntoleranceReactionImpl#getSubstance <em>Substance</em>}</li>
 *   <li>{@link fhir.impl.AllergyIntoleranceReactionImpl#getCertainty <em>Certainty</em>}</li>
 *   <li>{@link fhir.impl.AllergyIntoleranceReactionImpl#getManifestation <em>Manifestation</em>}</li>
 *   <li>{@link fhir.impl.AllergyIntoleranceReactionImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link fhir.impl.AllergyIntoleranceReactionImpl#getOnset <em>Onset</em>}</li>
 *   <li>{@link fhir.impl.AllergyIntoleranceReactionImpl#getSeverity <em>Severity</em>}</li>
 *   <li>{@link fhir.impl.AllergyIntoleranceReactionImpl#getExposureRoute <em>Exposure Route</em>}</li>
 *   <li>{@link fhir.impl.AllergyIntoleranceReactionImpl#getNote <em>Note</em>}</li>
 * </ul>
 *
 * @generated
 */
