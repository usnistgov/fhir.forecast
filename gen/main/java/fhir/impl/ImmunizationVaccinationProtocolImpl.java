 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.impl.ImmunizationVaccinationProtocolImpl#getDoseSequence <em>Dose Sequence</em>}</li>
 *   <li>{@link fhir.impl.ImmunizationVaccinationProtocolImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link fhir.impl.ImmunizationVaccinationProtocolImpl#getAuthority <em>Authority</em>}</li>
 *   <li>{@link fhir.impl.ImmunizationVaccinationProtocolImpl#getSeries <em>Series</em>}</li>
 *   <li>{@link fhir.impl.ImmunizationVaccinationProtocolImpl#getSeriesDoses <em>Series Doses</em>}</li>
 *   <li>{@link fhir.impl.ImmunizationVaccinationProtocolImpl#getTargetDisease <em>Target Disease</em>}</li>
 *   <li>{@link fhir.impl.ImmunizationVaccinationProtocolImpl#getDoseStatus <em>Dose Status</em>}</li>
 *   <li>{@link fhir.impl.ImmunizationVaccinationProtocolImpl#getDoseStatusReason <em>Dose Status Reason</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ImmunizationVaccinationProtocolImpl extends BackboneElementImpl implements ImmunizationVaccinationProtocol {
	 ...
	 * @generated
	 */
	public NotificationChain basicSetSeries(fhir.String newSeries, NotificationChain msgs) {
		fhir.String oldSeries = series;
		series = newSeries;
		if (eNotificationRequired()) {
	 ...
	 * @generated
	 */
	public void setSeries(fhir.String newSeries) {
		if (newSeries != series) {
			NotificationChain msgs = null;
			if (series != null)
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case FhirPackage.IMMUNIZATION_VACCINATION_PROTOCOL__AUTHORITY:
				...
				return;
			case FhirPackage.IMMUNIZATION_VACCINATION_PROTOCOL__SERIES:
				setSeries((fhir.String)newValue);
				return;
			case FhirPackage.IMMUNIZATION_VACCINATION_PROTOCOL__SERIES_DOSES:
