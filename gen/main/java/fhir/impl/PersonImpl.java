 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.impl.PersonImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link fhir.impl.PersonImpl#getName <em>Name</em>}</li>
 *   <li>{@link fhir.impl.PersonImpl#getTelecom <em>Telecom</em>}</li>
 *   <li>{@link fhir.impl.PersonImpl#getGender <em>Gender</em>}</li>
 *   <li>{@link fhir.impl.PersonImpl#getBirthDate <em>Birth Date</em>}</li>
 *   <li>{@link fhir.impl.PersonImpl#getAddress <em>Address</em>}</li>
 *   <li>{@link fhir.impl.PersonImpl#getPhoto <em>Photo</em>}</li>
 *   <li>{@link fhir.impl.PersonImpl#getManagingOrganization <em>Managing Organization</em>}</li>
 *   <li>{@link fhir.impl.PersonImpl#getActive <em>Active</em>}</li>
 *   <li>{@link fhir.impl.PersonImpl#getLink <em>Link</em>}</li>
 * </ul>
 *
 * @generated
 */
