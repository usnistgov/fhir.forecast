 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.impl.ImagingStudyInstanceImpl#getNumber <em>Number</em>}</li>
 *   <li>{@link fhir.impl.ImagingStudyInstanceImpl#getUid <em>Uid</em>}</li>
 *   <li>{@link fhir.impl.ImagingStudyInstanceImpl#getSopClass <em>Sop Class</em>}</li>
 *   <li>{@link fhir.impl.ImagingStudyInstanceImpl#getType <em>Type</em>}</li>
 *   <li>{@link fhir.impl.ImagingStudyInstanceImpl#getTitle <em>Title</em>}</li>
 *   <li>{@link fhir.impl.ImagingStudyInstanceImpl#getContent <em>Content</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ImagingStudyInstanceImpl extends BackboneElementImpl implements ImagingStudyInstance {
	 ...
	 * @generated
	 */
	public NotificationChain basicSetType(fhir.String newType, NotificationChain msgs) {
		fhir.String oldType = type;
		type = newType;
		if (eNotificationRequired()) {
	 ...
	 * @generated
	 */
	public void setType(fhir.String newType) {
		if (newType != type) {
			NotificationChain msgs = null;
			if (type != null)
