 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.impl.ConceptMapDependsOnImpl#getElement <em>Element</em>}</li>
 *   <li>{@link fhir.impl.ConceptMapDependsOnImpl#getCodeSystem <em>Code System</em>}</li>
 *   <li>{@link fhir.impl.ConceptMapDependsOnImpl#getCode <em>Code</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ConceptMapDependsOnImpl extends BackboneElementImpl implements ConceptMapDependsOn {
	 ...
	 * @generated
	 */
	public NotificationChain basicSetCode(fhir.String newCode, NotificationChain msgs) {
		fhir.String oldCode = code;
		code = newCode;
		if (eNotificationRequired()) {
	 ...
	 * @generated
	 */
	public void setCode(fhir.String newCode) {
		if (newCode != code) {
			NotificationChain msgs = null;
			if (code != null)
