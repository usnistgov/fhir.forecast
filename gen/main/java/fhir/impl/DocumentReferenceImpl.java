 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.impl.DocumentReferenceImpl#getMasterIdentifier <em>Master Identifier</em>}</li>
 *   <li>{@link fhir.impl.DocumentReferenceImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link fhir.impl.DocumentReferenceImpl#getSubject <em>Subject</em>}</li>
 *   <li>{@link fhir.impl.DocumentReferenceImpl#getType <em>Type</em>}</li>
 *   <li>{@link fhir.impl.DocumentReferenceImpl#getClass_ <em>Class</em>}</li>
 *   <li>{@link fhir.impl.DocumentReferenceImpl#getAuthor <em>Author</em>}</li>
 *   <li>{@link fhir.impl.DocumentReferenceImpl#getCustodian <em>Custodian</em>}</li>
 *   <li>{@link fhir.impl.DocumentReferenceImpl#getAuthenticator <em>Authenticator</em>}</li>
 *   <li>{@link fhir.impl.DocumentReferenceImpl#getCreated <em>Created</em>}</li>
 *   <li>{@link fhir.impl.DocumentReferenceImpl#getIndexed <em>Indexed</em>}</li>
 *   <li>{@link fhir.impl.DocumentReferenceImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link fhir.impl.DocumentReferenceImpl#getDocStatus <em>Doc Status</em>}</li>
 *   <li>{@link fhir.impl.DocumentReferenceImpl#getRelatesTo <em>Relates To</em>}</li>
 *   <li>{@link fhir.impl.DocumentReferenceImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link fhir.impl.DocumentReferenceImpl#getSecurityLabel <em>Security Label</em>}</li>
 *   <li>{@link fhir.impl.DocumentReferenceImpl#getContent <em>Content</em>}</li>
 *   <li>{@link fhir.impl.DocumentReferenceImpl#getContext <em>Context</em>}</li>
 * </ul>
 *
 * @generated
 */
