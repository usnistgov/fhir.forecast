 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.impl.NutritionOrderImpl#getPatient <em>Patient</em>}</li>
 *   <li>{@link fhir.impl.NutritionOrderImpl#getOrderer <em>Orderer</em>}</li>
 *   <li>{@link fhir.impl.NutritionOrderImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link fhir.impl.NutritionOrderImpl#getEncounter <em>Encounter</em>}</li>
 *   <li>{@link fhir.impl.NutritionOrderImpl#getDateTime <em>Date Time</em>}</li>
 *   <li>{@link fhir.impl.NutritionOrderImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link fhir.impl.NutritionOrderImpl#getAllergyIntolerance <em>Allergy Intolerance</em>}</li>
 *   <li>{@link fhir.impl.NutritionOrderImpl#getFoodPreferenceModifier <em>Food Preference Modifier</em>}</li>
 *   <li>{@link fhir.impl.NutritionOrderImpl#getExcludeFoodModifier <em>Exclude Food Modifier</em>}</li>
 *   <li>{@link fhir.impl.NutritionOrderImpl#getOralDiet <em>Oral Diet</em>}</li>
 *   <li>{@link fhir.impl.NutritionOrderImpl#getSupplement <em>Supplement</em>}</li>
 *   <li>{@link fhir.impl.NutritionOrderImpl#getEnteralFormula <em>Enteral Formula</em>}</li>
 * </ul>
 *
 * @generated
 */
