 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.impl.ClaimDetailImpl#getSequence <em>Sequence</em>}</li>
 *   <li>{@link fhir.impl.ClaimDetailImpl#getType <em>Type</em>}</li>
 *   <li>{@link fhir.impl.ClaimDetailImpl#getService <em>Service</em>}</li>
 *   <li>{@link fhir.impl.ClaimDetailImpl#getQuantity <em>Quantity</em>}</li>
 *   <li>{@link fhir.impl.ClaimDetailImpl#getUnitPrice <em>Unit Price</em>}</li>
 *   <li>{@link fhir.impl.ClaimDetailImpl#getFactor <em>Factor</em>}</li>
 *   <li>{@link fhir.impl.ClaimDetailImpl#getPoints <em>Points</em>}</li>
 *   <li>{@link fhir.impl.ClaimDetailImpl#getNet <em>Net</em>}</li>
 *   <li>{@link fhir.impl.ClaimDetailImpl#getUdi <em>Udi</em>}</li>
 *   <li>{@link fhir.impl.ClaimDetailImpl#getSubDetail <em>Sub Detail</em>}</li>
 * </ul>
 *
 * @generated
 */
