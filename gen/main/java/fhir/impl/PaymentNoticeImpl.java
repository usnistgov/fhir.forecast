 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.impl.PaymentNoticeImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link fhir.impl.PaymentNoticeImpl#getRuleset <em>Ruleset</em>}</li>
 *   <li>{@link fhir.impl.PaymentNoticeImpl#getOriginalRuleset <em>Original Ruleset</em>}</li>
 *   <li>{@link fhir.impl.PaymentNoticeImpl#getCreated <em>Created</em>}</li>
 *   <li>{@link fhir.impl.PaymentNoticeImpl#getTarget <em>Target</em>}</li>
 *   <li>{@link fhir.impl.PaymentNoticeImpl#getProvider <em>Provider</em>}</li>
 *   <li>{@link fhir.impl.PaymentNoticeImpl#getOrganization <em>Organization</em>}</li>
 *   <li>{@link fhir.impl.PaymentNoticeImpl#getRequest <em>Request</em>}</li>
 *   <li>{@link fhir.impl.PaymentNoticeImpl#getResponse <em>Response</em>}</li>
 *   <li>{@link fhir.impl.PaymentNoticeImpl#getPaymentStatus <em>Payment Status</em>}</li>
 * </ul>
 *
 * @generated
 */
