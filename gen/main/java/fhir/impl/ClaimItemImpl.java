 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.impl.ClaimItemImpl#getSequence <em>Sequence</em>}</li>
 *   <li>{@link fhir.impl.ClaimItemImpl#getType <em>Type</em>}</li>
 *   <li>{@link fhir.impl.ClaimItemImpl#getProvider <em>Provider</em>}</li>
 *   <li>{@link fhir.impl.ClaimItemImpl#getDiagnosisLinkId <em>Diagnosis Link Id</em>}</li>
 *   <li>{@link fhir.impl.ClaimItemImpl#getService <em>Service</em>}</li>
 *   <li>{@link fhir.impl.ClaimItemImpl#getServiceDate <em>Service Date</em>}</li>
 *   <li>{@link fhir.impl.ClaimItemImpl#getQuantity <em>Quantity</em>}</li>
 *   <li>{@link fhir.impl.ClaimItemImpl#getUnitPrice <em>Unit Price</em>}</li>
 *   <li>{@link fhir.impl.ClaimItemImpl#getFactor <em>Factor</em>}</li>
 *   <li>{@link fhir.impl.ClaimItemImpl#getPoints <em>Points</em>}</li>
 *   <li>{@link fhir.impl.ClaimItemImpl#getNet <em>Net</em>}</li>
 *   <li>{@link fhir.impl.ClaimItemImpl#getUdi <em>Udi</em>}</li>
 *   <li>{@link fhir.impl.ClaimItemImpl#getBodySite <em>Body Site</em>}</li>
 *   <li>{@link fhir.impl.ClaimItemImpl#getSubSite <em>Sub Site</em>}</li>
 *   <li>{@link fhir.impl.ClaimItemImpl#getModifier <em>Modifier</em>}</li>
 *   <li>{@link fhir.impl.ClaimItemImpl#getDetail <em>Detail</em>}</li>
 *   <li>{@link fhir.impl.ClaimItemImpl#getProsthesis <em>Prosthesis</em>}</li>
 * </ul>
 *
 * @generated
 */
