 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.impl.GroupImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link fhir.impl.GroupImpl#getType <em>Type</em>}</li>
 *   <li>{@link fhir.impl.GroupImpl#getActual <em>Actual</em>}</li>
 *   <li>{@link fhir.impl.GroupImpl#getCode <em>Code</em>}</li>
 *   <li>{@link fhir.impl.GroupImpl#getName <em>Name</em>}</li>
 *   <li>{@link fhir.impl.GroupImpl#getQuantity <em>Quantity</em>}</li>
 *   <li>{@link fhir.impl.GroupImpl#getCharacteristic <em>Characteristic</em>}</li>
 *   <li>{@link fhir.impl.GroupImpl#getMember <em>Member</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GroupImpl extends DomainResourceImpl implements Group {
	 ...
	 * @generated
	 */
	public NotificationChain basicSetActual(fhir.Boolean newActual, NotificationChain msgs) {
		fhir.Boolean oldActual = actual;
		actual = newActual;
		if (eNotificationRequired()) {
	 ...
	 * @generated
	 */
	public void setActual(fhir.Boolean newActual) {
		if (newActual != actual) {
			NotificationChain msgs = null;
			if (actual != null)
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case FhirPackage.GROUP__TYPE:
				...
				return;
			case FhirPackage.GROUP__ACTUAL:
				setActual((fhir.Boolean)newValue);
				return;
			case FhirPackage.GROUP__CODE:
