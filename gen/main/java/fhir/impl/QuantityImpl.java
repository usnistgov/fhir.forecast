 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.impl.QuantityImpl#getValue <em>Value</em>}</li>
 *   <li>{@link fhir.impl.QuantityImpl#getComparator <em>Comparator</em>}</li>
 *   <li>{@link fhir.impl.QuantityImpl#getUnit <em>Unit</em>}</li>
 *   <li>{@link fhir.impl.QuantityImpl#getSystem <em>System</em>}</li>
 *   <li>{@link fhir.impl.QuantityImpl#getCode <em>Code</em>}</li>
 * </ul>
 *
 * @generated
 */
public class QuantityImpl extends ElementImpl implements Quantity {
	 ...
	 * @generated
	 */
	public NotificationChain basicSetUnit(fhir.String newUnit, NotificationChain msgs) {
		fhir.String oldUnit = unit;
		unit = newUnit;
		if (eNotificationRequired()) {
	 ...
	 * @generated
	 */
	public void setUnit(fhir.String newUnit) {
		if (newUnit != unit) {
			NotificationChain msgs = null;
			if (unit != null)
