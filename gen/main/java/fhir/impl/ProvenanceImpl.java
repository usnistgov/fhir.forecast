 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.impl.ProvenanceImpl#getTarget <em>Target</em>}</li>
 *   <li>{@link fhir.impl.ProvenanceImpl#getPeriod <em>Period</em>}</li>
 *   <li>{@link fhir.impl.ProvenanceImpl#getRecorded <em>Recorded</em>}</li>
 *   <li>{@link fhir.impl.ProvenanceImpl#getReason <em>Reason</em>}</li>
 *   <li>{@link fhir.impl.ProvenanceImpl#getActivity <em>Activity</em>}</li>
 *   <li>{@link fhir.impl.ProvenanceImpl#getLocation <em>Location</em>}</li>
 *   <li>{@link fhir.impl.ProvenanceImpl#getPolicy <em>Policy</em>}</li>
 *   <li>{@link fhir.impl.ProvenanceImpl#getAgent <em>Agent</em>}</li>
 *   <li>{@link fhir.impl.ProvenanceImpl#getEntity <em>Entity</em>}</li>
 *   <li>{@link fhir.impl.ProvenanceImpl#getSignature <em>Signature</em>}</li>
 * </ul>
 *
 * @generated
 */
