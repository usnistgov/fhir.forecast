 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.impl.ImagingStudyImpl#getStarted <em>Started</em>}</li>
 *   <li>{@link fhir.impl.ImagingStudyImpl#getPatient <em>Patient</em>}</li>
 *   <li>{@link fhir.impl.ImagingStudyImpl#getUid <em>Uid</em>}</li>
 *   <li>{@link fhir.impl.ImagingStudyImpl#getAccession <em>Accession</em>}</li>
 *   <li>{@link fhir.impl.ImagingStudyImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link fhir.impl.ImagingStudyImpl#getOrder <em>Order</em>}</li>
 *   <li>{@link fhir.impl.ImagingStudyImpl#getModalityList <em>Modality List</em>}</li>
 *   <li>{@link fhir.impl.ImagingStudyImpl#getReferrer <em>Referrer</em>}</li>
 *   <li>{@link fhir.impl.ImagingStudyImpl#getAvailability <em>Availability</em>}</li>
 *   <li>{@link fhir.impl.ImagingStudyImpl#getUrl <em>Url</em>}</li>
 *   <li>{@link fhir.impl.ImagingStudyImpl#getNumberOfSeries <em>Number Of Series</em>}</li>
 *   <li>{@link fhir.impl.ImagingStudyImpl#getNumberOfInstances <em>Number Of Instances</em>}</li>
 *   <li>{@link fhir.impl.ImagingStudyImpl#getProcedure <em>Procedure</em>}</li>
 *   <li>{@link fhir.impl.ImagingStudyImpl#getInterpreter <em>Interpreter</em>}</li>
 *   <li>{@link fhir.impl.ImagingStudyImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link fhir.impl.ImagingStudyImpl#getSeries <em>Series</em>}</li>
 * </ul>
 *
 * @generated
 */
