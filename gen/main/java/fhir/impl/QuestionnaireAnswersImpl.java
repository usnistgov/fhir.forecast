 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.impl.QuestionnaireAnswersImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link fhir.impl.QuestionnaireAnswersImpl#getQuestionnaire <em>Questionnaire</em>}</li>
 *   <li>{@link fhir.impl.QuestionnaireAnswersImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link fhir.impl.QuestionnaireAnswersImpl#getSubject <em>Subject</em>}</li>
 *   <li>{@link fhir.impl.QuestionnaireAnswersImpl#getAuthor <em>Author</em>}</li>
 *   <li>{@link fhir.impl.QuestionnaireAnswersImpl#getAuthored <em>Authored</em>}</li>
 *   <li>{@link fhir.impl.QuestionnaireAnswersImpl#getSource <em>Source</em>}</li>
 *   <li>{@link fhir.impl.QuestionnaireAnswersImpl#getEncounter <em>Encounter</em>}</li>
 *   <li>{@link fhir.impl.QuestionnaireAnswersImpl#getGroup <em>Group</em>}</li>
 * </ul>
 *
 * @generated
 */
