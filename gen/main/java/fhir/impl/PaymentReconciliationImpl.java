 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.impl.PaymentReconciliationImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link fhir.impl.PaymentReconciliationImpl#getRequest <em>Request</em>}</li>
 *   <li>{@link fhir.impl.PaymentReconciliationImpl#getOutcome <em>Outcome</em>}</li>
 *   <li>{@link fhir.impl.PaymentReconciliationImpl#getDisposition <em>Disposition</em>}</li>
 *   <li>{@link fhir.impl.PaymentReconciliationImpl#getRuleset <em>Ruleset</em>}</li>
 *   <li>{@link fhir.impl.PaymentReconciliationImpl#getOriginalRuleset <em>Original Ruleset</em>}</li>
 *   <li>{@link fhir.impl.PaymentReconciliationImpl#getCreated <em>Created</em>}</li>
 *   <li>{@link fhir.impl.PaymentReconciliationImpl#getPeriod <em>Period</em>}</li>
 *   <li>{@link fhir.impl.PaymentReconciliationImpl#getOrganization <em>Organization</em>}</li>
 *   <li>{@link fhir.impl.PaymentReconciliationImpl#getRequestProvider <em>Request Provider</em>}</li>
 *   <li>{@link fhir.impl.PaymentReconciliationImpl#getRequestOrganization <em>Request Organization</em>}</li>
 *   <li>{@link fhir.impl.PaymentReconciliationImpl#getDetail <em>Detail</em>}</li>
 *   <li>{@link fhir.impl.PaymentReconciliationImpl#getForm <em>Form</em>}</li>
 *   <li>{@link fhir.impl.PaymentReconciliationImpl#getTotal <em>Total</em>}</li>
 *   <li>{@link fhir.impl.PaymentReconciliationImpl#getNote <em>Note</em>}</li>
 * </ul>
 *
 * @generated
 */
