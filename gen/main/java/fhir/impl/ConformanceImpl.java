 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.impl.ConformanceImpl#getUrl <em>Url</em>}</li>
 *   <li>{@link fhir.impl.ConformanceImpl#getVersion <em>Version</em>}</li>
 *   <li>{@link fhir.impl.ConformanceImpl#getName <em>Name</em>}</li>
 *   <li>{@link fhir.impl.ConformanceImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link fhir.impl.ConformanceImpl#getExperimental <em>Experimental</em>}</li>
 *   <li>{@link fhir.impl.ConformanceImpl#getPublisher <em>Publisher</em>}</li>
 *   <li>{@link fhir.impl.ConformanceImpl#getContact <em>Contact</em>}</li>
 *   <li>{@link fhir.impl.ConformanceImpl#getDate <em>Date</em>}</li>
 *   <li>{@link fhir.impl.ConformanceImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link fhir.impl.ConformanceImpl#getRequirements <em>Requirements</em>}</li>
 *   <li>{@link fhir.impl.ConformanceImpl#getCopyright <em>Copyright</em>}</li>
 *   <li>{@link fhir.impl.ConformanceImpl#getKind <em>Kind</em>}</li>
 *   <li>{@link fhir.impl.ConformanceImpl#getSoftware <em>Software</em>}</li>
 *   <li>{@link fhir.impl.ConformanceImpl#getImplementation <em>Implementation</em>}</li>
 *   <li>{@link fhir.impl.ConformanceImpl#getFhirVersion <em>Fhir Version</em>}</li>
 *   <li>{@link fhir.impl.ConformanceImpl#getAcceptUnknown <em>Accept Unknown</em>}</li>
 *   <li>{@link fhir.impl.ConformanceImpl#getFormat <em>Format</em>}</li>
 *   <li>{@link fhir.impl.ConformanceImpl#getProfile <em>Profile</em>}</li>
 *   <li>{@link fhir.impl.ConformanceImpl#getRest <em>Rest</em>}</li>
 *   <li>{@link fhir.impl.ConformanceImpl#getMessaging <em>Messaging</em>}</li>
 *   <li>{@link fhir.impl.ConformanceImpl#getDocument <em>Document</em>}</li>
 * </ul>
 *
 * @generated
 */
