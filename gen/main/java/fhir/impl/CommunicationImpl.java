 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.impl.CommunicationImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link fhir.impl.CommunicationImpl#getCategory <em>Category</em>}</li>
 *   <li>{@link fhir.impl.CommunicationImpl#getSender <em>Sender</em>}</li>
 *   <li>{@link fhir.impl.CommunicationImpl#getRecipient <em>Recipient</em>}</li>
 *   <li>{@link fhir.impl.CommunicationImpl#getPayload <em>Payload</em>}</li>
 *   <li>{@link fhir.impl.CommunicationImpl#getMedium <em>Medium</em>}</li>
 *   <li>{@link fhir.impl.CommunicationImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link fhir.impl.CommunicationImpl#getEncounter <em>Encounter</em>}</li>
 *   <li>{@link fhir.impl.CommunicationImpl#getSent <em>Sent</em>}</li>
 *   <li>{@link fhir.impl.CommunicationImpl#getReceived <em>Received</em>}</li>
 *   <li>{@link fhir.impl.CommunicationImpl#getReason <em>Reason</em>}</li>
 *   <li>{@link fhir.impl.CommunicationImpl#getSubject <em>Subject</em>}</li>
 *   <li>{@link fhir.impl.CommunicationImpl#getRequestDetail <em>Request Detail</em>}</li>
 * </ul>
 *
 * @generated
 */
