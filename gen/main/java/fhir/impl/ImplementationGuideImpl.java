 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.impl.ImplementationGuideImpl#getUrl <em>Url</em>}</li>
 *   <li>{@link fhir.impl.ImplementationGuideImpl#getVersion <em>Version</em>}</li>
 *   <li>{@link fhir.impl.ImplementationGuideImpl#getName <em>Name</em>}</li>
 *   <li>{@link fhir.impl.ImplementationGuideImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link fhir.impl.ImplementationGuideImpl#getExperimental <em>Experimental</em>}</li>
 *   <li>{@link fhir.impl.ImplementationGuideImpl#getPublisher <em>Publisher</em>}</li>
 *   <li>{@link fhir.impl.ImplementationGuideImpl#getContact <em>Contact</em>}</li>
 *   <li>{@link fhir.impl.ImplementationGuideImpl#getDate <em>Date</em>}</li>
 *   <li>{@link fhir.impl.ImplementationGuideImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link fhir.impl.ImplementationGuideImpl#getUseContext <em>Use Context</em>}</li>
 *   <li>{@link fhir.impl.ImplementationGuideImpl#getCopyright <em>Copyright</em>}</li>
 *   <li>{@link fhir.impl.ImplementationGuideImpl#getFhirVersion <em>Fhir Version</em>}</li>
 *   <li>{@link fhir.impl.ImplementationGuideImpl#getDependency <em>Dependency</em>}</li>
 *   <li>{@link fhir.impl.ImplementationGuideImpl#getPackage <em>Package</em>}</li>
 *   <li>{@link fhir.impl.ImplementationGuideImpl#getGlobal <em>Global</em>}</li>
 *   <li>{@link fhir.impl.ImplementationGuideImpl#getBinary <em>Binary</em>}</li>
 *   <li>{@link fhir.impl.ImplementationGuideImpl#getPage <em>Page</em>}</li>
 * </ul>
 *
 * @generated
 */
