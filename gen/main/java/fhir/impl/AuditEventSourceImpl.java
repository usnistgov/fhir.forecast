 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.impl.AuditEventSourceImpl#getSite <em>Site</em>}</li>
 *   <li>{@link fhir.impl.AuditEventSourceImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link fhir.impl.AuditEventSourceImpl#getType <em>Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AuditEventSourceImpl extends BackboneElementImpl implements AuditEventSource {
	 ...
	 * @generated
	 */
	public NotificationChain basicSetSite(fhir.String newSite, NotificationChain msgs) {
		fhir.String oldSite = site;
		site = newSite;
	 ...
	 * @generated
	 */
	public void setSite(fhir.String newSite) {
		if (newSite != site) {
