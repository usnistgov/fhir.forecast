 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.impl.ListEntryImpl#getFlag <em>Flag</em>}</li>
 *   <li>{@link fhir.impl.ListEntryImpl#getDeleted <em>Deleted</em>}</li>
 *   <li>{@link fhir.impl.ListEntryImpl#getDate <em>Date</em>}</li>
 *   <li>{@link fhir.impl.ListEntryImpl#getItem <em>Item</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ListEntryImpl extends BackboneElementImpl implements ListEntry {
	 ...
	 * @ordered
	 */
	protected fhir.Boolean deleted;
	 ...
	 * @generated
	 */
	public fhir.Boolean getDeleted() {
		return deleted;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetDeleted(fhir.Boolean newDeleted, NotificationChain msgs) {
		fhir.Boolean oldDeleted = deleted;
		deleted = newDeleted;
		if (eNotificationRequired()) {
	 ...
	 * @generated
	 */
	public void setDeleted(fhir.Boolean newDeleted) {
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case FhirPackage.LIST_ENTRY__FLAG:
				...
				return;
			case FhirPackage.LIST_ENTRY__DELETED:
				setDeleted((fhir.Boolean)newValue);
				return;
			case FhirPackage.LIST_ENTRY__DATE:
