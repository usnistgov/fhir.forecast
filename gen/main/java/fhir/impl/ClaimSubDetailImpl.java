 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.impl.ClaimSubDetailImpl#getSequence <em>Sequence</em>}</li>
 *   <li>{@link fhir.impl.ClaimSubDetailImpl#getType <em>Type</em>}</li>
 *   <li>{@link fhir.impl.ClaimSubDetailImpl#getService <em>Service</em>}</li>
 *   <li>{@link fhir.impl.ClaimSubDetailImpl#getQuantity <em>Quantity</em>}</li>
 *   <li>{@link fhir.impl.ClaimSubDetailImpl#getUnitPrice <em>Unit Price</em>}</li>
 *   <li>{@link fhir.impl.ClaimSubDetailImpl#getFactor <em>Factor</em>}</li>
 *   <li>{@link fhir.impl.ClaimSubDetailImpl#getPoints <em>Points</em>}</li>
 *   <li>{@link fhir.impl.ClaimSubDetailImpl#getNet <em>Net</em>}</li>
 *   <li>{@link fhir.impl.ClaimSubDetailImpl#getUdi <em>Udi</em>}</li>
 * </ul>
 *
 * @generated
 */
