 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.impl.DiagnosticReportImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link fhir.impl.DiagnosticReportImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link fhir.impl.DiagnosticReportImpl#getCategory <em>Category</em>}</li>
 *   <li>{@link fhir.impl.DiagnosticReportImpl#getCode <em>Code</em>}</li>
 *   <li>{@link fhir.impl.DiagnosticReportImpl#getSubject <em>Subject</em>}</li>
 *   <li>{@link fhir.impl.DiagnosticReportImpl#getEncounter <em>Encounter</em>}</li>
 *   <li>{@link fhir.impl.DiagnosticReportImpl#getEffectiveDateTime <em>Effective Date Time</em>}</li>
 *   <li>{@link fhir.impl.DiagnosticReportImpl#getEffectivePeriod <em>Effective Period</em>}</li>
 *   <li>{@link fhir.impl.DiagnosticReportImpl#getIssued <em>Issued</em>}</li>
 *   <li>{@link fhir.impl.DiagnosticReportImpl#getPerformer <em>Performer</em>}</li>
 *   <li>{@link fhir.impl.DiagnosticReportImpl#getRequest <em>Request</em>}</li>
 *   <li>{@link fhir.impl.DiagnosticReportImpl#getSpecimen <em>Specimen</em>}</li>
 *   <li>{@link fhir.impl.DiagnosticReportImpl#getResult <em>Result</em>}</li>
 *   <li>{@link fhir.impl.DiagnosticReportImpl#getImagingStudy <em>Imaging Study</em>}</li>
 *   <li>{@link fhir.impl.DiagnosticReportImpl#getImage <em>Image</em>}</li>
 *   <li>{@link fhir.impl.DiagnosticReportImpl#getConclusion <em>Conclusion</em>}</li>
 *   <li>{@link fhir.impl.DiagnosticReportImpl#getCodedDiagnosis <em>Coded Diagnosis</em>}</li>
 *   <li>{@link fhir.impl.DiagnosticReportImpl#getPresentedForm <em>Presented Form</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DiagnosticReportImpl extends DomainResourceImpl implements DiagnosticReport {
	 ...
	 * @ordered
	 */
	protected fhir.String conclusion;
	 ...
	 * @generated
	 */
	public fhir.String getConclusion() {
		return conclusion;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetConclusion(fhir.String newConclusion, NotificationChain msgs) {
		fhir.String oldConclusion = conclusion;
	 ...
	 * @generated
	 */
	public void setConclusion(fhir.String newConclusion) {
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case FhirPackage.DIAGNOSTIC_REPORT__IMAGE:
				...
				return;
			case FhirPackage.DIAGNOSTIC_REPORT__CONCLUSION:
				setConclusion((fhir.String)newValue);
				return;
			case FhirPackage.DIAGNOSTIC_REPORT__CODED_DIAGNOSIS:
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			...
			case FhirPackage.DIAGNOSTIC_REPORT__IMAGE:
				...
				return;
			case FhirPackage.DIAGNOSTIC_REPORT__CONCLUSION:
				setConclusion((fhir.String)null);
				return;
			case FhirPackage.DIAGNOSTIC_REPORT__CODED_DIAGNOSIS:
				getCodedDiagnosis().clear();
				return;
