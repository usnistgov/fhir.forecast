 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.impl.ExtensionImpl#getValueBoolean <em>Value Boolean</em>}</li>
 *   <li>{@link fhir.impl.ExtensionImpl#getValueInteger <em>Value Integer</em>}</li>
 *   <li>{@link fhir.impl.ExtensionImpl#getValueDecimal <em>Value Decimal</em>}</li>
 *   <li>{@link fhir.impl.ExtensionImpl#getValueBase64Binary <em>Value Base64 Binary</em>}</li>
 *   <li>{@link fhir.impl.ExtensionImpl#getValueInstant <em>Value Instant</em>}</li>
 *   <li>{@link fhir.impl.ExtensionImpl#getValueString <em>Value String</em>}</li>
 *   <li>{@link fhir.impl.ExtensionImpl#getValueUri <em>Value Uri</em>}</li>
 *   <li>{@link fhir.impl.ExtensionImpl#getValueDate <em>Value Date</em>}</li>
 *   <li>{@link fhir.impl.ExtensionImpl#getValueDateTime <em>Value Date Time</em>}</li>
 *   <li>{@link fhir.impl.ExtensionImpl#getValueTime <em>Value Time</em>}</li>
 *   <li>{@link fhir.impl.ExtensionImpl#getValueCode <em>Value Code</em>}</li>
 *   <li>{@link fhir.impl.ExtensionImpl#getValueOid <em>Value Oid</em>}</li>
 *   <li>{@link fhir.impl.ExtensionImpl#getValueUuid <em>Value Uuid</em>}</li>
 *   <li>{@link fhir.impl.ExtensionImpl#getValueId <em>Value Id</em>}</li>
 *   <li>{@link fhir.impl.ExtensionImpl#getValueUnsignedInt <em>Value Unsigned Int</em>}</li>
 *   <li>{@link fhir.impl.ExtensionImpl#getValuePositiveInt <em>Value Positive Int</em>}</li>
 *   <li>{@link fhir.impl.ExtensionImpl#getValueMarkdown <em>Value Markdown</em>}</li>
 *   <li>{@link fhir.impl.ExtensionImpl#getValueAnnotation <em>Value Annotation</em>}</li>
 *   <li>{@link fhir.impl.ExtensionImpl#getValueAttachment <em>Value Attachment</em>}</li>
 *   <li>{@link fhir.impl.ExtensionImpl#getValueIdentifier <em>Value Identifier</em>}</li>
 *   <li>{@link fhir.impl.ExtensionImpl#getValueCodeableConcept <em>Value Codeable Concept</em>}</li>
 *   <li>{@link fhir.impl.ExtensionImpl#getValueCoding <em>Value Coding</em>}</li>
 *   <li>{@link fhir.impl.ExtensionImpl#getValueQuantity <em>Value Quantity</em>}</li>
 *   <li>{@link fhir.impl.ExtensionImpl#getValueRange <em>Value Range</em>}</li>
 *   <li>{@link fhir.impl.ExtensionImpl#getValuePeriod <em>Value Period</em>}</li>
 *   <li>{@link fhir.impl.ExtensionImpl#getValueRatio <em>Value Ratio</em>}</li>
 *   <li>{@link fhir.impl.ExtensionImpl#getValueReference <em>Value Reference</em>}</li>
 *   <li>{@link fhir.impl.ExtensionImpl#getValueSampledData <em>Value Sampled Data</em>}</li>
 *   <li>{@link fhir.impl.ExtensionImpl#getValueSignature <em>Value Signature</em>}</li>
 *   <li>{@link fhir.impl.ExtensionImpl#getValueHumanName <em>Value Human Name</em>}</li>
 *   <li>{@link fhir.impl.ExtensionImpl#getValueAddress <em>Value Address</em>}</li>
 *   <li>{@link fhir.impl.ExtensionImpl#getValueContactPoint <em>Value Contact Point</em>}</li>
 *   <li>{@link fhir.impl.ExtensionImpl#getValueTiming <em>Value Timing</em>}</li>
 *   <li>{@link fhir.impl.ExtensionImpl#getValueMeta <em>Value Meta</em>}</li>
 *   <li>{@link fhir.impl.ExtensionImpl#getUrl <em>Url</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ExtensionImpl extends ElementImpl implements Extension {
	 ...
	 * @ordered
	 */
	protected fhir.Boolean valueBoolean;
	 ...
	 * @ordered
	 */
	protected fhir.Integer valueInteger;
	 ...
	 * @ordered
	 */
	protected fhir.String valueString;
	 ...
	 * @generated
	 */
	public fhir.Boolean getValueBoolean() {
		return valueBoolean;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetValueBoolean(fhir.Boolean newValueBoolean, NotificationChain msgs) {
		fhir.Boolean oldValueBoolean = valueBoolean;
	 ...
	 * @generated
	 */
	public void setValueBoolean(fhir.Boolean newValueBoolean) {
	 ...
	 * @generated
	 */
	public fhir.Integer getValueInteger() {
		return valueInteger;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetValueInteger(fhir.Integer newValueInteger, NotificationChain msgs) {
		fhir.Integer oldValueInteger = valueInteger;
	 ...
	 * @generated
	 */
	public void setValueInteger(fhir.Integer newValueInteger) {
	 ...
	 * @generated
	 */
	public fhir.String getValueString() {
		return valueString;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetValueString(fhir.String newValueString, NotificationChain msgs) {
		fhir.String oldValueString = valueString;
	 ...
	 * @generated
	 */
	public void setValueString(fhir.String newValueString) {
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case FhirPackage.EXTENSION__VALUE_BOOLEAN:
				setValueBoolean((fhir.Boolean)newValue);
				return;
			case FhirPackage.EXTENSION__VALUE_INTEGER:
				setValueInteger((fhir.Integer)newValue);
				return;
			case FhirPackage.EXTENSION__VALUE_DECIMAL:
			...
			case FhirPackage.EXTENSION__VALUE_INSTANT:
				...
				return;
			case FhirPackage.EXTENSION__VALUE_STRING:
				setValueString((fhir.String)newValue);
				return;
			case FhirPackage.EXTENSION__VALUE_URI:
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			case FhirPackage.EXTENSION__VALUE_BOOLEAN:
				setValueBoolean((fhir.Boolean)null);
				return;
			case FhirPackage.EXTENSION__VALUE_INTEGER:
				setValueInteger((fhir.Integer)null);
				return;
			case FhirPackage.EXTENSION__VALUE_DECIMAL:
			...
			case FhirPackage.EXTENSION__VALUE_INSTANT:
				...
				return;
			case FhirPackage.EXTENSION__VALUE_STRING:
				setValueString((fhir.String)null);
				return;
			case FhirPackage.EXTENSION__VALUE_URI:
