 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.impl.ContractValuedItem1Impl#getEntityCodeableConcept <em>Entity Codeable Concept</em>}</li>
 *   <li>{@link fhir.impl.ContractValuedItem1Impl#getEntityReference <em>Entity Reference</em>}</li>
 *   <li>{@link fhir.impl.ContractValuedItem1Impl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link fhir.impl.ContractValuedItem1Impl#getEffectiveTime <em>Effective Time</em>}</li>
 *   <li>{@link fhir.impl.ContractValuedItem1Impl#getQuantity <em>Quantity</em>}</li>
 *   <li>{@link fhir.impl.ContractValuedItem1Impl#getUnitPrice <em>Unit Price</em>}</li>
 *   <li>{@link fhir.impl.ContractValuedItem1Impl#getFactor <em>Factor</em>}</li>
 *   <li>{@link fhir.impl.ContractValuedItem1Impl#getPoints <em>Points</em>}</li>
 *   <li>{@link fhir.impl.ContractValuedItem1Impl#getNet <em>Net</em>}</li>
 * </ul>
 *
 * @generated
 */
