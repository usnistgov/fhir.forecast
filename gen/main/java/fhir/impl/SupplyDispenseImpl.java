 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.impl.SupplyDispenseImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link fhir.impl.SupplyDispenseImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link fhir.impl.SupplyDispenseImpl#getType <em>Type</em>}</li>
 *   <li>{@link fhir.impl.SupplyDispenseImpl#getQuantity <em>Quantity</em>}</li>
 *   <li>{@link fhir.impl.SupplyDispenseImpl#getSuppliedItem <em>Supplied Item</em>}</li>
 *   <li>{@link fhir.impl.SupplyDispenseImpl#getSupplier <em>Supplier</em>}</li>
 *   <li>{@link fhir.impl.SupplyDispenseImpl#getWhenPrepared <em>When Prepared</em>}</li>
 *   <li>{@link fhir.impl.SupplyDispenseImpl#getWhenHandedOver <em>When Handed Over</em>}</li>
 *   <li>{@link fhir.impl.SupplyDispenseImpl#getDestination <em>Destination</em>}</li>
 *   <li>{@link fhir.impl.SupplyDispenseImpl#getReceiver <em>Receiver</em>}</li>
 * </ul>
 *
 * @generated
 */
