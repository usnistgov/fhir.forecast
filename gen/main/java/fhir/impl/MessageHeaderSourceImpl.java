 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.impl.MessageHeaderSourceImpl#getName <em>Name</em>}</li>
 *   <li>{@link fhir.impl.MessageHeaderSourceImpl#getSoftware <em>Software</em>}</li>
 *   <li>{@link fhir.impl.MessageHeaderSourceImpl#getVersion <em>Version</em>}</li>
 *   <li>{@link fhir.impl.MessageHeaderSourceImpl#getContact <em>Contact</em>}</li>
 *   <li>{@link fhir.impl.MessageHeaderSourceImpl#getEndpoint <em>Endpoint</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MessageHeaderSourceImpl extends BackboneElementImpl implements MessageHeaderSource {
	 ...
	 * @ordered
	 */
	protected fhir.String software;
	 ...
	 * @generated
	 */
	public fhir.String getSoftware() {
		return software;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetSoftware(fhir.String newSoftware, NotificationChain msgs) {
		fhir.String oldSoftware = software;
	 ...
	 * @generated
	 */
	public void setSoftware(fhir.String newSoftware) {
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case FhirPackage.MESSAGE_HEADER_SOURCE__NAME:
				...
				return;
			case FhirPackage.MESSAGE_HEADER_SOURCE__SOFTWARE:
				setSoftware((fhir.String)newValue);
				return;
			case FhirPackage.MESSAGE_HEADER_SOURCE__VERSION:
