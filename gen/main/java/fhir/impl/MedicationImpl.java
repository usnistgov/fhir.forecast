 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.impl.MedicationImpl#getCode <em>Code</em>}</li>
 *   <li>{@link fhir.impl.MedicationImpl#getIsBrand <em>Is Brand</em>}</li>
 *   <li>{@link fhir.impl.MedicationImpl#getManufacturer <em>Manufacturer</em>}</li>
 *   <li>{@link fhir.impl.MedicationImpl#getProduct <em>Product</em>}</li>
 *   <li>{@link fhir.impl.MedicationImpl#getPackage <em>Package</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MedicationImpl extends DomainResourceImpl implements Medication {
	 ...
	 * @ordered
	 */
	protected fhir.Boolean isBrand;
	 ...
	 * @generated
	 */
	public fhir.Boolean getIsBrand() {
		return isBrand;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetIsBrand(fhir.Boolean newIsBrand, NotificationChain msgs) {
		fhir.Boolean oldIsBrand = isBrand;
		isBrand = newIsBrand;
		if (eNotificationRequired()) {
	 ...
	 * @generated
	 */
	public void setIsBrand(fhir.Boolean newIsBrand) {
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case FhirPackage.MEDICATION__CODE:
				...
				return;
			case FhirPackage.MEDICATION__IS_BRAND:
				setIsBrand((fhir.Boolean)newValue);
				return;
			case FhirPackage.MEDICATION__MANUFACTURER:
