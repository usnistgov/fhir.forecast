 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.impl.ElementDefinitionMappingImpl#getIdentity <em>Identity</em>}</li>
 *   <li>{@link fhir.impl.ElementDefinitionMappingImpl#getLanguage <em>Language</em>}</li>
 *   <li>{@link fhir.impl.ElementDefinitionMappingImpl#getMap <em>Map</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ElementDefinitionMappingImpl extends ElementImpl implements ElementDefinitionMapping {
	 ...
	 * @generated
	 */
	public NotificationChain basicSetMap(fhir.String newMap, NotificationChain msgs) {
		fhir.String oldMap = map;
		map = newMap;
		if (eNotificationRequired()) {
	 ...
	 * @generated
	 */
	public void setMap(fhir.String newMap) {
		if (newMap != map) {
			NotificationChain msgs = null;
			if (map != null)
