 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.impl.AuditEventParticipantImpl#getRole <em>Role</em>}</li>
 *   <li>{@link fhir.impl.AuditEventParticipantImpl#getReference <em>Reference</em>}</li>
 *   <li>{@link fhir.impl.AuditEventParticipantImpl#getUserId <em>User Id</em>}</li>
 *   <li>{@link fhir.impl.AuditEventParticipantImpl#getAltId <em>Alt Id</em>}</li>
 *   <li>{@link fhir.impl.AuditEventParticipantImpl#getName <em>Name</em>}</li>
 *   <li>{@link fhir.impl.AuditEventParticipantImpl#getRequestor <em>Requestor</em>}</li>
 *   <li>{@link fhir.impl.AuditEventParticipantImpl#getLocation <em>Location</em>}</li>
 *   <li>{@link fhir.impl.AuditEventParticipantImpl#getPolicy <em>Policy</em>}</li>
 *   <li>{@link fhir.impl.AuditEventParticipantImpl#getMedia <em>Media</em>}</li>
 *   <li>{@link fhir.impl.AuditEventParticipantImpl#getNetwork <em>Network</em>}</li>
 *   <li>{@link fhir.impl.AuditEventParticipantImpl#getPurposeOfUse <em>Purpose Of Use</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AuditEventParticipantImpl extends BackboneElementImpl implements AuditEventParticipant {
	 ...
	 * @ordered
	 */
	protected fhir.Boolean requestor;
	 ...
	 * @generated
	 */
	public NotificationChain basicSetAltId(fhir.String newAltId, NotificationChain msgs) {
		fhir.String oldAltId = altId;
		altId = newAltId;
		if (eNotificationRequired()) {
	 ...
	 * @generated
	 */
	public void setAltId(fhir.String newAltId) {
		if (newAltId != altId) {
			NotificationChain msgs = null;
			if (altId != null)
	 ...
	 * @generated
	 */
	public fhir.Boolean getRequestor() {
		return requestor;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetRequestor(fhir.Boolean newRequestor, NotificationChain msgs) {
		fhir.Boolean oldRequestor = requestor;
	 ...
	 * @generated
	 */
	public void setRequestor(fhir.Boolean newRequestor) {
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case FhirPackage.AUDIT_EVENT_PARTICIPANT__USER_ID:
				...
				return;
			case FhirPackage.AUDIT_EVENT_PARTICIPANT__ALT_ID:
				setAltId((fhir.String)newValue);
				return;
			case FhirPackage.AUDIT_EVENT_PARTICIPANT__NAME:
				setName((fhir.String)newValue);
				return;
			case FhirPackage.AUDIT_EVENT_PARTICIPANT__REQUESTOR:
				setRequestor((fhir.Boolean)newValue);
				return;
			case FhirPackage.AUDIT_EVENT_PARTICIPANT__LOCATION:
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			...
			case FhirPackage.AUDIT_EVENT_PARTICIPANT__USER_ID:
				...
				return;
			case FhirPackage.AUDIT_EVENT_PARTICIPANT__ALT_ID:
				setAltId((fhir.String)null);
				return;
			case FhirPackage.AUDIT_EVENT_PARTICIPANT__NAME:
				setName((fhir.String)null);
				return;
			case FhirPackage.AUDIT_EVENT_PARTICIPANT__REQUESTOR:
				setRequestor((fhir.Boolean)null);
				return;
			case FhirPackage.AUDIT_EVENT_PARTICIPANT__LOCATION:
