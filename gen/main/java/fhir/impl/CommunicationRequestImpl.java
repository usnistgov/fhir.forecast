 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.impl.CommunicationRequestImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link fhir.impl.CommunicationRequestImpl#getCategory <em>Category</em>}</li>
 *   <li>{@link fhir.impl.CommunicationRequestImpl#getSender <em>Sender</em>}</li>
 *   <li>{@link fhir.impl.CommunicationRequestImpl#getRecipient <em>Recipient</em>}</li>
 *   <li>{@link fhir.impl.CommunicationRequestImpl#getPayload <em>Payload</em>}</li>
 *   <li>{@link fhir.impl.CommunicationRequestImpl#getMedium <em>Medium</em>}</li>
 *   <li>{@link fhir.impl.CommunicationRequestImpl#getRequester <em>Requester</em>}</li>
 *   <li>{@link fhir.impl.CommunicationRequestImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link fhir.impl.CommunicationRequestImpl#getEncounter <em>Encounter</em>}</li>
 *   <li>{@link fhir.impl.CommunicationRequestImpl#getScheduledDateTime <em>Scheduled Date Time</em>}</li>
 *   <li>{@link fhir.impl.CommunicationRequestImpl#getScheduledPeriod <em>Scheduled Period</em>}</li>
 *   <li>{@link fhir.impl.CommunicationRequestImpl#getReason <em>Reason</em>}</li>
 *   <li>{@link fhir.impl.CommunicationRequestImpl#getRequestedOn <em>Requested On</em>}</li>
 *   <li>{@link fhir.impl.CommunicationRequestImpl#getSubject <em>Subject</em>}</li>
 *   <li>{@link fhir.impl.CommunicationRequestImpl#getPriority <em>Priority</em>}</li>
 * </ul>
 *
 * @generated
 */
