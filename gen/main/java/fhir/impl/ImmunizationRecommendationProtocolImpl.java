 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.impl.ImmunizationRecommendationProtocolImpl#getDoseSequence <em>Dose Sequence</em>}</li>
 *   <li>{@link fhir.impl.ImmunizationRecommendationProtocolImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link fhir.impl.ImmunizationRecommendationProtocolImpl#getAuthority <em>Authority</em>}</li>
 *   <li>{@link fhir.impl.ImmunizationRecommendationProtocolImpl#getSeries <em>Series</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ImmunizationRecommendationProtocolImpl extends BackboneElementImpl implements ImmunizationRecommendationProtocol {
	 ...
	 * @ordered
	 */
	protected fhir.Integer doseSequence;
	 ...
	 * @generated
	 */
	public fhir.Integer getDoseSequence() {
		return doseSequence;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetDoseSequence(fhir.Integer newDoseSequence, NotificationChain msgs) {
		fhir.Integer oldDoseSequence = doseSequence;
	 ...
	 * @generated
	 */
	public void setDoseSequence(fhir.Integer newDoseSequence) {
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case FhirPackage.IMMUNIZATION_RECOMMENDATION_PROTOCOL__DOSE_SEQUENCE:
				setDoseSequence((fhir.Integer)newValue);
				return;
			case FhirPackage.IMMUNIZATION_RECOMMENDATION_PROTOCOL__DESCRIPTION:
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			case FhirPackage.IMMUNIZATION_RECOMMENDATION_PROTOCOL__DOSE_SEQUENCE:
				setDoseSequence((fhir.Integer)null);
				return;
			case FhirPackage.IMMUNIZATION_RECOMMENDATION_PROTOCOL__DESCRIPTION:
