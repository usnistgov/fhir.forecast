 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.impl.ProcedureImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link fhir.impl.ProcedureImpl#getSubject <em>Subject</em>}</li>
 *   <li>{@link fhir.impl.ProcedureImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link fhir.impl.ProcedureImpl#getCategory <em>Category</em>}</li>
 *   <li>{@link fhir.impl.ProcedureImpl#getCode <em>Code</em>}</li>
 *   <li>{@link fhir.impl.ProcedureImpl#getNotPerformed <em>Not Performed</em>}</li>
 *   <li>{@link fhir.impl.ProcedureImpl#getReasonNotPerformed <em>Reason Not Performed</em>}</li>
 *   <li>{@link fhir.impl.ProcedureImpl#getBodySite <em>Body Site</em>}</li>
 *   <li>{@link fhir.impl.ProcedureImpl#getReasonCodeableConcept <em>Reason Codeable Concept</em>}</li>
 *   <li>{@link fhir.impl.ProcedureImpl#getReasonReference <em>Reason Reference</em>}</li>
 *   <li>{@link fhir.impl.ProcedureImpl#getPerformer <em>Performer</em>}</li>
 *   <li>{@link fhir.impl.ProcedureImpl#getPerformedDateTime <em>Performed Date Time</em>}</li>
 *   <li>{@link fhir.impl.ProcedureImpl#getPerformedPeriod <em>Performed Period</em>}</li>
 *   <li>{@link fhir.impl.ProcedureImpl#getEncounter <em>Encounter</em>}</li>
 *   <li>{@link fhir.impl.ProcedureImpl#getLocation <em>Location</em>}</li>
 *   <li>{@link fhir.impl.ProcedureImpl#getOutcome <em>Outcome</em>}</li>
 *   <li>{@link fhir.impl.ProcedureImpl#getReport <em>Report</em>}</li>
 *   <li>{@link fhir.impl.ProcedureImpl#getComplication <em>Complication</em>}</li>
 *   <li>{@link fhir.impl.ProcedureImpl#getFollowUp <em>Follow Up</em>}</li>
 *   <li>{@link fhir.impl.ProcedureImpl#getRequest <em>Request</em>}</li>
 *   <li>{@link fhir.impl.ProcedureImpl#getNotes <em>Notes</em>}</li>
 *   <li>{@link fhir.impl.ProcedureImpl#getFocalDevice <em>Focal Device</em>}</li>
 *   <li>{@link fhir.impl.ProcedureImpl#getUsed <em>Used</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ProcedureImpl extends DomainResourceImpl implements Procedure {
	 ...
	 * @ordered
	 */
	protected fhir.Boolean notPerformed;
	 ...
	 * @generated
	 */
	public fhir.Boolean getNotPerformed() {
		return notPerformed;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetNotPerformed(fhir.Boolean newNotPerformed, NotificationChain msgs) {
		fhir.Boolean oldNotPerformed = notPerformed;
	 ...
	 * @generated
	 */
	public void setNotPerformed(fhir.Boolean newNotPerformed) {
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case FhirPackage.PROCEDURE__CODE:
				...
				return;
			case FhirPackage.PROCEDURE__NOT_PERFORMED:
				setNotPerformed((fhir.Boolean)newValue);
				return;
			case FhirPackage.PROCEDURE__REASON_NOT_PERFORMED:
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			...
			case FhirPackage.PROCEDURE__CODE:
				...
				return;
			case FhirPackage.PROCEDURE__NOT_PERFORMED:
				setNotPerformed((fhir.Boolean)null);
				return;
			case FhirPackage.PROCEDURE__REASON_NOT_PERFORMED:
				getReasonNotPerformed().clear();
				return;
