 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.impl.SubscriptionChannelImpl#getType <em>Type</em>}</li>
 *   <li>{@link fhir.impl.SubscriptionChannelImpl#getEndpoint <em>Endpoint</em>}</li>
 *   <li>{@link fhir.impl.SubscriptionChannelImpl#getPayload <em>Payload</em>}</li>
 *   <li>{@link fhir.impl.SubscriptionChannelImpl#getHeader <em>Header</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SubscriptionChannelImpl extends BackboneElementImpl implements SubscriptionChannel {
	 ...
	 * @generated
	 */
	public NotificationChain basicSetPayload(fhir.String newPayload, NotificationChain msgs) {
		fhir.String oldPayload = payload;
		payload = newPayload;
		if (eNotificationRequired()) {
	 ...
	 * @generated
	 */
	public void setPayload(fhir.String newPayload) {
	 ...
	 * @generated
	 */
	public NotificationChain basicSetHeader(fhir.String newHeader, NotificationChain msgs) {
		fhir.String oldHeader = header;
		header = newHeader;
		if (eNotificationRequired()) {
	 ...
	 * @generated
	 */
	public void setHeader(fhir.String newHeader) {
		if (newHeader != header) {
			NotificationChain msgs = null;
			if (header != null)
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case FhirPackage.SUBSCRIPTION_CHANNEL__ENDPOINT:
				...
				return;
			case FhirPackage.SUBSCRIPTION_CHANNEL__PAYLOAD:
				setPayload((fhir.String)newValue);
				return;
			case FhirPackage.SUBSCRIPTION_CHANNEL__HEADER:
				setHeader((fhir.String)newValue);
				return;
		}
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			...
			case FhirPackage.SUBSCRIPTION_CHANNEL__ENDPOINT:
				...
				return;
			case FhirPackage.SUBSCRIPTION_CHANNEL__PAYLOAD:
				setPayload((fhir.String)null);
				return;
			case FhirPackage.SUBSCRIPTION_CHANNEL__HEADER:
				setHeader((fhir.String)null);
				return;
		}
