 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.impl.ObservationImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link fhir.impl.ObservationImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link fhir.impl.ObservationImpl#getCategory <em>Category</em>}</li>
 *   <li>{@link fhir.impl.ObservationImpl#getCode <em>Code</em>}</li>
 *   <li>{@link fhir.impl.ObservationImpl#getSubject <em>Subject</em>}</li>
 *   <li>{@link fhir.impl.ObservationImpl#getEncounter <em>Encounter</em>}</li>
 *   <li>{@link fhir.impl.ObservationImpl#getEffectiveDateTime <em>Effective Date Time</em>}</li>
 *   <li>{@link fhir.impl.ObservationImpl#getEffectivePeriod <em>Effective Period</em>}</li>
 *   <li>{@link fhir.impl.ObservationImpl#getIssued <em>Issued</em>}</li>
 *   <li>{@link fhir.impl.ObservationImpl#getPerformer <em>Performer</em>}</li>
 *   <li>{@link fhir.impl.ObservationImpl#getValueQuantity <em>Value Quantity</em>}</li>
 *   <li>{@link fhir.impl.ObservationImpl#getValueCodeableConcept <em>Value Codeable Concept</em>}</li>
 *   <li>{@link fhir.impl.ObservationImpl#getValueString <em>Value String</em>}</li>
 *   <li>{@link fhir.impl.ObservationImpl#getValueRange <em>Value Range</em>}</li>
 *   <li>{@link fhir.impl.ObservationImpl#getValueRatio <em>Value Ratio</em>}</li>
 *   <li>{@link fhir.impl.ObservationImpl#getValueSampledData <em>Value Sampled Data</em>}</li>
 *   <li>{@link fhir.impl.ObservationImpl#getValueAttachment <em>Value Attachment</em>}</li>
 *   <li>{@link fhir.impl.ObservationImpl#getValueTime <em>Value Time</em>}</li>
 *   <li>{@link fhir.impl.ObservationImpl#getValueDateTime <em>Value Date Time</em>}</li>
 *   <li>{@link fhir.impl.ObservationImpl#getValuePeriod <em>Value Period</em>}</li>
 *   <li>{@link fhir.impl.ObservationImpl#getDataAbsentReason <em>Data Absent Reason</em>}</li>
 *   <li>{@link fhir.impl.ObservationImpl#getInterpretation <em>Interpretation</em>}</li>
 *   <li>{@link fhir.impl.ObservationImpl#getComments <em>Comments</em>}</li>
 *   <li>{@link fhir.impl.ObservationImpl#getBodySite <em>Body Site</em>}</li>
 *   <li>{@link fhir.impl.ObservationImpl#getMethod <em>Method</em>}</li>
 *   <li>{@link fhir.impl.ObservationImpl#getSpecimen <em>Specimen</em>}</li>
 *   <li>{@link fhir.impl.ObservationImpl#getDevice <em>Device</em>}</li>
 *   <li>{@link fhir.impl.ObservationImpl#getReferenceRange <em>Reference Range</em>}</li>
 *   <li>{@link fhir.impl.ObservationImpl#getRelated <em>Related</em>}</li>
 *   <li>{@link fhir.impl.ObservationImpl#getComponent <em>Component</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ObservationImpl extends DomainResourceImpl implements Observation {
	 ...
	 * @ordered
	 */
	protected fhir.String comments;
	 ...
	 * @generated
	 */
	public fhir.String getComments() {
		return comments;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetComments(fhir.String newComments, NotificationChain msgs) {
		fhir.String oldComments = comments;
	 ...
	 * @generated
	 */
	public void setComments(fhir.String newComments) {
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case FhirPackage.OBSERVATION__INTERPRETATION:
				...
				return;
			case FhirPackage.OBSERVATION__COMMENTS:
				setComments((fhir.String)newValue);
				return;
			case FhirPackage.OBSERVATION__BODY_SITE:
