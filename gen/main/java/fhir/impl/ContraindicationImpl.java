 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.impl.ContraindicationImpl#getPatient <em>Patient</em>}</li>
 *   <li>{@link fhir.impl.ContraindicationImpl#getCategory <em>Category</em>}</li>
 *   <li>{@link fhir.impl.ContraindicationImpl#getSeverity <em>Severity</em>}</li>
 *   <li>{@link fhir.impl.ContraindicationImpl#getImplicated <em>Implicated</em>}</li>
 *   <li>{@link fhir.impl.ContraindicationImpl#getDetail <em>Detail</em>}</li>
 *   <li>{@link fhir.impl.ContraindicationImpl#getDate <em>Date</em>}</li>
 *   <li>{@link fhir.impl.ContraindicationImpl#getAuthor <em>Author</em>}</li>
 *   <li>{@link fhir.impl.ContraindicationImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link fhir.impl.ContraindicationImpl#getReference <em>Reference</em>}</li>
 *   <li>{@link fhir.impl.ContraindicationImpl#getMitigation <em>Mitigation</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ContraindicationImpl extends DomainResourceImpl implements Contraindication {
	 ...
	 * @generated
	 */
	public NotificationChain basicSetDetail(fhir.String newDetail, NotificationChain msgs) {
		fhir.String oldDetail = detail;
		detail = newDetail;
		if (eNotificationRequired()) {
	 ...
	 * @generated
	 */
	public void setDetail(fhir.String newDetail) {
		if (newDetail != detail) {
			NotificationChain msgs = null;
			if (detail != null)
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case FhirPackage.CONTRAINDICATION__IMPLICATED:
				...
				return;
			case FhirPackage.CONTRAINDICATION__DETAIL:
				setDetail((fhir.String)newValue);
				return;
			case FhirPackage.CONTRAINDICATION__DATE:
