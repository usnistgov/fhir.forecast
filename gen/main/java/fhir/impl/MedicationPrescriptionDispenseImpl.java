 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.impl.MedicationPrescriptionDispenseImpl#getMedicationCodeableConcept <em>Medication Codeable Concept</em>}</li>
 *   <li>{@link fhir.impl.MedicationPrescriptionDispenseImpl#getMedicationReference <em>Medication Reference</em>}</li>
 *   <li>{@link fhir.impl.MedicationPrescriptionDispenseImpl#getValidityPeriod <em>Validity Period</em>}</li>
 *   <li>{@link fhir.impl.MedicationPrescriptionDispenseImpl#getNumberOfRepeatsAllowed <em>Number Of Repeats Allowed</em>}</li>
 *   <li>{@link fhir.impl.MedicationPrescriptionDispenseImpl#getQuantity <em>Quantity</em>}</li>
 *   <li>{@link fhir.impl.MedicationPrescriptionDispenseImpl#getExpectedSupplyDuration <em>Expected Supply Duration</em>}</li>
 * </ul>
 *
 * @generated
 */
