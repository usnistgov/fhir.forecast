 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.impl.LocationImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link fhir.impl.LocationImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link fhir.impl.LocationImpl#getName <em>Name</em>}</li>
 *   <li>{@link fhir.impl.LocationImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link fhir.impl.LocationImpl#getMode <em>Mode</em>}</li>
 *   <li>{@link fhir.impl.LocationImpl#getType <em>Type</em>}</li>
 *   <li>{@link fhir.impl.LocationImpl#getTelecom <em>Telecom</em>}</li>
 *   <li>{@link fhir.impl.LocationImpl#getAddress <em>Address</em>}</li>
 *   <li>{@link fhir.impl.LocationImpl#getPhysicalType <em>Physical Type</em>}</li>
 *   <li>{@link fhir.impl.LocationImpl#getPosition <em>Position</em>}</li>
 *   <li>{@link fhir.impl.LocationImpl#getManagingOrganization <em>Managing Organization</em>}</li>
 *   <li>{@link fhir.impl.LocationImpl#getPartOf <em>Part Of</em>}</li>
 * </ul>
 *
 * @generated
 */
