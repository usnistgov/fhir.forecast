 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.impl.EncounterImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link fhir.impl.EncounterImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link fhir.impl.EncounterImpl#getStatusHistory <em>Status History</em>}</li>
 *   <li>{@link fhir.impl.EncounterImpl#getClass_ <em>Class</em>}</li>
 *   <li>{@link fhir.impl.EncounterImpl#getType <em>Type</em>}</li>
 *   <li>{@link fhir.impl.EncounterImpl#getPriority <em>Priority</em>}</li>
 *   <li>{@link fhir.impl.EncounterImpl#getPatient <em>Patient</em>}</li>
 *   <li>{@link fhir.impl.EncounterImpl#getEpisodeOfCare <em>Episode Of Care</em>}</li>
 *   <li>{@link fhir.impl.EncounterImpl#getIncomingReferral <em>Incoming Referral</em>}</li>
 *   <li>{@link fhir.impl.EncounterImpl#getParticipant <em>Participant</em>}</li>
 *   <li>{@link fhir.impl.EncounterImpl#getAppointment <em>Appointment</em>}</li>
 *   <li>{@link fhir.impl.EncounterImpl#getPeriod <em>Period</em>}</li>
 *   <li>{@link fhir.impl.EncounterImpl#getLength <em>Length</em>}</li>
 *   <li>{@link fhir.impl.EncounterImpl#getReason <em>Reason</em>}</li>
 *   <li>{@link fhir.impl.EncounterImpl#getIndication <em>Indication</em>}</li>
 *   <li>{@link fhir.impl.EncounterImpl#getHospitalization <em>Hospitalization</em>}</li>
 *   <li>{@link fhir.impl.EncounterImpl#getLocation <em>Location</em>}</li>
 *   <li>{@link fhir.impl.EncounterImpl#getServiceProvider <em>Service Provider</em>}</li>
 *   <li>{@link fhir.impl.EncounterImpl#getPartOf <em>Part Of</em>}</li>
 * </ul>
 *
 * @generated
 */
