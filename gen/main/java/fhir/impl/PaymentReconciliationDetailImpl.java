 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.impl.PaymentReconciliationDetailImpl#getType <em>Type</em>}</li>
 *   <li>{@link fhir.impl.PaymentReconciliationDetailImpl#getRequest <em>Request</em>}</li>
 *   <li>{@link fhir.impl.PaymentReconciliationDetailImpl#getResponce <em>Responce</em>}</li>
 *   <li>{@link fhir.impl.PaymentReconciliationDetailImpl#getSubmitter <em>Submitter</em>}</li>
 *   <li>{@link fhir.impl.PaymentReconciliationDetailImpl#getPayee <em>Payee</em>}</li>
 *   <li>{@link fhir.impl.PaymentReconciliationDetailImpl#getDate <em>Date</em>}</li>
 *   <li>{@link fhir.impl.PaymentReconciliationDetailImpl#getAmount <em>Amount</em>}</li>
 * </ul>
 *
 * @generated
 */
