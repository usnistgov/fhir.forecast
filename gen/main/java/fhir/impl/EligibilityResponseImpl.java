 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.impl.EligibilityResponseImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link fhir.impl.EligibilityResponseImpl#getRequest <em>Request</em>}</li>
 *   <li>{@link fhir.impl.EligibilityResponseImpl#getOutcome <em>Outcome</em>}</li>
 *   <li>{@link fhir.impl.EligibilityResponseImpl#getDisposition <em>Disposition</em>}</li>
 *   <li>{@link fhir.impl.EligibilityResponseImpl#getRuleset <em>Ruleset</em>}</li>
 *   <li>{@link fhir.impl.EligibilityResponseImpl#getOriginalRuleset <em>Original Ruleset</em>}</li>
 *   <li>{@link fhir.impl.EligibilityResponseImpl#getCreated <em>Created</em>}</li>
 *   <li>{@link fhir.impl.EligibilityResponseImpl#getOrganization <em>Organization</em>}</li>
 *   <li>{@link fhir.impl.EligibilityResponseImpl#getRequestProvider <em>Request Provider</em>}</li>
 *   <li>{@link fhir.impl.EligibilityResponseImpl#getRequestOrganization <em>Request Organization</em>}</li>
 * </ul>
 *
 * @generated
 */
