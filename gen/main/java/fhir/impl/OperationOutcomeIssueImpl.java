 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.impl.OperationOutcomeIssueImpl#getSeverity <em>Severity</em>}</li>
 *   <li>{@link fhir.impl.OperationOutcomeIssueImpl#getCode <em>Code</em>}</li>
 *   <li>{@link fhir.impl.OperationOutcomeIssueImpl#getDetails <em>Details</em>}</li>
 *   <li>{@link fhir.impl.OperationOutcomeIssueImpl#getDiagnostics <em>Diagnostics</em>}</li>
 *   <li>{@link fhir.impl.OperationOutcomeIssueImpl#getLocation <em>Location</em>}</li>
 * </ul>
 *
 * @generated
 */
public class OperationOutcomeIssueImpl extends BackboneElementImpl implements OperationOutcomeIssue {
	 ...
	 * @ordered
	 */
	protected fhir.String diagnostics;
	 ...
	 * @ordered
	 */
	protected EList<fhir.String> location;
	 ...
	 * @generated
	 */
	public fhir.String getDiagnostics() {
		return diagnostics;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetDiagnostics(fhir.String newDiagnostics, NotificationChain msgs) {
		fhir.String oldDiagnostics = diagnostics;
	 ...
	 * @generated
	 */
	public void setDiagnostics(fhir.String newDiagnostics) {
	 ...
	 * @generated
	 */
	public EList<fhir.String> getLocation() {
		if (location == null) {
			location = new EObjectContainmentEList<fhir.String>(fhir.String.class, this, FhirPackage.OPERATION_OUTCOME_ISSUE__LOCATION);
		}
		return location;
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case FhirPackage.OPERATION_OUTCOME_ISSUE__DETAILS:
				...
				return;
			case FhirPackage.OPERATION_OUTCOME_ISSUE__DIAGNOSTICS:
				setDiagnostics((fhir.String)newValue);
				return;
			case FhirPackage.OPERATION_OUTCOME_ISSUE__LOCATION:
				getLocation().clear();
				getLocation().addAll((Collection<? extends fhir.String>)newValue);
				return;
		}
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			...
			case FhirPackage.OPERATION_OUTCOME_ISSUE__DETAILS:
				...
				return;
			case FhirPackage.OPERATION_OUTCOME_ISSUE__DIAGNOSTICS:
				setDiagnostics((fhir.String)null);
				return;
			case FhirPackage.OPERATION_OUTCOME_ISSUE__LOCATION:
				getLocation().clear();
				return;
