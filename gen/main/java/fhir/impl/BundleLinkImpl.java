 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.impl.BundleLinkImpl#getRelation <em>Relation</em>}</li>
 *   <li>{@link fhir.impl.BundleLinkImpl#getUrl <em>Url</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BundleLinkImpl extends BackboneElementImpl implements BundleLink {
	 ...
	 * @ordered
	 */
	protected fhir.String relation;
	 ...
	 * @generated
	 */
	public fhir.String getRelation() {
		return relation;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetRelation(fhir.String newRelation, NotificationChain msgs) {
		fhir.String oldRelation = relation;
	 ...
	 * @generated
	 */
	public void setRelation(fhir.String newRelation) {
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case FhirPackage.BUNDLE_LINK__RELATION:
				setRelation((fhir.String)newValue);
				return;
			case FhirPackage.BUNDLE_LINK__URL:
				setUrl((Uri)newValue);
				return;
