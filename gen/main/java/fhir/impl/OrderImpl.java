 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.impl.OrderImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link fhir.impl.OrderImpl#getDate <em>Date</em>}</li>
 *   <li>{@link fhir.impl.OrderImpl#getSubject <em>Subject</em>}</li>
 *   <li>{@link fhir.impl.OrderImpl#getSource <em>Source</em>}</li>
 *   <li>{@link fhir.impl.OrderImpl#getTarget <em>Target</em>}</li>
 *   <li>{@link fhir.impl.OrderImpl#getReasonCodeableConcept <em>Reason Codeable Concept</em>}</li>
 *   <li>{@link fhir.impl.OrderImpl#getReasonReference <em>Reason Reference</em>}</li>
 *   <li>{@link fhir.impl.OrderImpl#getWhen <em>When</em>}</li>
 *   <li>{@link fhir.impl.OrderImpl#getDetail <em>Detail</em>}</li>
 * </ul>
 *
 * @generated
 */
