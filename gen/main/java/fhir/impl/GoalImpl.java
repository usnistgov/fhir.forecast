 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.impl.GoalImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link fhir.impl.GoalImpl#getSubject <em>Subject</em>}</li>
 *   <li>{@link fhir.impl.GoalImpl#getStartDate <em>Start Date</em>}</li>
 *   <li>{@link fhir.impl.GoalImpl#getStartCodeableConcept <em>Start Codeable Concept</em>}</li>
 *   <li>{@link fhir.impl.GoalImpl#getTargetDate <em>Target Date</em>}</li>
 *   <li>{@link fhir.impl.GoalImpl#getTargetQuantity <em>Target Quantity</em>}</li>
 *   <li>{@link fhir.impl.GoalImpl#getCategory <em>Category</em>}</li>
 *   <li>{@link fhir.impl.GoalImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link fhir.impl.GoalImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link fhir.impl.GoalImpl#getStatusDate <em>Status Date</em>}</li>
 *   <li>{@link fhir.impl.GoalImpl#getStatusReason <em>Status Reason</em>}</li>
 *   <li>{@link fhir.impl.GoalImpl#getAuthor <em>Author</em>}</li>
 *   <li>{@link fhir.impl.GoalImpl#getPriority <em>Priority</em>}</li>
 *   <li>{@link fhir.impl.GoalImpl#getAddresses <em>Addresses</em>}</li>
 *   <li>{@link fhir.impl.GoalImpl#getNote <em>Note</em>}</li>
 *   <li>{@link fhir.impl.GoalImpl#getOutcome <em>Outcome</em>}</li>
 * </ul>
 *
 * @generated
 */
