 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.impl.ProcedureRequestImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link fhir.impl.ProcedureRequestImpl#getSubject <em>Subject</em>}</li>
 *   <li>{@link fhir.impl.ProcedureRequestImpl#getCode <em>Code</em>}</li>
 *   <li>{@link fhir.impl.ProcedureRequestImpl#getBodySite <em>Body Site</em>}</li>
 *   <li>{@link fhir.impl.ProcedureRequestImpl#getReasonCodeableConcept <em>Reason Codeable Concept</em>}</li>
 *   <li>{@link fhir.impl.ProcedureRequestImpl#getReasonReference <em>Reason Reference</em>}</li>
 *   <li>{@link fhir.impl.ProcedureRequestImpl#getScheduledDateTime <em>Scheduled Date Time</em>}</li>
 *   <li>{@link fhir.impl.ProcedureRequestImpl#getScheduledPeriod <em>Scheduled Period</em>}</li>
 *   <li>{@link fhir.impl.ProcedureRequestImpl#getScheduledTiming <em>Scheduled Timing</em>}</li>
 *   <li>{@link fhir.impl.ProcedureRequestImpl#getEncounter <em>Encounter</em>}</li>
 *   <li>{@link fhir.impl.ProcedureRequestImpl#getPerformer <em>Performer</em>}</li>
 *   <li>{@link fhir.impl.ProcedureRequestImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link fhir.impl.ProcedureRequestImpl#getNotes <em>Notes</em>}</li>
 *   <li>{@link fhir.impl.ProcedureRequestImpl#getAsNeededBoolean <em>As Needed Boolean</em>}</li>
 *   <li>{@link fhir.impl.ProcedureRequestImpl#getAsNeededCodeableConcept <em>As Needed Codeable Concept</em>}</li>
 *   <li>{@link fhir.impl.ProcedureRequestImpl#getOrderedOn <em>Ordered On</em>}</li>
 *   <li>{@link fhir.impl.ProcedureRequestImpl#getOrderer <em>Orderer</em>}</li>
 *   <li>{@link fhir.impl.ProcedureRequestImpl#getPriority <em>Priority</em>}</li>
 * </ul>
 *
 * @generated
 */
