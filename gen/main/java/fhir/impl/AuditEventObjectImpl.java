 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.impl.AuditEventObjectImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link fhir.impl.AuditEventObjectImpl#getReference <em>Reference</em>}</li>
 *   <li>{@link fhir.impl.AuditEventObjectImpl#getType <em>Type</em>}</li>
 *   <li>{@link fhir.impl.AuditEventObjectImpl#getRole <em>Role</em>}</li>
 *   <li>{@link fhir.impl.AuditEventObjectImpl#getLifecycle <em>Lifecycle</em>}</li>
 *   <li>{@link fhir.impl.AuditEventObjectImpl#getSecurityLabel <em>Security Label</em>}</li>
 *   <li>{@link fhir.impl.AuditEventObjectImpl#getName <em>Name</em>}</li>
 *   <li>{@link fhir.impl.AuditEventObjectImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link fhir.impl.AuditEventObjectImpl#getQuery <em>Query</em>}</li>
 *   <li>{@link fhir.impl.AuditEventObjectImpl#getDetail <em>Detail</em>}</li>
 * </ul>
 *
 * @generated
 */
