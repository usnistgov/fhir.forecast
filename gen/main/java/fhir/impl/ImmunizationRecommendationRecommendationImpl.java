 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.impl.ImmunizationRecommendationRecommendationImpl#getDate <em>Date</em>}</li>
 *   <li>{@link fhir.impl.ImmunizationRecommendationRecommendationImpl#getVaccineCode <em>Vaccine Code</em>}</li>
 *   <li>{@link fhir.impl.ImmunizationRecommendationRecommendationImpl#getDoseNumber <em>Dose Number</em>}</li>
 *   <li>{@link fhir.impl.ImmunizationRecommendationRecommendationImpl#getForecastStatus <em>Forecast Status</em>}</li>
 *   <li>{@link fhir.impl.ImmunizationRecommendationRecommendationImpl#getDateCriterion <em>Date Criterion</em>}</li>
 *   <li>{@link fhir.impl.ImmunizationRecommendationRecommendationImpl#getProtocol <em>Protocol</em>}</li>
 *   <li>{@link fhir.impl.ImmunizationRecommendationRecommendationImpl#getSupportingImmunization <em>Supporting Immunization</em>}</li>
 *   <li>{@link fhir.impl.ImmunizationRecommendationRecommendationImpl#getSupportingPatientInformation <em>Supporting Patient Information</em>}</li>
 * </ul>
 *
 * @generated
 */
