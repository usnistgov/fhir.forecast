 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.impl.EnrollmentRequestImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link fhir.impl.EnrollmentRequestImpl#getRuleset <em>Ruleset</em>}</li>
 *   <li>{@link fhir.impl.EnrollmentRequestImpl#getOriginalRuleset <em>Original Ruleset</em>}</li>
 *   <li>{@link fhir.impl.EnrollmentRequestImpl#getCreated <em>Created</em>}</li>
 *   <li>{@link fhir.impl.EnrollmentRequestImpl#getTarget <em>Target</em>}</li>
 *   <li>{@link fhir.impl.EnrollmentRequestImpl#getProvider <em>Provider</em>}</li>
 *   <li>{@link fhir.impl.EnrollmentRequestImpl#getOrganization <em>Organization</em>}</li>
 *   <li>{@link fhir.impl.EnrollmentRequestImpl#getSubject <em>Subject</em>}</li>
 *   <li>{@link fhir.impl.EnrollmentRequestImpl#getCoverage <em>Coverage</em>}</li>
 *   <li>{@link fhir.impl.EnrollmentRequestImpl#getRelationship <em>Relationship</em>}</li>
 * </ul>
 *
 * @generated
 */
