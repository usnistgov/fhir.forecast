 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.impl.MedicationAdministrationDosageImpl#getText <em>Text</em>}</li>
 *   <li>{@link fhir.impl.MedicationAdministrationDosageImpl#getSiteCodeableConcept <em>Site Codeable Concept</em>}</li>
 *   <li>{@link fhir.impl.MedicationAdministrationDosageImpl#getSiteReference <em>Site Reference</em>}</li>
 *   <li>{@link fhir.impl.MedicationAdministrationDosageImpl#getRoute <em>Route</em>}</li>
 *   <li>{@link fhir.impl.MedicationAdministrationDosageImpl#getMethod <em>Method</em>}</li>
 *   <li>{@link fhir.impl.MedicationAdministrationDosageImpl#getQuantity <em>Quantity</em>}</li>
 *   <li>{@link fhir.impl.MedicationAdministrationDosageImpl#getRateRatio <em>Rate Ratio</em>}</li>
 *   <li>{@link fhir.impl.MedicationAdministrationDosageImpl#getRateRange <em>Rate Range</em>}</li>
 * </ul>
 *
 * @generated
 */
