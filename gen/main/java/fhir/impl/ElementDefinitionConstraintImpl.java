 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.impl.ElementDefinitionConstraintImpl#getKey <em>Key</em>}</li>
 *   <li>{@link fhir.impl.ElementDefinitionConstraintImpl#getRequirements <em>Requirements</em>}</li>
 *   <li>{@link fhir.impl.ElementDefinitionConstraintImpl#getSeverity <em>Severity</em>}</li>
 *   <li>{@link fhir.impl.ElementDefinitionConstraintImpl#getHuman <em>Human</em>}</li>
 *   <li>{@link fhir.impl.ElementDefinitionConstraintImpl#getXpath <em>Xpath</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ElementDefinitionConstraintImpl extends ElementImpl implements ElementDefinitionConstraint {
	 ...
	 * @generated
	 */
	public NotificationChain basicSetHuman(fhir.String newHuman, NotificationChain msgs) {
		fhir.String oldHuman = human;
		human = newHuman;
		if (eNotificationRequired()) {
	 ...
	 * @generated
	 */
	public void setHuman(fhir.String newHuman) {
		if (newHuman != human) {
			NotificationChain msgs = null;
			if (human != null)
