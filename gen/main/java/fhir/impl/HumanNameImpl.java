 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.impl.HumanNameImpl#getUse <em>Use</em>}</li>
 *   <li>{@link fhir.impl.HumanNameImpl#getText <em>Text</em>}</li>
 *   <li>{@link fhir.impl.HumanNameImpl#getFamily <em>Family</em>}</li>
 *   <li>{@link fhir.impl.HumanNameImpl#getGiven <em>Given</em>}</li>
 *   <li>{@link fhir.impl.HumanNameImpl#getPrefix <em>Prefix</em>}</li>
 *   <li>{@link fhir.impl.HumanNameImpl#getSuffix <em>Suffix</em>}</li>
 *   <li>{@link fhir.impl.HumanNameImpl#getPeriod <em>Period</em>}</li>
 * </ul>
 *
 * @generated
 */
public class HumanNameImpl extends ElementImpl implements HumanName {
	 ...
	 * @ordered
	 */
	protected EList<fhir.String> family;
	 ...
	 * @ordered
	 */
	protected EList<fhir.String> given;
	 ...
	 * @ordered
	 */
	protected EList<fhir.String> prefix;
	 ...
	 * @ordered
	 */
	protected EList<fhir.String> suffix;
	 ...
	 * @generated
	 */
	public EList<fhir.String> getFamily() {
		if (family == null) {
			family = new EObjectContainmentEList<fhir.String>(fhir.String.class, this, FhirPackage.HUMAN_NAME__FAMILY);
		}
		return family;
	}
	 ...
	 * @generated
	 */
	public EList<fhir.String> getGiven() {
		if (given == null) {
			given = new EObjectContainmentEList<fhir.String>(fhir.String.class, this, FhirPackage.HUMAN_NAME__GIVEN);
		}
		return given;
	}
	 ...
	 * @generated
	 */
	public EList<fhir.String> getPrefix() {
		if (prefix == null) {
			prefix = new EObjectContainmentEList<fhir.String>(fhir.String.class, this, FhirPackage.HUMAN_NAME__PREFIX);
		}
		return prefix;
	}
	 ...
	 * @generated
	 */
	public EList<fhir.String> getSuffix() {
		if (suffix == null) {
			suffix = new EObjectContainmentEList<fhir.String>(fhir.String.class, this, FhirPackage.HUMAN_NAME__SUFFIX);
		}
		return suffix;
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case FhirPackage.HUMAN_NAME__FAMILY:
				getFamily().clear();
				getFamily().addAll((Collection<? extends fhir.String>)newValue);
				return;
			case FhirPackage.HUMAN_NAME__GIVEN:
				getGiven().clear();
				getGiven().addAll((Collection<? extends fhir.String>)newValue);
				return;
			case FhirPackage.HUMAN_NAME__PREFIX:
				getPrefix().clear();
				getPrefix().addAll((Collection<? extends fhir.String>)newValue);
				return;
			case FhirPackage.HUMAN_NAME__SUFFIX:
				getSuffix().clear();
				getSuffix().addAll((Collection<? extends fhir.String>)newValue);
				return;
			case FhirPackage.HUMAN_NAME__PERIOD:
