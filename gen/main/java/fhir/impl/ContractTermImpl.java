 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.impl.ContractTermImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link fhir.impl.ContractTermImpl#getIssued <em>Issued</em>}</li>
 *   <li>{@link fhir.impl.ContractTermImpl#getApplies <em>Applies</em>}</li>
 *   <li>{@link fhir.impl.ContractTermImpl#getType <em>Type</em>}</li>
 *   <li>{@link fhir.impl.ContractTermImpl#getSubType <em>Sub Type</em>}</li>
 *   <li>{@link fhir.impl.ContractTermImpl#getSubject <em>Subject</em>}</li>
 *   <li>{@link fhir.impl.ContractTermImpl#getAction <em>Action</em>}</li>
 *   <li>{@link fhir.impl.ContractTermImpl#getActionReason <em>Action Reason</em>}</li>
 *   <li>{@link fhir.impl.ContractTermImpl#getActor <em>Actor</em>}</li>
 *   <li>{@link fhir.impl.ContractTermImpl#getText <em>Text</em>}</li>
 *   <li>{@link fhir.impl.ContractTermImpl#getValuedItem <em>Valued Item</em>}</li>
 *   <li>{@link fhir.impl.ContractTermImpl#getGroup <em>Group</em>}</li>
 * </ul>
 *
 * @generated
 */
