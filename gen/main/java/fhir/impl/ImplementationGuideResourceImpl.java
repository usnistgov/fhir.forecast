 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.impl.ImplementationGuideResourceImpl#getPurpose <em>Purpose</em>}</li>
 *   <li>{@link fhir.impl.ImplementationGuideResourceImpl#getName <em>Name</em>}</li>
 *   <li>{@link fhir.impl.ImplementationGuideResourceImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link fhir.impl.ImplementationGuideResourceImpl#getAcronym <em>Acronym</em>}</li>
 *   <li>{@link fhir.impl.ImplementationGuideResourceImpl#getSourceUri <em>Source Uri</em>}</li>
 *   <li>{@link fhir.impl.ImplementationGuideResourceImpl#getSourceReference <em>Source Reference</em>}</li>
 *   <li>{@link fhir.impl.ImplementationGuideResourceImpl#getExampleFor <em>Example For</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ImplementationGuideResourceImpl extends BackboneElementImpl implements ImplementationGuideResource {
	 ...
	 * @generated
	 */
	public NotificationChain basicSetAcronym(fhir.String newAcronym, NotificationChain msgs) {
		fhir.String oldAcronym = acronym;
		acronym = newAcronym;
		if (eNotificationRequired()) {
	 ...
	 * @generated
	 */
	public void setAcronym(fhir.String newAcronym) {
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case FhirPackage.IMPLEMENTATION_GUIDE_RESOURCE__DESCRIPTION:
				...
				return;
			case FhirPackage.IMPLEMENTATION_GUIDE_RESOURCE__ACRONYM:
				setAcronym((fhir.String)newValue);
				return;
			case FhirPackage.IMPLEMENTATION_GUIDE_RESOURCE__SOURCE_URI:
