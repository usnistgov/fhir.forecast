 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.impl.ClaimResponseCoverageImpl#getSequence <em>Sequence</em>}</li>
 *   <li>{@link fhir.impl.ClaimResponseCoverageImpl#getFocal <em>Focal</em>}</li>
 *   <li>{@link fhir.impl.ClaimResponseCoverageImpl#getCoverage <em>Coverage</em>}</li>
 *   <li>{@link fhir.impl.ClaimResponseCoverageImpl#getBusinessArrangement <em>Business Arrangement</em>}</li>
 *   <li>{@link fhir.impl.ClaimResponseCoverageImpl#getRelationship <em>Relationship</em>}</li>
 *   <li>{@link fhir.impl.ClaimResponseCoverageImpl#getPreAuthRef <em>Pre Auth Ref</em>}</li>
 *   <li>{@link fhir.impl.ClaimResponseCoverageImpl#getClaimResponse <em>Claim Response</em>}</li>
 *   <li>{@link fhir.impl.ClaimResponseCoverageImpl#getOriginalRuleset <em>Original Ruleset</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ClaimResponseCoverageImpl extends BackboneElementImpl implements ClaimResponseCoverage {
	 ...
	 * @ordered
	 */
	protected fhir.String businessArrangement;
	 ...
	 * @ordered
	 */
	protected EList<fhir.String> preAuthRef;
	 ...
	 * @generated
	 */
	public NotificationChain basicSetFocal(fhir.Boolean newFocal, NotificationChain msgs) {
		fhir.Boolean oldFocal = focal;
		focal = newFocal;
		if (eNotificationRequired()) {
	 ...
	 * @generated
	 */
	public void setFocal(fhir.Boolean newFocal) {
		if (newFocal != focal) {
			NotificationChain msgs = null;
			if (focal != null)
	 ...
	 * @generated
	 */
	public fhir.String getBusinessArrangement() {
	 ...
	 * @generated
	 */
	public NotificationChain basicSetBusinessArrangement(fhir.String newBusinessArrangement, NotificationChain msgs) {
		fhir.String oldBusinessArrangement = businessArrangement;
	 ...
	 * @generated
	 */
	public void setBusinessArrangement(fhir.String newBusinessArrangement) {
	 ...
	 * @generated
	 */
	public EList<fhir.String> getPreAuthRef() {
		if (preAuthRef == null) {
			preAuthRef = new EObjectContainmentEList<fhir.String>(fhir.String.class, this, FhirPackage.CLAIM_RESPONSE_COVERAGE__PRE_AUTH_REF);
		}
		return preAuthRef;
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case FhirPackage.CLAIM_RESPONSE_COVERAGE__SEQUENCE:
				...
				return;
			case FhirPackage.CLAIM_RESPONSE_COVERAGE__FOCAL:
				setFocal((fhir.Boolean)newValue);
				return;
			case FhirPackage.CLAIM_RESPONSE_COVERAGE__COVERAGE:
				setCoverage((Reference)newValue);
				return;
			case FhirPackage.CLAIM_RESPONSE_COVERAGE__BUSINESS_ARRANGEMENT:
				setBusinessArrangement((fhir.String)newValue);
				return;
			case FhirPackage.CLAIM_RESPONSE_COVERAGE__RELATIONSHIP:
			...
			case FhirPackage.CLAIM_RESPONSE_COVERAGE__PRE_AUTH_REF:
				getPreAuthRef().clear();
				getPreAuthRef().addAll((Collection<? extends fhir.String>)newValue);
				return;
			case FhirPackage.CLAIM_RESPONSE_COVERAGE__CLAIM_RESPONSE:
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			case FhirPackage.CLAIM_RESPONSE_COVERAGE__SEQUENCE:
				...
				return;
			case FhirPackage.CLAIM_RESPONSE_COVERAGE__FOCAL:
				setFocal((fhir.Boolean)null);
				return;
			case FhirPackage.CLAIM_RESPONSE_COVERAGE__COVERAGE:
				setCoverage((Reference)null);
				return;
			case FhirPackage.CLAIM_RESPONSE_COVERAGE__BUSINESS_ARRANGEMENT:
				setBusinessArrangement((fhir.String)null);
				return;
			case FhirPackage.CLAIM_RESPONSE_COVERAGE__RELATIONSHIP:
