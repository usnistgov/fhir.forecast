 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.impl.PractitionerPractitionerRoleImpl#getManagingOrganization <em>Managing Organization</em>}</li>
 *   <li>{@link fhir.impl.PractitionerPractitionerRoleImpl#getRole <em>Role</em>}</li>
 *   <li>{@link fhir.impl.PractitionerPractitionerRoleImpl#getSpecialty <em>Specialty</em>}</li>
 *   <li>{@link fhir.impl.PractitionerPractitionerRoleImpl#getPeriod <em>Period</em>}</li>
 *   <li>{@link fhir.impl.PractitionerPractitionerRoleImpl#getLocation <em>Location</em>}</li>
 *   <li>{@link fhir.impl.PractitionerPractitionerRoleImpl#getHealthcareService <em>Healthcare Service</em>}</li>
 * </ul>
 *
 * @generated
 */
