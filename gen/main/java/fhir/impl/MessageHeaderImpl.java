 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.impl.MessageHeaderImpl#getTimestamp <em>Timestamp</em>}</li>
 *   <li>{@link fhir.impl.MessageHeaderImpl#getEvent <em>Event</em>}</li>
 *   <li>{@link fhir.impl.MessageHeaderImpl#getResponse <em>Response</em>}</li>
 *   <li>{@link fhir.impl.MessageHeaderImpl#getSource <em>Source</em>}</li>
 *   <li>{@link fhir.impl.MessageHeaderImpl#getDestination <em>Destination</em>}</li>
 *   <li>{@link fhir.impl.MessageHeaderImpl#getEnterer <em>Enterer</em>}</li>
 *   <li>{@link fhir.impl.MessageHeaderImpl#getAuthor <em>Author</em>}</li>
 *   <li>{@link fhir.impl.MessageHeaderImpl#getReceiver <em>Receiver</em>}</li>
 *   <li>{@link fhir.impl.MessageHeaderImpl#getResponsible <em>Responsible</em>}</li>
 *   <li>{@link fhir.impl.MessageHeaderImpl#getReason <em>Reason</em>}</li>
 *   <li>{@link fhir.impl.MessageHeaderImpl#getData <em>Data</em>}</li>
 * </ul>
 *
 * @generated
 */
