 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.impl.ConceptMapTargetImpl#getCodeSystem <em>Code System</em>}</li>
 *   <li>{@link fhir.impl.ConceptMapTargetImpl#getCode <em>Code</em>}</li>
 *   <li>{@link fhir.impl.ConceptMapTargetImpl#getEquivalence <em>Equivalence</em>}</li>
 *   <li>{@link fhir.impl.ConceptMapTargetImpl#getComments <em>Comments</em>}</li>
 *   <li>{@link fhir.impl.ConceptMapTargetImpl#getDependsOn <em>Depends On</em>}</li>
 *   <li>{@link fhir.impl.ConceptMapTargetImpl#getProduct <em>Product</em>}</li>
 * </ul>
 *
 * @generated
 */
