 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.impl.SupplyRequestImpl#getPatient <em>Patient</em>}</li>
 *   <li>{@link fhir.impl.SupplyRequestImpl#getSource <em>Source</em>}</li>
 *   <li>{@link fhir.impl.SupplyRequestImpl#getDate <em>Date</em>}</li>
 *   <li>{@link fhir.impl.SupplyRequestImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link fhir.impl.SupplyRequestImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link fhir.impl.SupplyRequestImpl#getKind <em>Kind</em>}</li>
 *   <li>{@link fhir.impl.SupplyRequestImpl#getOrderedItem <em>Ordered Item</em>}</li>
 *   <li>{@link fhir.impl.SupplyRequestImpl#getSupplier <em>Supplier</em>}</li>
 *   <li>{@link fhir.impl.SupplyRequestImpl#getReasonCodeableConcept <em>Reason Codeable Concept</em>}</li>
 *   <li>{@link fhir.impl.SupplyRequestImpl#getReasonReference <em>Reason Reference</em>}</li>
 *   <li>{@link fhir.impl.SupplyRequestImpl#getWhen <em>When</em>}</li>
 * </ul>
 *
 * @generated
 */
