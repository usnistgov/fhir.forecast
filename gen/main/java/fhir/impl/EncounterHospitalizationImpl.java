 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.impl.EncounterHospitalizationImpl#getPreAdmissionIdentifier <em>Pre Admission Identifier</em>}</li>
 *   <li>{@link fhir.impl.EncounterHospitalizationImpl#getOrigin <em>Origin</em>}</li>
 *   <li>{@link fhir.impl.EncounterHospitalizationImpl#getAdmitSource <em>Admit Source</em>}</li>
 *   <li>{@link fhir.impl.EncounterHospitalizationImpl#getAdmittingDiagnosis <em>Admitting Diagnosis</em>}</li>
 *   <li>{@link fhir.impl.EncounterHospitalizationImpl#getReAdmission <em>Re Admission</em>}</li>
 *   <li>{@link fhir.impl.EncounterHospitalizationImpl#getDietPreference <em>Diet Preference</em>}</li>
 *   <li>{@link fhir.impl.EncounterHospitalizationImpl#getSpecialCourtesy <em>Special Courtesy</em>}</li>
 *   <li>{@link fhir.impl.EncounterHospitalizationImpl#getSpecialArrangement <em>Special Arrangement</em>}</li>
 *   <li>{@link fhir.impl.EncounterHospitalizationImpl#getDestination <em>Destination</em>}</li>
 *   <li>{@link fhir.impl.EncounterHospitalizationImpl#getDischargeDisposition <em>Discharge Disposition</em>}</li>
 *   <li>{@link fhir.impl.EncounterHospitalizationImpl#getDischargeDiagnosis <em>Discharge Diagnosis</em>}</li>
 * </ul>
 *
 * @generated
 */
