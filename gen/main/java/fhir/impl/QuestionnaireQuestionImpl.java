 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.impl.QuestionnaireQuestionImpl#getLinkId <em>Link Id</em>}</li>
 *   <li>{@link fhir.impl.QuestionnaireQuestionImpl#getConcept <em>Concept</em>}</li>
 *   <li>{@link fhir.impl.QuestionnaireQuestionImpl#getText <em>Text</em>}</li>
 *   <li>{@link fhir.impl.QuestionnaireQuestionImpl#getType <em>Type</em>}</li>
 *   <li>{@link fhir.impl.QuestionnaireQuestionImpl#getRequired <em>Required</em>}</li>
 *   <li>{@link fhir.impl.QuestionnaireQuestionImpl#getRepeats <em>Repeats</em>}</li>
 *   <li>{@link fhir.impl.QuestionnaireQuestionImpl#getOptions <em>Options</em>}</li>
 *   <li>{@link fhir.impl.QuestionnaireQuestionImpl#getOption <em>Option</em>}</li>
 *   <li>{@link fhir.impl.QuestionnaireQuestionImpl#getGroup <em>Group</em>}</li>
 * </ul>
 *
 * @generated
 */
