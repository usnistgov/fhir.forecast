 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.impl.ClaimProsthesisImpl#getInitial <em>Initial</em>}</li>
 *   <li>{@link fhir.impl.ClaimProsthesisImpl#getPriorDate <em>Prior Date</em>}</li>
 *   <li>{@link fhir.impl.ClaimProsthesisImpl#getPriorMaterial <em>Prior Material</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ClaimProsthesisImpl extends BackboneElementImpl implements ClaimProsthesis {
	 ...
	 * @ordered
	 */
	protected fhir.Boolean initial;
	 ...
	 * @generated
	 */
	public fhir.Boolean getInitial() {
		return initial;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetInitial(fhir.Boolean newInitial, NotificationChain msgs) {
		fhir.Boolean oldInitial = initial;
		initial = newInitial;
	 ...
	 * @generated
	 */
	public void setInitial(fhir.Boolean newInitial) {
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case FhirPackage.CLAIM_PROSTHESIS__INITIAL:
				setInitial((fhir.Boolean)newValue);
				return;
			case FhirPackage.CLAIM_PROSTHESIS__PRIOR_DATE:
