 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.impl.MedicationDispenseDosageInstructionImpl#getText <em>Text</em>}</li>
 *   <li>{@link fhir.impl.MedicationDispenseDosageInstructionImpl#getAdditionalInstructions <em>Additional Instructions</em>}</li>
 *   <li>{@link fhir.impl.MedicationDispenseDosageInstructionImpl#getTiming <em>Timing</em>}</li>
 *   <li>{@link fhir.impl.MedicationDispenseDosageInstructionImpl#getAsNeededBoolean <em>As Needed Boolean</em>}</li>
 *   <li>{@link fhir.impl.MedicationDispenseDosageInstructionImpl#getAsNeededCodeableConcept <em>As Needed Codeable Concept</em>}</li>
 *   <li>{@link fhir.impl.MedicationDispenseDosageInstructionImpl#getSiteCodeableConcept <em>Site Codeable Concept</em>}</li>
 *   <li>{@link fhir.impl.MedicationDispenseDosageInstructionImpl#getSiteReference <em>Site Reference</em>}</li>
 *   <li>{@link fhir.impl.MedicationDispenseDosageInstructionImpl#getRoute <em>Route</em>}</li>
 *   <li>{@link fhir.impl.MedicationDispenseDosageInstructionImpl#getMethod <em>Method</em>}</li>
 *   <li>{@link fhir.impl.MedicationDispenseDosageInstructionImpl#getDoseRange <em>Dose Range</em>}</li>
 *   <li>{@link fhir.impl.MedicationDispenseDosageInstructionImpl#getDoseQuantity <em>Dose Quantity</em>}</li>
 *   <li>{@link fhir.impl.MedicationDispenseDosageInstructionImpl#getRateRatio <em>Rate Ratio</em>}</li>
 *   <li>{@link fhir.impl.MedicationDispenseDosageInstructionImpl#getRateRange <em>Rate Range</em>}</li>
 *   <li>{@link fhir.impl.MedicationDispenseDosageInstructionImpl#getMaxDosePerPeriod <em>Max Dose Per Period</em>}</li>
 * </ul>
 *
 * @generated
 */
