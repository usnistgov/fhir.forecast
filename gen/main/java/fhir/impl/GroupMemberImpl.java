 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.impl.GroupMemberImpl#getEntity <em>Entity</em>}</li>
 *   <li>{@link fhir.impl.GroupMemberImpl#getPeriod <em>Period</em>}</li>
 *   <li>{@link fhir.impl.GroupMemberImpl#getInactive <em>Inactive</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GroupMemberImpl extends BackboneElementImpl implements GroupMember {
	 ...
	 * @ordered
	 */
	protected fhir.Boolean inactive;
	 ...
	 * @generated
	 */
	public fhir.Boolean getInactive() {
		return inactive;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetInactive(fhir.Boolean newInactive, NotificationChain msgs) {
		fhir.Boolean oldInactive = inactive;
	 ...
	 * @generated
	 */
	public void setInactive(fhir.Boolean newInactive) {
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case FhirPackage.GROUP_MEMBER__PERIOD:
				...
				return;
			case FhirPackage.GROUP_MEMBER__INACTIVE:
				setInactive((fhir.Boolean)newValue);
				return;
		}
