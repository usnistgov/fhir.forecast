 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.impl.ObservationComponentImpl#getCode <em>Code</em>}</li>
 *   <li>{@link fhir.impl.ObservationComponentImpl#getValueQuantity <em>Value Quantity</em>}</li>
 *   <li>{@link fhir.impl.ObservationComponentImpl#getValueCodeableConcept <em>Value Codeable Concept</em>}</li>
 *   <li>{@link fhir.impl.ObservationComponentImpl#getValueString <em>Value String</em>}</li>
 *   <li>{@link fhir.impl.ObservationComponentImpl#getValueRange <em>Value Range</em>}</li>
 *   <li>{@link fhir.impl.ObservationComponentImpl#getValueRatio <em>Value Ratio</em>}</li>
 *   <li>{@link fhir.impl.ObservationComponentImpl#getValueSampledData <em>Value Sampled Data</em>}</li>
 *   <li>{@link fhir.impl.ObservationComponentImpl#getValueAttachment <em>Value Attachment</em>}</li>
 *   <li>{@link fhir.impl.ObservationComponentImpl#getValueTime <em>Value Time</em>}</li>
 *   <li>{@link fhir.impl.ObservationComponentImpl#getValueDateTime <em>Value Date Time</em>}</li>
 *   <li>{@link fhir.impl.ObservationComponentImpl#getValuePeriod <em>Value Period</em>}</li>
 *   <li>{@link fhir.impl.ObservationComponentImpl#getDataAbsentReason <em>Data Absent Reason</em>}</li>
 *   <li>{@link fhir.impl.ObservationComponentImpl#getReferenceRange <em>Reference Range</em>}</li>
 * </ul>
 *
 * @generated
 */
