 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.impl.ConformanceRestImpl#getMode <em>Mode</em>}</li>
 *   <li>{@link fhir.impl.ConformanceRestImpl#getDocumentation <em>Documentation</em>}</li>
 *   <li>{@link fhir.impl.ConformanceRestImpl#getSecurity <em>Security</em>}</li>
 *   <li>{@link fhir.impl.ConformanceRestImpl#getResource <em>Resource</em>}</li>
 *   <li>{@link fhir.impl.ConformanceRestImpl#getInteraction <em>Interaction</em>}</li>
 *   <li>{@link fhir.impl.ConformanceRestImpl#getTransactionMode <em>Transaction Mode</em>}</li>
 *   <li>{@link fhir.impl.ConformanceRestImpl#getSearchParam <em>Search Param</em>}</li>
 *   <li>{@link fhir.impl.ConformanceRestImpl#getOperation <em>Operation</em>}</li>
 *   <li>{@link fhir.impl.ConformanceRestImpl#getCompartment <em>Compartment</em>}</li>
 * </ul>
 *
 * @generated
 */
