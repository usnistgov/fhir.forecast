 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.impl.SampledDataImpl#getOrigin <em>Origin</em>}</li>
 *   <li>{@link fhir.impl.SampledDataImpl#getPeriod <em>Period</em>}</li>
 *   <li>{@link fhir.impl.SampledDataImpl#getFactor <em>Factor</em>}</li>
 *   <li>{@link fhir.impl.SampledDataImpl#getLowerLimit <em>Lower Limit</em>}</li>
 *   <li>{@link fhir.impl.SampledDataImpl#getUpperLimit <em>Upper Limit</em>}</li>
 *   <li>{@link fhir.impl.SampledDataImpl#getDimensions <em>Dimensions</em>}</li>
 *   <li>{@link fhir.impl.SampledDataImpl#getData <em>Data</em>}</li>
 * </ul>
 *
 * @generated
 */
