 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.impl.GroupCharacteristicImpl#getCode <em>Code</em>}</li>
 *   <li>{@link fhir.impl.GroupCharacteristicImpl#getValueCodeableConcept <em>Value Codeable Concept</em>}</li>
 *   <li>{@link fhir.impl.GroupCharacteristicImpl#getValueBoolean <em>Value Boolean</em>}</li>
 *   <li>{@link fhir.impl.GroupCharacteristicImpl#getValueQuantity <em>Value Quantity</em>}</li>
 *   <li>{@link fhir.impl.GroupCharacteristicImpl#getValueRange <em>Value Range</em>}</li>
 *   <li>{@link fhir.impl.GroupCharacteristicImpl#getExclude <em>Exclude</em>}</li>
 *   <li>{@link fhir.impl.GroupCharacteristicImpl#getPeriod <em>Period</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GroupCharacteristicImpl extends BackboneElementImpl implements GroupCharacteristic {
	 ...
	 * @ordered
	 */
	protected fhir.Boolean exclude;
	 ...
	 * @generated
	 */
	public fhir.Boolean getExclude() {
		return exclude;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetExclude(fhir.Boolean newExclude, NotificationChain msgs) {
		fhir.Boolean oldExclude = exclude;
		exclude = newExclude;
		if (eNotificationRequired()) {
	 ...
	 * @generated
	 */
	public void setExclude(fhir.Boolean newExclude) {
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case FhirPackage.GROUP_CHARACTERISTIC__VALUE_RANGE:
				...
				return;
			case FhirPackage.GROUP_CHARACTERISTIC__EXCLUDE:
				setExclude((fhir.Boolean)newValue);
				return;
			case FhirPackage.GROUP_CHARACTERISTIC__PERIOD:
