 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.impl.DataElementImpl#getUrl <em>Url</em>}</li>
 *   <li>{@link fhir.impl.DataElementImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link fhir.impl.DataElementImpl#getVersion <em>Version</em>}</li>
 *   <li>{@link fhir.impl.DataElementImpl#getName <em>Name</em>}</li>
 *   <li>{@link fhir.impl.DataElementImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link fhir.impl.DataElementImpl#getExperimental <em>Experimental</em>}</li>
 *   <li>{@link fhir.impl.DataElementImpl#getPublisher <em>Publisher</em>}</li>
 *   <li>{@link fhir.impl.DataElementImpl#getContact <em>Contact</em>}</li>
 *   <li>{@link fhir.impl.DataElementImpl#getDate <em>Date</em>}</li>
 *   <li>{@link fhir.impl.DataElementImpl#getUseContext <em>Use Context</em>}</li>
 *   <li>{@link fhir.impl.DataElementImpl#getCopyright <em>Copyright</em>}</li>
 *   <li>{@link fhir.impl.DataElementImpl#getStringency <em>Stringency</em>}</li>
 *   <li>{@link fhir.impl.DataElementImpl#getMapping <em>Mapping</em>}</li>
 *   <li>{@link fhir.impl.DataElementImpl#getElement <em>Element</em>}</li>
 * </ul>
 *
 * @generated
 */
