 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.impl.ClaimResponseImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link fhir.impl.ClaimResponseImpl#getRequest <em>Request</em>}</li>
 *   <li>{@link fhir.impl.ClaimResponseImpl#getRuleset <em>Ruleset</em>}</li>
 *   <li>{@link fhir.impl.ClaimResponseImpl#getOriginalRuleset <em>Original Ruleset</em>}</li>
 *   <li>{@link fhir.impl.ClaimResponseImpl#getCreated <em>Created</em>}</li>
 *   <li>{@link fhir.impl.ClaimResponseImpl#getOrganization <em>Organization</em>}</li>
 *   <li>{@link fhir.impl.ClaimResponseImpl#getRequestProvider <em>Request Provider</em>}</li>
 *   <li>{@link fhir.impl.ClaimResponseImpl#getRequestOrganization <em>Request Organization</em>}</li>
 *   <li>{@link fhir.impl.ClaimResponseImpl#getOutcome <em>Outcome</em>}</li>
 *   <li>{@link fhir.impl.ClaimResponseImpl#getDisposition <em>Disposition</em>}</li>
 *   <li>{@link fhir.impl.ClaimResponseImpl#getPayeeType <em>Payee Type</em>}</li>
 *   <li>{@link fhir.impl.ClaimResponseImpl#getItem <em>Item</em>}</li>
 *   <li>{@link fhir.impl.ClaimResponseImpl#getAddItem <em>Add Item</em>}</li>
 *   <li>{@link fhir.impl.ClaimResponseImpl#getError <em>Error</em>}</li>
 *   <li>{@link fhir.impl.ClaimResponseImpl#getTotalCost <em>Total Cost</em>}</li>
 *   <li>{@link fhir.impl.ClaimResponseImpl#getUnallocDeductable <em>Unalloc Deductable</em>}</li>
 *   <li>{@link fhir.impl.ClaimResponseImpl#getTotalBenefit <em>Total Benefit</em>}</li>
 *   <li>{@link fhir.impl.ClaimResponseImpl#getPaymentAdjustment <em>Payment Adjustment</em>}</li>
 *   <li>{@link fhir.impl.ClaimResponseImpl#getPaymentAdjustmentReason <em>Payment Adjustment Reason</em>}</li>
 *   <li>{@link fhir.impl.ClaimResponseImpl#getPaymentDate <em>Payment Date</em>}</li>
 *   <li>{@link fhir.impl.ClaimResponseImpl#getPaymentAmount <em>Payment Amount</em>}</li>
 *   <li>{@link fhir.impl.ClaimResponseImpl#getPaymentRef <em>Payment Ref</em>}</li>
 *   <li>{@link fhir.impl.ClaimResponseImpl#getReserved <em>Reserved</em>}</li>
 *   <li>{@link fhir.impl.ClaimResponseImpl#getForm <em>Form</em>}</li>
 *   <li>{@link fhir.impl.ClaimResponseImpl#getNote <em>Note</em>}</li>
 *   <li>{@link fhir.impl.ClaimResponseImpl#getCoverage <em>Coverage</em>}</li>
 * </ul>
 *
 * @generated
 */
