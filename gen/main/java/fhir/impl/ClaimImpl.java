 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.impl.ClaimImpl#getType <em>Type</em>}</li>
 *   <li>{@link fhir.impl.ClaimImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link fhir.impl.ClaimImpl#getRuleset <em>Ruleset</em>}</li>
 *   <li>{@link fhir.impl.ClaimImpl#getOriginalRuleset <em>Original Ruleset</em>}</li>
 *   <li>{@link fhir.impl.ClaimImpl#getCreated <em>Created</em>}</li>
 *   <li>{@link fhir.impl.ClaimImpl#getTarget <em>Target</em>}</li>
 *   <li>{@link fhir.impl.ClaimImpl#getProvider <em>Provider</em>}</li>
 *   <li>{@link fhir.impl.ClaimImpl#getOrganization <em>Organization</em>}</li>
 *   <li>{@link fhir.impl.ClaimImpl#getUse <em>Use</em>}</li>
 *   <li>{@link fhir.impl.ClaimImpl#getPriority <em>Priority</em>}</li>
 *   <li>{@link fhir.impl.ClaimImpl#getFundsReserve <em>Funds Reserve</em>}</li>
 *   <li>{@link fhir.impl.ClaimImpl#getEnterer <em>Enterer</em>}</li>
 *   <li>{@link fhir.impl.ClaimImpl#getFacility <em>Facility</em>}</li>
 *   <li>{@link fhir.impl.ClaimImpl#getPrescription <em>Prescription</em>}</li>
 *   <li>{@link fhir.impl.ClaimImpl#getOriginalPrescription <em>Original Prescription</em>}</li>
 *   <li>{@link fhir.impl.ClaimImpl#getPayee <em>Payee</em>}</li>
 *   <li>{@link fhir.impl.ClaimImpl#getReferral <em>Referral</em>}</li>
 *   <li>{@link fhir.impl.ClaimImpl#getDiagnosis <em>Diagnosis</em>}</li>
 *   <li>{@link fhir.impl.ClaimImpl#getCondition <em>Condition</em>}</li>
 *   <li>{@link fhir.impl.ClaimImpl#getPatient <em>Patient</em>}</li>
 *   <li>{@link fhir.impl.ClaimImpl#getCoverage <em>Coverage</em>}</li>
 *   <li>{@link fhir.impl.ClaimImpl#getException <em>Exception</em>}</li>
 *   <li>{@link fhir.impl.ClaimImpl#getSchool <em>School</em>}</li>
 *   <li>{@link fhir.impl.ClaimImpl#getAccident <em>Accident</em>}</li>
 *   <li>{@link fhir.impl.ClaimImpl#getAccidentType <em>Accident Type</em>}</li>
 *   <li>{@link fhir.impl.ClaimImpl#getInterventionException <em>Intervention Exception</em>}</li>
 *   <li>{@link fhir.impl.ClaimImpl#getItem <em>Item</em>}</li>
 *   <li>{@link fhir.impl.ClaimImpl#getAdditionalMaterials <em>Additional Materials</em>}</li>
 *   <li>{@link fhir.impl.ClaimImpl#getMissingTeeth <em>Missing Teeth</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ClaimImpl extends DomainResourceImpl implements Claim {
	 ...
	 * @generated
	 */
	public NotificationChain basicSetSchool(fhir.String newSchool, NotificationChain msgs) {
		fhir.String oldSchool = school;
		school = newSchool;
		if (eNotificationRequired()) {
	 ...
	 * @generated
	 */
	public void setSchool(fhir.String newSchool) {
		if (newSchool != school) {
			NotificationChain msgs = null;
			if (school != null)
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case FhirPackage.CLAIM__EXCEPTION:
				...
				return;
			case FhirPackage.CLAIM__SCHOOL:
				setSchool((fhir.String)newValue);
				return;
			case FhirPackage.CLAIM__ACCIDENT:
