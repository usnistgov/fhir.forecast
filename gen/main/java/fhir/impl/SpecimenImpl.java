 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.impl.SpecimenImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link fhir.impl.SpecimenImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link fhir.impl.SpecimenImpl#getType <em>Type</em>}</li>
 *   <li>{@link fhir.impl.SpecimenImpl#getParent <em>Parent</em>}</li>
 *   <li>{@link fhir.impl.SpecimenImpl#getSubject <em>Subject</em>}</li>
 *   <li>{@link fhir.impl.SpecimenImpl#getAccessionIdentifier <em>Accession Identifier</em>}</li>
 *   <li>{@link fhir.impl.SpecimenImpl#getReceivedTime <em>Received Time</em>}</li>
 *   <li>{@link fhir.impl.SpecimenImpl#getCollection <em>Collection</em>}</li>
 *   <li>{@link fhir.impl.SpecimenImpl#getTreatment <em>Treatment</em>}</li>
 *   <li>{@link fhir.impl.SpecimenImpl#getContainer <em>Container</em>}</li>
 * </ul>
 *
 * @generated
 */
