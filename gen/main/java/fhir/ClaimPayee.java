 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.ClaimPayee#getType <em>Type</em>}</li>
 *   <li>{@link fhir.ClaimPayee#getProvider <em>Provider</em>}</li>
 *   <li>{@link fhir.ClaimPayee#getOrganization <em>Organization</em>}</li>
 *   <li>{@link fhir.ClaimPayee#getPerson <em>Person</em>}</li>
 * </ul>
 *
 * @see fhir.FhirPackage#getClaimPayee()
...
public interface ClaimPayee extends BackboneElement {
	 ...
	 * @see #setType(Coding)
	 * @see fhir.FhirPackage#getClaimPayee_Type()
	...
	/**
	 * Sets the value of the '{@link fhir.ClaimPayee#getType <em>Type</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getClaimPayee_Provider()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.ClaimPayee#getProvider <em>Provider</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getClaimPayee_Organization()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.ClaimPayee#getOrganization <em>Organization</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getClaimPayee_Person()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.ClaimPayee#getPerson <em>Person</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
