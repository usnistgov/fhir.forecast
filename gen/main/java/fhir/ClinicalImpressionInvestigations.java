 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.ClinicalImpressionInvestigations#getCode <em>Code</em>}</li>
 *   <li>{@link fhir.ClinicalImpressionInvestigations#getItem <em>Item</em>}</li>
 * </ul>
 *
 * @see fhir.FhirPackage#getClinicalImpressionInvestigations()
...
public interface ClinicalImpressionInvestigations extends BackboneElement {
	 ...
	 * @see fhir.FhirPackage#getClinicalImpressionInvestigations_Code()
	...
	/**
	 * Sets the value of the '{@link fhir.ClinicalImpressionInvestigations#getCode <em>Code</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getClinicalImpressionInvestigations_Item()
