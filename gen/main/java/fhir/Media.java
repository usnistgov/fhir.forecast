 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.Media#getType <em>Type</em>}</li>
 *   <li>{@link fhir.Media#getSubtype <em>Subtype</em>}</li>
 *   <li>{@link fhir.Media#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link fhir.Media#getSubject <em>Subject</em>}</li>
 *   <li>{@link fhir.Media#getOperator <em>Operator</em>}</li>
 *   <li>{@link fhir.Media#getView <em>View</em>}</li>
 *   <li>{@link fhir.Media#getDeviceName <em>Device Name</em>}</li>
 *   <li>{@link fhir.Media#getHeight <em>Height</em>}</li>
 *   <li>{@link fhir.Media#getWidth <em>Width</em>}</li>
 *   <li>{@link fhir.Media#getFrames <em>Frames</em>}</li>
 *   <li>{@link fhir.Media#getDuration <em>Duration</em>}</li>
 *   <li>{@link fhir.Media#getContent <em>Content</em>}</li>
 * </ul>
 *
 * @see fhir.FhirPackage#getMedia()
...
public interface Media extends DomainResource {
	 ...
	 * @see fhir.FhirPackage#getMedia_Type()
	...
	/**
	 * Sets the value of the '{@link fhir.Media#getType <em>Type</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getMedia_Subtype()
	...
	/**
	 * Sets the value of the '{@link fhir.Media#getSubtype <em>Subtype</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getMedia_Identifier()
	 * @model containment="true"
	 ...
	 * @see fhir.FhirPackage#getMedia_Subject()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.Media#getSubject <em>Subject</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getMedia_Operator()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.Media#getOperator <em>Operator</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getMedia_View()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.Media#getView <em>View</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setDeviceName(fhir.String)
	 * @see fhir.FhirPackage#getMedia_DeviceName()
	 * @model containment="true"
	 *        extendedMetaData="kind='element' name='deviceName' namespace='##targetNamespace'"
	 * @generated
	 */
	fhir.String getDeviceName();

	/**
	 * Sets the value of the '{@link fhir.Media#getDeviceName <em>Device Name</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	void setDeviceName(fhir.String value);
	 ...
	 * @see fhir.FhirPackage#getMedia_Height()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.Media#getHeight <em>Height</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getMedia_Width()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.Media#getWidth <em>Width</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getMedia_Frames()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.Media#getFrames <em>Frames</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getMedia_Duration()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.Media#getDuration <em>Duration</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getMedia_Content()
	 * @model containment="true" required="true"
	...
	/**
	 * Sets the value of the '{@link fhir.Media#getContent <em>Content</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
