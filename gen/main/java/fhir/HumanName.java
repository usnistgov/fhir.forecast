 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.HumanName#getUse <em>Use</em>}</li>
 *   <li>{@link fhir.HumanName#getText <em>Text</em>}</li>
 *   <li>{@link fhir.HumanName#getFamily <em>Family</em>}</li>
 *   <li>{@link fhir.HumanName#getGiven <em>Given</em>}</li>
 *   <li>{@link fhir.HumanName#getPrefix <em>Prefix</em>}</li>
 *   <li>{@link fhir.HumanName#getSuffix <em>Suffix</em>}</li>
 *   <li>{@link fhir.HumanName#getPeriod <em>Period</em>}</li>
 * </ul>
 *
 * @see fhir.FhirPackage#getHumanName()
...
public interface HumanName extends Element {
	 ...
	 * @see #setUse(NameUse)
	 * @see fhir.FhirPackage#getHumanName_Use()
	...
	/**
	 * Sets the value of the '{@link fhir.HumanName#getUse <em>Use</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getHumanName_Text()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.HumanName#getText <em>Text</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getHumanName_Family()
	 * @model containment="true"
	 *        extendedMetaData="kind='element' name='family' namespace='##targetNamespace'"
	 * @generated
	 */
	EList<fhir.String> getFamily();
	 ...
	 * @see fhir.FhirPackage#getHumanName_Prefix()
	 * @model containment="true"
	 *        extendedMetaData="kind='element' name='prefix' namespace='##targetNamespace'"
	 * @generated
	 */
	EList<fhir.String> getPrefix();
	 ...
	 * @see fhir.FhirPackage#getHumanName_Suffix()
	 * @model containment="true"
	 *        extendedMetaData="kind='element' name='suffix' namespace='##targetNamespace'"
	 * @generated
	 */
	EList<fhir.String> getSuffix();
	 ...
	 * @see fhir.FhirPackage#getHumanName_Period()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.HumanName#getPeriod <em>Period</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
