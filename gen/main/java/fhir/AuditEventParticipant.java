 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.AuditEventParticipant#getRole <em>Role</em>}</li>
 *   <li>{@link fhir.AuditEventParticipant#getReference <em>Reference</em>}</li>
 *   <li>{@link fhir.AuditEventParticipant#getUserId <em>User Id</em>}</li>
 *   <li>{@link fhir.AuditEventParticipant#getAltId <em>Alt Id</em>}</li>
 *   <li>{@link fhir.AuditEventParticipant#getName <em>Name</em>}</li>
 *   <li>{@link fhir.AuditEventParticipant#getRequestor <em>Requestor</em>}</li>
 *   <li>{@link fhir.AuditEventParticipant#getLocation <em>Location</em>}</li>
 *   <li>{@link fhir.AuditEventParticipant#getPolicy <em>Policy</em>}</li>
 *   <li>{@link fhir.AuditEventParticipant#getMedia <em>Media</em>}</li>
 *   <li>{@link fhir.AuditEventParticipant#getNetwork <em>Network</em>}</li>
 *   <li>{@link fhir.AuditEventParticipant#getPurposeOfUse <em>Purpose Of Use</em>}</li>
 * </ul>
 *
 * @see fhir.FhirPackage#getAuditEventParticipant()
...
public interface AuditEventParticipant extends BackboneElement {
	 ...
	 * @see fhir.FhirPackage#getAuditEventParticipant_Role()
	 ...
	 * @see fhir.FhirPackage#getAuditEventParticipant_Reference()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.AuditEventParticipant#getReference <em>Reference</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getAuditEventParticipant_UserId()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.AuditEventParticipant#getUserId <em>User Id</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setAltId(fhir.String)
	 * @see fhir.FhirPackage#getAuditEventParticipant_AltId()
	 * @model containment="true"
	 *        extendedMetaData="kind='element' name='altId' namespace='##targetNamespace'"
	 * @generated
	 */
	fhir.String getAltId();

	/**
	 * Sets the value of the '{@link fhir.AuditEventParticipant#getAltId <em>Alt Id</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	void setAltId(fhir.String value);
	 ...
	 * @see fhir.FhirPackage#getAuditEventParticipant_Name()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.AuditEventParticipant#getName <em>Name</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setRequestor(fhir.Boolean)
	 * @see fhir.FhirPackage#getAuditEventParticipant_Requestor()
	 * @model containment="true" required="true"
	 *        extendedMetaData="kind='element' name='requestor' namespace='##targetNamespace'"
	 * @generated
	 */
	fhir.Boolean getRequestor();

	/**
	 * Sets the value of the '{@link fhir.AuditEventParticipant#getRequestor <em>Requestor</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	void setRequestor(fhir.Boolean value);
	 ...
	 * @see fhir.FhirPackage#getAuditEventParticipant_Location()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.AuditEventParticipant#getLocation <em>Location</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getAuditEventParticipant_Policy()
	 * @model containment="true"
	 ...
	 * @see #setMedia(Coding)
	 * @see fhir.FhirPackage#getAuditEventParticipant_Media()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.AuditEventParticipant#getMedia <em>Media</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getAuditEventParticipant_Network()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.AuditEventParticipant#getNetwork <em>Network</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getAuditEventParticipant_PurposeOfUse()
	 * @model containment="true"
