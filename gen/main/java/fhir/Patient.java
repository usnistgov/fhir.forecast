 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.Patient#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link fhir.Patient#getActive <em>Active</em>}</li>
 *   <li>{@link fhir.Patient#getName <em>Name</em>}</li>
 *   <li>{@link fhir.Patient#getTelecom <em>Telecom</em>}</li>
 *   <li>{@link fhir.Patient#getGender <em>Gender</em>}</li>
 *   <li>{@link fhir.Patient#getBirthDate <em>Birth Date</em>}</li>
 *   <li>{@link fhir.Patient#getDeceasedBoolean <em>Deceased Boolean</em>}</li>
 *   <li>{@link fhir.Patient#getDeceasedDateTime <em>Deceased Date Time</em>}</li>
 *   <li>{@link fhir.Patient#getAddress <em>Address</em>}</li>
 *   <li>{@link fhir.Patient#getMaritalStatus <em>Marital Status</em>}</li>
 *   <li>{@link fhir.Patient#getMultipleBirthBoolean <em>Multiple Birth Boolean</em>}</li>
 *   <li>{@link fhir.Patient#getMultipleBirthInteger <em>Multiple Birth Integer</em>}</li>
 *   <li>{@link fhir.Patient#getPhoto <em>Photo</em>}</li>
 *   <li>{@link fhir.Patient#getContact <em>Contact</em>}</li>
 *   <li>{@link fhir.Patient#getAnimal <em>Animal</em>}</li>
 *   <li>{@link fhir.Patient#getCommunication <em>Communication</em>}</li>
 *   <li>{@link fhir.Patient#getCareProvider <em>Care Provider</em>}</li>
 *   <li>{@link fhir.Patient#getManagingOrganization <em>Managing Organization</em>}</li>
 *   <li>{@link fhir.Patient#getLink <em>Link</em>}</li>
 * </ul>
 *
 * @see fhir.FhirPackage#getPatient()
...
public interface Patient extends DomainResource {
	 ...
	 * @see fhir.FhirPackage#getPatient_Identifier()
	 ...
	 * @see #setActive(fhir.Boolean)
	 * @see fhir.FhirPackage#getPatient_Active()
	 * @model containment="true"
	 *        extendedMetaData="kind='element' name='active' namespace='##targetNamespace'"
	 * @generated
	 */
	fhir.Boolean getActive();

	/**
	 * Sets the value of the '{@link fhir.Patient#getActive <em>Active</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	void setActive(fhir.Boolean value);

	/**
	 * Returns the value of the '<em><b>Name</b></em>' containment reference list.
	 * The list contents are of type {@link fhir.HumanName}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 ...
	 * @see fhir.FhirPackage#getPatient_Name()
	 * @model containment="true"
	 ...
	 * @see fhir.FhirPackage#getPatient_Telecom()
	 * @model containment="true"
	 ...
	 * @see #setGender(Code)
	 * @see fhir.FhirPackage#getPatient_Gender()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.Patient#getGender <em>Gender</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getPatient_BirthDate()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.Patient#getBirthDate <em>Birth Date</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getPatient_DeceasedBoolean()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.Patient#getDeceasedBoolean <em>Deceased Boolean</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getPatient_DeceasedDateTime()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.Patient#getDeceasedDateTime <em>Deceased Date Time</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The list contents are of type {@link fhir.Address}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 ...
	 * @see fhir.FhirPackage#getPatient_Address()
	 * @model containment="true"
	 ...
	 * @see fhir.FhirPackage#getPatient_MaritalStatus()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.Patient#getMaritalStatus <em>Marital Status</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setMultipleBirthBoolean(fhir.Boolean)
	 * @see fhir.FhirPackage#getPatient_MultipleBirthBoolean()
	 * @model containment="true"
	 *        extendedMetaData="kind='element' name='multipleBirthBoolean' namespace='##targetNamespace'"
	 * @generated
	 */
	fhir.Boolean getMultipleBirthBoolean();

	/**
	 * Sets the value of the '{@link fhir.Patient#getMultipleBirthBoolean <em>Multiple Birth Boolean</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	void setMultipleBirthBoolean(fhir.Boolean value);
	 ...
	 * @see #setMultipleBirthInteger(fhir.Integer)
	 * @see fhir.FhirPackage#getPatient_MultipleBirthInteger()
	 * @model containment="true"
	 *        extendedMetaData="kind='element' name='multipleBirthInteger' namespace='##targetNamespace'"
	 * @generated
	 */
	fhir.Integer getMultipleBirthInteger();

	/**
	 * Sets the value of the '{@link fhir.Patient#getMultipleBirthInteger <em>Multiple Birth Integer</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	void setMultipleBirthInteger(fhir.Integer value);
	 ...
	 * @see fhir.FhirPackage#getPatient_Photo()
	 * @model containment="true"
	 ...
	 * The list contents are of type {@link fhir.PatientContact}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 ...
	 * @see fhir.FhirPackage#getPatient_Contact()
	 * @model containment="true"
	 ...
	 * @see fhir.FhirPackage#getPatient_Animal()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.Patient#getAnimal <em>Animal</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The list contents are of type {@link fhir.PatientCommunication}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 ...
	 * @see fhir.FhirPackage#getPatient_Communication()
	 * @model containment="true"
	 ...
	 * @see fhir.FhirPackage#getPatient_CareProvider()
	 * @model containment="true"
	 ...
	 * @see fhir.FhirPackage#getPatient_ManagingOrganization()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.Patient#getManagingOrganization <em>Managing Organization</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The list contents are of type {@link fhir.PatientLink}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 ...
	 * @see fhir.FhirPackage#getPatient_Link()
	 * @model containment="true"
