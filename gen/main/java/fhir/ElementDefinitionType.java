 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.ElementDefinitionType#getCode <em>Code</em>}</li>
 *   <li>{@link fhir.ElementDefinitionType#getProfile <em>Profile</em>}</li>
 *   <li>{@link fhir.ElementDefinitionType#getAggregation <em>Aggregation</em>}</li>
 * </ul>
 *
 * @see fhir.FhirPackage#getElementDefinitionType()
...
public interface ElementDefinitionType extends Element {
	 ...
	 * @see #setCode(Code)
	 * @see fhir.FhirPackage#getElementDefinitionType_Code()
	...
	/**
	 * Sets the value of the '{@link fhir.ElementDefinitionType#getCode <em>Code</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getElementDefinitionType_Profile()
	 ...
	 * The list contents are of type {@link fhir.AggregationMode}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 ...
	 * @see fhir.FhirPackage#getElementDefinitionType_Aggregation()
	 * @model containment="true"
