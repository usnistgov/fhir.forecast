 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.ClaimResponseAddItem#getSequenceLinkId <em>Sequence Link Id</em>}</li>
 *   <li>{@link fhir.ClaimResponseAddItem#getService <em>Service</em>}</li>
 *   <li>{@link fhir.ClaimResponseAddItem#getFee <em>Fee</em>}</li>
 *   <li>{@link fhir.ClaimResponseAddItem#getNoteNumberLinkId <em>Note Number Link Id</em>}</li>
 *   <li>{@link fhir.ClaimResponseAddItem#getAdjudication <em>Adjudication</em>}</li>
 *   <li>{@link fhir.ClaimResponseAddItem#getDetail <em>Detail</em>}</li>
 * </ul>
 *
 * @see fhir.FhirPackage#getClaimResponseAddItem()
...
public interface ClaimResponseAddItem extends BackboneElement {
	 ...
	 * @see fhir.FhirPackage#getClaimResponseAddItem_SequenceLinkId()
	 ...
	 * @see fhir.FhirPackage#getClaimResponseAddItem_Service()
	...
	/**
	 * Sets the value of the '{@link fhir.ClaimResponseAddItem#getService <em>Service</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setFee(Money)
	 * @see fhir.FhirPackage#getClaimResponseAddItem_Fee()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.ClaimResponseAddItem#getFee <em>Fee</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getClaimResponseAddItem_NoteNumberLinkId()
	 * @model containment="true"
	 ...
	 * The list contents are of type {@link fhir.ClaimResponseAdjudication3}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 ...
	 * @see fhir.FhirPackage#getClaimResponseAddItem_Adjudication()
	 * @model containment="true"
	 ...
	 * The list contents are of type {@link fhir.ClaimResponseDetail1}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 ...
	 * @see fhir.FhirPackage#getClaimResponseAddItem_Detail()
	 * @model containment="true"
