 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.DocumentReferenceContext#getEncounter <em>Encounter</em>}</li>
 *   <li>{@link fhir.DocumentReferenceContext#getEvent <em>Event</em>}</li>
 *   <li>{@link fhir.DocumentReferenceContext#getPeriod <em>Period</em>}</li>
 *   <li>{@link fhir.DocumentReferenceContext#getFacilityType <em>Facility Type</em>}</li>
 *   <li>{@link fhir.DocumentReferenceContext#getPracticeSetting <em>Practice Setting</em>}</li>
 *   <li>{@link fhir.DocumentReferenceContext#getSourcePatientInfo <em>Source Patient Info</em>}</li>
 *   <li>{@link fhir.DocumentReferenceContext#getRelated <em>Related</em>}</li>
 * </ul>
 *
 * @see fhir.FhirPackage#getDocumentReferenceContext()
...
public interface DocumentReferenceContext extends BackboneElement {
	 ...
	 * @see fhir.FhirPackage#getDocumentReferenceContext_Encounter()
	...
	/**
	 * Sets the value of the '{@link fhir.DocumentReferenceContext#getEncounter <em>Encounter</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getDocumentReferenceContext_Event()
	 * @model containment="true"
	 ...
	 * @see fhir.FhirPackage#getDocumentReferenceContext_Period()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.DocumentReferenceContext#getPeriod <em>Period</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getDocumentReferenceContext_FacilityType()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.DocumentReferenceContext#getFacilityType <em>Facility Type</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getDocumentReferenceContext_PracticeSetting()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.DocumentReferenceContext#getPracticeSetting <em>Practice Setting</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getDocumentReferenceContext_SourcePatientInfo()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.DocumentReferenceContext#getSourcePatientInfo <em>Source Patient Info</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The list contents are of type {@link fhir.DocumentReferenceRelated}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 ...
	 * @see fhir.FhirPackage#getDocumentReferenceContext_Related()
	 * @model containment="true"
