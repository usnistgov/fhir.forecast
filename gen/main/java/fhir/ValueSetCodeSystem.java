 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.ValueSetCodeSystem#getSystem <em>System</em>}</li>
 *   <li>{@link fhir.ValueSetCodeSystem#getVersion <em>Version</em>}</li>
 *   <li>{@link fhir.ValueSetCodeSystem#getCaseSensitive <em>Case Sensitive</em>}</li>
 *   <li>{@link fhir.ValueSetCodeSystem#getConcept <em>Concept</em>}</li>
 * </ul>
 *
 * @see fhir.FhirPackage#getValueSetCodeSystem()
...
public interface ValueSetCodeSystem extends BackboneElement {
	 ...
	 * @see #setSystem(Uri)
	 * @see fhir.FhirPackage#getValueSetCodeSystem_System()
	...
	/**
	 * Sets the value of the '{@link fhir.ValueSetCodeSystem#getSystem <em>System</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getValueSetCodeSystem_Version()
	...
	/**
	 * Sets the value of the '{@link fhir.ValueSetCodeSystem#getVersion <em>Version</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setCaseSensitive(fhir.Boolean)
	 * @see fhir.FhirPackage#getValueSetCodeSystem_CaseSensitive()
	 * @model containment="true"
	 *        extendedMetaData="kind='element' name='caseSensitive' namespace='##targetNamespace'"
	 * @generated
	 */
	fhir.Boolean getCaseSensitive();

	/**
	 * Sets the value of the '{@link fhir.ValueSetCodeSystem#getCaseSensitive <em>Case Sensitive</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	void setCaseSensitive(fhir.Boolean value);
	 ...
	 * @see fhir.FhirPackage#getValueSetCodeSystem_Concept()
	 * @model containment="true" required="true"
