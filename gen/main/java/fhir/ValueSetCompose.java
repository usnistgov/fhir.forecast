 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.ValueSetCompose#getImport <em>Import</em>}</li>
 *   <li>{@link fhir.ValueSetCompose#getInclude <em>Include</em>}</li>
 *   <li>{@link fhir.ValueSetCompose#getExclude <em>Exclude</em>}</li>
 * </ul>
 *
 * @see fhir.FhirPackage#getValueSetCompose()
...
public interface ValueSetCompose extends BackboneElement {
	 ...
	 * @see fhir.FhirPackage#getValueSetCompose_Import()
	 ...
	 * The list contents are of type {@link fhir.ValueSetInclude}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 ...
	 * @see fhir.FhirPackage#getValueSetCompose_Include()
	 * @model containment="true"
	 ...
	 * @see fhir.FhirPackage#getValueSetCompose_Exclude()
	 * @model containment="true"
