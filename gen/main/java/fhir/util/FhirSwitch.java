...
public class FhirSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case FhirPackage.BOOLEAN: {
				fhir.Boolean boolean_ = (fhir.Boolean)theEObject;
			...
			case FhirPackage.INTEGER: {
				fhir.Integer integer = (fhir.Integer)theEObject;
			...
			case FhirPackage.STRING: {
				fhir.String string = (fhir.String)theEObject;
	 ...
	 * @generated
	 */
	public T caseBoolean(fhir.Boolean object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T caseInteger(fhir.Integer object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T caseString(fhir.String object) {
		return null;
	}
