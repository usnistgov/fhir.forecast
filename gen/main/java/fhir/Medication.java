 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.Medication#getCode <em>Code</em>}</li>
 *   <li>{@link fhir.Medication#getIsBrand <em>Is Brand</em>}</li>
 *   <li>{@link fhir.Medication#getManufacturer <em>Manufacturer</em>}</li>
 *   <li>{@link fhir.Medication#getProduct <em>Product</em>}</li>
 *   <li>{@link fhir.Medication#getPackage <em>Package</em>}</li>
 * </ul>
 *
 * @see fhir.FhirPackage#getMedication()
...
public interface Medication extends DomainResource {
	 ...
	 * @see fhir.FhirPackage#getMedication_Code()
	...
	/**
	 * Sets the value of the '{@link fhir.Medication#getCode <em>Code</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setIsBrand(fhir.Boolean)
	 * @see fhir.FhirPackage#getMedication_IsBrand()
	 * @model containment="true"
	 *        extendedMetaData="kind='element' name='isBrand' namespace='##targetNamespace'"
	 * @generated
	 */
	fhir.Boolean getIsBrand();

	/**
	 * Sets the value of the '{@link fhir.Medication#getIsBrand <em>Is Brand</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	void setIsBrand(fhir.Boolean value);
	 ...
	 * @see fhir.FhirPackage#getMedication_Manufacturer()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.Medication#getManufacturer <em>Manufacturer</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getMedication_Product()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.Medication#getProduct <em>Product</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getMedication_Package()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.Medication#getPackage <em>Package</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
