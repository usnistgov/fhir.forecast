 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.Provenance#getTarget <em>Target</em>}</li>
 *   <li>{@link fhir.Provenance#getPeriod <em>Period</em>}</li>
 *   <li>{@link fhir.Provenance#getRecorded <em>Recorded</em>}</li>
 *   <li>{@link fhir.Provenance#getReason <em>Reason</em>}</li>
 *   <li>{@link fhir.Provenance#getActivity <em>Activity</em>}</li>
 *   <li>{@link fhir.Provenance#getLocation <em>Location</em>}</li>
 *   <li>{@link fhir.Provenance#getPolicy <em>Policy</em>}</li>
 *   <li>{@link fhir.Provenance#getAgent <em>Agent</em>}</li>
 *   <li>{@link fhir.Provenance#getEntity <em>Entity</em>}</li>
 *   <li>{@link fhir.Provenance#getSignature <em>Signature</em>}</li>
 * </ul>
 *
 * @see fhir.FhirPackage#getProvenance()
...
public interface Provenance extends DomainResource {
	 ...
	 * @see fhir.FhirPackage#getProvenance_Target()
	 ...
	 * @see fhir.FhirPackage#getProvenance_Period()
	...
	/**
	 * Sets the value of the '{@link fhir.Provenance#getPeriod <em>Period</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getProvenance_Recorded()
	 * @model containment="true" required="true"
	...
	/**
	 * Sets the value of the '{@link fhir.Provenance#getRecorded <em>Recorded</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getProvenance_Reason()
	 * @model containment="true"
	 ...
	 * @see fhir.FhirPackage#getProvenance_Activity()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.Provenance#getActivity <em>Activity</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getProvenance_Location()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.Provenance#getLocation <em>Location</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getProvenance_Policy()
	 * @model containment="true"
	 ...
	 * The list contents are of type {@link fhir.ProvenanceAgent}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 ...
	 * @see fhir.FhirPackage#getProvenance_Agent()
	 * @model containment="true"
	 ...
	 * The list contents are of type {@link fhir.ProvenanceEntity}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 ...
	 * @see fhir.FhirPackage#getProvenance_Entity()
	 * @model containment="true"
	 ...
	 * The list contents are of type {@link fhir.Signature}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 ...
	 * @see fhir.FhirPackage#getProvenance_Signature()
	 * @model containment="true"
