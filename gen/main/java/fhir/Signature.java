 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.Signature#getType <em>Type</em>}</li>
 *   <li>{@link fhir.Signature#getWhen <em>When</em>}</li>
 *   <li>{@link fhir.Signature#getWhoUri <em>Who Uri</em>}</li>
 *   <li>{@link fhir.Signature#getWhoReference <em>Who Reference</em>}</li>
 *   <li>{@link fhir.Signature#getContentType <em>Content Type</em>}</li>
 *   <li>{@link fhir.Signature#getBlob <em>Blob</em>}</li>
 * </ul>
 *
 * @see fhir.FhirPackage#getSignature()
...
public interface Signature extends Element {
	 ...
	 * @see fhir.FhirPackage#getSignature_Type()
	 ...
	 * @see #setWhen(Instant)
	 * @see fhir.FhirPackage#getSignature_When()
	 * @model containment="true" required="true"
	...
	/**
	 * Sets the value of the '{@link fhir.Signature#getWhen <em>When</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setWhoUri(Uri)
	 * @see fhir.FhirPackage#getSignature_WhoUri()
	...
	/**
	 * Sets the value of the '{@link fhir.Signature#getWhoUri <em>Who Uri</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getSignature_WhoReference()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.Signature#getWhoReference <em>Who Reference</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getSignature_ContentType()
	 * @model containment="true" required="true"
	...
	/**
	 * Sets the value of the '{@link fhir.Signature#getContentType <em>Content Type</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getSignature_Blob()
	 * @model containment="true" required="true"
	...
	/**
	 * Sets the value of the '{@link fhir.Signature#getBlob <em>Blob</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
