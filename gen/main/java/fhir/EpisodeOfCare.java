 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.EpisodeOfCare#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link fhir.EpisodeOfCare#getStatus <em>Status</em>}</li>
 *   <li>{@link fhir.EpisodeOfCare#getStatusHistory <em>Status History</em>}</li>
 *   <li>{@link fhir.EpisodeOfCare#getType <em>Type</em>}</li>
 *   <li>{@link fhir.EpisodeOfCare#getCondition <em>Condition</em>}</li>
 *   <li>{@link fhir.EpisodeOfCare#getPatient <em>Patient</em>}</li>
 *   <li>{@link fhir.EpisodeOfCare#getManagingOrganization <em>Managing Organization</em>}</li>
 *   <li>{@link fhir.EpisodeOfCare#getPeriod <em>Period</em>}</li>
 *   <li>{@link fhir.EpisodeOfCare#getReferralRequest <em>Referral Request</em>}</li>
 *   <li>{@link fhir.EpisodeOfCare#getCareManager <em>Care Manager</em>}</li>
 *   <li>{@link fhir.EpisodeOfCare#getCareTeam <em>Care Team</em>}</li>
 * </ul>
 *
 * @see fhir.FhirPackage#getEpisodeOfCare()
...
public interface EpisodeOfCare extends DomainResource {
	 ...
	 * @see fhir.FhirPackage#getEpisodeOfCare_Identifier()
	 ...
	 * @see fhir.FhirPackage#getEpisodeOfCare_Status()
	...
	/**
	 * Sets the value of the '{@link fhir.EpisodeOfCare#getStatus <em>Status</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The list contents are of type {@link fhir.EpisodeOfCareStatusHistory}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 ...
	 * @see fhir.FhirPackage#getEpisodeOfCare_StatusHistory()
	 * @model containment="true"
	 ...
	 * @see fhir.FhirPackage#getEpisodeOfCare_Type()
	 * @model containment="true"
	 ...
	 * @see fhir.FhirPackage#getEpisodeOfCare_Condition()
	 * @model containment="true"
	 ...
	 * @see fhir.FhirPackage#getEpisodeOfCare_Patient()
	 * @model containment="true" required="true"
	...
	/**
	 * Sets the value of the '{@link fhir.EpisodeOfCare#getPatient <em>Patient</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getEpisodeOfCare_ManagingOrganization()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.EpisodeOfCare#getManagingOrganization <em>Managing Organization</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getEpisodeOfCare_Period()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.EpisodeOfCare#getPeriod <em>Period</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getEpisodeOfCare_ReferralRequest()
	 * @model containment="true"
	 ...
	 * @see fhir.FhirPackage#getEpisodeOfCare_CareManager()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.EpisodeOfCare#getCareManager <em>Care Manager</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The list contents are of type {@link fhir.EpisodeOfCareCareTeam}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 ...
	 * @see fhir.FhirPackage#getEpisodeOfCare_CareTeam()
	 * @model containment="true"
