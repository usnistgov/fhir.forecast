 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.NutritionOrderEnteralFormula#getBaseFormulaType <em>Base Formula Type</em>}</li>
 *   <li>{@link fhir.NutritionOrderEnteralFormula#getBaseFormulaProductName <em>Base Formula Product Name</em>}</li>
 *   <li>{@link fhir.NutritionOrderEnteralFormula#getAdditiveType <em>Additive Type</em>}</li>
 *   <li>{@link fhir.NutritionOrderEnteralFormula#getAdditiveProductName <em>Additive Product Name</em>}</li>
 *   <li>{@link fhir.NutritionOrderEnteralFormula#getCaloricDensity <em>Caloric Density</em>}</li>
 *   <li>{@link fhir.NutritionOrderEnteralFormula#getRouteofAdministration <em>Routeof Administration</em>}</li>
 *   <li>{@link fhir.NutritionOrderEnteralFormula#getAdministration <em>Administration</em>}</li>
 *   <li>{@link fhir.NutritionOrderEnteralFormula#getMaxVolumeToDeliver <em>Max Volume To Deliver</em>}</li>
 *   <li>{@link fhir.NutritionOrderEnteralFormula#getAdministrationInstruction <em>Administration Instruction</em>}</li>
 * </ul>
 *
 * @see fhir.FhirPackage#getNutritionOrderEnteralFormula()
...
public interface NutritionOrderEnteralFormula extends BackboneElement {
	 ...
	 * @see fhir.FhirPackage#getNutritionOrderEnteralFormula_BaseFormulaType()
	...
	/**
	 * Sets the value of the '{@link fhir.NutritionOrderEnteralFormula#getBaseFormulaType <em>Base Formula Type</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setBaseFormulaProductName(fhir.String)
	 * @see fhir.FhirPackage#getNutritionOrderEnteralFormula_BaseFormulaProductName()
	 * @model containment="true"
	 *        extendedMetaData="kind='element' name='baseFormulaProductName' namespace='##targetNamespace'"
	 * @generated
	 */
	fhir.String getBaseFormulaProductName();

	/**
	 * Sets the value of the '{@link fhir.NutritionOrderEnteralFormula#getBaseFormulaProductName <em>Base Formula Product Name</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	void setBaseFormulaProductName(fhir.String value);
	 ...
	 * @see fhir.FhirPackage#getNutritionOrderEnteralFormula_AdditiveType()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.NutritionOrderEnteralFormula#getAdditiveType <em>Additive Type</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setAdditiveProductName(fhir.String)
	 * @see fhir.FhirPackage#getNutritionOrderEnteralFormula_AdditiveProductName()
	 * @model containment="true"
	 *        extendedMetaData="kind='element' name='additiveProductName' namespace='##targetNamespace'"
	 * @generated
	 */
	fhir.String getAdditiveProductName();

	/**
	 * Sets the value of the '{@link fhir.NutritionOrderEnteralFormula#getAdditiveProductName <em>Additive Product Name</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	void setAdditiveProductName(fhir.String value);
	 ...
	 * @see fhir.FhirPackage#getNutritionOrderEnteralFormula_CaloricDensity()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.NutritionOrderEnteralFormula#getCaloricDensity <em>Caloric Density</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getNutritionOrderEnteralFormula_RouteofAdministration()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.NutritionOrderEnteralFormula#getRouteofAdministration <em>Routeof Administration</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The list contents are of type {@link fhir.NutritionOrderAdministration}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 ...
	 * @see fhir.FhirPackage#getNutritionOrderEnteralFormula_Administration()
	 * @model containment="true"
	 ...
	 * @see fhir.FhirPackage#getNutritionOrderEnteralFormula_MaxVolumeToDeliver()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.NutritionOrderEnteralFormula#getMaxVolumeToDeliver <em>Max Volume To Deliver</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setAdministrationInstruction(fhir.String)
	 * @see fhir.FhirPackage#getNutritionOrderEnteralFormula_AdministrationInstruction()
	 * @model containment="true"
	 *        extendedMetaData="kind='element' name='administrationInstruction' namespace='##targetNamespace'"
	 * @generated
	 */
	fhir.String getAdministrationInstruction();

	/**
	 * Sets the value of the '{@link fhir.NutritionOrderEnteralFormula#getAdministrationInstruction <em>Administration Instruction</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	void setAdministrationInstruction(fhir.String value);
