 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.ConceptMapDependsOn#getElement <em>Element</em>}</li>
 *   <li>{@link fhir.ConceptMapDependsOn#getCodeSystem <em>Code System</em>}</li>
 *   <li>{@link fhir.ConceptMapDependsOn#getCode <em>Code</em>}</li>
 * </ul>
 *
 * @see fhir.FhirPackage#getConceptMapDependsOn()
...
public interface ConceptMapDependsOn extends BackboneElement {
	 ...
	 * @see #setElement(Uri)
	 * @see fhir.FhirPackage#getConceptMapDependsOn_Element()
	...
	/**
	 * Sets the value of the '{@link fhir.ConceptMapDependsOn#getElement <em>Element</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getConceptMapDependsOn_CodeSystem()
	 * @model containment="true" required="true"
	...
	/**
	 * Sets the value of the '{@link fhir.ConceptMapDependsOn#getCodeSystem <em>Code System</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setCode(fhir.String)
	 * @see fhir.FhirPackage#getConceptMapDependsOn_Code()
	 * @model containment="true" required="true"
	...
	/**
	 * Sets the value of the '{@link fhir.ConceptMapDependsOn#getCode <em>Code</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	void setCode(fhir.String value);
