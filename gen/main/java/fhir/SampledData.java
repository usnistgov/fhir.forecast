 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.SampledData#getOrigin <em>Origin</em>}</li>
 *   <li>{@link fhir.SampledData#getPeriod <em>Period</em>}</li>
 *   <li>{@link fhir.SampledData#getFactor <em>Factor</em>}</li>
 *   <li>{@link fhir.SampledData#getLowerLimit <em>Lower Limit</em>}</li>
 *   <li>{@link fhir.SampledData#getUpperLimit <em>Upper Limit</em>}</li>
 *   <li>{@link fhir.SampledData#getDimensions <em>Dimensions</em>}</li>
 *   <li>{@link fhir.SampledData#getData <em>Data</em>}</li>
 * </ul>
 *
 * @see fhir.FhirPackage#getSampledData()
...
public interface SampledData extends Element {
	 ...
	 * @see fhir.FhirPackage#getSampledData_Origin()
	...
	/**
	 * Sets the value of the '{@link fhir.SampledData#getOrigin <em>Origin</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getSampledData_Period()
	 * @model containment="true" required="true"
	...
	/**
	 * Sets the value of the '{@link fhir.SampledData#getPeriod <em>Period</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getSampledData_Factor()
	...
	/**
	 * Sets the value of the '{@link fhir.SampledData#getFactor <em>Factor</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getSampledData_LowerLimit()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.SampledData#getLowerLimit <em>Lower Limit</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getSampledData_UpperLimit()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.SampledData#getUpperLimit <em>Upper Limit</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getSampledData_Dimensions()
	 * @model containment="true" required="true"
	...
	/**
	 * Sets the value of the '{@link fhir.SampledData#getDimensions <em>Dimensions</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getSampledData_Data()
	 * @model containment="true" required="true"
	...
	/**
	 * Sets the value of the '{@link fhir.SampledData#getData <em>Data</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
