 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.Practitioner#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link fhir.Practitioner#getActive <em>Active</em>}</li>
 *   <li>{@link fhir.Practitioner#getName <em>Name</em>}</li>
 *   <li>{@link fhir.Practitioner#getTelecom <em>Telecom</em>}</li>
 *   <li>{@link fhir.Practitioner#getAddress <em>Address</em>}</li>
 *   <li>{@link fhir.Practitioner#getGender <em>Gender</em>}</li>
 *   <li>{@link fhir.Practitioner#getBirthDate <em>Birth Date</em>}</li>
 *   <li>{@link fhir.Practitioner#getPhoto <em>Photo</em>}</li>
 *   <li>{@link fhir.Practitioner#getPractitionerRole <em>Practitioner Role</em>}</li>
 *   <li>{@link fhir.Practitioner#getQualification <em>Qualification</em>}</li>
 *   <li>{@link fhir.Practitioner#getCommunication <em>Communication</em>}</li>
 * </ul>
 *
 * @see fhir.FhirPackage#getPractitioner()
...
public interface Practitioner extends DomainResource {
	 ...
	 * @see fhir.FhirPackage#getPractitioner_Identifier()
	 ...
	 * @see fhir.FhirPackage#getPractitioner_Active()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.Practitioner#getActive <em>Active</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getPractitioner_Name()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.Practitioner#getName <em>Name</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getPractitioner_Telecom()
	 * @model containment="true"
	 ...
	 * @see fhir.FhirPackage#getPractitioner_Address()
	 * @model containment="true"
	 ...
	 * @see #setGender(Code)
	 * @see fhir.FhirPackage#getPractitioner_Gender()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.Practitioner#getGender <em>Gender</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getPractitioner_BirthDate()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.Practitioner#getBirthDate <em>Birth Date</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getPractitioner_Photo()
	 * @model containment="true"
	 ...
	 * The list contents are of type {@link fhir.PractitionerPractitionerRole}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 ...
	 * @see fhir.FhirPackage#getPractitioner_PractitionerRole()
	 * @model containment="true"
	 ...
	 * The list contents are of type {@link fhir.PractitionerQualification}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 ...
	 * @see fhir.FhirPackage#getPractitioner_Qualification()
	 * @model containment="true"
	 ...
	 * @see fhir.FhirPackage#getPractitioner_Communication()
	 * @model containment="true"
