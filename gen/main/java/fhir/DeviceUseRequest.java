 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.DeviceUseRequest#getBodySiteCodeableConcept <em>Body Site Codeable Concept</em>}</li>
 *   <li>{@link fhir.DeviceUseRequest#getBodySiteReference <em>Body Site Reference</em>}</li>
 *   <li>{@link fhir.DeviceUseRequest#getStatus <em>Status</em>}</li>
 *   <li>{@link fhir.DeviceUseRequest#getDevice <em>Device</em>}</li>
 *   <li>{@link fhir.DeviceUseRequest#getEncounter <em>Encounter</em>}</li>
 *   <li>{@link fhir.DeviceUseRequest#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link fhir.DeviceUseRequest#getIndication <em>Indication</em>}</li>
 *   <li>{@link fhir.DeviceUseRequest#getNotes <em>Notes</em>}</li>
 *   <li>{@link fhir.DeviceUseRequest#getPrnReason <em>Prn Reason</em>}</li>
 *   <li>{@link fhir.DeviceUseRequest#getOrderedOn <em>Ordered On</em>}</li>
 *   <li>{@link fhir.DeviceUseRequest#getRecordedOn <em>Recorded On</em>}</li>
 *   <li>{@link fhir.DeviceUseRequest#getSubject <em>Subject</em>}</li>
 *   <li>{@link fhir.DeviceUseRequest#getTimingTiming <em>Timing Timing</em>}</li>
 *   <li>{@link fhir.DeviceUseRequest#getTimingPeriod <em>Timing Period</em>}</li>
 *   <li>{@link fhir.DeviceUseRequest#getTimingDateTime <em>Timing Date Time</em>}</li>
 *   <li>{@link fhir.DeviceUseRequest#getPriority <em>Priority</em>}</li>
 * </ul>
 *
 * @see fhir.FhirPackage#getDeviceUseRequest()
...
public interface DeviceUseRequest extends DomainResource {
	 ...
	 * @see fhir.FhirPackage#getDeviceUseRequest_BodySiteCodeableConcept()
	...
	/**
	 * Sets the value of the '{@link fhir.DeviceUseRequest#getBodySiteCodeableConcept <em>Body Site Codeable Concept</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getDeviceUseRequest_BodySiteReference()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.DeviceUseRequest#getBodySiteReference <em>Body Site Reference</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getDeviceUseRequest_Status()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.DeviceUseRequest#getStatus <em>Status</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getDeviceUseRequest_Device()
	...
	/**
	 * Sets the value of the '{@link fhir.DeviceUseRequest#getDevice <em>Device</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getDeviceUseRequest_Encounter()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.DeviceUseRequest#getEncounter <em>Encounter</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getDeviceUseRequest_Identifier()
	 * @model containment="true"
	 ...
	 * @see fhir.FhirPackage#getDeviceUseRequest_Indication()
	 * @model containment="true"
	 ...
	 * @see fhir.FhirPackage#getDeviceUseRequest_Notes()
	 * @model containment="true"
	 *        extendedMetaData="kind='element' name='notes' namespace='##targetNamespace'"
	 * @generated
	 */
	EList<fhir.String> getNotes();
	 ...
	 * @see fhir.FhirPackage#getDeviceUseRequest_PrnReason()
	 * @model containment="true"
	 ...
	 * @see fhir.FhirPackage#getDeviceUseRequest_OrderedOn()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.DeviceUseRequest#getOrderedOn <em>Ordered On</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getDeviceUseRequest_RecordedOn()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.DeviceUseRequest#getRecordedOn <em>Recorded On</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getDeviceUseRequest_Subject()
	 * @model containment="true" required="true"
	...
	/**
	 * Sets the value of the '{@link fhir.DeviceUseRequest#getSubject <em>Subject</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getDeviceUseRequest_TimingTiming()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.DeviceUseRequest#getTimingTiming <em>Timing Timing</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getDeviceUseRequest_TimingPeriod()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.DeviceUseRequest#getTimingPeriod <em>Timing Period</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getDeviceUseRequest_TimingDateTime()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.DeviceUseRequest#getTimingDateTime <em>Timing Date Time</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getDeviceUseRequest_Priority()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.DeviceUseRequest#getPriority <em>Priority</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
