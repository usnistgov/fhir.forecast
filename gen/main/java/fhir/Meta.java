 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.Meta#getVersionId <em>Version Id</em>}</li>
 *   <li>{@link fhir.Meta#getLastUpdated <em>Last Updated</em>}</li>
 *   <li>{@link fhir.Meta#getProfile <em>Profile</em>}</li>
 *   <li>{@link fhir.Meta#getSecurity <em>Security</em>}</li>
 *   <li>{@link fhir.Meta#getTag <em>Tag</em>}</li>
 * </ul>
 *
 * @see fhir.FhirPackage#getMeta()
...
public interface Meta extends Element {
	 ...
	 * @see #setVersionId(Id)
	 * @see fhir.FhirPackage#getMeta_VersionId()
	...
	/**
	 * Sets the value of the '{@link fhir.Meta#getVersionId <em>Version Id</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getMeta_LastUpdated()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.Meta#getLastUpdated <em>Last Updated</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getMeta_Profile()
	 * @model containment="true"
	 ...
	 * @see fhir.FhirPackage#getMeta_Security()
	 * @model containment="true"
	 ...
	 * @see fhir.FhirPackage#getMeta_Tag()
	 * @model containment="true"
