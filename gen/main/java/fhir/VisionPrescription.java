 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.VisionPrescription#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link fhir.VisionPrescription#getDateWritten <em>Date Written</em>}</li>
 *   <li>{@link fhir.VisionPrescription#getPatient <em>Patient</em>}</li>
 *   <li>{@link fhir.VisionPrescription#getPrescriber <em>Prescriber</em>}</li>
 *   <li>{@link fhir.VisionPrescription#getEncounter <em>Encounter</em>}</li>
 *   <li>{@link fhir.VisionPrescription#getReasonCodeableConcept <em>Reason Codeable Concept</em>}</li>
 *   <li>{@link fhir.VisionPrescription#getReasonReference <em>Reason Reference</em>}</li>
 *   <li>{@link fhir.VisionPrescription#getDispense <em>Dispense</em>}</li>
 * </ul>
 *
 * @see fhir.FhirPackage#getVisionPrescription()
...
public interface VisionPrescription extends DomainResource {
	 ...
	 * @see fhir.FhirPackage#getVisionPrescription_Identifier()
	 ...
	 * @see fhir.FhirPackage#getVisionPrescription_DateWritten()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.VisionPrescription#getDateWritten <em>Date Written</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getVisionPrescription_Patient()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.VisionPrescription#getPatient <em>Patient</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getVisionPrescription_Prescriber()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.VisionPrescription#getPrescriber <em>Prescriber</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getVisionPrescription_Encounter()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.VisionPrescription#getEncounter <em>Encounter</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getVisionPrescription_ReasonCodeableConcept()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.VisionPrescription#getReasonCodeableConcept <em>Reason Codeable Concept</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getVisionPrescription_ReasonReference()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.VisionPrescription#getReasonReference <em>Reason Reference</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The list contents are of type {@link fhir.VisionPrescriptionDispense}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 ...
	 * @see fhir.FhirPackage#getVisionPrescription_Dispense()
	 * @model containment="true"
