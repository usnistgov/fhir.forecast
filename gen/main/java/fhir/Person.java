 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.Person#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link fhir.Person#getName <em>Name</em>}</li>
 *   <li>{@link fhir.Person#getTelecom <em>Telecom</em>}</li>
 *   <li>{@link fhir.Person#getGender <em>Gender</em>}</li>
 *   <li>{@link fhir.Person#getBirthDate <em>Birth Date</em>}</li>
 *   <li>{@link fhir.Person#getAddress <em>Address</em>}</li>
 *   <li>{@link fhir.Person#getPhoto <em>Photo</em>}</li>
 *   <li>{@link fhir.Person#getManagingOrganization <em>Managing Organization</em>}</li>
 *   <li>{@link fhir.Person#getActive <em>Active</em>}</li>
 *   <li>{@link fhir.Person#getLink <em>Link</em>}</li>
 * </ul>
 *
 * @see fhir.FhirPackage#getPerson()
...
public interface Person extends DomainResource {
	 ...
	 * @see fhir.FhirPackage#getPerson_Identifier()
	 ...
	 * @see fhir.FhirPackage#getPerson_Name()
	 * @model containment="true"
	 ...
	 * @see fhir.FhirPackage#getPerson_Telecom()
	 * @model containment="true"
	 ...
	 * @see #setGender(Code)
	 * @see fhir.FhirPackage#getPerson_Gender()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.Person#getGender <em>Gender</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getPerson_BirthDate()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.Person#getBirthDate <em>Birth Date</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getPerson_Address()
	 * @model containment="true"
	 ...
	 * @see fhir.FhirPackage#getPerson_Photo()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.Person#getPhoto <em>Photo</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getPerson_ManagingOrganization()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.Person#getManagingOrganization <em>Managing Organization</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getPerson_Active()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.Person#getActive <em>Active</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The list contents are of type {@link fhir.PersonLink}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 ...
	 * @see fhir.FhirPackage#getPerson_Link()
	 * @model containment="true"
