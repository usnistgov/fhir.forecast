 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.BundleRequest#getMethod <em>Method</em>}</li>
 *   <li>{@link fhir.BundleRequest#getUrl <em>Url</em>}</li>
 *   <li>{@link fhir.BundleRequest#getIfNoneMatch <em>If None Match</em>}</li>
 *   <li>{@link fhir.BundleRequest#getIfModifiedSince <em>If Modified Since</em>}</li>
 *   <li>{@link fhir.BundleRequest#getIfMatch <em>If Match</em>}</li>
 *   <li>{@link fhir.BundleRequest#getIfNoneExist <em>If None Exist</em>}</li>
 * </ul>
 *
 * @see fhir.FhirPackage#getBundleRequest()
...
public interface BundleRequest extends BackboneElement {
	 ...
	 * @see fhir.FhirPackage#getBundleRequest_Method()
	...
	/**
	 * Sets the value of the '{@link fhir.BundleRequest#getMethod <em>Method</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setUrl(Uri)
	 * @see fhir.FhirPackage#getBundleRequest_Url()
	 * @model containment="true" required="true"
	...
	/**
	 * Sets the value of the '{@link fhir.BundleRequest#getUrl <em>Url</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setIfNoneMatch(fhir.String)
	 * @see fhir.FhirPackage#getBundleRequest_IfNoneMatch()
	 * @model containment="true"
	 *        extendedMetaData="kind='element' name='ifNoneMatch' namespace='##targetNamespace'"
	 * @generated
	 */
	fhir.String getIfNoneMatch();

	/**
	 * Sets the value of the '{@link fhir.BundleRequest#getIfNoneMatch <em>If None Match</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	void setIfNoneMatch(fhir.String value);
	 ...
	 * @see fhir.FhirPackage#getBundleRequest_IfModifiedSince()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.BundleRequest#getIfModifiedSince <em>If Modified Since</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setIfMatch(fhir.String)
	 * @see fhir.FhirPackage#getBundleRequest_IfMatch()
	 * @model containment="true"
	 *        extendedMetaData="kind='element' name='ifMatch' namespace='##targetNamespace'"
	 * @generated
	 */
	fhir.String getIfMatch();

	/**
	 * Sets the value of the '{@link fhir.BundleRequest#getIfMatch <em>If Match</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	void setIfMatch(fhir.String value);
	 ...
	 * @see #setIfNoneExist(fhir.String)
	 * @see fhir.FhirPackage#getBundleRequest_IfNoneExist()
	 * @model containment="true"
	 *        extendedMetaData="kind='element' name='ifNoneExist' namespace='##targetNamespace'"
	 * @generated
	 */
	fhir.String getIfNoneExist();

	/**
	 * Sets the value of the '{@link fhir.BundleRequest#getIfNoneExist <em>If None Exist</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	void setIfNoneExist(fhir.String value);
