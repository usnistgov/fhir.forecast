 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.OrderResponse#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link fhir.OrderResponse#getRequest <em>Request</em>}</li>
 *   <li>{@link fhir.OrderResponse#getDate <em>Date</em>}</li>
 *   <li>{@link fhir.OrderResponse#getWho <em>Who</em>}</li>
 *   <li>{@link fhir.OrderResponse#getOrderStatus <em>Order Status</em>}</li>
 *   <li>{@link fhir.OrderResponse#getDescription <em>Description</em>}</li>
 *   <li>{@link fhir.OrderResponse#getFulfillment <em>Fulfillment</em>}</li>
 * </ul>
 *
 * @see fhir.FhirPackage#getOrderResponse()
...
public interface OrderResponse extends DomainResource {
	 ...
	 * @see fhir.FhirPackage#getOrderResponse_Identifier()
	 ...
	 * @see fhir.FhirPackage#getOrderResponse_Request()
	...
	/**
	 * Sets the value of the '{@link fhir.OrderResponse#getRequest <em>Request</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getOrderResponse_Date()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.OrderResponse#getDate <em>Date</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getOrderResponse_Who()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.OrderResponse#getWho <em>Who</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getOrderResponse_OrderStatus()
	 * @model containment="true" required="true"
	...
	/**
	 * Sets the value of the '{@link fhir.OrderResponse#getOrderStatus <em>Order Status</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getOrderResponse_Description()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.OrderResponse#getDescription <em>Description</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getOrderResponse_Fulfillment()
	 * @model containment="true"
