 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.ImmunizationExplanation#getReason <em>Reason</em>}</li>
 *   <li>{@link fhir.ImmunizationExplanation#getReasonNotGiven <em>Reason Not Given</em>}</li>
 * </ul>
 *
 * @see fhir.FhirPackage#getImmunizationExplanation()
...
public interface ImmunizationExplanation extends BackboneElement {
	 ...
	 * @see fhir.FhirPackage#getImmunizationExplanation_Reason()
	 ...
	 * @see fhir.FhirPackage#getImmunizationExplanation_ReasonNotGiven()
	 * @model containment="true"
