 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.DiagnosticOrderItem#getCode <em>Code</em>}</li>
 *   <li>{@link fhir.DiagnosticOrderItem#getSpecimen <em>Specimen</em>}</li>
 *   <li>{@link fhir.DiagnosticOrderItem#getBodySite <em>Body Site</em>}</li>
 *   <li>{@link fhir.DiagnosticOrderItem#getStatus <em>Status</em>}</li>
 *   <li>{@link fhir.DiagnosticOrderItem#getEvent <em>Event</em>}</li>
 * </ul>
 *
 * @see fhir.FhirPackage#getDiagnosticOrderItem()
...
public interface DiagnosticOrderItem extends BackboneElement {
	 ...
	 * @see fhir.FhirPackage#getDiagnosticOrderItem_Code()
	...
	/**
	 * Sets the value of the '{@link fhir.DiagnosticOrderItem#getCode <em>Code</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getDiagnosticOrderItem_Specimen()
	 ...
	 * @see fhir.FhirPackage#getDiagnosticOrderItem_BodySite()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.DiagnosticOrderItem#getBodySite <em>Body Site</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getDiagnosticOrderItem_Status()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.DiagnosticOrderItem#getStatus <em>Status</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getDiagnosticOrderItem_Event()
	 * @model containment="true"
