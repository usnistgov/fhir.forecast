 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.CarePlanDetail#getCategory <em>Category</em>}</li>
 *   <li>{@link fhir.CarePlanDetail#getCode <em>Code</em>}</li>
 *   <li>{@link fhir.CarePlanDetail#getReasonCode <em>Reason Code</em>}</li>
 *   <li>{@link fhir.CarePlanDetail#getReasonReference <em>Reason Reference</em>}</li>
 *   <li>{@link fhir.CarePlanDetail#getGoal <em>Goal</em>}</li>
 *   <li>{@link fhir.CarePlanDetail#getStatus <em>Status</em>}</li>
 *   <li>{@link fhir.CarePlanDetail#getStatusReason <em>Status Reason</em>}</li>
 *   <li>{@link fhir.CarePlanDetail#getProhibited <em>Prohibited</em>}</li>
 *   <li>{@link fhir.CarePlanDetail#getScheduledTiming <em>Scheduled Timing</em>}</li>
 *   <li>{@link fhir.CarePlanDetail#getScheduledPeriod <em>Scheduled Period</em>}</li>
 *   <li>{@link fhir.CarePlanDetail#getScheduledString <em>Scheduled String</em>}</li>
 *   <li>{@link fhir.CarePlanDetail#getLocation <em>Location</em>}</li>
 *   <li>{@link fhir.CarePlanDetail#getPerformer <em>Performer</em>}</li>
 *   <li>{@link fhir.CarePlanDetail#getProductCodeableConcept <em>Product Codeable Concept</em>}</li>
 *   <li>{@link fhir.CarePlanDetail#getProductReference <em>Product Reference</em>}</li>
 *   <li>{@link fhir.CarePlanDetail#getDailyAmount <em>Daily Amount</em>}</li>
 *   <li>{@link fhir.CarePlanDetail#getQuantity <em>Quantity</em>}</li>
 *   <li>{@link fhir.CarePlanDetail#getDescription <em>Description</em>}</li>
 * </ul>
 *
 * @see fhir.FhirPackage#getCarePlanDetail()
...
public interface CarePlanDetail extends BackboneElement {
	 ...
	 * @see fhir.FhirPackage#getCarePlanDetail_Category()
	...
	/**
	 * Sets the value of the '{@link fhir.CarePlanDetail#getCategory <em>Category</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getCarePlanDetail_Code()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.CarePlanDetail#getCode <em>Code</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getCarePlanDetail_ReasonCode()
	 * @model containment="true"
	 ...
	 * @see fhir.FhirPackage#getCarePlanDetail_ReasonReference()
	 * @model containment="true"
	 ...
	 * @see fhir.FhirPackage#getCarePlanDetail_Goal()
	 * @model containment="true"
	 ...
	 * @see fhir.FhirPackage#getCarePlanDetail_Status()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.CarePlanDetail#getStatus <em>Status</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getCarePlanDetail_StatusReason()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.CarePlanDetail#getStatusReason <em>Status Reason</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setProhibited(fhir.Boolean)
	 * @see fhir.FhirPackage#getCarePlanDetail_Prohibited()
	 * @model containment="true" required="true"
	 *        extendedMetaData="kind='element' name='prohibited' namespace='##targetNamespace'"
	 * @generated
	 */
	fhir.Boolean getProhibited();

	/**
	 * Sets the value of the '{@link fhir.CarePlanDetail#getProhibited <em>Prohibited</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	void setProhibited(fhir.Boolean value);
	 ...
	 * @see fhir.FhirPackage#getCarePlanDetail_ScheduledTiming()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.CarePlanDetail#getScheduledTiming <em>Scheduled Timing</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getCarePlanDetail_ScheduledPeriod()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.CarePlanDetail#getScheduledPeriod <em>Scheduled Period</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setScheduledString(fhir.String)
	 * @see fhir.FhirPackage#getCarePlanDetail_ScheduledString()
	 * @model containment="true"
	 *        extendedMetaData="kind='element' name='scheduledString' namespace='##targetNamespace'"
	 * @generated
	 */
	fhir.String getScheduledString();

	/**
	 * Sets the value of the '{@link fhir.CarePlanDetail#getScheduledString <em>Scheduled String</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	void setScheduledString(fhir.String value);
	 ...
	 * @see fhir.FhirPackage#getCarePlanDetail_Location()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.CarePlanDetail#getLocation <em>Location</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getCarePlanDetail_Performer()
	 * @model containment="true"
	 ...
	 * @see fhir.FhirPackage#getCarePlanDetail_ProductCodeableConcept()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.CarePlanDetail#getProductCodeableConcept <em>Product Codeable Concept</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getCarePlanDetail_ProductReference()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.CarePlanDetail#getProductReference <em>Product Reference</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getCarePlanDetail_DailyAmount()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.CarePlanDetail#getDailyAmount <em>Daily Amount</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getCarePlanDetail_Quantity()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.CarePlanDetail#getQuantity <em>Quantity</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getCarePlanDetail_Description()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.CarePlanDetail#getDescription <em>Description</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
