 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.RiskAssessmentPrediction#getOutcome <em>Outcome</em>}</li>
 *   <li>{@link fhir.RiskAssessmentPrediction#getProbabilityDecimal <em>Probability Decimal</em>}</li>
 *   <li>{@link fhir.RiskAssessmentPrediction#getProbabilityRange <em>Probability Range</em>}</li>
 *   <li>{@link fhir.RiskAssessmentPrediction#getProbabilityCodeableConcept <em>Probability Codeable Concept</em>}</li>
 *   <li>{@link fhir.RiskAssessmentPrediction#getRelativeRisk <em>Relative Risk</em>}</li>
 *   <li>{@link fhir.RiskAssessmentPrediction#getWhenPeriod <em>When Period</em>}</li>
 *   <li>{@link fhir.RiskAssessmentPrediction#getWhenRange <em>When Range</em>}</li>
 *   <li>{@link fhir.RiskAssessmentPrediction#getRationale <em>Rationale</em>}</li>
 * </ul>
 *
 * @see fhir.FhirPackage#getRiskAssessmentPrediction()
...
public interface RiskAssessmentPrediction extends BackboneElement {
	 ...
	 * @see fhir.FhirPackage#getRiskAssessmentPrediction_Outcome()
	...
	/**
	 * Sets the value of the '{@link fhir.RiskAssessmentPrediction#getOutcome <em>Outcome</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getRiskAssessmentPrediction_ProbabilityDecimal()
	...
	/**
	 * Sets the value of the '{@link fhir.RiskAssessmentPrediction#getProbabilityDecimal <em>Probability Decimal</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getRiskAssessmentPrediction_ProbabilityRange()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.RiskAssessmentPrediction#getProbabilityRange <em>Probability Range</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getRiskAssessmentPrediction_ProbabilityCodeableConcept()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.RiskAssessmentPrediction#getProbabilityCodeableConcept <em>Probability Codeable Concept</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getRiskAssessmentPrediction_RelativeRisk()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.RiskAssessmentPrediction#getRelativeRisk <em>Relative Risk</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getRiskAssessmentPrediction_WhenPeriod()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.RiskAssessmentPrediction#getWhenPeriod <em>When Period</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getRiskAssessmentPrediction_WhenRange()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.RiskAssessmentPrediction#getWhenRange <em>When Range</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setRationale(fhir.String)
	 * @see fhir.FhirPackage#getRiskAssessmentPrediction_Rationale()
	 * @model containment="true"
	 *        extendedMetaData="kind='element' name='rationale' namespace='##targetNamespace'"
	 * @generated
	 */
	fhir.String getRationale();

	/**
	 * Sets the value of the '{@link fhir.RiskAssessmentPrediction#getRationale <em>Rationale</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	void setRationale(fhir.String value);
