 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.MedicationDispenseSubstitution#getType <em>Type</em>}</li>
 *   <li>{@link fhir.MedicationDispenseSubstitution#getReason <em>Reason</em>}</li>
 *   <li>{@link fhir.MedicationDispenseSubstitution#getResponsibleParty <em>Responsible Party</em>}</li>
 * </ul>
 *
 * @see fhir.FhirPackage#getMedicationDispenseSubstitution()
...
public interface MedicationDispenseSubstitution extends BackboneElement {
	 ...
	 * @see fhir.FhirPackage#getMedicationDispenseSubstitution_Type()
	...
	/**
	 * Sets the value of the '{@link fhir.MedicationDispenseSubstitution#getType <em>Type</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getMedicationDispenseSubstitution_Reason()
	 ...
	 * @see fhir.FhirPackage#getMedicationDispenseSubstitution_ResponsibleParty()
	 * @model containment="true"
