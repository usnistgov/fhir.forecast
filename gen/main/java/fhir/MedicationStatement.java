 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.MedicationStatement#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link fhir.MedicationStatement#getPatient <em>Patient</em>}</li>
 *   <li>{@link fhir.MedicationStatement#getInformationSource <em>Information Source</em>}</li>
 *   <li>{@link fhir.MedicationStatement#getDateAsserted <em>Date Asserted</em>}</li>
 *   <li>{@link fhir.MedicationStatement#getStatus <em>Status</em>}</li>
 *   <li>{@link fhir.MedicationStatement#getWasNotTaken <em>Was Not Taken</em>}</li>
 *   <li>{@link fhir.MedicationStatement#getReasonNotTaken <em>Reason Not Taken</em>}</li>
 *   <li>{@link fhir.MedicationStatement#getReasonForUseCodeableConcept <em>Reason For Use Codeable Concept</em>}</li>
 *   <li>{@link fhir.MedicationStatement#getReasonForUseReference <em>Reason For Use Reference</em>}</li>
 *   <li>{@link fhir.MedicationStatement#getEffectiveDateTime <em>Effective Date Time</em>}</li>
 *   <li>{@link fhir.MedicationStatement#getEffectivePeriod <em>Effective Period</em>}</li>
 *   <li>{@link fhir.MedicationStatement#getNote <em>Note</em>}</li>
 *   <li>{@link fhir.MedicationStatement#getSupportingInformation <em>Supporting Information</em>}</li>
 *   <li>{@link fhir.MedicationStatement#getMedicationCodeableConcept <em>Medication Codeable Concept</em>}</li>
 *   <li>{@link fhir.MedicationStatement#getMedicationReference <em>Medication Reference</em>}</li>
 *   <li>{@link fhir.MedicationStatement#getDosage <em>Dosage</em>}</li>
 * </ul>
 *
 * @see fhir.FhirPackage#getMedicationStatement()
...
public interface MedicationStatement extends DomainResource {
	 ...
	 * @see fhir.FhirPackage#getMedicationStatement_Identifier()
	 ...
	 * @see fhir.FhirPackage#getMedicationStatement_Patient()
	...
	/**
	 * Sets the value of the '{@link fhir.MedicationStatement#getPatient <em>Patient</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getMedicationStatement_InformationSource()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.MedicationStatement#getInformationSource <em>Information Source</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getMedicationStatement_DateAsserted()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.MedicationStatement#getDateAsserted <em>Date Asserted</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getMedicationStatement_Status()
	 * @model containment="true" required="true"
	...
	/**
	 * Sets the value of the '{@link fhir.MedicationStatement#getStatus <em>Status</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setWasNotTaken(fhir.Boolean)
	 * @see fhir.FhirPackage#getMedicationStatement_WasNotTaken()
	 * @model containment="true"
	 *        extendedMetaData="kind='element' name='wasNotTaken' namespace='##targetNamespace'"
	 * @generated
	 */
	fhir.Boolean getWasNotTaken();

	/**
	 * Sets the value of the '{@link fhir.MedicationStatement#getWasNotTaken <em>Was Not Taken</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	void setWasNotTaken(fhir.Boolean value);
	 ...
	 * @see fhir.FhirPackage#getMedicationStatement_ReasonNotTaken()
	 * @model containment="true"
	 ...
	 * @see fhir.FhirPackage#getMedicationStatement_ReasonForUseCodeableConcept()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.MedicationStatement#getReasonForUseCodeableConcept <em>Reason For Use Codeable Concept</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getMedicationStatement_ReasonForUseReference()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.MedicationStatement#getReasonForUseReference <em>Reason For Use Reference</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getMedicationStatement_EffectiveDateTime()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.MedicationStatement#getEffectiveDateTime <em>Effective Date Time</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getMedicationStatement_EffectivePeriod()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.MedicationStatement#getEffectivePeriod <em>Effective Period</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getMedicationStatement_Note()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.MedicationStatement#getNote <em>Note</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getMedicationStatement_SupportingInformation()
	 * @model containment="true"
	 ...
	 * @see fhir.FhirPackage#getMedicationStatement_MedicationCodeableConcept()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.MedicationStatement#getMedicationCodeableConcept <em>Medication Codeable Concept</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getMedicationStatement_MedicationReference()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.MedicationStatement#getMedicationReference <em>Medication Reference</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The list contents are of type {@link fhir.MedicationStatementDosage}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 ...
	 * @see fhir.FhirPackage#getMedicationStatement_Dosage()
	 * @model containment="true"
