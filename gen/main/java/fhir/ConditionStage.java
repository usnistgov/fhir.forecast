 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.ConditionStage#getSummary <em>Summary</em>}</li>
 *   <li>{@link fhir.ConditionStage#getAssessment <em>Assessment</em>}</li>
 * </ul>
 *
 * @see fhir.FhirPackage#getConditionStage()
...
public interface ConditionStage extends BackboneElement {
	 ...
	 * @see fhir.FhirPackage#getConditionStage_Summary()
	...
	/**
	 * Sets the value of the '{@link fhir.ConditionStage#getSummary <em>Summary</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getConditionStage_Assessment()
	 * @model containment="true"
