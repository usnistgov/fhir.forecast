 ...
 * </p>
 * <ul>
 *   <li>{@link fhir.DiagnosticReport#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link fhir.DiagnosticReport#getStatus <em>Status</em>}</li>
 *   <li>{@link fhir.DiagnosticReport#getCategory <em>Category</em>}</li>
 *   <li>{@link fhir.DiagnosticReport#getCode <em>Code</em>}</li>
 *   <li>{@link fhir.DiagnosticReport#getSubject <em>Subject</em>}</li>
 *   <li>{@link fhir.DiagnosticReport#getEncounter <em>Encounter</em>}</li>
 *   <li>{@link fhir.DiagnosticReport#getEffectiveDateTime <em>Effective Date Time</em>}</li>
 *   <li>{@link fhir.DiagnosticReport#getEffectivePeriod <em>Effective Period</em>}</li>
 *   <li>{@link fhir.DiagnosticReport#getIssued <em>Issued</em>}</li>
 *   <li>{@link fhir.DiagnosticReport#getPerformer <em>Performer</em>}</li>
 *   <li>{@link fhir.DiagnosticReport#getRequest <em>Request</em>}</li>
 *   <li>{@link fhir.DiagnosticReport#getSpecimen <em>Specimen</em>}</li>
 *   <li>{@link fhir.DiagnosticReport#getResult <em>Result</em>}</li>
 *   <li>{@link fhir.DiagnosticReport#getImagingStudy <em>Imaging Study</em>}</li>
 *   <li>{@link fhir.DiagnosticReport#getImage <em>Image</em>}</li>
 *   <li>{@link fhir.DiagnosticReport#getConclusion <em>Conclusion</em>}</li>
 *   <li>{@link fhir.DiagnosticReport#getCodedDiagnosis <em>Coded Diagnosis</em>}</li>
 *   <li>{@link fhir.DiagnosticReport#getPresentedForm <em>Presented Form</em>}</li>
 * </ul>
 *
 * @see fhir.FhirPackage#getDiagnosticReport()
...
public interface DiagnosticReport extends DomainResource {
	 ...
	 * @see fhir.FhirPackage#getDiagnosticReport_Identifier()
	 ...
	 * @see fhir.FhirPackage#getDiagnosticReport_Status()
	...
	/**
	 * Sets the value of the '{@link fhir.DiagnosticReport#getStatus <em>Status</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getDiagnosticReport_Category()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.DiagnosticReport#getCategory <em>Category</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getDiagnosticReport_Code()
	 * @model containment="true" required="true"
	...
	/**
	 * Sets the value of the '{@link fhir.DiagnosticReport#getCode <em>Code</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getDiagnosticReport_Subject()
	 * @model containment="true" required="true"
	...
	/**
	 * Sets the value of the '{@link fhir.DiagnosticReport#getSubject <em>Subject</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getDiagnosticReport_Encounter()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.DiagnosticReport#getEncounter <em>Encounter</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getDiagnosticReport_EffectiveDateTime()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.DiagnosticReport#getEffectiveDateTime <em>Effective Date Time</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getDiagnosticReport_EffectivePeriod()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link fhir.DiagnosticReport#getEffectivePeriod <em>Effective Period</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getDiagnosticReport_Issued()
	 * @model containment="true" required="true"
	...
	/**
	 * Sets the value of the '{@link fhir.DiagnosticReport#getIssued <em>Issued</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getDiagnosticReport_Performer()
	 * @model containment="true" required="true"
	...
	/**
	 * Sets the value of the '{@link fhir.DiagnosticReport#getPerformer <em>Performer</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhir.FhirPackage#getDiagnosticReport_Request()
	 * @model containment="true"
	 ...
	 * @see fhir.FhirPackage#getDiagnosticReport_Specimen()
	 * @model containment="true"
	 ...
	 * @see fhir.FhirPackage#getDiagnosticReport_Result()
	 * @model containment="true"
	 ...
	 * @see fhir.FhirPackage#getDiagnosticReport_ImagingStudy()
	 * @model containment="true"
	 ...
	 * The list contents are of type {@link fhir.DiagnosticReportImage}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 ...
	 * @see fhir.FhirPackage#getDiagnosticReport_Image()
	 * @model containment="true"
	 ...
	 * @see #setConclusion(fhir.String)
	 * @see fhir.FhirPackage#getDiagnosticReport_Conclusion()
	 * @model containment="true"
	 *        extendedMetaData="kind='element' name='conclusion' namespace='##targetNamespace'"
	 * @generated
	 */
	fhir.String getConclusion();

	/**
	 * Sets the value of the '{@link fhir.DiagnosticReport#getConclusion <em>Conclusion</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	void setConclusion(fhir.String value);
	 ...
	 * @see fhir.FhirPackage#getDiagnosticReport_CodedDiagnosis()
	 * @model containment="true"
	 ...
	 * @see fhir.FhirPackage#getDiagnosticReport_PresentedForm()
	 * @model containment="true"
