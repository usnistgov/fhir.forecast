...
import xhtml.DisabledType1;
import xhtml.MultipleType;
 ...
 * </p>
 * <ul>
 *   <li>{@link xhtml.impl.SelectTypeImpl#getGroup <em>Group</em>}</li>
 *   <li>{@link xhtml.impl.SelectTypeImpl#getOptgroup <em>Optgroup</em>}</li>
 *   <li>{@link xhtml.impl.SelectTypeImpl#getOption <em>Option</em>}</li>
 *   <li>{@link xhtml.impl.SelectTypeImpl#getClass_ <em>Class</em>}</li>
 *   <li>{@link xhtml.impl.SelectTypeImpl#getDir <em>Dir</em>}</li>
 *   <li>{@link xhtml.impl.SelectTypeImpl#getDisabled <em>Disabled</em>}</li>
 *   <li>{@link xhtml.impl.SelectTypeImpl#getId <em>Id</em>}</li>
 *   <li>{@link xhtml.impl.SelectTypeImpl#getLang <em>Lang</em>}</li>
 *   <li>{@link xhtml.impl.SelectTypeImpl#getLang1 <em>Lang1</em>}</li>
 *   <li>{@link xhtml.impl.SelectTypeImpl#getMultiple <em>Multiple</em>}</li>
 *   <li>{@link xhtml.impl.SelectTypeImpl#getName <em>Name</em>}</li>
 *   <li>{@link xhtml.impl.SelectTypeImpl#getOnblur <em>Onblur</em>}</li>
 *   <li>{@link xhtml.impl.SelectTypeImpl#getOnchange <em>Onchange</em>}</li>
 *   <li>{@link xhtml.impl.SelectTypeImpl#getOnclick <em>Onclick</em>}</li>
 *   <li>{@link xhtml.impl.SelectTypeImpl#getOndblclick <em>Ondblclick</em>}</li>
 *   <li>{@link xhtml.impl.SelectTypeImpl#getOnfocus <em>Onfocus</em>}</li>
 *   <li>{@link xhtml.impl.SelectTypeImpl#getOnkeydown <em>Onkeydown</em>}</li>
 *   <li>{@link xhtml.impl.SelectTypeImpl#getOnkeypress <em>Onkeypress</em>}</li>
 *   <li>{@link xhtml.impl.SelectTypeImpl#getOnkeyup <em>Onkeyup</em>}</li>
 *   <li>{@link xhtml.impl.SelectTypeImpl#getOnmousedown <em>Onmousedown</em>}</li>
 *   <li>{@link xhtml.impl.SelectTypeImpl#getOnmousemove <em>Onmousemove</em>}</li>
 *   <li>{@link xhtml.impl.SelectTypeImpl#getOnmouseout <em>Onmouseout</em>}</li>
 *   <li>{@link xhtml.impl.SelectTypeImpl#getOnmouseover <em>Onmouseover</em>}</li>
 *   <li>{@link xhtml.impl.SelectTypeImpl#getOnmouseup <em>Onmouseup</em>}</li>
 *   <li>{@link xhtml.impl.SelectTypeImpl#getSize <em>Size</em>}</li>
 *   <li>{@link xhtml.impl.SelectTypeImpl#getStyle <em>Style</em>}</li>
 *   <li>{@link xhtml.impl.SelectTypeImpl#getTabindex <em>Tabindex</em>}</li>
 *   <li>{@link xhtml.impl.SelectTypeImpl#getTitle <em>Title</em>}</li>
 * </ul>
 *
 * @generated
 */
