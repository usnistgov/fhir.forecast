...
import xhtml.DisabledType4;
import xhtml.OptionType;
import xhtml.SelectedType;
 ...
 * </p>
 * <ul>
 *   <li>{@link xhtml.impl.OptionTypeImpl#getMixed <em>Mixed</em>}</li>
 *   <li>{@link xhtml.impl.OptionTypeImpl#getClass_ <em>Class</em>}</li>
 *   <li>{@link xhtml.impl.OptionTypeImpl#getDir <em>Dir</em>}</li>
 *   <li>{@link xhtml.impl.OptionTypeImpl#getDisabled <em>Disabled</em>}</li>
 *   <li>{@link xhtml.impl.OptionTypeImpl#getId <em>Id</em>}</li>
 *   <li>{@link xhtml.impl.OptionTypeImpl#getLabel <em>Label</em>}</li>
 *   <li>{@link xhtml.impl.OptionTypeImpl#getLang <em>Lang</em>}</li>
 *   <li>{@link xhtml.impl.OptionTypeImpl#getLang1 <em>Lang1</em>}</li>
 *   <li>{@link xhtml.impl.OptionTypeImpl#getOnclick <em>Onclick</em>}</li>
 *   <li>{@link xhtml.impl.OptionTypeImpl#getOndblclick <em>Ondblclick</em>}</li>
 *   <li>{@link xhtml.impl.OptionTypeImpl#getOnkeydown <em>Onkeydown</em>}</li>
 *   <li>{@link xhtml.impl.OptionTypeImpl#getOnkeypress <em>Onkeypress</em>}</li>
 *   <li>{@link xhtml.impl.OptionTypeImpl#getOnkeyup <em>Onkeyup</em>}</li>
 *   <li>{@link xhtml.impl.OptionTypeImpl#getOnmousedown <em>Onmousedown</em>}</li>
 *   <li>{@link xhtml.impl.OptionTypeImpl#getOnmousemove <em>Onmousemove</em>}</li>
 *   <li>{@link xhtml.impl.OptionTypeImpl#getOnmouseout <em>Onmouseout</em>}</li>
 *   <li>{@link xhtml.impl.OptionTypeImpl#getOnmouseover <em>Onmouseover</em>}</li>
 *   <li>{@link xhtml.impl.OptionTypeImpl#getOnmouseup <em>Onmouseup</em>}</li>
 *   <li>{@link xhtml.impl.OptionTypeImpl#getSelected <em>Selected</em>}</li>
 *   <li>{@link xhtml.impl.OptionTypeImpl#getStyle <em>Style</em>}</li>
 *   <li>{@link xhtml.impl.OptionTypeImpl#getTitle <em>Title</em>}</li>
 *   <li>{@link xhtml.impl.OptionTypeImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
