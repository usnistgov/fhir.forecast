 ...
 * </p>
 * <ul>
 *   <li>{@link xhtml.impl.FormContentImpl#getGroup <em>Group</em>}</li>
 *   <li>{@link xhtml.impl.FormContentImpl#getP <em>P</em>}</li>
 *   <li>{@link xhtml.impl.FormContentImpl#getH1 <em>H1</em>}</li>
 *   <li>{@link xhtml.impl.FormContentImpl#getH2 <em>H2</em>}</li>
 *   <li>{@link xhtml.impl.FormContentImpl#getH3 <em>H3</em>}</li>
 *   <li>{@link xhtml.impl.FormContentImpl#getH4 <em>H4</em>}</li>
 *   <li>{@link xhtml.impl.FormContentImpl#getH5 <em>H5</em>}</li>
 *   <li>{@link xhtml.impl.FormContentImpl#getH6 <em>H6</em>}</li>
 *   <li>{@link xhtml.impl.FormContentImpl#getDiv <em>Div</em>}</li>
 *   <li>{@link xhtml.impl.FormContentImpl#getUl <em>Ul</em>}</li>
 *   <li>{@link xhtml.impl.FormContentImpl#getOl <em>Ol</em>}</li>
 *   <li>{@link xhtml.impl.FormContentImpl#getDl <em>Dl</em>}</li>
 *   <li>{@link xhtml.impl.FormContentImpl#getPre <em>Pre</em>}</li>
 *   <li>{@link xhtml.impl.FormContentImpl#getHr <em>Hr</em>}</li>
 *   <li>{@link xhtml.impl.FormContentImpl#getBlockquote <em>Blockquote</em>}</li>
 *   <li>{@link xhtml.impl.FormContentImpl#getAddress <em>Address</em>}</li>
 *   <li>{@link xhtml.impl.FormContentImpl#getFieldset <em>Fieldset</em>}</li>
 *   <li>{@link xhtml.impl.FormContentImpl#getTable <em>Table</em>}</li>
 *   <li>{@link xhtml.impl.FormContentImpl#getNoscript <em>Noscript</em>}</li>
 *   <li>{@link xhtml.impl.FormContentImpl#getIns <em>Ins</em>}</li>
 *   <li>{@link xhtml.impl.FormContentImpl#getDel <em>Del</em>}</li>
 *   <li>{@link xhtml.impl.FormContentImpl#getScript <em>Script</em>}</li>
 * </ul>
 *
 * @generated
 */
