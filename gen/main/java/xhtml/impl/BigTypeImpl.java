 ...
 * </p>
 * <ul>
 *   <li>{@link xhtml.impl.BigTypeImpl#getClass_ <em>Class</em>}</li>
 *   <li>{@link xhtml.impl.BigTypeImpl#getDir <em>Dir</em>}</li>
 *   <li>{@link xhtml.impl.BigTypeImpl#getId <em>Id</em>}</li>
 *   <li>{@link xhtml.impl.BigTypeImpl#getLang <em>Lang</em>}</li>
 *   <li>{@link xhtml.impl.BigTypeImpl#getLang1 <em>Lang1</em>}</li>
 *   <li>{@link xhtml.impl.BigTypeImpl#getOnclick <em>Onclick</em>}</li>
 *   <li>{@link xhtml.impl.BigTypeImpl#getOndblclick <em>Ondblclick</em>}</li>
 *   <li>{@link xhtml.impl.BigTypeImpl#getOnkeydown <em>Onkeydown</em>}</li>
 *   <li>{@link xhtml.impl.BigTypeImpl#getOnkeypress <em>Onkeypress</em>}</li>
 *   <li>{@link xhtml.impl.BigTypeImpl#getOnkeyup <em>Onkeyup</em>}</li>
 *   <li>{@link xhtml.impl.BigTypeImpl#getOnmousedown <em>Onmousedown</em>}</li>
 *   <li>{@link xhtml.impl.BigTypeImpl#getOnmousemove <em>Onmousemove</em>}</li>
 *   <li>{@link xhtml.impl.BigTypeImpl#getOnmouseout <em>Onmouseout</em>}</li>
 *   <li>{@link xhtml.impl.BigTypeImpl#getOnmouseover <em>Onmouseover</em>}</li>
 *   <li>{@link xhtml.impl.BigTypeImpl#getOnmouseup <em>Onmouseup</em>}</li>
 *   <li>{@link xhtml.impl.BigTypeImpl#getStyle <em>Style</em>}</li>
 *   <li>{@link xhtml.impl.BigTypeImpl#getTitle <em>Title</em>}</li>
 * </ul>
 *
 * @generated
 */
