 ...
 * </p>
 * <ul>
 *   <li>{@link xhtml.impl.BlockquoteTypeImpl#getCite <em>Cite</em>}</li>
 *   <li>{@link xhtml.impl.BlockquoteTypeImpl#getClass_ <em>Class</em>}</li>
 *   <li>{@link xhtml.impl.BlockquoteTypeImpl#getDir <em>Dir</em>}</li>
 *   <li>{@link xhtml.impl.BlockquoteTypeImpl#getId <em>Id</em>}</li>
 *   <li>{@link xhtml.impl.BlockquoteTypeImpl#getLang <em>Lang</em>}</li>
 *   <li>{@link xhtml.impl.BlockquoteTypeImpl#getLang1 <em>Lang1</em>}</li>
 *   <li>{@link xhtml.impl.BlockquoteTypeImpl#getOnclick <em>Onclick</em>}</li>
 *   <li>{@link xhtml.impl.BlockquoteTypeImpl#getOndblclick <em>Ondblclick</em>}</li>
 *   <li>{@link xhtml.impl.BlockquoteTypeImpl#getOnkeydown <em>Onkeydown</em>}</li>
 *   <li>{@link xhtml.impl.BlockquoteTypeImpl#getOnkeypress <em>Onkeypress</em>}</li>
 *   <li>{@link xhtml.impl.BlockquoteTypeImpl#getOnkeyup <em>Onkeyup</em>}</li>
 *   <li>{@link xhtml.impl.BlockquoteTypeImpl#getOnmousedown <em>Onmousedown</em>}</li>
 *   <li>{@link xhtml.impl.BlockquoteTypeImpl#getOnmousemove <em>Onmousemove</em>}</li>
 *   <li>{@link xhtml.impl.BlockquoteTypeImpl#getOnmouseout <em>Onmouseout</em>}</li>
 *   <li>{@link xhtml.impl.BlockquoteTypeImpl#getOnmouseover <em>Onmouseover</em>}</li>
 *   <li>{@link xhtml.impl.BlockquoteTypeImpl#getOnmouseup <em>Onmouseup</em>}</li>
 *   <li>{@link xhtml.impl.BlockquoteTypeImpl#getStyle <em>Style</em>}</li>
 *   <li>{@link xhtml.impl.BlockquoteTypeImpl#getTitle <em>Title</em>}</li>
 * </ul>
 *
 * @generated
 */
