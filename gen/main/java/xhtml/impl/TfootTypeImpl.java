 ...
 * </p>
 * <ul>
 *   <li>{@link xhtml.impl.TfootTypeImpl#getTr <em>Tr</em>}</li>
 *   <li>{@link xhtml.impl.TfootTypeImpl#getAlign <em>Align</em>}</li>
 *   <li>{@link xhtml.impl.TfootTypeImpl#getChar <em>Char</em>}</li>
 *   <li>{@link xhtml.impl.TfootTypeImpl#getCharoff <em>Charoff</em>}</li>
 *   <li>{@link xhtml.impl.TfootTypeImpl#getClass_ <em>Class</em>}</li>
 *   <li>{@link xhtml.impl.TfootTypeImpl#getDir <em>Dir</em>}</li>
 *   <li>{@link xhtml.impl.TfootTypeImpl#getId <em>Id</em>}</li>
 *   <li>{@link xhtml.impl.TfootTypeImpl#getLang <em>Lang</em>}</li>
 *   <li>{@link xhtml.impl.TfootTypeImpl#getLang1 <em>Lang1</em>}</li>
 *   <li>{@link xhtml.impl.TfootTypeImpl#getOnclick <em>Onclick</em>}</li>
 *   <li>{@link xhtml.impl.TfootTypeImpl#getOndblclick <em>Ondblclick</em>}</li>
 *   <li>{@link xhtml.impl.TfootTypeImpl#getOnkeydown <em>Onkeydown</em>}</li>
 *   <li>{@link xhtml.impl.TfootTypeImpl#getOnkeypress <em>Onkeypress</em>}</li>
 *   <li>{@link xhtml.impl.TfootTypeImpl#getOnkeyup <em>Onkeyup</em>}</li>
 *   <li>{@link xhtml.impl.TfootTypeImpl#getOnmousedown <em>Onmousedown</em>}</li>
 *   <li>{@link xhtml.impl.TfootTypeImpl#getOnmousemove <em>Onmousemove</em>}</li>
 *   <li>{@link xhtml.impl.TfootTypeImpl#getOnmouseout <em>Onmouseout</em>}</li>
 *   <li>{@link xhtml.impl.TfootTypeImpl#getOnmouseover <em>Onmouseover</em>}</li>
 *   <li>{@link xhtml.impl.TfootTypeImpl#getOnmouseup <em>Onmouseup</em>}</li>
 *   <li>{@link xhtml.impl.TfootTypeImpl#getStyle <em>Style</em>}</li>
 *   <li>{@link xhtml.impl.TfootTypeImpl#getTitle <em>Title</em>}</li>
 *   <li>{@link xhtml.impl.TfootTypeImpl#getValign <em>Valign</em>}</li>
 * </ul>
 *
 * @generated
 */
