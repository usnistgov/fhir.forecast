 ...
 * </p>
 * <ul>
 *   <li>{@link xhtml.impl.MapTypeImpl#getGroup <em>Group</em>}</li>
 *   <li>{@link xhtml.impl.MapTypeImpl#getP <em>P</em>}</li>
 *   <li>{@link xhtml.impl.MapTypeImpl#getH1 <em>H1</em>}</li>
 *   <li>{@link xhtml.impl.MapTypeImpl#getH2 <em>H2</em>}</li>
 *   <li>{@link xhtml.impl.MapTypeImpl#getH3 <em>H3</em>}</li>
 *   <li>{@link xhtml.impl.MapTypeImpl#getH4 <em>H4</em>}</li>
 *   <li>{@link xhtml.impl.MapTypeImpl#getH5 <em>H5</em>}</li>
 *   <li>{@link xhtml.impl.MapTypeImpl#getH6 <em>H6</em>}</li>
 *   <li>{@link xhtml.impl.MapTypeImpl#getDiv <em>Div</em>}</li>
 *   <li>{@link xhtml.impl.MapTypeImpl#getUl <em>Ul</em>}</li>
 *   <li>{@link xhtml.impl.MapTypeImpl#getOl <em>Ol</em>}</li>
 *   <li>{@link xhtml.impl.MapTypeImpl#getDl <em>Dl</em>}</li>
 *   <li>{@link xhtml.impl.MapTypeImpl#getPre <em>Pre</em>}</li>
 *   <li>{@link xhtml.impl.MapTypeImpl#getHr <em>Hr</em>}</li>
 *   <li>{@link xhtml.impl.MapTypeImpl#getBlockquote <em>Blockquote</em>}</li>
 *   <li>{@link xhtml.impl.MapTypeImpl#getAddress <em>Address</em>}</li>
 *   <li>{@link xhtml.impl.MapTypeImpl#getFieldset <em>Fieldset</em>}</li>
 *   <li>{@link xhtml.impl.MapTypeImpl#getTable <em>Table</em>}</li>
 *   <li>{@link xhtml.impl.MapTypeImpl#getForm <em>Form</em>}</li>
 *   <li>{@link xhtml.impl.MapTypeImpl#getNoscript <em>Noscript</em>}</li>
 *   <li>{@link xhtml.impl.MapTypeImpl#getIns <em>Ins</em>}</li>
 *   <li>{@link xhtml.impl.MapTypeImpl#getDel <em>Del</em>}</li>
 *   <li>{@link xhtml.impl.MapTypeImpl#getScript <em>Script</em>}</li>
 *   <li>{@link xhtml.impl.MapTypeImpl#getArea <em>Area</em>}</li>
 *   <li>{@link xhtml.impl.MapTypeImpl#getClass_ <em>Class</em>}</li>
 *   <li>{@link xhtml.impl.MapTypeImpl#getDir <em>Dir</em>}</li>
 *   <li>{@link xhtml.impl.MapTypeImpl#getId <em>Id</em>}</li>
 *   <li>{@link xhtml.impl.MapTypeImpl#getLang <em>Lang</em>}</li>
 *   <li>{@link xhtml.impl.MapTypeImpl#getLang1 <em>Lang1</em>}</li>
 *   <li>{@link xhtml.impl.MapTypeImpl#getName <em>Name</em>}</li>
 *   <li>{@link xhtml.impl.MapTypeImpl#getOnclick <em>Onclick</em>}</li>
 *   <li>{@link xhtml.impl.MapTypeImpl#getOndblclick <em>Ondblclick</em>}</li>
 *   <li>{@link xhtml.impl.MapTypeImpl#getOnkeydown <em>Onkeydown</em>}</li>
 *   <li>{@link xhtml.impl.MapTypeImpl#getOnkeypress <em>Onkeypress</em>}</li>
 *   <li>{@link xhtml.impl.MapTypeImpl#getOnkeyup <em>Onkeyup</em>}</li>
 *   <li>{@link xhtml.impl.MapTypeImpl#getOnmousedown <em>Onmousedown</em>}</li>
 *   <li>{@link xhtml.impl.MapTypeImpl#getOnmousemove <em>Onmousemove</em>}</li>
 *   <li>{@link xhtml.impl.MapTypeImpl#getOnmouseout <em>Onmouseout</em>}</li>
 *   <li>{@link xhtml.impl.MapTypeImpl#getOnmouseover <em>Onmouseover</em>}</li>
 *   <li>{@link xhtml.impl.MapTypeImpl#getOnmouseup <em>Onmouseup</em>}</li>
 *   <li>{@link xhtml.impl.MapTypeImpl#getStyle <em>Style</em>}</li>
 *   <li>{@link xhtml.impl.MapTypeImpl#getTitle <em>Title</em>}</li>
 * </ul>
 *
 * @generated
 */
