 ...
 * </p>
 * <ul>
 *   <li>{@link xhtml.impl.PreTypeImpl#getClass_ <em>Class</em>}</li>
 *   <li>{@link xhtml.impl.PreTypeImpl#getDir <em>Dir</em>}</li>
 *   <li>{@link xhtml.impl.PreTypeImpl#getId <em>Id</em>}</li>
 *   <li>{@link xhtml.impl.PreTypeImpl#getLang <em>Lang</em>}</li>
 *   <li>{@link xhtml.impl.PreTypeImpl#getLang1 <em>Lang1</em>}</li>
 *   <li>{@link xhtml.impl.PreTypeImpl#getOnclick <em>Onclick</em>}</li>
 *   <li>{@link xhtml.impl.PreTypeImpl#getOndblclick <em>Ondblclick</em>}</li>
 *   <li>{@link xhtml.impl.PreTypeImpl#getOnkeydown <em>Onkeydown</em>}</li>
 *   <li>{@link xhtml.impl.PreTypeImpl#getOnkeypress <em>Onkeypress</em>}</li>
 *   <li>{@link xhtml.impl.PreTypeImpl#getOnkeyup <em>Onkeyup</em>}</li>
 *   <li>{@link xhtml.impl.PreTypeImpl#getOnmousedown <em>Onmousedown</em>}</li>
 *   <li>{@link xhtml.impl.PreTypeImpl#getOnmousemove <em>Onmousemove</em>}</li>
 *   <li>{@link xhtml.impl.PreTypeImpl#getOnmouseout <em>Onmouseout</em>}</li>
 *   <li>{@link xhtml.impl.PreTypeImpl#getOnmouseover <em>Onmouseover</em>}</li>
 *   <li>{@link xhtml.impl.PreTypeImpl#getOnmouseup <em>Onmouseup</em>}</li>
 *   <li>{@link xhtml.impl.PreTypeImpl#getSpace <em>Space</em>}</li>
 *   <li>{@link xhtml.impl.PreTypeImpl#getStyle <em>Style</em>}</li>
 *   <li>{@link xhtml.impl.PreTypeImpl#getTitle <em>Title</em>}</li>
 * </ul>
 *
 * @generated
 */
