 ...
 * </p>
 * <ul>
 *   <li>{@link xhtml.impl.BlockImpl#getGroup <em>Group</em>}</li>
 *   <li>{@link xhtml.impl.BlockImpl#getP <em>P</em>}</li>
 *   <li>{@link xhtml.impl.BlockImpl#getH1 <em>H1</em>}</li>
 *   <li>{@link xhtml.impl.BlockImpl#getH2 <em>H2</em>}</li>
 *   <li>{@link xhtml.impl.BlockImpl#getH3 <em>H3</em>}</li>
 *   <li>{@link xhtml.impl.BlockImpl#getH4 <em>H4</em>}</li>
 *   <li>{@link xhtml.impl.BlockImpl#getH5 <em>H5</em>}</li>
 *   <li>{@link xhtml.impl.BlockImpl#getH6 <em>H6</em>}</li>
 *   <li>{@link xhtml.impl.BlockImpl#getDiv <em>Div</em>}</li>
 *   <li>{@link xhtml.impl.BlockImpl#getUl <em>Ul</em>}</li>
 *   <li>{@link xhtml.impl.BlockImpl#getOl <em>Ol</em>}</li>
 *   <li>{@link xhtml.impl.BlockImpl#getDl <em>Dl</em>}</li>
 *   <li>{@link xhtml.impl.BlockImpl#getPre <em>Pre</em>}</li>
 *   <li>{@link xhtml.impl.BlockImpl#getHr <em>Hr</em>}</li>
 *   <li>{@link xhtml.impl.BlockImpl#getBlockquote <em>Blockquote</em>}</li>
 *   <li>{@link xhtml.impl.BlockImpl#getAddress <em>Address</em>}</li>
 *   <li>{@link xhtml.impl.BlockImpl#getFieldset <em>Fieldset</em>}</li>
 *   <li>{@link xhtml.impl.BlockImpl#getTable <em>Table</em>}</li>
 *   <li>{@link xhtml.impl.BlockImpl#getForm <em>Form</em>}</li>
 *   <li>{@link xhtml.impl.BlockImpl#getNoscript <em>Noscript</em>}</li>
 *   <li>{@link xhtml.impl.BlockImpl#getIns <em>Ins</em>}</li>
 *   <li>{@link xhtml.impl.BlockImpl#getDel <em>Del</em>}</li>
 *   <li>{@link xhtml.impl.BlockImpl#getScript <em>Script</em>}</li>
 * </ul>
 *
 * @generated
 */
