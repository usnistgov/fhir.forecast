...
import xhtml.AlignType;
import xhtml.DirType;
import xhtml.Scope;
import xhtml.TdType;
import xhtml.ValignType;
 ...
 * </p>
 * <ul>
 *   <li>{@link xhtml.impl.TdTypeImpl#getAbbr1 <em>Abbr1</em>}</li>
 *   <li>{@link xhtml.impl.TdTypeImpl#getAlign <em>Align</em>}</li>
 *   <li>{@link xhtml.impl.TdTypeImpl#getAxis <em>Axis</em>}</li>
 *   <li>{@link xhtml.impl.TdTypeImpl#getChar <em>Char</em>}</li>
 *   <li>{@link xhtml.impl.TdTypeImpl#getCharoff <em>Charoff</em>}</li>
 *   <li>{@link xhtml.impl.TdTypeImpl#getClass_ <em>Class</em>}</li>
 *   <li>{@link xhtml.impl.TdTypeImpl#getColspan <em>Colspan</em>}</li>
 *   <li>{@link xhtml.impl.TdTypeImpl#getDir <em>Dir</em>}</li>
 *   <li>{@link xhtml.impl.TdTypeImpl#getHeaders <em>Headers</em>}</li>
 *   <li>{@link xhtml.impl.TdTypeImpl#getId <em>Id</em>}</li>
 *   <li>{@link xhtml.impl.TdTypeImpl#getLang <em>Lang</em>}</li>
 *   <li>{@link xhtml.impl.TdTypeImpl#getLang1 <em>Lang1</em>}</li>
 *   <li>{@link xhtml.impl.TdTypeImpl#getOnclick <em>Onclick</em>}</li>
 *   <li>{@link xhtml.impl.TdTypeImpl#getOndblclick <em>Ondblclick</em>}</li>
 *   <li>{@link xhtml.impl.TdTypeImpl#getOnkeydown <em>Onkeydown</em>}</li>
 *   <li>{@link xhtml.impl.TdTypeImpl#getOnkeypress <em>Onkeypress</em>}</li>
 *   <li>{@link xhtml.impl.TdTypeImpl#getOnkeyup <em>Onkeyup</em>}</li>
 *   <li>{@link xhtml.impl.TdTypeImpl#getOnmousedown <em>Onmousedown</em>}</li>
 *   <li>{@link xhtml.impl.TdTypeImpl#getOnmousemove <em>Onmousemove</em>}</li>
 *   <li>{@link xhtml.impl.TdTypeImpl#getOnmouseout <em>Onmouseout</em>}</li>
 *   <li>{@link xhtml.impl.TdTypeImpl#getOnmouseover <em>Onmouseover</em>}</li>
 *   <li>{@link xhtml.impl.TdTypeImpl#getOnmouseup <em>Onmouseup</em>}</li>
 *   <li>{@link xhtml.impl.TdTypeImpl#getRowspan <em>Rowspan</em>}</li>
 *   <li>{@link xhtml.impl.TdTypeImpl#getScope <em>Scope</em>}</li>
 *   <li>{@link xhtml.impl.TdTypeImpl#getStyle <em>Style</em>}</li>
 *   <li>{@link xhtml.impl.TdTypeImpl#getTitle <em>Title</em>}</li>
 *   <li>{@link xhtml.impl.TdTypeImpl#getValign <em>Valign</em>}</li>
 * </ul>
 *
 * @generated
 */
