 ...
 * </p>
 * <ul>
 *   <li>{@link xhtml.impl.DlTypeImpl#getGroup <em>Group</em>}</li>
 *   <li>{@link xhtml.impl.DlTypeImpl#getDt <em>Dt</em>}</li>
 *   <li>{@link xhtml.impl.DlTypeImpl#getDd <em>Dd</em>}</li>
 *   <li>{@link xhtml.impl.DlTypeImpl#getClass_ <em>Class</em>}</li>
 *   <li>{@link xhtml.impl.DlTypeImpl#getDir <em>Dir</em>}</li>
 *   <li>{@link xhtml.impl.DlTypeImpl#getId <em>Id</em>}</li>
 *   <li>{@link xhtml.impl.DlTypeImpl#getLang <em>Lang</em>}</li>
 *   <li>{@link xhtml.impl.DlTypeImpl#getLang1 <em>Lang1</em>}</li>
 *   <li>{@link xhtml.impl.DlTypeImpl#getOnclick <em>Onclick</em>}</li>
 *   <li>{@link xhtml.impl.DlTypeImpl#getOndblclick <em>Ondblclick</em>}</li>
 *   <li>{@link xhtml.impl.DlTypeImpl#getOnkeydown <em>Onkeydown</em>}</li>
 *   <li>{@link xhtml.impl.DlTypeImpl#getOnkeypress <em>Onkeypress</em>}</li>
 *   <li>{@link xhtml.impl.DlTypeImpl#getOnkeyup <em>Onkeyup</em>}</li>
 *   <li>{@link xhtml.impl.DlTypeImpl#getOnmousedown <em>Onmousedown</em>}</li>
 *   <li>{@link xhtml.impl.DlTypeImpl#getOnmousemove <em>Onmousemove</em>}</li>
 *   <li>{@link xhtml.impl.DlTypeImpl#getOnmouseout <em>Onmouseout</em>}</li>
 *   <li>{@link xhtml.impl.DlTypeImpl#getOnmouseover <em>Onmouseover</em>}</li>
 *   <li>{@link xhtml.impl.DlTypeImpl#getOnmouseup <em>Onmouseup</em>}</li>
 *   <li>{@link xhtml.impl.DlTypeImpl#getStyle <em>Style</em>}</li>
 *   <li>{@link xhtml.impl.DlTypeImpl#getTitle <em>Title</em>}</li>
 * </ul>
 *
 * @generated
 */
