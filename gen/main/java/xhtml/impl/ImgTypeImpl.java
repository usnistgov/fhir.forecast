 ...
 * </p>
 * <ul>
 *   <li>{@link xhtml.impl.ImgTypeImpl#getAlt <em>Alt</em>}</li>
 *   <li>{@link xhtml.impl.ImgTypeImpl#getClass_ <em>Class</em>}</li>
 *   <li>{@link xhtml.impl.ImgTypeImpl#getDir <em>Dir</em>}</li>
 *   <li>{@link xhtml.impl.ImgTypeImpl#getHeight <em>Height</em>}</li>
 *   <li>{@link xhtml.impl.ImgTypeImpl#getId <em>Id</em>}</li>
 *   <li>{@link xhtml.impl.ImgTypeImpl#getIsmap <em>Ismap</em>}</li>
 *   <li>{@link xhtml.impl.ImgTypeImpl#getLang <em>Lang</em>}</li>
 *   <li>{@link xhtml.impl.ImgTypeImpl#getLang1 <em>Lang1</em>}</li>
 *   <li>{@link xhtml.impl.ImgTypeImpl#getLongdesc <em>Longdesc</em>}</li>
 *   <li>{@link xhtml.impl.ImgTypeImpl#getOnclick <em>Onclick</em>}</li>
 *   <li>{@link xhtml.impl.ImgTypeImpl#getOndblclick <em>Ondblclick</em>}</li>
 *   <li>{@link xhtml.impl.ImgTypeImpl#getOnkeydown <em>Onkeydown</em>}</li>
 *   <li>{@link xhtml.impl.ImgTypeImpl#getOnkeypress <em>Onkeypress</em>}</li>
 *   <li>{@link xhtml.impl.ImgTypeImpl#getOnkeyup <em>Onkeyup</em>}</li>
 *   <li>{@link xhtml.impl.ImgTypeImpl#getOnmousedown <em>Onmousedown</em>}</li>
 *   <li>{@link xhtml.impl.ImgTypeImpl#getOnmousemove <em>Onmousemove</em>}</li>
 *   <li>{@link xhtml.impl.ImgTypeImpl#getOnmouseout <em>Onmouseout</em>}</li>
 *   <li>{@link xhtml.impl.ImgTypeImpl#getOnmouseover <em>Onmouseover</em>}</li>
 *   <li>{@link xhtml.impl.ImgTypeImpl#getOnmouseup <em>Onmouseup</em>}</li>
 *   <li>{@link xhtml.impl.ImgTypeImpl#getSrc <em>Src</em>}</li>
 *   <li>{@link xhtml.impl.ImgTypeImpl#getStyle <em>Style</em>}</li>
 *   <li>{@link xhtml.impl.ImgTypeImpl#getTitle <em>Title</em>}</li>
 *   <li>{@link xhtml.impl.ImgTypeImpl#getUsemap <em>Usemap</em>}</li>
 *   <li>{@link xhtml.impl.ImgTypeImpl#getWidth <em>Width</em>}</li>
 * </ul>
 *
 * @generated
 */
