 ...
 * </p>
 * <ul>
 *   <li>{@link xhtml.impl.CaptionTypeImpl#getClass_ <em>Class</em>}</li>
 *   <li>{@link xhtml.impl.CaptionTypeImpl#getDir <em>Dir</em>}</li>
 *   <li>{@link xhtml.impl.CaptionTypeImpl#getId <em>Id</em>}</li>
 *   <li>{@link xhtml.impl.CaptionTypeImpl#getLang <em>Lang</em>}</li>
 *   <li>{@link xhtml.impl.CaptionTypeImpl#getLang1 <em>Lang1</em>}</li>
 *   <li>{@link xhtml.impl.CaptionTypeImpl#getOnclick <em>Onclick</em>}</li>
 *   <li>{@link xhtml.impl.CaptionTypeImpl#getOndblclick <em>Ondblclick</em>}</li>
 *   <li>{@link xhtml.impl.CaptionTypeImpl#getOnkeydown <em>Onkeydown</em>}</li>
 *   <li>{@link xhtml.impl.CaptionTypeImpl#getOnkeypress <em>Onkeypress</em>}</li>
 *   <li>{@link xhtml.impl.CaptionTypeImpl#getOnkeyup <em>Onkeyup</em>}</li>
 *   <li>{@link xhtml.impl.CaptionTypeImpl#getOnmousedown <em>Onmousedown</em>}</li>
 *   <li>{@link xhtml.impl.CaptionTypeImpl#getOnmousemove <em>Onmousemove</em>}</li>
 *   <li>{@link xhtml.impl.CaptionTypeImpl#getOnmouseout <em>Onmouseout</em>}</li>
 *   <li>{@link xhtml.impl.CaptionTypeImpl#getOnmouseover <em>Onmouseover</em>}</li>
 *   <li>{@link xhtml.impl.CaptionTypeImpl#getOnmouseup <em>Onmouseup</em>}</li>
 *   <li>{@link xhtml.impl.CaptionTypeImpl#getStyle <em>Style</em>}</li>
 *   <li>{@link xhtml.impl.CaptionTypeImpl#getTitle <em>Title</em>}</li>
 * </ul>
 *
 * @generated
 */
