 ...
 * </p>
 * <ul>
 *   <li>{@link xhtml.impl.ATypeImpl#getAccesskey <em>Accesskey</em>}</li>
 *   <li>{@link xhtml.impl.ATypeImpl#getCharset <em>Charset</em>}</li>
 *   <li>{@link xhtml.impl.ATypeImpl#getClass_ <em>Class</em>}</li>
 *   <li>{@link xhtml.impl.ATypeImpl#getCoords <em>Coords</em>}</li>
 *   <li>{@link xhtml.impl.ATypeImpl#getDir <em>Dir</em>}</li>
 *   <li>{@link xhtml.impl.ATypeImpl#getHref <em>Href</em>}</li>
 *   <li>{@link xhtml.impl.ATypeImpl#getHreflang <em>Hreflang</em>}</li>
 *   <li>{@link xhtml.impl.ATypeImpl#getId <em>Id</em>}</li>
 *   <li>{@link xhtml.impl.ATypeImpl#getLang <em>Lang</em>}</li>
 *   <li>{@link xhtml.impl.ATypeImpl#getLang1 <em>Lang1</em>}</li>
 *   <li>{@link xhtml.impl.ATypeImpl#getName <em>Name</em>}</li>
 *   <li>{@link xhtml.impl.ATypeImpl#getOnblur <em>Onblur</em>}</li>
 *   <li>{@link xhtml.impl.ATypeImpl#getOnclick <em>Onclick</em>}</li>
 *   <li>{@link xhtml.impl.ATypeImpl#getOndblclick <em>Ondblclick</em>}</li>
 *   <li>{@link xhtml.impl.ATypeImpl#getOnfocus <em>Onfocus</em>}</li>
 *   <li>{@link xhtml.impl.ATypeImpl#getOnkeydown <em>Onkeydown</em>}</li>
 *   <li>{@link xhtml.impl.ATypeImpl#getOnkeypress <em>Onkeypress</em>}</li>
 *   <li>{@link xhtml.impl.ATypeImpl#getOnkeyup <em>Onkeyup</em>}</li>
 *   <li>{@link xhtml.impl.ATypeImpl#getOnmousedown <em>Onmousedown</em>}</li>
 *   <li>{@link xhtml.impl.ATypeImpl#getOnmousemove <em>Onmousemove</em>}</li>
 *   <li>{@link xhtml.impl.ATypeImpl#getOnmouseout <em>Onmouseout</em>}</li>
 *   <li>{@link xhtml.impl.ATypeImpl#getOnmouseover <em>Onmouseover</em>}</li>
 *   <li>{@link xhtml.impl.ATypeImpl#getOnmouseup <em>Onmouseup</em>}</li>
 *   <li>{@link xhtml.impl.ATypeImpl#getRel <em>Rel</em>}</li>
 *   <li>{@link xhtml.impl.ATypeImpl#getRev <em>Rev</em>}</li>
 *   <li>{@link xhtml.impl.ATypeImpl#getShape <em>Shape</em>}</li>
 *   <li>{@link xhtml.impl.ATypeImpl#getStyle <em>Style</em>}</li>
 *   <li>{@link xhtml.impl.ATypeImpl#getTabindex <em>Tabindex</em>}</li>
 *   <li>{@link xhtml.impl.ATypeImpl#getTitle <em>Title</em>}</li>
 *   <li>{@link xhtml.impl.ATypeImpl#getType <em>Type</em>}</li>
 * </ul>
 *
 * @generated
 */
