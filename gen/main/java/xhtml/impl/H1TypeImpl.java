 ...
 * </p>
 * <ul>
 *   <li>{@link xhtml.impl.H1TypeImpl#getClass_ <em>Class</em>}</li>
 *   <li>{@link xhtml.impl.H1TypeImpl#getDir <em>Dir</em>}</li>
 *   <li>{@link xhtml.impl.H1TypeImpl#getId <em>Id</em>}</li>
 *   <li>{@link xhtml.impl.H1TypeImpl#getLang <em>Lang</em>}</li>
 *   <li>{@link xhtml.impl.H1TypeImpl#getLang1 <em>Lang1</em>}</li>
 *   <li>{@link xhtml.impl.H1TypeImpl#getOnclick <em>Onclick</em>}</li>
 *   <li>{@link xhtml.impl.H1TypeImpl#getOndblclick <em>Ondblclick</em>}</li>
 *   <li>{@link xhtml.impl.H1TypeImpl#getOnkeydown <em>Onkeydown</em>}</li>
 *   <li>{@link xhtml.impl.H1TypeImpl#getOnkeypress <em>Onkeypress</em>}</li>
 *   <li>{@link xhtml.impl.H1TypeImpl#getOnkeyup <em>Onkeyup</em>}</li>
 *   <li>{@link xhtml.impl.H1TypeImpl#getOnmousedown <em>Onmousedown</em>}</li>
 *   <li>{@link xhtml.impl.H1TypeImpl#getOnmousemove <em>Onmousemove</em>}</li>
 *   <li>{@link xhtml.impl.H1TypeImpl#getOnmouseout <em>Onmouseout</em>}</li>
 *   <li>{@link xhtml.impl.H1TypeImpl#getOnmouseover <em>Onmouseover</em>}</li>
 *   <li>{@link xhtml.impl.H1TypeImpl#getOnmouseup <em>Onmouseup</em>}</li>
 *   <li>{@link xhtml.impl.H1TypeImpl#getStyle <em>Style</em>}</li>
 *   <li>{@link xhtml.impl.H1TypeImpl#getTitle <em>Title</em>}</li>
 * </ul>
 *
 * @generated
 */
