 ...
 * </p>
 * <ul>
 *   <li>{@link xhtml.impl.AreaTypeImpl#getAccesskey <em>Accesskey</em>}</li>
 *   <li>{@link xhtml.impl.AreaTypeImpl#getAlt <em>Alt</em>}</li>
 *   <li>{@link xhtml.impl.AreaTypeImpl#getClass_ <em>Class</em>}</li>
 *   <li>{@link xhtml.impl.AreaTypeImpl#getCoords <em>Coords</em>}</li>
 *   <li>{@link xhtml.impl.AreaTypeImpl#getDir <em>Dir</em>}</li>
 *   <li>{@link xhtml.impl.AreaTypeImpl#getHref <em>Href</em>}</li>
 *   <li>{@link xhtml.impl.AreaTypeImpl#getId <em>Id</em>}</li>
 *   <li>{@link xhtml.impl.AreaTypeImpl#getLang <em>Lang</em>}</li>
 *   <li>{@link xhtml.impl.AreaTypeImpl#getLang1 <em>Lang1</em>}</li>
 *   <li>{@link xhtml.impl.AreaTypeImpl#getNohref <em>Nohref</em>}</li>
 *   <li>{@link xhtml.impl.AreaTypeImpl#getOnblur <em>Onblur</em>}</li>
 *   <li>{@link xhtml.impl.AreaTypeImpl#getOnclick <em>Onclick</em>}</li>
 *   <li>{@link xhtml.impl.AreaTypeImpl#getOndblclick <em>Ondblclick</em>}</li>
 *   <li>{@link xhtml.impl.AreaTypeImpl#getOnfocus <em>Onfocus</em>}</li>
 *   <li>{@link xhtml.impl.AreaTypeImpl#getOnkeydown <em>Onkeydown</em>}</li>
 *   <li>{@link xhtml.impl.AreaTypeImpl#getOnkeypress <em>Onkeypress</em>}</li>
 *   <li>{@link xhtml.impl.AreaTypeImpl#getOnkeyup <em>Onkeyup</em>}</li>
 *   <li>{@link xhtml.impl.AreaTypeImpl#getOnmousedown <em>Onmousedown</em>}</li>
 *   <li>{@link xhtml.impl.AreaTypeImpl#getOnmousemove <em>Onmousemove</em>}</li>
 *   <li>{@link xhtml.impl.AreaTypeImpl#getOnmouseout <em>Onmouseout</em>}</li>
 *   <li>{@link xhtml.impl.AreaTypeImpl#getOnmouseover <em>Onmouseover</em>}</li>
 *   <li>{@link xhtml.impl.AreaTypeImpl#getOnmouseup <em>Onmouseup</em>}</li>
 *   <li>{@link xhtml.impl.AreaTypeImpl#getShape <em>Shape</em>}</li>
 *   <li>{@link xhtml.impl.AreaTypeImpl#getStyle <em>Style</em>}</li>
 *   <li>{@link xhtml.impl.AreaTypeImpl#getTabindex <em>Tabindex</em>}</li>
 *   <li>{@link xhtml.impl.AreaTypeImpl#getTitle <em>Title</em>}</li>
 * </ul>
 *
 * @generated
 */
