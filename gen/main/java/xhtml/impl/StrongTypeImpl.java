 ...
 * </p>
 * <ul>
 *   <li>{@link xhtml.impl.StrongTypeImpl#getClass_ <em>Class</em>}</li>
 *   <li>{@link xhtml.impl.StrongTypeImpl#getDir <em>Dir</em>}</li>
 *   <li>{@link xhtml.impl.StrongTypeImpl#getId <em>Id</em>}</li>
 *   <li>{@link xhtml.impl.StrongTypeImpl#getLang <em>Lang</em>}</li>
 *   <li>{@link xhtml.impl.StrongTypeImpl#getLang1 <em>Lang1</em>}</li>
 *   <li>{@link xhtml.impl.StrongTypeImpl#getOnclick <em>Onclick</em>}</li>
 *   <li>{@link xhtml.impl.StrongTypeImpl#getOndblclick <em>Ondblclick</em>}</li>
 *   <li>{@link xhtml.impl.StrongTypeImpl#getOnkeydown <em>Onkeydown</em>}</li>
 *   <li>{@link xhtml.impl.StrongTypeImpl#getOnkeypress <em>Onkeypress</em>}</li>
 *   <li>{@link xhtml.impl.StrongTypeImpl#getOnkeyup <em>Onkeyup</em>}</li>
 *   <li>{@link xhtml.impl.StrongTypeImpl#getOnmousedown <em>Onmousedown</em>}</li>
 *   <li>{@link xhtml.impl.StrongTypeImpl#getOnmousemove <em>Onmousemove</em>}</li>
 *   <li>{@link xhtml.impl.StrongTypeImpl#getOnmouseout <em>Onmouseout</em>}</li>
 *   <li>{@link xhtml.impl.StrongTypeImpl#getOnmouseover <em>Onmouseover</em>}</li>
 *   <li>{@link xhtml.impl.StrongTypeImpl#getOnmouseup <em>Onmouseup</em>}</li>
 *   <li>{@link xhtml.impl.StrongTypeImpl#getStyle <em>Style</em>}</li>
 *   <li>{@link xhtml.impl.StrongTypeImpl#getTitle <em>Title</em>}</li>
 * </ul>
 *
 * @generated
 */
