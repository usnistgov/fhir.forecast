 ...
 * </p>
 * <ul>
 *   <li>{@link xhtml.impl.LinkTypeImpl#getCharset <em>Charset</em>}</li>
 *   <li>{@link xhtml.impl.LinkTypeImpl#getClass_ <em>Class</em>}</li>
 *   <li>{@link xhtml.impl.LinkTypeImpl#getDir <em>Dir</em>}</li>
 *   <li>{@link xhtml.impl.LinkTypeImpl#getHref <em>Href</em>}</li>
 *   <li>{@link xhtml.impl.LinkTypeImpl#getHreflang <em>Hreflang</em>}</li>
 *   <li>{@link xhtml.impl.LinkTypeImpl#getId <em>Id</em>}</li>
 *   <li>{@link xhtml.impl.LinkTypeImpl#getLang <em>Lang</em>}</li>
 *   <li>{@link xhtml.impl.LinkTypeImpl#getLang1 <em>Lang1</em>}</li>
 *   <li>{@link xhtml.impl.LinkTypeImpl#getMedia <em>Media</em>}</li>
 *   <li>{@link xhtml.impl.LinkTypeImpl#getOnclick <em>Onclick</em>}</li>
 *   <li>{@link xhtml.impl.LinkTypeImpl#getOndblclick <em>Ondblclick</em>}</li>
 *   <li>{@link xhtml.impl.LinkTypeImpl#getOnkeydown <em>Onkeydown</em>}</li>
 *   <li>{@link xhtml.impl.LinkTypeImpl#getOnkeypress <em>Onkeypress</em>}</li>
 *   <li>{@link xhtml.impl.LinkTypeImpl#getOnkeyup <em>Onkeyup</em>}</li>
 *   <li>{@link xhtml.impl.LinkTypeImpl#getOnmousedown <em>Onmousedown</em>}</li>
 *   <li>{@link xhtml.impl.LinkTypeImpl#getOnmousemove <em>Onmousemove</em>}</li>
 *   <li>{@link xhtml.impl.LinkTypeImpl#getOnmouseout <em>Onmouseout</em>}</li>
 *   <li>{@link xhtml.impl.LinkTypeImpl#getOnmouseover <em>Onmouseover</em>}</li>
 *   <li>{@link xhtml.impl.LinkTypeImpl#getOnmouseup <em>Onmouseup</em>}</li>
 *   <li>{@link xhtml.impl.LinkTypeImpl#getRel <em>Rel</em>}</li>
 *   <li>{@link xhtml.impl.LinkTypeImpl#getRev <em>Rev</em>}</li>
 *   <li>{@link xhtml.impl.LinkTypeImpl#getStyle <em>Style</em>}</li>
 *   <li>{@link xhtml.impl.LinkTypeImpl#getTitle <em>Title</em>}</li>
 *   <li>{@link xhtml.impl.LinkTypeImpl#getType <em>Type</em>}</li>
 * </ul>
 *
 * @generated
 */
