 ...
 * </p>
 * <ul>
 *   <li>{@link xhtml.impl.LegendTypeImpl#getAccesskey <em>Accesskey</em>}</li>
 *   <li>{@link xhtml.impl.LegendTypeImpl#getClass_ <em>Class</em>}</li>
 *   <li>{@link xhtml.impl.LegendTypeImpl#getDir <em>Dir</em>}</li>
 *   <li>{@link xhtml.impl.LegendTypeImpl#getId <em>Id</em>}</li>
 *   <li>{@link xhtml.impl.LegendTypeImpl#getLang <em>Lang</em>}</li>
 *   <li>{@link xhtml.impl.LegendTypeImpl#getLang1 <em>Lang1</em>}</li>
 *   <li>{@link xhtml.impl.LegendTypeImpl#getOnclick <em>Onclick</em>}</li>
 *   <li>{@link xhtml.impl.LegendTypeImpl#getOndblclick <em>Ondblclick</em>}</li>
 *   <li>{@link xhtml.impl.LegendTypeImpl#getOnkeydown <em>Onkeydown</em>}</li>
 *   <li>{@link xhtml.impl.LegendTypeImpl#getOnkeypress <em>Onkeypress</em>}</li>
 *   <li>{@link xhtml.impl.LegendTypeImpl#getOnkeyup <em>Onkeyup</em>}</li>
 *   <li>{@link xhtml.impl.LegendTypeImpl#getOnmousedown <em>Onmousedown</em>}</li>
 *   <li>{@link xhtml.impl.LegendTypeImpl#getOnmousemove <em>Onmousemove</em>}</li>
 *   <li>{@link xhtml.impl.LegendTypeImpl#getOnmouseout <em>Onmouseout</em>}</li>
 *   <li>{@link xhtml.impl.LegendTypeImpl#getOnmouseover <em>Onmouseover</em>}</li>
 *   <li>{@link xhtml.impl.LegendTypeImpl#getOnmouseup <em>Onmouseup</em>}</li>
 *   <li>{@link xhtml.impl.LegendTypeImpl#getStyle <em>Style</em>}</li>
 *   <li>{@link xhtml.impl.LegendTypeImpl#getTitle <em>Title</em>}</li>
 * </ul>
 *
 * @generated
 */
