 ...
 * </p>
 * <ul>
 *   <li>{@link xhtml.impl.TheadTypeImpl#getTr <em>Tr</em>}</li>
 *   <li>{@link xhtml.impl.TheadTypeImpl#getAlign <em>Align</em>}</li>
 *   <li>{@link xhtml.impl.TheadTypeImpl#getChar <em>Char</em>}</li>
 *   <li>{@link xhtml.impl.TheadTypeImpl#getCharoff <em>Charoff</em>}</li>
 *   <li>{@link xhtml.impl.TheadTypeImpl#getClass_ <em>Class</em>}</li>
 *   <li>{@link xhtml.impl.TheadTypeImpl#getDir <em>Dir</em>}</li>
 *   <li>{@link xhtml.impl.TheadTypeImpl#getId <em>Id</em>}</li>
 *   <li>{@link xhtml.impl.TheadTypeImpl#getLang <em>Lang</em>}</li>
 *   <li>{@link xhtml.impl.TheadTypeImpl#getLang1 <em>Lang1</em>}</li>
 *   <li>{@link xhtml.impl.TheadTypeImpl#getOnclick <em>Onclick</em>}</li>
 *   <li>{@link xhtml.impl.TheadTypeImpl#getOndblclick <em>Ondblclick</em>}</li>
 *   <li>{@link xhtml.impl.TheadTypeImpl#getOnkeydown <em>Onkeydown</em>}</li>
 *   <li>{@link xhtml.impl.TheadTypeImpl#getOnkeypress <em>Onkeypress</em>}</li>
 *   <li>{@link xhtml.impl.TheadTypeImpl#getOnkeyup <em>Onkeyup</em>}</li>
 *   <li>{@link xhtml.impl.TheadTypeImpl#getOnmousedown <em>Onmousedown</em>}</li>
 *   <li>{@link xhtml.impl.TheadTypeImpl#getOnmousemove <em>Onmousemove</em>}</li>
 *   <li>{@link xhtml.impl.TheadTypeImpl#getOnmouseout <em>Onmouseout</em>}</li>
 *   <li>{@link xhtml.impl.TheadTypeImpl#getOnmouseover <em>Onmouseover</em>}</li>
 *   <li>{@link xhtml.impl.TheadTypeImpl#getOnmouseup <em>Onmouseup</em>}</li>
 *   <li>{@link xhtml.impl.TheadTypeImpl#getStyle <em>Style</em>}</li>
 *   <li>{@link xhtml.impl.TheadTypeImpl#getTitle <em>Title</em>}</li>
 *   <li>{@link xhtml.impl.TheadTypeImpl#getValign <em>Valign</em>}</li>
 * </ul>
 *
 * @generated
 */
