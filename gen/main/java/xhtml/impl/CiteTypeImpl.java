 ...
 * </p>
 * <ul>
 *   <li>{@link xhtml.impl.CiteTypeImpl#getClass_ <em>Class</em>}</li>
 *   <li>{@link xhtml.impl.CiteTypeImpl#getDir <em>Dir</em>}</li>
 *   <li>{@link xhtml.impl.CiteTypeImpl#getId <em>Id</em>}</li>
 *   <li>{@link xhtml.impl.CiteTypeImpl#getLang <em>Lang</em>}</li>
 *   <li>{@link xhtml.impl.CiteTypeImpl#getLang1 <em>Lang1</em>}</li>
 *   <li>{@link xhtml.impl.CiteTypeImpl#getOnclick <em>Onclick</em>}</li>
 *   <li>{@link xhtml.impl.CiteTypeImpl#getOndblclick <em>Ondblclick</em>}</li>
 *   <li>{@link xhtml.impl.CiteTypeImpl#getOnkeydown <em>Onkeydown</em>}</li>
 *   <li>{@link xhtml.impl.CiteTypeImpl#getOnkeypress <em>Onkeypress</em>}</li>
 *   <li>{@link xhtml.impl.CiteTypeImpl#getOnkeyup <em>Onkeyup</em>}</li>
 *   <li>{@link xhtml.impl.CiteTypeImpl#getOnmousedown <em>Onmousedown</em>}</li>
 *   <li>{@link xhtml.impl.CiteTypeImpl#getOnmousemove <em>Onmousemove</em>}</li>
 *   <li>{@link xhtml.impl.CiteTypeImpl#getOnmouseout <em>Onmouseout</em>}</li>
 *   <li>{@link xhtml.impl.CiteTypeImpl#getOnmouseover <em>Onmouseover</em>}</li>
 *   <li>{@link xhtml.impl.CiteTypeImpl#getOnmouseup <em>Onmouseup</em>}</li>
 *   <li>{@link xhtml.impl.CiteTypeImpl#getStyle <em>Style</em>}</li>
 *   <li>{@link xhtml.impl.CiteTypeImpl#getTitle <em>Title</em>}</li>
 * </ul>
 *
 * @generated
 */
