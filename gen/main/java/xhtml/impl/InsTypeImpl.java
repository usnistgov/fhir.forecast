 ...
 * </p>
 * <ul>
 *   <li>{@link xhtml.impl.InsTypeImpl#getCite1 <em>Cite1</em>}</li>
 *   <li>{@link xhtml.impl.InsTypeImpl#getClass_ <em>Class</em>}</li>
 *   <li>{@link xhtml.impl.InsTypeImpl#getDatetime <em>Datetime</em>}</li>
 *   <li>{@link xhtml.impl.InsTypeImpl#getDir <em>Dir</em>}</li>
 *   <li>{@link xhtml.impl.InsTypeImpl#getId <em>Id</em>}</li>
 *   <li>{@link xhtml.impl.InsTypeImpl#getLang <em>Lang</em>}</li>
 *   <li>{@link xhtml.impl.InsTypeImpl#getLang1 <em>Lang1</em>}</li>
 *   <li>{@link xhtml.impl.InsTypeImpl#getOnclick <em>Onclick</em>}</li>
 *   <li>{@link xhtml.impl.InsTypeImpl#getOndblclick <em>Ondblclick</em>}</li>
 *   <li>{@link xhtml.impl.InsTypeImpl#getOnkeydown <em>Onkeydown</em>}</li>
 *   <li>{@link xhtml.impl.InsTypeImpl#getOnkeypress <em>Onkeypress</em>}</li>
 *   <li>{@link xhtml.impl.InsTypeImpl#getOnkeyup <em>Onkeyup</em>}</li>
 *   <li>{@link xhtml.impl.InsTypeImpl#getOnmousedown <em>Onmousedown</em>}</li>
 *   <li>{@link xhtml.impl.InsTypeImpl#getOnmousemove <em>Onmousemove</em>}</li>
 *   <li>{@link xhtml.impl.InsTypeImpl#getOnmouseout <em>Onmouseout</em>}</li>
 *   <li>{@link xhtml.impl.InsTypeImpl#getOnmouseover <em>Onmouseover</em>}</li>
 *   <li>{@link xhtml.impl.InsTypeImpl#getOnmouseup <em>Onmouseup</em>}</li>
 *   <li>{@link xhtml.impl.InsTypeImpl#getStyle <em>Style</em>}</li>
 *   <li>{@link xhtml.impl.InsTypeImpl#getTitle <em>Title</em>}</li>
 * </ul>
 *
 * @generated
 */
