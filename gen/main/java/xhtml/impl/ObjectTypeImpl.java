...
import xhtml.DeclareType;
import xhtml.DelType;
import xhtml.DfnType;
import xhtml.DirType;
 ...
 * </p>
 * <ul>
 *   <li>{@link xhtml.impl.ObjectTypeImpl#getMixed <em>Mixed</em>}</li>
 *   <li>{@link xhtml.impl.ObjectTypeImpl#getGroup <em>Group</em>}</li>
 *   <li>{@link xhtml.impl.ObjectTypeImpl#getParam <em>Param</em>}</li>
 *   <li>{@link xhtml.impl.ObjectTypeImpl#getP <em>P</em>}</li>
 *   <li>{@link xhtml.impl.ObjectTypeImpl#getH1 <em>H1</em>}</li>
 *   <li>{@link xhtml.impl.ObjectTypeImpl#getH2 <em>H2</em>}</li>
 *   <li>{@link xhtml.impl.ObjectTypeImpl#getH3 <em>H3</em>}</li>
 *   <li>{@link xhtml.impl.ObjectTypeImpl#getH4 <em>H4</em>}</li>
 *   <li>{@link xhtml.impl.ObjectTypeImpl#getH5 <em>H5</em>}</li>
 *   <li>{@link xhtml.impl.ObjectTypeImpl#getH6 <em>H6</em>}</li>
 *   <li>{@link xhtml.impl.ObjectTypeImpl#getDiv <em>Div</em>}</li>
 *   <li>{@link xhtml.impl.ObjectTypeImpl#getUl <em>Ul</em>}</li>
 *   <li>{@link xhtml.impl.ObjectTypeImpl#getOl <em>Ol</em>}</li>
 *   <li>{@link xhtml.impl.ObjectTypeImpl#getDl <em>Dl</em>}</li>
 *   <li>{@link xhtml.impl.ObjectTypeImpl#getPre <em>Pre</em>}</li>
 *   <li>{@link xhtml.impl.ObjectTypeImpl#getHr <em>Hr</em>}</li>
 *   <li>{@link xhtml.impl.ObjectTypeImpl#getBlockquote <em>Blockquote</em>}</li>
 *   <li>{@link xhtml.impl.ObjectTypeImpl#getAddress <em>Address</em>}</li>
 *   <li>{@link xhtml.impl.ObjectTypeImpl#getFieldset <em>Fieldset</em>}</li>
 *   <li>{@link xhtml.impl.ObjectTypeImpl#getTable <em>Table</em>}</li>
 *   <li>{@link xhtml.impl.ObjectTypeImpl#getForm <em>Form</em>}</li>
 *   <li>{@link xhtml.impl.ObjectTypeImpl#getA <em>A</em>}</li>
 *   <li>{@link xhtml.impl.ObjectTypeImpl#getBr <em>Br</em>}</li>
 *   <li>{@link xhtml.impl.ObjectTypeImpl#getSpan <em>Span</em>}</li>
 *   <li>{@link xhtml.impl.ObjectTypeImpl#getBdo <em>Bdo</em>}</li>
 *   <li>{@link xhtml.impl.ObjectTypeImpl#getMap <em>Map</em>}</li>
 *   <li>{@link xhtml.impl.ObjectTypeImpl#getObject <em>Object</em>}</li>
 *   <li>{@link xhtml.impl.ObjectTypeImpl#getImg <em>Img</em>}</li>
 *   <li>{@link xhtml.impl.ObjectTypeImpl#getTt <em>Tt</em>}</li>
 *   <li>{@link xhtml.impl.ObjectTypeImpl#getI <em>I</em>}</li>
 *   <li>{@link xhtml.impl.ObjectTypeImpl#getB <em>B</em>}</li>
 *   <li>{@link xhtml.impl.ObjectTypeImpl#getBig <em>Big</em>}</li>
 *   <li>{@link xhtml.impl.ObjectTypeImpl#getSmall <em>Small</em>}</li>
 *   <li>{@link xhtml.impl.ObjectTypeImpl#getEm <em>Em</em>}</li>
 *   <li>{@link xhtml.impl.ObjectTypeImpl#getStrong <em>Strong</em>}</li>
 *   <li>{@link xhtml.impl.ObjectTypeImpl#getDfn <em>Dfn</em>}</li>
 *   <li>{@link xhtml.impl.ObjectTypeImpl#getCode <em>Code</em>}</li>
 *   <li>{@link xhtml.impl.ObjectTypeImpl#getQ <em>Q</em>}</li>
 *   <li>{@link xhtml.impl.ObjectTypeImpl#getSamp <em>Samp</em>}</li>
 *   <li>{@link xhtml.impl.ObjectTypeImpl#getKbd <em>Kbd</em>}</li>
 *   <li>{@link xhtml.impl.ObjectTypeImpl#getVar <em>Var</em>}</li>
 *   <li>{@link xhtml.impl.ObjectTypeImpl#getCite <em>Cite</em>}</li>
 *   <li>{@link xhtml.impl.ObjectTypeImpl#getAbbr <em>Abbr</em>}</li>
 *   <li>{@link xhtml.impl.ObjectTypeImpl#getAcronym <em>Acronym</em>}</li>
 *   <li>{@link xhtml.impl.ObjectTypeImpl#getSub <em>Sub</em>}</li>
 *   <li>{@link xhtml.impl.ObjectTypeImpl#getSup <em>Sup</em>}</li>
 *   <li>{@link xhtml.impl.ObjectTypeImpl#getInput <em>Input</em>}</li>
 *   <li>{@link xhtml.impl.ObjectTypeImpl#getSelect <em>Select</em>}</li>
 *   <li>{@link xhtml.impl.ObjectTypeImpl#getTextarea <em>Textarea</em>}</li>
 *   <li>{@link xhtml.impl.ObjectTypeImpl#getLabel <em>Label</em>}</li>
 *   <li>{@link xhtml.impl.ObjectTypeImpl#getButton <em>Button</em>}</li>
 *   <li>{@link xhtml.impl.ObjectTypeImpl#getNoscript <em>Noscript</em>}</li>
 *   <li>{@link xhtml.impl.ObjectTypeImpl#getIns <em>Ins</em>}</li>
 *   <li>{@link xhtml.impl.ObjectTypeImpl#getDel <em>Del</em>}</li>
 *   <li>{@link xhtml.impl.ObjectTypeImpl#getScript <em>Script</em>}</li>
 *   <li>{@link xhtml.impl.ObjectTypeImpl#getArchive <em>Archive</em>}</li>
 *   <li>{@link xhtml.impl.ObjectTypeImpl#getClass_ <em>Class</em>}</li>
 *   <li>{@link xhtml.impl.ObjectTypeImpl#getClassid <em>Classid</em>}</li>
 *   <li>{@link xhtml.impl.ObjectTypeImpl#getCodebase <em>Codebase</em>}</li>
 *   <li>{@link xhtml.impl.ObjectTypeImpl#getCodetype <em>Codetype</em>}</li>
 *   <li>{@link xhtml.impl.ObjectTypeImpl#getData <em>Data</em>}</li>
 *   <li>{@link xhtml.impl.ObjectTypeImpl#getDeclare <em>Declare</em>}</li>
 *   <li>{@link xhtml.impl.ObjectTypeImpl#getDir <em>Dir</em>}</li>
 *   <li>{@link xhtml.impl.ObjectTypeImpl#getHeight <em>Height</em>}</li>
 *   <li>{@link xhtml.impl.ObjectTypeImpl#getId <em>Id</em>}</li>
 *   <li>{@link xhtml.impl.ObjectTypeImpl#getLang <em>Lang</em>}</li>
 *   <li>{@link xhtml.impl.ObjectTypeImpl#getLang1 <em>Lang1</em>}</li>
 *   <li>{@link xhtml.impl.ObjectTypeImpl#getName <em>Name</em>}</li>
 *   <li>{@link xhtml.impl.ObjectTypeImpl#getOnclick <em>Onclick</em>}</li>
 *   <li>{@link xhtml.impl.ObjectTypeImpl#getOndblclick <em>Ondblclick</em>}</li>
 *   <li>{@link xhtml.impl.ObjectTypeImpl#getOnkeydown <em>Onkeydown</em>}</li>
 *   <li>{@link xhtml.impl.ObjectTypeImpl#getOnkeypress <em>Onkeypress</em>}</li>
 *   <li>{@link xhtml.impl.ObjectTypeImpl#getOnkeyup <em>Onkeyup</em>}</li>
 *   <li>{@link xhtml.impl.ObjectTypeImpl#getOnmousedown <em>Onmousedown</em>}</li>
 *   <li>{@link xhtml.impl.ObjectTypeImpl#getOnmousemove <em>Onmousemove</em>}</li>
 *   <li>{@link xhtml.impl.ObjectTypeImpl#getOnmouseout <em>Onmouseout</em>}</li>
 *   <li>{@link xhtml.impl.ObjectTypeImpl#getOnmouseover <em>Onmouseover</em>}</li>
 *   <li>{@link xhtml.impl.ObjectTypeImpl#getOnmouseup <em>Onmouseup</em>}</li>
 *   <li>{@link xhtml.impl.ObjectTypeImpl#getStandby <em>Standby</em>}</li>
 *   <li>{@link xhtml.impl.ObjectTypeImpl#getStyle <em>Style</em>}</li>
 *   <li>{@link xhtml.impl.ObjectTypeImpl#getTabindex <em>Tabindex</em>}</li>
 *   <li>{@link xhtml.impl.ObjectTypeImpl#getTitle <em>Title</em>}</li>
 *   <li>{@link xhtml.impl.ObjectTypeImpl#getType <em>Type</em>}</li>
 *   <li>{@link xhtml.impl.ObjectTypeImpl#getUsemap <em>Usemap</em>}</li>
 *   <li>{@link xhtml.impl.ObjectTypeImpl#getWidth <em>Width</em>}</li>
 * </ul>
 *
 * @generated
 */
