 ...
 * </p>
 * <ul>
 *   <li>{@link xhtml.impl.BodyTypeImpl#getClass_ <em>Class</em>}</li>
 *   <li>{@link xhtml.impl.BodyTypeImpl#getDir <em>Dir</em>}</li>
 *   <li>{@link xhtml.impl.BodyTypeImpl#getId <em>Id</em>}</li>
 *   <li>{@link xhtml.impl.BodyTypeImpl#getLang <em>Lang</em>}</li>
 *   <li>{@link xhtml.impl.BodyTypeImpl#getLang1 <em>Lang1</em>}</li>
 *   <li>{@link xhtml.impl.BodyTypeImpl#getOnclick <em>Onclick</em>}</li>
 *   <li>{@link xhtml.impl.BodyTypeImpl#getOndblclick <em>Ondblclick</em>}</li>
 *   <li>{@link xhtml.impl.BodyTypeImpl#getOnkeydown <em>Onkeydown</em>}</li>
 *   <li>{@link xhtml.impl.BodyTypeImpl#getOnkeypress <em>Onkeypress</em>}</li>
 *   <li>{@link xhtml.impl.BodyTypeImpl#getOnkeyup <em>Onkeyup</em>}</li>
 *   <li>{@link xhtml.impl.BodyTypeImpl#getOnload <em>Onload</em>}</li>
 *   <li>{@link xhtml.impl.BodyTypeImpl#getOnmousedown <em>Onmousedown</em>}</li>
 *   <li>{@link xhtml.impl.BodyTypeImpl#getOnmousemove <em>Onmousemove</em>}</li>
 *   <li>{@link xhtml.impl.BodyTypeImpl#getOnmouseout <em>Onmouseout</em>}</li>
 *   <li>{@link xhtml.impl.BodyTypeImpl#getOnmouseover <em>Onmouseover</em>}</li>
 *   <li>{@link xhtml.impl.BodyTypeImpl#getOnmouseup <em>Onmouseup</em>}</li>
 *   <li>{@link xhtml.impl.BodyTypeImpl#getOnunload <em>Onunload</em>}</li>
 *   <li>{@link xhtml.impl.BodyTypeImpl#getStyle <em>Style</em>}</li>
 *   <li>{@link xhtml.impl.BodyTypeImpl#getTitle <em>Title</em>}</li>
 * </ul>
 *
 * @generated
 */
