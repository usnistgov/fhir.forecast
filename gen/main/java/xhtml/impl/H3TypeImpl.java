 ...
 * </p>
 * <ul>
 *   <li>{@link xhtml.impl.H3TypeImpl#getClass_ <em>Class</em>}</li>
 *   <li>{@link xhtml.impl.H3TypeImpl#getDir <em>Dir</em>}</li>
 *   <li>{@link xhtml.impl.H3TypeImpl#getId <em>Id</em>}</li>
 *   <li>{@link xhtml.impl.H3TypeImpl#getLang <em>Lang</em>}</li>
 *   <li>{@link xhtml.impl.H3TypeImpl#getLang1 <em>Lang1</em>}</li>
 *   <li>{@link xhtml.impl.H3TypeImpl#getOnclick <em>Onclick</em>}</li>
 *   <li>{@link xhtml.impl.H3TypeImpl#getOndblclick <em>Ondblclick</em>}</li>
 *   <li>{@link xhtml.impl.H3TypeImpl#getOnkeydown <em>Onkeydown</em>}</li>
 *   <li>{@link xhtml.impl.H3TypeImpl#getOnkeypress <em>Onkeypress</em>}</li>
 *   <li>{@link xhtml.impl.H3TypeImpl#getOnkeyup <em>Onkeyup</em>}</li>
 *   <li>{@link xhtml.impl.H3TypeImpl#getOnmousedown <em>Onmousedown</em>}</li>
 *   <li>{@link xhtml.impl.H3TypeImpl#getOnmousemove <em>Onmousemove</em>}</li>
 *   <li>{@link xhtml.impl.H3TypeImpl#getOnmouseout <em>Onmouseout</em>}</li>
 *   <li>{@link xhtml.impl.H3TypeImpl#getOnmouseover <em>Onmouseover</em>}</li>
 *   <li>{@link xhtml.impl.H3TypeImpl#getOnmouseup <em>Onmouseup</em>}</li>
 *   <li>{@link xhtml.impl.H3TypeImpl#getStyle <em>Style</em>}</li>
 *   <li>{@link xhtml.impl.H3TypeImpl#getTitle <em>Title</em>}</li>
 * </ul>
 *
 * @generated
 */
