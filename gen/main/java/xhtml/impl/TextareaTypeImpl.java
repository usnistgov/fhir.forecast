...
import xhtml.DisabledType;
import xhtml.ReadonlyType;
 ...
 * </p>
 * <ul>
 *   <li>{@link xhtml.impl.TextareaTypeImpl#getMixed <em>Mixed</em>}</li>
 *   <li>{@link xhtml.impl.TextareaTypeImpl#getAccesskey <em>Accesskey</em>}</li>
 *   <li>{@link xhtml.impl.TextareaTypeImpl#getClass_ <em>Class</em>}</li>
 *   <li>{@link xhtml.impl.TextareaTypeImpl#getCols <em>Cols</em>}</li>
 *   <li>{@link xhtml.impl.TextareaTypeImpl#getDir <em>Dir</em>}</li>
 *   <li>{@link xhtml.impl.TextareaTypeImpl#getDisabled <em>Disabled</em>}</li>
 *   <li>{@link xhtml.impl.TextareaTypeImpl#getId <em>Id</em>}</li>
 *   <li>{@link xhtml.impl.TextareaTypeImpl#getLang <em>Lang</em>}</li>
 *   <li>{@link xhtml.impl.TextareaTypeImpl#getLang1 <em>Lang1</em>}</li>
 *   <li>{@link xhtml.impl.TextareaTypeImpl#getName <em>Name</em>}</li>
 *   <li>{@link xhtml.impl.TextareaTypeImpl#getOnblur <em>Onblur</em>}</li>
 *   <li>{@link xhtml.impl.TextareaTypeImpl#getOnchange <em>Onchange</em>}</li>
 *   <li>{@link xhtml.impl.TextareaTypeImpl#getOnclick <em>Onclick</em>}</li>
 *   <li>{@link xhtml.impl.TextareaTypeImpl#getOndblclick <em>Ondblclick</em>}</li>
 *   <li>{@link xhtml.impl.TextareaTypeImpl#getOnfocus <em>Onfocus</em>}</li>
 *   <li>{@link xhtml.impl.TextareaTypeImpl#getOnkeydown <em>Onkeydown</em>}</li>
 *   <li>{@link xhtml.impl.TextareaTypeImpl#getOnkeypress <em>Onkeypress</em>}</li>
 *   <li>{@link xhtml.impl.TextareaTypeImpl#getOnkeyup <em>Onkeyup</em>}</li>
 *   <li>{@link xhtml.impl.TextareaTypeImpl#getOnmousedown <em>Onmousedown</em>}</li>
 *   <li>{@link xhtml.impl.TextareaTypeImpl#getOnmousemove <em>Onmousemove</em>}</li>
 *   <li>{@link xhtml.impl.TextareaTypeImpl#getOnmouseout <em>Onmouseout</em>}</li>
 *   <li>{@link xhtml.impl.TextareaTypeImpl#getOnmouseover <em>Onmouseover</em>}</li>
 *   <li>{@link xhtml.impl.TextareaTypeImpl#getOnmouseup <em>Onmouseup</em>}</li>
 *   <li>{@link xhtml.impl.TextareaTypeImpl#getOnselect <em>Onselect</em>}</li>
 *   <li>{@link xhtml.impl.TextareaTypeImpl#getReadonly <em>Readonly</em>}</li>
 *   <li>{@link xhtml.impl.TextareaTypeImpl#getRows <em>Rows</em>}</li>
 *   <li>{@link xhtml.impl.TextareaTypeImpl#getStyle <em>Style</em>}</li>
 *   <li>{@link xhtml.impl.TextareaTypeImpl#getTabindex <em>Tabindex</em>}</li>
 *   <li>{@link xhtml.impl.TextareaTypeImpl#getTitle <em>Title</em>}</li>
 * </ul>
 *
 * @generated
 */
