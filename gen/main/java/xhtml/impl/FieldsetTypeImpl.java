 ...
 * </p>
 * <ul>
 *   <li>{@link xhtml.impl.FieldsetTypeImpl#getMixed <em>Mixed</em>}</li>
 *   <li>{@link xhtml.impl.FieldsetTypeImpl#getLegend <em>Legend</em>}</li>
 *   <li>{@link xhtml.impl.FieldsetTypeImpl#getGroup <em>Group</em>}</li>
 *   <li>{@link xhtml.impl.FieldsetTypeImpl#getP <em>P</em>}</li>
 *   <li>{@link xhtml.impl.FieldsetTypeImpl#getH1 <em>H1</em>}</li>
 *   <li>{@link xhtml.impl.FieldsetTypeImpl#getH2 <em>H2</em>}</li>
 *   <li>{@link xhtml.impl.FieldsetTypeImpl#getH3 <em>H3</em>}</li>
 *   <li>{@link xhtml.impl.FieldsetTypeImpl#getH4 <em>H4</em>}</li>
 *   <li>{@link xhtml.impl.FieldsetTypeImpl#getH5 <em>H5</em>}</li>
 *   <li>{@link xhtml.impl.FieldsetTypeImpl#getH6 <em>H6</em>}</li>
 *   <li>{@link xhtml.impl.FieldsetTypeImpl#getDiv <em>Div</em>}</li>
 *   <li>{@link xhtml.impl.FieldsetTypeImpl#getUl <em>Ul</em>}</li>
 *   <li>{@link xhtml.impl.FieldsetTypeImpl#getOl <em>Ol</em>}</li>
 *   <li>{@link xhtml.impl.FieldsetTypeImpl#getDl <em>Dl</em>}</li>
 *   <li>{@link xhtml.impl.FieldsetTypeImpl#getPre <em>Pre</em>}</li>
 *   <li>{@link xhtml.impl.FieldsetTypeImpl#getHr <em>Hr</em>}</li>
 *   <li>{@link xhtml.impl.FieldsetTypeImpl#getBlockquote <em>Blockquote</em>}</li>
 *   <li>{@link xhtml.impl.FieldsetTypeImpl#getAddress <em>Address</em>}</li>
 *   <li>{@link xhtml.impl.FieldsetTypeImpl#getFieldset <em>Fieldset</em>}</li>
 *   <li>{@link xhtml.impl.FieldsetTypeImpl#getTable <em>Table</em>}</li>
 *   <li>{@link xhtml.impl.FieldsetTypeImpl#getForm <em>Form</em>}</li>
 *   <li>{@link xhtml.impl.FieldsetTypeImpl#getA <em>A</em>}</li>
 *   <li>{@link xhtml.impl.FieldsetTypeImpl#getBr <em>Br</em>}</li>
 *   <li>{@link xhtml.impl.FieldsetTypeImpl#getSpan <em>Span</em>}</li>
 *   <li>{@link xhtml.impl.FieldsetTypeImpl#getBdo <em>Bdo</em>}</li>
 *   <li>{@link xhtml.impl.FieldsetTypeImpl#getMap <em>Map</em>}</li>
 *   <li>{@link xhtml.impl.FieldsetTypeImpl#getObject <em>Object</em>}</li>
 *   <li>{@link xhtml.impl.FieldsetTypeImpl#getImg <em>Img</em>}</li>
 *   <li>{@link xhtml.impl.FieldsetTypeImpl#getTt <em>Tt</em>}</li>
 *   <li>{@link xhtml.impl.FieldsetTypeImpl#getI <em>I</em>}</li>
 *   <li>{@link xhtml.impl.FieldsetTypeImpl#getB <em>B</em>}</li>
 *   <li>{@link xhtml.impl.FieldsetTypeImpl#getBig <em>Big</em>}</li>
 *   <li>{@link xhtml.impl.FieldsetTypeImpl#getSmall <em>Small</em>}</li>
 *   <li>{@link xhtml.impl.FieldsetTypeImpl#getEm <em>Em</em>}</li>
 *   <li>{@link xhtml.impl.FieldsetTypeImpl#getStrong <em>Strong</em>}</li>
 *   <li>{@link xhtml.impl.FieldsetTypeImpl#getDfn <em>Dfn</em>}</li>
 *   <li>{@link xhtml.impl.FieldsetTypeImpl#getCode <em>Code</em>}</li>
 *   <li>{@link xhtml.impl.FieldsetTypeImpl#getQ <em>Q</em>}</li>
 *   <li>{@link xhtml.impl.FieldsetTypeImpl#getSamp <em>Samp</em>}</li>
 *   <li>{@link xhtml.impl.FieldsetTypeImpl#getKbd <em>Kbd</em>}</li>
 *   <li>{@link xhtml.impl.FieldsetTypeImpl#getVar <em>Var</em>}</li>
 *   <li>{@link xhtml.impl.FieldsetTypeImpl#getCite <em>Cite</em>}</li>
 *   <li>{@link xhtml.impl.FieldsetTypeImpl#getAbbr <em>Abbr</em>}</li>
 *   <li>{@link xhtml.impl.FieldsetTypeImpl#getAcronym <em>Acronym</em>}</li>
 *   <li>{@link xhtml.impl.FieldsetTypeImpl#getSub <em>Sub</em>}</li>
 *   <li>{@link xhtml.impl.FieldsetTypeImpl#getSup <em>Sup</em>}</li>
 *   <li>{@link xhtml.impl.FieldsetTypeImpl#getInput <em>Input</em>}</li>
 *   <li>{@link xhtml.impl.FieldsetTypeImpl#getSelect <em>Select</em>}</li>
 *   <li>{@link xhtml.impl.FieldsetTypeImpl#getTextarea <em>Textarea</em>}</li>
 *   <li>{@link xhtml.impl.FieldsetTypeImpl#getLabel <em>Label</em>}</li>
 *   <li>{@link xhtml.impl.FieldsetTypeImpl#getButton <em>Button</em>}</li>
 *   <li>{@link xhtml.impl.FieldsetTypeImpl#getNoscript <em>Noscript</em>}</li>
 *   <li>{@link xhtml.impl.FieldsetTypeImpl#getIns <em>Ins</em>}</li>
 *   <li>{@link xhtml.impl.FieldsetTypeImpl#getDel <em>Del</em>}</li>
 *   <li>{@link xhtml.impl.FieldsetTypeImpl#getScript <em>Script</em>}</li>
 *   <li>{@link xhtml.impl.FieldsetTypeImpl#getClass_ <em>Class</em>}</li>
 *   <li>{@link xhtml.impl.FieldsetTypeImpl#getDir <em>Dir</em>}</li>
 *   <li>{@link xhtml.impl.FieldsetTypeImpl#getId <em>Id</em>}</li>
 *   <li>{@link xhtml.impl.FieldsetTypeImpl#getLang <em>Lang</em>}</li>
 *   <li>{@link xhtml.impl.FieldsetTypeImpl#getLang1 <em>Lang1</em>}</li>
 *   <li>{@link xhtml.impl.FieldsetTypeImpl#getOnclick <em>Onclick</em>}</li>
 *   <li>{@link xhtml.impl.FieldsetTypeImpl#getOndblclick <em>Ondblclick</em>}</li>
 *   <li>{@link xhtml.impl.FieldsetTypeImpl#getOnkeydown <em>Onkeydown</em>}</li>
 *   <li>{@link xhtml.impl.FieldsetTypeImpl#getOnkeypress <em>Onkeypress</em>}</li>
 *   <li>{@link xhtml.impl.FieldsetTypeImpl#getOnkeyup <em>Onkeyup</em>}</li>
 *   <li>{@link xhtml.impl.FieldsetTypeImpl#getOnmousedown <em>Onmousedown</em>}</li>
 *   <li>{@link xhtml.impl.FieldsetTypeImpl#getOnmousemove <em>Onmousemove</em>}</li>
 *   <li>{@link xhtml.impl.FieldsetTypeImpl#getOnmouseout <em>Onmouseout</em>}</li>
 *   <li>{@link xhtml.impl.FieldsetTypeImpl#getOnmouseover <em>Onmouseover</em>}</li>
 *   <li>{@link xhtml.impl.FieldsetTypeImpl#getOnmouseup <em>Onmouseup</em>}</li>
 *   <li>{@link xhtml.impl.FieldsetTypeImpl#getStyle <em>Style</em>}</li>
 *   <li>{@link xhtml.impl.FieldsetTypeImpl#getTitle <em>Title</em>}</li>
 * </ul>
 *
 * @generated
 */
