 ...
 * </p>
 * <ul>
 *   <li>{@link xhtml.impl.UlTypeImpl#getLi <em>Li</em>}</li>
 *   <li>{@link xhtml.impl.UlTypeImpl#getClass_ <em>Class</em>}</li>
 *   <li>{@link xhtml.impl.UlTypeImpl#getDir <em>Dir</em>}</li>
 *   <li>{@link xhtml.impl.UlTypeImpl#getId <em>Id</em>}</li>
 *   <li>{@link xhtml.impl.UlTypeImpl#getLang <em>Lang</em>}</li>
 *   <li>{@link xhtml.impl.UlTypeImpl#getLang1 <em>Lang1</em>}</li>
 *   <li>{@link xhtml.impl.UlTypeImpl#getOnclick <em>Onclick</em>}</li>
 *   <li>{@link xhtml.impl.UlTypeImpl#getOndblclick <em>Ondblclick</em>}</li>
 *   <li>{@link xhtml.impl.UlTypeImpl#getOnkeydown <em>Onkeydown</em>}</li>
 *   <li>{@link xhtml.impl.UlTypeImpl#getOnkeypress <em>Onkeypress</em>}</li>
 *   <li>{@link xhtml.impl.UlTypeImpl#getOnkeyup <em>Onkeyup</em>}</li>
 *   <li>{@link xhtml.impl.UlTypeImpl#getOnmousedown <em>Onmousedown</em>}</li>
 *   <li>{@link xhtml.impl.UlTypeImpl#getOnmousemove <em>Onmousemove</em>}</li>
 *   <li>{@link xhtml.impl.UlTypeImpl#getOnmouseout <em>Onmouseout</em>}</li>
 *   <li>{@link xhtml.impl.UlTypeImpl#getOnmouseover <em>Onmouseover</em>}</li>
 *   <li>{@link xhtml.impl.UlTypeImpl#getOnmouseup <em>Onmouseup</em>}</li>
 *   <li>{@link xhtml.impl.UlTypeImpl#getStyle <em>Style</em>}</li>
 *   <li>{@link xhtml.impl.UlTypeImpl#getTitle <em>Title</em>}</li>
 * </ul>
 *
 * @generated
 */
