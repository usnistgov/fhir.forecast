 ...
 * </p>
 * <ul>
 *   <li>{@link xhtml.impl.ColTypeImpl#getAlign <em>Align</em>}</li>
 *   <li>{@link xhtml.impl.ColTypeImpl#getChar <em>Char</em>}</li>
 *   <li>{@link xhtml.impl.ColTypeImpl#getCharoff <em>Charoff</em>}</li>
 *   <li>{@link xhtml.impl.ColTypeImpl#getClass_ <em>Class</em>}</li>
 *   <li>{@link xhtml.impl.ColTypeImpl#getDir <em>Dir</em>}</li>
 *   <li>{@link xhtml.impl.ColTypeImpl#getId <em>Id</em>}</li>
 *   <li>{@link xhtml.impl.ColTypeImpl#getLang <em>Lang</em>}</li>
 *   <li>{@link xhtml.impl.ColTypeImpl#getLang1 <em>Lang1</em>}</li>
 *   <li>{@link xhtml.impl.ColTypeImpl#getOnclick <em>Onclick</em>}</li>
 *   <li>{@link xhtml.impl.ColTypeImpl#getOndblclick <em>Ondblclick</em>}</li>
 *   <li>{@link xhtml.impl.ColTypeImpl#getOnkeydown <em>Onkeydown</em>}</li>
 *   <li>{@link xhtml.impl.ColTypeImpl#getOnkeypress <em>Onkeypress</em>}</li>
 *   <li>{@link xhtml.impl.ColTypeImpl#getOnkeyup <em>Onkeyup</em>}</li>
 *   <li>{@link xhtml.impl.ColTypeImpl#getOnmousedown <em>Onmousedown</em>}</li>
 *   <li>{@link xhtml.impl.ColTypeImpl#getOnmousemove <em>Onmousemove</em>}</li>
 *   <li>{@link xhtml.impl.ColTypeImpl#getOnmouseout <em>Onmouseout</em>}</li>
 *   <li>{@link xhtml.impl.ColTypeImpl#getOnmouseover <em>Onmouseover</em>}</li>
 *   <li>{@link xhtml.impl.ColTypeImpl#getOnmouseup <em>Onmouseup</em>}</li>
 *   <li>{@link xhtml.impl.ColTypeImpl#getSpan <em>Span</em>}</li>
 *   <li>{@link xhtml.impl.ColTypeImpl#getStyle <em>Style</em>}</li>
 *   <li>{@link xhtml.impl.ColTypeImpl#getTitle <em>Title</em>}</li>
 *   <li>{@link xhtml.impl.ColTypeImpl#getValign <em>Valign</em>}</li>
 *   <li>{@link xhtml.impl.ColTypeImpl#getWidth <em>Width</em>}</li>
 * </ul>
 *
 * @generated
 */
