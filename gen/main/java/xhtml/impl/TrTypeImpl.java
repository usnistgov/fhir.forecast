 ...
 * </p>
 * <ul>
 *   <li>{@link xhtml.impl.TrTypeImpl#getGroup <em>Group</em>}</li>
 *   <li>{@link xhtml.impl.TrTypeImpl#getTh <em>Th</em>}</li>
 *   <li>{@link xhtml.impl.TrTypeImpl#getTd <em>Td</em>}</li>
 *   <li>{@link xhtml.impl.TrTypeImpl#getAlign <em>Align</em>}</li>
 *   <li>{@link xhtml.impl.TrTypeImpl#getChar <em>Char</em>}</li>
 *   <li>{@link xhtml.impl.TrTypeImpl#getCharoff <em>Charoff</em>}</li>
 *   <li>{@link xhtml.impl.TrTypeImpl#getClass_ <em>Class</em>}</li>
 *   <li>{@link xhtml.impl.TrTypeImpl#getDir <em>Dir</em>}</li>
 *   <li>{@link xhtml.impl.TrTypeImpl#getId <em>Id</em>}</li>
 *   <li>{@link xhtml.impl.TrTypeImpl#getLang <em>Lang</em>}</li>
 *   <li>{@link xhtml.impl.TrTypeImpl#getLang1 <em>Lang1</em>}</li>
 *   <li>{@link xhtml.impl.TrTypeImpl#getOnclick <em>Onclick</em>}</li>
 *   <li>{@link xhtml.impl.TrTypeImpl#getOndblclick <em>Ondblclick</em>}</li>
 *   <li>{@link xhtml.impl.TrTypeImpl#getOnkeydown <em>Onkeydown</em>}</li>
 *   <li>{@link xhtml.impl.TrTypeImpl#getOnkeypress <em>Onkeypress</em>}</li>
 *   <li>{@link xhtml.impl.TrTypeImpl#getOnkeyup <em>Onkeyup</em>}</li>
 *   <li>{@link xhtml.impl.TrTypeImpl#getOnmousedown <em>Onmousedown</em>}</li>
 *   <li>{@link xhtml.impl.TrTypeImpl#getOnmousemove <em>Onmousemove</em>}</li>
 *   <li>{@link xhtml.impl.TrTypeImpl#getOnmouseout <em>Onmouseout</em>}</li>
 *   <li>{@link xhtml.impl.TrTypeImpl#getOnmouseover <em>Onmouseover</em>}</li>
 *   <li>{@link xhtml.impl.TrTypeImpl#getOnmouseup <em>Onmouseup</em>}</li>
 *   <li>{@link xhtml.impl.TrTypeImpl#getStyle <em>Style</em>}</li>
 *   <li>{@link xhtml.impl.TrTypeImpl#getTitle <em>Title</em>}</li>
 *   <li>{@link xhtml.impl.TrTypeImpl#getValign <em>Valign</em>}</li>
 * </ul>
 *
 * @generated
 */
