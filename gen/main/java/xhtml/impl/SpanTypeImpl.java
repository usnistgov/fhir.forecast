 ...
 * </p>
 * <ul>
 *   <li>{@link xhtml.impl.SpanTypeImpl#getClass_ <em>Class</em>}</li>
 *   <li>{@link xhtml.impl.SpanTypeImpl#getDir <em>Dir</em>}</li>
 *   <li>{@link xhtml.impl.SpanTypeImpl#getId <em>Id</em>}</li>
 *   <li>{@link xhtml.impl.SpanTypeImpl#getLang <em>Lang</em>}</li>
 *   <li>{@link xhtml.impl.SpanTypeImpl#getLang1 <em>Lang1</em>}</li>
 *   <li>{@link xhtml.impl.SpanTypeImpl#getOnclick <em>Onclick</em>}</li>
 *   <li>{@link xhtml.impl.SpanTypeImpl#getOndblclick <em>Ondblclick</em>}</li>
 *   <li>{@link xhtml.impl.SpanTypeImpl#getOnkeydown <em>Onkeydown</em>}</li>
 *   <li>{@link xhtml.impl.SpanTypeImpl#getOnkeypress <em>Onkeypress</em>}</li>
 *   <li>{@link xhtml.impl.SpanTypeImpl#getOnkeyup <em>Onkeyup</em>}</li>
 *   <li>{@link xhtml.impl.SpanTypeImpl#getOnmousedown <em>Onmousedown</em>}</li>
 *   <li>{@link xhtml.impl.SpanTypeImpl#getOnmousemove <em>Onmousemove</em>}</li>
 *   <li>{@link xhtml.impl.SpanTypeImpl#getOnmouseout <em>Onmouseout</em>}</li>
 *   <li>{@link xhtml.impl.SpanTypeImpl#getOnmouseover <em>Onmouseover</em>}</li>
 *   <li>{@link xhtml.impl.SpanTypeImpl#getOnmouseup <em>Onmouseup</em>}</li>
 *   <li>{@link xhtml.impl.SpanTypeImpl#getStyle <em>Style</em>}</li>
 *   <li>{@link xhtml.impl.SpanTypeImpl#getTitle <em>Title</em>}</li>
 * </ul>
 *
 * @generated
 */
