 ...
 * </p>
 * <ul>
 *   <li>{@link xhtml.impl.InlineImpl#getMixed <em>Mixed</em>}</li>
 *   <li>{@link xhtml.impl.InlineImpl#getGroup <em>Group</em>}</li>
 *   <li>{@link xhtml.impl.InlineImpl#getA <em>A</em>}</li>
 *   <li>{@link xhtml.impl.InlineImpl#getBr <em>Br</em>}</li>
 *   <li>{@link xhtml.impl.InlineImpl#getSpan <em>Span</em>}</li>
 *   <li>{@link xhtml.impl.InlineImpl#getBdo <em>Bdo</em>}</li>
 *   <li>{@link xhtml.impl.InlineImpl#getMap <em>Map</em>}</li>
 *   <li>{@link xhtml.impl.InlineImpl#getObject <em>Object</em>}</li>
 *   <li>{@link xhtml.impl.InlineImpl#getImg <em>Img</em>}</li>
 *   <li>{@link xhtml.impl.InlineImpl#getTt <em>Tt</em>}</li>
 *   <li>{@link xhtml.impl.InlineImpl#getI <em>I</em>}</li>
 *   <li>{@link xhtml.impl.InlineImpl#getB <em>B</em>}</li>
 *   <li>{@link xhtml.impl.InlineImpl#getBig <em>Big</em>}</li>
 *   <li>{@link xhtml.impl.InlineImpl#getSmall <em>Small</em>}</li>
 *   <li>{@link xhtml.impl.InlineImpl#getEm <em>Em</em>}</li>
 *   <li>{@link xhtml.impl.InlineImpl#getStrong <em>Strong</em>}</li>
 *   <li>{@link xhtml.impl.InlineImpl#getDfn <em>Dfn</em>}</li>
 *   <li>{@link xhtml.impl.InlineImpl#getCode <em>Code</em>}</li>
 *   <li>{@link xhtml.impl.InlineImpl#getQ <em>Q</em>}</li>
 *   <li>{@link xhtml.impl.InlineImpl#getSamp <em>Samp</em>}</li>
 *   <li>{@link xhtml.impl.InlineImpl#getKbd <em>Kbd</em>}</li>
 *   <li>{@link xhtml.impl.InlineImpl#getVar <em>Var</em>}</li>
 *   <li>{@link xhtml.impl.InlineImpl#getCite <em>Cite</em>}</li>
 *   <li>{@link xhtml.impl.InlineImpl#getAbbr <em>Abbr</em>}</li>
 *   <li>{@link xhtml.impl.InlineImpl#getAcronym <em>Acronym</em>}</li>
 *   <li>{@link xhtml.impl.InlineImpl#getSub <em>Sub</em>}</li>
 *   <li>{@link xhtml.impl.InlineImpl#getSup <em>Sup</em>}</li>
 *   <li>{@link xhtml.impl.InlineImpl#getInput <em>Input</em>}</li>
 *   <li>{@link xhtml.impl.InlineImpl#getSelect <em>Select</em>}</li>
 *   <li>{@link xhtml.impl.InlineImpl#getTextarea <em>Textarea</em>}</li>
 *   <li>{@link xhtml.impl.InlineImpl#getLabel <em>Label</em>}</li>
 *   <li>{@link xhtml.impl.InlineImpl#getButton <em>Button</em>}</li>
 *   <li>{@link xhtml.impl.InlineImpl#getIns <em>Ins</em>}</li>
 *   <li>{@link xhtml.impl.InlineImpl#getDel <em>Del</em>}</li>
 *   <li>{@link xhtml.impl.InlineImpl#getScript <em>Script</em>}</li>
 * </ul>
 *
 * @generated
 */
