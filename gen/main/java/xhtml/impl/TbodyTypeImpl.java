 ...
 * </p>
 * <ul>
 *   <li>{@link xhtml.impl.TbodyTypeImpl#getTr <em>Tr</em>}</li>
 *   <li>{@link xhtml.impl.TbodyTypeImpl#getAlign <em>Align</em>}</li>
 *   <li>{@link xhtml.impl.TbodyTypeImpl#getChar <em>Char</em>}</li>
 *   <li>{@link xhtml.impl.TbodyTypeImpl#getCharoff <em>Charoff</em>}</li>
 *   <li>{@link xhtml.impl.TbodyTypeImpl#getClass_ <em>Class</em>}</li>
 *   <li>{@link xhtml.impl.TbodyTypeImpl#getDir <em>Dir</em>}</li>
 *   <li>{@link xhtml.impl.TbodyTypeImpl#getId <em>Id</em>}</li>
 *   <li>{@link xhtml.impl.TbodyTypeImpl#getLang <em>Lang</em>}</li>
 *   <li>{@link xhtml.impl.TbodyTypeImpl#getLang1 <em>Lang1</em>}</li>
 *   <li>{@link xhtml.impl.TbodyTypeImpl#getOnclick <em>Onclick</em>}</li>
 *   <li>{@link xhtml.impl.TbodyTypeImpl#getOndblclick <em>Ondblclick</em>}</li>
 *   <li>{@link xhtml.impl.TbodyTypeImpl#getOnkeydown <em>Onkeydown</em>}</li>
 *   <li>{@link xhtml.impl.TbodyTypeImpl#getOnkeypress <em>Onkeypress</em>}</li>
 *   <li>{@link xhtml.impl.TbodyTypeImpl#getOnkeyup <em>Onkeyup</em>}</li>
 *   <li>{@link xhtml.impl.TbodyTypeImpl#getOnmousedown <em>Onmousedown</em>}</li>
 *   <li>{@link xhtml.impl.TbodyTypeImpl#getOnmousemove <em>Onmousemove</em>}</li>
 *   <li>{@link xhtml.impl.TbodyTypeImpl#getOnmouseout <em>Onmouseout</em>}</li>
 *   <li>{@link xhtml.impl.TbodyTypeImpl#getOnmouseover <em>Onmouseover</em>}</li>
 *   <li>{@link xhtml.impl.TbodyTypeImpl#getOnmouseup <em>Onmouseup</em>}</li>
 *   <li>{@link xhtml.impl.TbodyTypeImpl#getStyle <em>Style</em>}</li>
 *   <li>{@link xhtml.impl.TbodyTypeImpl#getTitle <em>Title</em>}</li>
 *   <li>{@link xhtml.impl.TbodyTypeImpl#getValign <em>Valign</em>}</li>
 * </ul>
 *
 * @generated
 */
