 ...
 * </p>
 * <ul>
 *   <li>{@link xhtml.impl.DocumentRootImpl#getMixed <em>Mixed</em>}</li>
 *   <li>{@link xhtml.impl.DocumentRootImpl#getXMLNSPrefixMap <em>XMLNS Prefix Map</em>}</li>
 *   <li>{@link xhtml.impl.DocumentRootImpl#getXSISchemaLocation <em>XSI Schema Location</em>}</li>
 *   <li>{@link xhtml.impl.DocumentRootImpl#getA <em>A</em>}</li>
 *   <li>{@link xhtml.impl.DocumentRootImpl#getAbbr <em>Abbr</em>}</li>
 *   <li>{@link xhtml.impl.DocumentRootImpl#getAcronym <em>Acronym</em>}</li>
 *   <li>{@link xhtml.impl.DocumentRootImpl#getAddress <em>Address</em>}</li>
 *   <li>{@link xhtml.impl.DocumentRootImpl#getArea <em>Area</em>}</li>
 *   <li>{@link xhtml.impl.DocumentRootImpl#getB <em>B</em>}</li>
 *   <li>{@link xhtml.impl.DocumentRootImpl#getBase <em>Base</em>}</li>
 *   <li>{@link xhtml.impl.DocumentRootImpl#getBdo <em>Bdo</em>}</li>
 *   <li>{@link xhtml.impl.DocumentRootImpl#getBig <em>Big</em>}</li>
 *   <li>{@link xhtml.impl.DocumentRootImpl#getBlockquote <em>Blockquote</em>}</li>
 *   <li>{@link xhtml.impl.DocumentRootImpl#getBody <em>Body</em>}</li>
 *   <li>{@link xhtml.impl.DocumentRootImpl#getBr <em>Br</em>}</li>
 *   <li>{@link xhtml.impl.DocumentRootImpl#getButton <em>Button</em>}</li>
 *   <li>{@link xhtml.impl.DocumentRootImpl#getCaption <em>Caption</em>}</li>
 *   <li>{@link xhtml.impl.DocumentRootImpl#getCite <em>Cite</em>}</li>
 *   <li>{@link xhtml.impl.DocumentRootImpl#getCode <em>Code</em>}</li>
 *   <li>{@link xhtml.impl.DocumentRootImpl#getCol <em>Col</em>}</li>
 *   <li>{@link xhtml.impl.DocumentRootImpl#getColgroup <em>Colgroup</em>}</li>
 *   <li>{@link xhtml.impl.DocumentRootImpl#getDd <em>Dd</em>}</li>
 *   <li>{@link xhtml.impl.DocumentRootImpl#getDel <em>Del</em>}</li>
 *   <li>{@link xhtml.impl.DocumentRootImpl#getDfn <em>Dfn</em>}</li>
 *   <li>{@link xhtml.impl.DocumentRootImpl#getDiv <em>Div</em>}</li>
 *   <li>{@link xhtml.impl.DocumentRootImpl#getDl <em>Dl</em>}</li>
 *   <li>{@link xhtml.impl.DocumentRootImpl#getDt <em>Dt</em>}</li>
 *   <li>{@link xhtml.impl.DocumentRootImpl#getEm <em>Em</em>}</li>
 *   <li>{@link xhtml.impl.DocumentRootImpl#getFieldset <em>Fieldset</em>}</li>
 *   <li>{@link xhtml.impl.DocumentRootImpl#getForm <em>Form</em>}</li>
 *   <li>{@link xhtml.impl.DocumentRootImpl#getH1 <em>H1</em>}</li>
 *   <li>{@link xhtml.impl.DocumentRootImpl#getH2 <em>H2</em>}</li>
 *   <li>{@link xhtml.impl.DocumentRootImpl#getH3 <em>H3</em>}</li>
 *   <li>{@link xhtml.impl.DocumentRootImpl#getH4 <em>H4</em>}</li>
 *   <li>{@link xhtml.impl.DocumentRootImpl#getH5 <em>H5</em>}</li>
 *   <li>{@link xhtml.impl.DocumentRootImpl#getH6 <em>H6</em>}</li>
 *   <li>{@link xhtml.impl.DocumentRootImpl#getHead <em>Head</em>}</li>
 *   <li>{@link xhtml.impl.DocumentRootImpl#getHr <em>Hr</em>}</li>
 *   <li>{@link xhtml.impl.DocumentRootImpl#getHtml <em>Html</em>}</li>
 *   <li>{@link xhtml.impl.DocumentRootImpl#getI <em>I</em>}</li>
 *   <li>{@link xhtml.impl.DocumentRootImpl#getImg <em>Img</em>}</li>
 *   <li>{@link xhtml.impl.DocumentRootImpl#getInput <em>Input</em>}</li>
 *   <li>{@link xhtml.impl.DocumentRootImpl#getIns <em>Ins</em>}</li>
 *   <li>{@link xhtml.impl.DocumentRootImpl#getKbd <em>Kbd</em>}</li>
 *   <li>{@link xhtml.impl.DocumentRootImpl#getLabel <em>Label</em>}</li>
 *   <li>{@link xhtml.impl.DocumentRootImpl#getLegend <em>Legend</em>}</li>
 *   <li>{@link xhtml.impl.DocumentRootImpl#getLi <em>Li</em>}</li>
 *   <li>{@link xhtml.impl.DocumentRootImpl#getLink <em>Link</em>}</li>
 *   <li>{@link xhtml.impl.DocumentRootImpl#getMap <em>Map</em>}</li>
 *   <li>{@link xhtml.impl.DocumentRootImpl#getMeta <em>Meta</em>}</li>
 *   <li>{@link xhtml.impl.DocumentRootImpl#getNoscript <em>Noscript</em>}</li>
 *   <li>{@link xhtml.impl.DocumentRootImpl#getObject <em>Object</em>}</li>
 *   <li>{@link xhtml.impl.DocumentRootImpl#getOl <em>Ol</em>}</li>
 *   <li>{@link xhtml.impl.DocumentRootImpl#getOptgroup <em>Optgroup</em>}</li>
 *   <li>{@link xhtml.impl.DocumentRootImpl#getOption <em>Option</em>}</li>
 *   <li>{@link xhtml.impl.DocumentRootImpl#getP <em>P</em>}</li>
 *   <li>{@link xhtml.impl.DocumentRootImpl#getParam <em>Param</em>}</li>
 *   <li>{@link xhtml.impl.DocumentRootImpl#getPre <em>Pre</em>}</li>
 *   <li>{@link xhtml.impl.DocumentRootImpl#getQ <em>Q</em>}</li>
 *   <li>{@link xhtml.impl.DocumentRootImpl#getSamp <em>Samp</em>}</li>
 *   <li>{@link xhtml.impl.DocumentRootImpl#getScript <em>Script</em>}</li>
 *   <li>{@link xhtml.impl.DocumentRootImpl#getSelect <em>Select</em>}</li>
 *   <li>{@link xhtml.impl.DocumentRootImpl#getSmall <em>Small</em>}</li>
 *   <li>{@link xhtml.impl.DocumentRootImpl#getSpan <em>Span</em>}</li>
 *   <li>{@link xhtml.impl.DocumentRootImpl#getStrong <em>Strong</em>}</li>
 *   <li>{@link xhtml.impl.DocumentRootImpl#getStyle <em>Style</em>}</li>
 *   <li>{@link xhtml.impl.DocumentRootImpl#getSub <em>Sub</em>}</li>
 *   <li>{@link xhtml.impl.DocumentRootImpl#getSup <em>Sup</em>}</li>
 *   <li>{@link xhtml.impl.DocumentRootImpl#getTable <em>Table</em>}</li>
 *   <li>{@link xhtml.impl.DocumentRootImpl#getTbody <em>Tbody</em>}</li>
 *   <li>{@link xhtml.impl.DocumentRootImpl#getTd <em>Td</em>}</li>
 *   <li>{@link xhtml.impl.DocumentRootImpl#getTextarea <em>Textarea</em>}</li>
 *   <li>{@link xhtml.impl.DocumentRootImpl#getTfoot <em>Tfoot</em>}</li>
 *   <li>{@link xhtml.impl.DocumentRootImpl#getTh <em>Th</em>}</li>
 *   <li>{@link xhtml.impl.DocumentRootImpl#getThead <em>Thead</em>}</li>
 *   <li>{@link xhtml.impl.DocumentRootImpl#getTitle <em>Title</em>}</li>
 *   <li>{@link xhtml.impl.DocumentRootImpl#getTr <em>Tr</em>}</li>
 *   <li>{@link xhtml.impl.DocumentRootImpl#getTt <em>Tt</em>}</li>
 *   <li>{@link xhtml.impl.DocumentRootImpl#getUl <em>Ul</em>}</li>
 *   <li>{@link xhtml.impl.DocumentRootImpl#getVar <em>Var</em>}</li>
 * </ul>
 *
 * @generated
 */
