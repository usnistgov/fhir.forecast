 ...
 * </p>
 * <ul>
 *   <li>{@link xhtml.impl.EmTypeImpl#getClass_ <em>Class</em>}</li>
 *   <li>{@link xhtml.impl.EmTypeImpl#getDir <em>Dir</em>}</li>
 *   <li>{@link xhtml.impl.EmTypeImpl#getId <em>Id</em>}</li>
 *   <li>{@link xhtml.impl.EmTypeImpl#getLang <em>Lang</em>}</li>
 *   <li>{@link xhtml.impl.EmTypeImpl#getLang1 <em>Lang1</em>}</li>
 *   <li>{@link xhtml.impl.EmTypeImpl#getOnclick <em>Onclick</em>}</li>
 *   <li>{@link xhtml.impl.EmTypeImpl#getOndblclick <em>Ondblclick</em>}</li>
 *   <li>{@link xhtml.impl.EmTypeImpl#getOnkeydown <em>Onkeydown</em>}</li>
 *   <li>{@link xhtml.impl.EmTypeImpl#getOnkeypress <em>Onkeypress</em>}</li>
 *   <li>{@link xhtml.impl.EmTypeImpl#getOnkeyup <em>Onkeyup</em>}</li>
 *   <li>{@link xhtml.impl.EmTypeImpl#getOnmousedown <em>Onmousedown</em>}</li>
 *   <li>{@link xhtml.impl.EmTypeImpl#getOnmousemove <em>Onmousemove</em>}</li>
 *   <li>{@link xhtml.impl.EmTypeImpl#getOnmouseout <em>Onmouseout</em>}</li>
 *   <li>{@link xhtml.impl.EmTypeImpl#getOnmouseover <em>Onmouseover</em>}</li>
 *   <li>{@link xhtml.impl.EmTypeImpl#getOnmouseup <em>Onmouseup</em>}</li>
 *   <li>{@link xhtml.impl.EmTypeImpl#getStyle <em>Style</em>}</li>
 *   <li>{@link xhtml.impl.EmTypeImpl#getTitle <em>Title</em>}</li>
 * </ul>
 *
 * @generated
 */
