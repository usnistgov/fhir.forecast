 ...
 * </p>
 * <ul>
 *   <li>{@link xhtml.impl.DelTypeImpl#getCite1 <em>Cite1</em>}</li>
 *   <li>{@link xhtml.impl.DelTypeImpl#getClass_ <em>Class</em>}</li>
 *   <li>{@link xhtml.impl.DelTypeImpl#getDatetime <em>Datetime</em>}</li>
 *   <li>{@link xhtml.impl.DelTypeImpl#getDir <em>Dir</em>}</li>
 *   <li>{@link xhtml.impl.DelTypeImpl#getId <em>Id</em>}</li>
 *   <li>{@link xhtml.impl.DelTypeImpl#getLang <em>Lang</em>}</li>
 *   <li>{@link xhtml.impl.DelTypeImpl#getLang1 <em>Lang1</em>}</li>
 *   <li>{@link xhtml.impl.DelTypeImpl#getOnclick <em>Onclick</em>}</li>
 *   <li>{@link xhtml.impl.DelTypeImpl#getOndblclick <em>Ondblclick</em>}</li>
 *   <li>{@link xhtml.impl.DelTypeImpl#getOnkeydown <em>Onkeydown</em>}</li>
 *   <li>{@link xhtml.impl.DelTypeImpl#getOnkeypress <em>Onkeypress</em>}</li>
 *   <li>{@link xhtml.impl.DelTypeImpl#getOnkeyup <em>Onkeyup</em>}</li>
 *   <li>{@link xhtml.impl.DelTypeImpl#getOnmousedown <em>Onmousedown</em>}</li>
 *   <li>{@link xhtml.impl.DelTypeImpl#getOnmousemove <em>Onmousemove</em>}</li>
 *   <li>{@link xhtml.impl.DelTypeImpl#getOnmouseout <em>Onmouseout</em>}</li>
 *   <li>{@link xhtml.impl.DelTypeImpl#getOnmouseover <em>Onmouseover</em>}</li>
 *   <li>{@link xhtml.impl.DelTypeImpl#getOnmouseup <em>Onmouseup</em>}</li>
 *   <li>{@link xhtml.impl.DelTypeImpl#getStyle <em>Style</em>}</li>
 *   <li>{@link xhtml.impl.DelTypeImpl#getTitle <em>Title</em>}</li>
 * </ul>
 *
 * @generated
 */
