...
import forecast.impl.ForecastPackageImpl;
import xhtml.XhtmlFactory;
import xhtml.XhtmlPackage;
import xhtml.util.XhtmlValidator;
...
public class XhtmlPackageImpl extends EPackageImpl implements XhtmlPackage {
	 ...
	 * @see xhtml.XhtmlPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public static XhtmlPackage init() {
		...
		ForecastPackageImpl theForecastPackage = (ForecastPackageImpl)(EPackage.Registry.INSTANCE.getEPackage(ForecastPackage.eNS_URI) instanceof ForecastPackageImpl ? EPackage.Registry.INSTANCE.getEPackage(ForecastPackage.eNS_URI) : ForecastPackage.eINSTANCE);
	...
	protected void fixInstanceClass(EClassifier eClassifier) {
		if (eClassifier.getInstanceClassName() == null) {
			eClassifier.setInstanceClassName("xhtml." + eClassifier.getName());
