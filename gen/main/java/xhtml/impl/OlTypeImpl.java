 ...
 * </p>
 * <ul>
 *   <li>{@link xhtml.impl.OlTypeImpl#getLi <em>Li</em>}</li>
 *   <li>{@link xhtml.impl.OlTypeImpl#getClass_ <em>Class</em>}</li>
 *   <li>{@link xhtml.impl.OlTypeImpl#getDir <em>Dir</em>}</li>
 *   <li>{@link xhtml.impl.OlTypeImpl#getId <em>Id</em>}</li>
 *   <li>{@link xhtml.impl.OlTypeImpl#getLang <em>Lang</em>}</li>
 *   <li>{@link xhtml.impl.OlTypeImpl#getLang1 <em>Lang1</em>}</li>
 *   <li>{@link xhtml.impl.OlTypeImpl#getOnclick <em>Onclick</em>}</li>
 *   <li>{@link xhtml.impl.OlTypeImpl#getOndblclick <em>Ondblclick</em>}</li>
 *   <li>{@link xhtml.impl.OlTypeImpl#getOnkeydown <em>Onkeydown</em>}</li>
 *   <li>{@link xhtml.impl.OlTypeImpl#getOnkeypress <em>Onkeypress</em>}</li>
 *   <li>{@link xhtml.impl.OlTypeImpl#getOnkeyup <em>Onkeyup</em>}</li>
 *   <li>{@link xhtml.impl.OlTypeImpl#getOnmousedown <em>Onmousedown</em>}</li>
 *   <li>{@link xhtml.impl.OlTypeImpl#getOnmousemove <em>Onmousemove</em>}</li>
 *   <li>{@link xhtml.impl.OlTypeImpl#getOnmouseout <em>Onmouseout</em>}</li>
 *   <li>{@link xhtml.impl.OlTypeImpl#getOnmouseover <em>Onmouseover</em>}</li>
 *   <li>{@link xhtml.impl.OlTypeImpl#getOnmouseup <em>Onmouseup</em>}</li>
 *   <li>{@link xhtml.impl.OlTypeImpl#getStyle <em>Style</em>}</li>
 *   <li>{@link xhtml.impl.OlTypeImpl#getTitle <em>Title</em>}</li>
 * </ul>
 *
 * @generated
 */
