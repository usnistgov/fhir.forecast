 ...
 * </p>
 * <ul>
 *   <li>{@link xhtml.impl.NoscriptTypeImpl#getClass_ <em>Class</em>}</li>
 *   <li>{@link xhtml.impl.NoscriptTypeImpl#getDir <em>Dir</em>}</li>
 *   <li>{@link xhtml.impl.NoscriptTypeImpl#getId <em>Id</em>}</li>
 *   <li>{@link xhtml.impl.NoscriptTypeImpl#getLang <em>Lang</em>}</li>
 *   <li>{@link xhtml.impl.NoscriptTypeImpl#getLang1 <em>Lang1</em>}</li>
 *   <li>{@link xhtml.impl.NoscriptTypeImpl#getOnclick <em>Onclick</em>}</li>
 *   <li>{@link xhtml.impl.NoscriptTypeImpl#getOndblclick <em>Ondblclick</em>}</li>
 *   <li>{@link xhtml.impl.NoscriptTypeImpl#getOnkeydown <em>Onkeydown</em>}</li>
 *   <li>{@link xhtml.impl.NoscriptTypeImpl#getOnkeypress <em>Onkeypress</em>}</li>
 *   <li>{@link xhtml.impl.NoscriptTypeImpl#getOnkeyup <em>Onkeyup</em>}</li>
 *   <li>{@link xhtml.impl.NoscriptTypeImpl#getOnmousedown <em>Onmousedown</em>}</li>
 *   <li>{@link xhtml.impl.NoscriptTypeImpl#getOnmousemove <em>Onmousemove</em>}</li>
 *   <li>{@link xhtml.impl.NoscriptTypeImpl#getOnmouseout <em>Onmouseout</em>}</li>
 *   <li>{@link xhtml.impl.NoscriptTypeImpl#getOnmouseover <em>Onmouseover</em>}</li>
 *   <li>{@link xhtml.impl.NoscriptTypeImpl#getOnmouseup <em>Onmouseup</em>}</li>
 *   <li>{@link xhtml.impl.NoscriptTypeImpl#getStyle <em>Style</em>}</li>
 *   <li>{@link xhtml.impl.NoscriptTypeImpl#getTitle <em>Title</em>}</li>
 * </ul>
 *
 * @generated
 */
