 ...
 * </p>
 * <ul>
 *   <li>{@link xhtml.impl.TableTypeImpl#getCaption <em>Caption</em>}</li>
 *   <li>{@link xhtml.impl.TableTypeImpl#getCol <em>Col</em>}</li>
 *   <li>{@link xhtml.impl.TableTypeImpl#getColgroup <em>Colgroup</em>}</li>
 *   <li>{@link xhtml.impl.TableTypeImpl#getThead <em>Thead</em>}</li>
 *   <li>{@link xhtml.impl.TableTypeImpl#getTfoot <em>Tfoot</em>}</li>
 *   <li>{@link xhtml.impl.TableTypeImpl#getTbody <em>Tbody</em>}</li>
 *   <li>{@link xhtml.impl.TableTypeImpl#getTr <em>Tr</em>}</li>
 *   <li>{@link xhtml.impl.TableTypeImpl#getBorder <em>Border</em>}</li>
 *   <li>{@link xhtml.impl.TableTypeImpl#getCellpadding <em>Cellpadding</em>}</li>
 *   <li>{@link xhtml.impl.TableTypeImpl#getCellspacing <em>Cellspacing</em>}</li>
 *   <li>{@link xhtml.impl.TableTypeImpl#getClass_ <em>Class</em>}</li>
 *   <li>{@link xhtml.impl.TableTypeImpl#getDir <em>Dir</em>}</li>
 *   <li>{@link xhtml.impl.TableTypeImpl#getFrame <em>Frame</em>}</li>
 *   <li>{@link xhtml.impl.TableTypeImpl#getId <em>Id</em>}</li>
 *   <li>{@link xhtml.impl.TableTypeImpl#getLang <em>Lang</em>}</li>
 *   <li>{@link xhtml.impl.TableTypeImpl#getLang1 <em>Lang1</em>}</li>
 *   <li>{@link xhtml.impl.TableTypeImpl#getOnclick <em>Onclick</em>}</li>
 *   <li>{@link xhtml.impl.TableTypeImpl#getOndblclick <em>Ondblclick</em>}</li>
 *   <li>{@link xhtml.impl.TableTypeImpl#getOnkeydown <em>Onkeydown</em>}</li>
 *   <li>{@link xhtml.impl.TableTypeImpl#getOnkeypress <em>Onkeypress</em>}</li>
 *   <li>{@link xhtml.impl.TableTypeImpl#getOnkeyup <em>Onkeyup</em>}</li>
 *   <li>{@link xhtml.impl.TableTypeImpl#getOnmousedown <em>Onmousedown</em>}</li>
 *   <li>{@link xhtml.impl.TableTypeImpl#getOnmousemove <em>Onmousemove</em>}</li>
 *   <li>{@link xhtml.impl.TableTypeImpl#getOnmouseout <em>Onmouseout</em>}</li>
 *   <li>{@link xhtml.impl.TableTypeImpl#getOnmouseover <em>Onmouseover</em>}</li>
 *   <li>{@link xhtml.impl.TableTypeImpl#getOnmouseup <em>Onmouseup</em>}</li>
 *   <li>{@link xhtml.impl.TableTypeImpl#getRules <em>Rules</em>}</li>
 *   <li>{@link xhtml.impl.TableTypeImpl#getStyle <em>Style</em>}</li>
 *   <li>{@link xhtml.impl.TableTypeImpl#getSummary <em>Summary</em>}</li>
 *   <li>{@link xhtml.impl.TableTypeImpl#getTitle <em>Title</em>}</li>
 *   <li>{@link xhtml.impl.TableTypeImpl#getWidth <em>Width</em>}</li>
 * </ul>
 *
 * @generated
 */
