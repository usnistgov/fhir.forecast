 ...
 * </p>
 * <ul>
 *   <li>{@link xhtml.impl.AddressTypeImpl#getClass_ <em>Class</em>}</li>
 *   <li>{@link xhtml.impl.AddressTypeImpl#getDir <em>Dir</em>}</li>
 *   <li>{@link xhtml.impl.AddressTypeImpl#getId <em>Id</em>}</li>
 *   <li>{@link xhtml.impl.AddressTypeImpl#getLang <em>Lang</em>}</li>
 *   <li>{@link xhtml.impl.AddressTypeImpl#getLang1 <em>Lang1</em>}</li>
 *   <li>{@link xhtml.impl.AddressTypeImpl#getOnclick <em>Onclick</em>}</li>
 *   <li>{@link xhtml.impl.AddressTypeImpl#getOndblclick <em>Ondblclick</em>}</li>
 *   <li>{@link xhtml.impl.AddressTypeImpl#getOnkeydown <em>Onkeydown</em>}</li>
 *   <li>{@link xhtml.impl.AddressTypeImpl#getOnkeypress <em>Onkeypress</em>}</li>
 *   <li>{@link xhtml.impl.AddressTypeImpl#getOnkeyup <em>Onkeyup</em>}</li>
 *   <li>{@link xhtml.impl.AddressTypeImpl#getOnmousedown <em>Onmousedown</em>}</li>
 *   <li>{@link xhtml.impl.AddressTypeImpl#getOnmousemove <em>Onmousemove</em>}</li>
 *   <li>{@link xhtml.impl.AddressTypeImpl#getOnmouseout <em>Onmouseout</em>}</li>
 *   <li>{@link xhtml.impl.AddressTypeImpl#getOnmouseover <em>Onmouseover</em>}</li>
 *   <li>{@link xhtml.impl.AddressTypeImpl#getOnmouseup <em>Onmouseup</em>}</li>
 *   <li>{@link xhtml.impl.AddressTypeImpl#getStyle <em>Style</em>}</li>
 *   <li>{@link xhtml.impl.AddressTypeImpl#getTitle <em>Title</em>}</li>
 * </ul>
 *
 * @generated
 */
