 ...
 * </p>
 * <ul>
 *   <li>{@link xhtml.impl.PreContentImpl#getMixed <em>Mixed</em>}</li>
 *   <li>{@link xhtml.impl.PreContentImpl#getGroup <em>Group</em>}</li>
 *   <li>{@link xhtml.impl.PreContentImpl#getA <em>A</em>}</li>
 *   <li>{@link xhtml.impl.PreContentImpl#getTt <em>Tt</em>}</li>
 *   <li>{@link xhtml.impl.PreContentImpl#getI <em>I</em>}</li>
 *   <li>{@link xhtml.impl.PreContentImpl#getB <em>B</em>}</li>
 *   <li>{@link xhtml.impl.PreContentImpl#getBig <em>Big</em>}</li>
 *   <li>{@link xhtml.impl.PreContentImpl#getSmall <em>Small</em>}</li>
 *   <li>{@link xhtml.impl.PreContentImpl#getEm <em>Em</em>}</li>
 *   <li>{@link xhtml.impl.PreContentImpl#getStrong <em>Strong</em>}</li>
 *   <li>{@link xhtml.impl.PreContentImpl#getDfn <em>Dfn</em>}</li>
 *   <li>{@link xhtml.impl.PreContentImpl#getCode <em>Code</em>}</li>
 *   <li>{@link xhtml.impl.PreContentImpl#getQ <em>Q</em>}</li>
 *   <li>{@link xhtml.impl.PreContentImpl#getSamp <em>Samp</em>}</li>
 *   <li>{@link xhtml.impl.PreContentImpl#getKbd <em>Kbd</em>}</li>
 *   <li>{@link xhtml.impl.PreContentImpl#getVar <em>Var</em>}</li>
 *   <li>{@link xhtml.impl.PreContentImpl#getCite <em>Cite</em>}</li>
 *   <li>{@link xhtml.impl.PreContentImpl#getAbbr <em>Abbr</em>}</li>
 *   <li>{@link xhtml.impl.PreContentImpl#getAcronym <em>Acronym</em>}</li>
 *   <li>{@link xhtml.impl.PreContentImpl#getSub <em>Sub</em>}</li>
 *   <li>{@link xhtml.impl.PreContentImpl#getSup <em>Sup</em>}</li>
 *   <li>{@link xhtml.impl.PreContentImpl#getBr <em>Br</em>}</li>
 *   <li>{@link xhtml.impl.PreContentImpl#getSpan <em>Span</em>}</li>
 *   <li>{@link xhtml.impl.PreContentImpl#getBdo <em>Bdo</em>}</li>
 *   <li>{@link xhtml.impl.PreContentImpl#getMap <em>Map</em>}</li>
 *   <li>{@link xhtml.impl.PreContentImpl#getIns <em>Ins</em>}</li>
 *   <li>{@link xhtml.impl.PreContentImpl#getDel <em>Del</em>}</li>
 *   <li>{@link xhtml.impl.PreContentImpl#getScript <em>Script</em>}</li>
 *   <li>{@link xhtml.impl.PreContentImpl#getInput <em>Input</em>}</li>
 *   <li>{@link xhtml.impl.PreContentImpl#getSelect <em>Select</em>}</li>
 *   <li>{@link xhtml.impl.PreContentImpl#getTextarea <em>Textarea</em>}</li>
 *   <li>{@link xhtml.impl.PreContentImpl#getLabel <em>Label</em>}</li>
 *   <li>{@link xhtml.impl.PreContentImpl#getButton <em>Button</em>}</li>
 * </ul>
 *
 * @generated
 */
