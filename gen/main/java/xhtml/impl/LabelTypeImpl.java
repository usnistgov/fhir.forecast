 ...
 * </p>
 * <ul>
 *   <li>{@link xhtml.impl.LabelTypeImpl#getAccesskey <em>Accesskey</em>}</li>
 *   <li>{@link xhtml.impl.LabelTypeImpl#getClass_ <em>Class</em>}</li>
 *   <li>{@link xhtml.impl.LabelTypeImpl#getDir <em>Dir</em>}</li>
 *   <li>{@link xhtml.impl.LabelTypeImpl#getFor <em>For</em>}</li>
 *   <li>{@link xhtml.impl.LabelTypeImpl#getId <em>Id</em>}</li>
 *   <li>{@link xhtml.impl.LabelTypeImpl#getLang <em>Lang</em>}</li>
 *   <li>{@link xhtml.impl.LabelTypeImpl#getLang1 <em>Lang1</em>}</li>
 *   <li>{@link xhtml.impl.LabelTypeImpl#getOnblur <em>Onblur</em>}</li>
 *   <li>{@link xhtml.impl.LabelTypeImpl#getOnclick <em>Onclick</em>}</li>
 *   <li>{@link xhtml.impl.LabelTypeImpl#getOndblclick <em>Ondblclick</em>}</li>
 *   <li>{@link xhtml.impl.LabelTypeImpl#getOnfocus <em>Onfocus</em>}</li>
 *   <li>{@link xhtml.impl.LabelTypeImpl#getOnkeydown <em>Onkeydown</em>}</li>
 *   <li>{@link xhtml.impl.LabelTypeImpl#getOnkeypress <em>Onkeypress</em>}</li>
 *   <li>{@link xhtml.impl.LabelTypeImpl#getOnkeyup <em>Onkeyup</em>}</li>
 *   <li>{@link xhtml.impl.LabelTypeImpl#getOnmousedown <em>Onmousedown</em>}</li>
 *   <li>{@link xhtml.impl.LabelTypeImpl#getOnmousemove <em>Onmousemove</em>}</li>
 *   <li>{@link xhtml.impl.LabelTypeImpl#getOnmouseout <em>Onmouseout</em>}</li>
 *   <li>{@link xhtml.impl.LabelTypeImpl#getOnmouseover <em>Onmouseover</em>}</li>
 *   <li>{@link xhtml.impl.LabelTypeImpl#getOnmouseup <em>Onmouseup</em>}</li>
 *   <li>{@link xhtml.impl.LabelTypeImpl#getStyle <em>Style</em>}</li>
 *   <li>{@link xhtml.impl.LabelTypeImpl#getTitle <em>Title</em>}</li>
 * </ul>
 *
 * @generated
 */
