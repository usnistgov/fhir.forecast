...
import xhtml.DisabledType3;
import xhtml.TypeType;
 ...
 * </p>
 * <ul>
 *   <li>{@link xhtml.impl.ButtonTypeImpl#getAccesskey <em>Accesskey</em>}</li>
 *   <li>{@link xhtml.impl.ButtonTypeImpl#getClass_ <em>Class</em>}</li>
 *   <li>{@link xhtml.impl.ButtonTypeImpl#getDir <em>Dir</em>}</li>
 *   <li>{@link xhtml.impl.ButtonTypeImpl#getDisabled <em>Disabled</em>}</li>
 *   <li>{@link xhtml.impl.ButtonTypeImpl#getId <em>Id</em>}</li>
 *   <li>{@link xhtml.impl.ButtonTypeImpl#getLang <em>Lang</em>}</li>
 *   <li>{@link xhtml.impl.ButtonTypeImpl#getLang1 <em>Lang1</em>}</li>
 *   <li>{@link xhtml.impl.ButtonTypeImpl#getName <em>Name</em>}</li>
 *   <li>{@link xhtml.impl.ButtonTypeImpl#getOnblur <em>Onblur</em>}</li>
 *   <li>{@link xhtml.impl.ButtonTypeImpl#getOnclick <em>Onclick</em>}</li>
 *   <li>{@link xhtml.impl.ButtonTypeImpl#getOndblclick <em>Ondblclick</em>}</li>
 *   <li>{@link xhtml.impl.ButtonTypeImpl#getOnfocus <em>Onfocus</em>}</li>
 *   <li>{@link xhtml.impl.ButtonTypeImpl#getOnkeydown <em>Onkeydown</em>}</li>
 *   <li>{@link xhtml.impl.ButtonTypeImpl#getOnkeypress <em>Onkeypress</em>}</li>
 *   <li>{@link xhtml.impl.ButtonTypeImpl#getOnkeyup <em>Onkeyup</em>}</li>
 *   <li>{@link xhtml.impl.ButtonTypeImpl#getOnmousedown <em>Onmousedown</em>}</li>
 *   <li>{@link xhtml.impl.ButtonTypeImpl#getOnmousemove <em>Onmousemove</em>}</li>
 *   <li>{@link xhtml.impl.ButtonTypeImpl#getOnmouseout <em>Onmouseout</em>}</li>
 *   <li>{@link xhtml.impl.ButtonTypeImpl#getOnmouseover <em>Onmouseover</em>}</li>
 *   <li>{@link xhtml.impl.ButtonTypeImpl#getOnmouseup <em>Onmouseup</em>}</li>
 *   <li>{@link xhtml.impl.ButtonTypeImpl#getStyle <em>Style</em>}</li>
 *   <li>{@link xhtml.impl.ButtonTypeImpl#getTabindex <em>Tabindex</em>}</li>
 *   <li>{@link xhtml.impl.ButtonTypeImpl#getTitle <em>Title</em>}</li>
 *   <li>{@link xhtml.impl.ButtonTypeImpl#getType <em>Type</em>}</li>
 *   <li>{@link xhtml.impl.ButtonTypeImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
