 ...
 * </p>
 * <ul>
 *   <li>{@link xhtml.impl.FormTypeImpl#getAccept <em>Accept</em>}</li>
 *   <li>{@link xhtml.impl.FormTypeImpl#getAcceptCharset <em>Accept Charset</em>}</li>
 *   <li>{@link xhtml.impl.FormTypeImpl#getAction <em>Action</em>}</li>
 *   <li>{@link xhtml.impl.FormTypeImpl#getClass_ <em>Class</em>}</li>
 *   <li>{@link xhtml.impl.FormTypeImpl#getDir <em>Dir</em>}</li>
 *   <li>{@link xhtml.impl.FormTypeImpl#getEnctype <em>Enctype</em>}</li>
 *   <li>{@link xhtml.impl.FormTypeImpl#getId <em>Id</em>}</li>
 *   <li>{@link xhtml.impl.FormTypeImpl#getLang <em>Lang</em>}</li>
 *   <li>{@link xhtml.impl.FormTypeImpl#getLang1 <em>Lang1</em>}</li>
 *   <li>{@link xhtml.impl.FormTypeImpl#getMethod <em>Method</em>}</li>
 *   <li>{@link xhtml.impl.FormTypeImpl#getOnclick <em>Onclick</em>}</li>
 *   <li>{@link xhtml.impl.FormTypeImpl#getOndblclick <em>Ondblclick</em>}</li>
 *   <li>{@link xhtml.impl.FormTypeImpl#getOnkeydown <em>Onkeydown</em>}</li>
 *   <li>{@link xhtml.impl.FormTypeImpl#getOnkeypress <em>Onkeypress</em>}</li>
 *   <li>{@link xhtml.impl.FormTypeImpl#getOnkeyup <em>Onkeyup</em>}</li>
 *   <li>{@link xhtml.impl.FormTypeImpl#getOnmousedown <em>Onmousedown</em>}</li>
 *   <li>{@link xhtml.impl.FormTypeImpl#getOnmousemove <em>Onmousemove</em>}</li>
 *   <li>{@link xhtml.impl.FormTypeImpl#getOnmouseout <em>Onmouseout</em>}</li>
 *   <li>{@link xhtml.impl.FormTypeImpl#getOnmouseover <em>Onmouseover</em>}</li>
 *   <li>{@link xhtml.impl.FormTypeImpl#getOnmouseup <em>Onmouseup</em>}</li>
 *   <li>{@link xhtml.impl.FormTypeImpl#getOnreset <em>Onreset</em>}</li>
 *   <li>{@link xhtml.impl.FormTypeImpl#getOnsubmit <em>Onsubmit</em>}</li>
 *   <li>{@link xhtml.impl.FormTypeImpl#getStyle <em>Style</em>}</li>
 *   <li>{@link xhtml.impl.FormTypeImpl#getTitle <em>Title</em>}</li>
 * </ul>
 *
 * @generated
 */
