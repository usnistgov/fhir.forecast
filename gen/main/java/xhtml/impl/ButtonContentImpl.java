 ...
 * </p>
 * <ul>
 *   <li>{@link xhtml.impl.ButtonContentImpl#getMixed <em>Mixed</em>}</li>
 *   <li>{@link xhtml.impl.ButtonContentImpl#getGroup <em>Group</em>}</li>
 *   <li>{@link xhtml.impl.ButtonContentImpl#getP <em>P</em>}</li>
 *   <li>{@link xhtml.impl.ButtonContentImpl#getH1 <em>H1</em>}</li>
 *   <li>{@link xhtml.impl.ButtonContentImpl#getH2 <em>H2</em>}</li>
 *   <li>{@link xhtml.impl.ButtonContentImpl#getH3 <em>H3</em>}</li>
 *   <li>{@link xhtml.impl.ButtonContentImpl#getH4 <em>H4</em>}</li>
 *   <li>{@link xhtml.impl.ButtonContentImpl#getH5 <em>H5</em>}</li>
 *   <li>{@link xhtml.impl.ButtonContentImpl#getH6 <em>H6</em>}</li>
 *   <li>{@link xhtml.impl.ButtonContentImpl#getDiv <em>Div</em>}</li>
 *   <li>{@link xhtml.impl.ButtonContentImpl#getUl <em>Ul</em>}</li>
 *   <li>{@link xhtml.impl.ButtonContentImpl#getOl <em>Ol</em>}</li>
 *   <li>{@link xhtml.impl.ButtonContentImpl#getDl <em>Dl</em>}</li>
 *   <li>{@link xhtml.impl.ButtonContentImpl#getPre <em>Pre</em>}</li>
 *   <li>{@link xhtml.impl.ButtonContentImpl#getHr <em>Hr</em>}</li>
 *   <li>{@link xhtml.impl.ButtonContentImpl#getBlockquote <em>Blockquote</em>}</li>
 *   <li>{@link xhtml.impl.ButtonContentImpl#getAddress <em>Address</em>}</li>
 *   <li>{@link xhtml.impl.ButtonContentImpl#getTable <em>Table</em>}</li>
 *   <li>{@link xhtml.impl.ButtonContentImpl#getBr <em>Br</em>}</li>
 *   <li>{@link xhtml.impl.ButtonContentImpl#getSpan <em>Span</em>}</li>
 *   <li>{@link xhtml.impl.ButtonContentImpl#getBdo <em>Bdo</em>}</li>
 *   <li>{@link xhtml.impl.ButtonContentImpl#getMap <em>Map</em>}</li>
 *   <li>{@link xhtml.impl.ButtonContentImpl#getObject <em>Object</em>}</li>
 *   <li>{@link xhtml.impl.ButtonContentImpl#getImg <em>Img</em>}</li>
 *   <li>{@link xhtml.impl.ButtonContentImpl#getTt <em>Tt</em>}</li>
 *   <li>{@link xhtml.impl.ButtonContentImpl#getI <em>I</em>}</li>
 *   <li>{@link xhtml.impl.ButtonContentImpl#getB <em>B</em>}</li>
 *   <li>{@link xhtml.impl.ButtonContentImpl#getBig <em>Big</em>}</li>
 *   <li>{@link xhtml.impl.ButtonContentImpl#getSmall <em>Small</em>}</li>
 *   <li>{@link xhtml.impl.ButtonContentImpl#getEm <em>Em</em>}</li>
 *   <li>{@link xhtml.impl.ButtonContentImpl#getStrong <em>Strong</em>}</li>
 *   <li>{@link xhtml.impl.ButtonContentImpl#getDfn <em>Dfn</em>}</li>
 *   <li>{@link xhtml.impl.ButtonContentImpl#getCode <em>Code</em>}</li>
 *   <li>{@link xhtml.impl.ButtonContentImpl#getQ <em>Q</em>}</li>
 *   <li>{@link xhtml.impl.ButtonContentImpl#getSamp <em>Samp</em>}</li>
 *   <li>{@link xhtml.impl.ButtonContentImpl#getKbd <em>Kbd</em>}</li>
 *   <li>{@link xhtml.impl.ButtonContentImpl#getVar <em>Var</em>}</li>
 *   <li>{@link xhtml.impl.ButtonContentImpl#getCite <em>Cite</em>}</li>
 *   <li>{@link xhtml.impl.ButtonContentImpl#getAbbr <em>Abbr</em>}</li>
 *   <li>{@link xhtml.impl.ButtonContentImpl#getAcronym <em>Acronym</em>}</li>
 *   <li>{@link xhtml.impl.ButtonContentImpl#getSub <em>Sub</em>}</li>
 *   <li>{@link xhtml.impl.ButtonContentImpl#getSup <em>Sup</em>}</li>
 *   <li>{@link xhtml.impl.ButtonContentImpl#getNoscript <em>Noscript</em>}</li>
 *   <li>{@link xhtml.impl.ButtonContentImpl#getIns <em>Ins</em>}</li>
 *   <li>{@link xhtml.impl.ButtonContentImpl#getDel <em>Del</em>}</li>
 *   <li>{@link xhtml.impl.ButtonContentImpl#getScript <em>Script</em>}</li>
 * </ul>
 *
 * @generated
 */
