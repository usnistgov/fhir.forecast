 ...
 * </p>
 * <ul>
 *   <li>{@link xhtml.impl.BTypeImpl#getClass_ <em>Class</em>}</li>
 *   <li>{@link xhtml.impl.BTypeImpl#getDir <em>Dir</em>}</li>
 *   <li>{@link xhtml.impl.BTypeImpl#getId <em>Id</em>}</li>
 *   <li>{@link xhtml.impl.BTypeImpl#getLang <em>Lang</em>}</li>
 *   <li>{@link xhtml.impl.BTypeImpl#getLang1 <em>Lang1</em>}</li>
 *   <li>{@link xhtml.impl.BTypeImpl#getOnclick <em>Onclick</em>}</li>
 *   <li>{@link xhtml.impl.BTypeImpl#getOndblclick <em>Ondblclick</em>}</li>
 *   <li>{@link xhtml.impl.BTypeImpl#getOnkeydown <em>Onkeydown</em>}</li>
 *   <li>{@link xhtml.impl.BTypeImpl#getOnkeypress <em>Onkeypress</em>}</li>
 *   <li>{@link xhtml.impl.BTypeImpl#getOnkeyup <em>Onkeyup</em>}</li>
 *   <li>{@link xhtml.impl.BTypeImpl#getOnmousedown <em>Onmousedown</em>}</li>
 *   <li>{@link xhtml.impl.BTypeImpl#getOnmousemove <em>Onmousemove</em>}</li>
 *   <li>{@link xhtml.impl.BTypeImpl#getOnmouseout <em>Onmouseout</em>}</li>
 *   <li>{@link xhtml.impl.BTypeImpl#getOnmouseover <em>Onmouseover</em>}</li>
 *   <li>{@link xhtml.impl.BTypeImpl#getOnmouseup <em>Onmouseup</em>}</li>
 *   <li>{@link xhtml.impl.BTypeImpl#getStyle <em>Style</em>}</li>
 *   <li>{@link xhtml.impl.BTypeImpl#getTitle <em>Title</em>}</li>
 * </ul>
 *
 * @generated
 */
