 ...
 * </p>
 * <ul>
 *   <li>{@link xhtml.impl.HeadTypeImpl#getGroup <em>Group</em>}</li>
 *   <li>{@link xhtml.impl.HeadTypeImpl#getScript <em>Script</em>}</li>
 *   <li>{@link xhtml.impl.HeadTypeImpl#getStyle <em>Style</em>}</li>
 *   <li>{@link xhtml.impl.HeadTypeImpl#getMeta <em>Meta</em>}</li>
 *   <li>{@link xhtml.impl.HeadTypeImpl#getLink <em>Link</em>}</li>
 *   <li>{@link xhtml.impl.HeadTypeImpl#getObject <em>Object</em>}</li>
 *   <li>{@link xhtml.impl.HeadTypeImpl#getTitle <em>Title</em>}</li>
 *   <li>{@link xhtml.impl.HeadTypeImpl#getGroup1 <em>Group1</em>}</li>
 *   <li>{@link xhtml.impl.HeadTypeImpl#getScript1 <em>Script1</em>}</li>
 *   <li>{@link xhtml.impl.HeadTypeImpl#getStyle1 <em>Style1</em>}</li>
 *   <li>{@link xhtml.impl.HeadTypeImpl#getMeta1 <em>Meta1</em>}</li>
 *   <li>{@link xhtml.impl.HeadTypeImpl#getLink1 <em>Link1</em>}</li>
 *   <li>{@link xhtml.impl.HeadTypeImpl#getObject1 <em>Object1</em>}</li>
 *   <li>{@link xhtml.impl.HeadTypeImpl#getBase <em>Base</em>}</li>
 *   <li>{@link xhtml.impl.HeadTypeImpl#getGroup2 <em>Group2</em>}</li>
 *   <li>{@link xhtml.impl.HeadTypeImpl#getScript2 <em>Script2</em>}</li>
 *   <li>{@link xhtml.impl.HeadTypeImpl#getStyle2 <em>Style2</em>}</li>
 *   <li>{@link xhtml.impl.HeadTypeImpl#getMeta2 <em>Meta2</em>}</li>
 *   <li>{@link xhtml.impl.HeadTypeImpl#getLink2 <em>Link2</em>}</li>
 *   <li>{@link xhtml.impl.HeadTypeImpl#getObject2 <em>Object2</em>}</li>
 *   <li>{@link xhtml.impl.HeadTypeImpl#getBase1 <em>Base1</em>}</li>
 *   <li>{@link xhtml.impl.HeadTypeImpl#getGroup3 <em>Group3</em>}</li>
 *   <li>{@link xhtml.impl.HeadTypeImpl#getScript3 <em>Script3</em>}</li>
 *   <li>{@link xhtml.impl.HeadTypeImpl#getStyle3 <em>Style3</em>}</li>
 *   <li>{@link xhtml.impl.HeadTypeImpl#getMeta3 <em>Meta3</em>}</li>
 *   <li>{@link xhtml.impl.HeadTypeImpl#getLink3 <em>Link3</em>}</li>
 *   <li>{@link xhtml.impl.HeadTypeImpl#getObject3 <em>Object3</em>}</li>
 *   <li>{@link xhtml.impl.HeadTypeImpl#getTitle1 <em>Title1</em>}</li>
 *   <li>{@link xhtml.impl.HeadTypeImpl#getGroup4 <em>Group4</em>}</li>
 *   <li>{@link xhtml.impl.HeadTypeImpl#getScript4 <em>Script4</em>}</li>
 *   <li>{@link xhtml.impl.HeadTypeImpl#getStyle4 <em>Style4</em>}</li>
 *   <li>{@link xhtml.impl.HeadTypeImpl#getMeta4 <em>Meta4</em>}</li>
 *   <li>{@link xhtml.impl.HeadTypeImpl#getLink4 <em>Link4</em>}</li>
 *   <li>{@link xhtml.impl.HeadTypeImpl#getObject4 <em>Object4</em>}</li>
 *   <li>{@link xhtml.impl.HeadTypeImpl#getDir <em>Dir</em>}</li>
 *   <li>{@link xhtml.impl.HeadTypeImpl#getId <em>Id</em>}</li>
 *   <li>{@link xhtml.impl.HeadTypeImpl#getLang <em>Lang</em>}</li>
 *   <li>{@link xhtml.impl.HeadTypeImpl#getLang1 <em>Lang1</em>}</li>
 *   <li>{@link xhtml.impl.HeadTypeImpl#getProfile <em>Profile</em>}</li>
 * </ul>
 *
 * @generated
 */
