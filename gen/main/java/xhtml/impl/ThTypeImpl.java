 ...
 * </p>
 * <ul>
 *   <li>{@link xhtml.impl.ThTypeImpl#getAbbr1 <em>Abbr1</em>}</li>
 *   <li>{@link xhtml.impl.ThTypeImpl#getAlign <em>Align</em>}</li>
 *   <li>{@link xhtml.impl.ThTypeImpl#getAxis <em>Axis</em>}</li>
 *   <li>{@link xhtml.impl.ThTypeImpl#getChar <em>Char</em>}</li>
 *   <li>{@link xhtml.impl.ThTypeImpl#getCharoff <em>Charoff</em>}</li>
 *   <li>{@link xhtml.impl.ThTypeImpl#getClass_ <em>Class</em>}</li>
 *   <li>{@link xhtml.impl.ThTypeImpl#getColspan <em>Colspan</em>}</li>
 *   <li>{@link xhtml.impl.ThTypeImpl#getDir <em>Dir</em>}</li>
 *   <li>{@link xhtml.impl.ThTypeImpl#getHeaders <em>Headers</em>}</li>
 *   <li>{@link xhtml.impl.ThTypeImpl#getId <em>Id</em>}</li>
 *   <li>{@link xhtml.impl.ThTypeImpl#getLang <em>Lang</em>}</li>
 *   <li>{@link xhtml.impl.ThTypeImpl#getLang1 <em>Lang1</em>}</li>
 *   <li>{@link xhtml.impl.ThTypeImpl#getOnclick <em>Onclick</em>}</li>
 *   <li>{@link xhtml.impl.ThTypeImpl#getOndblclick <em>Ondblclick</em>}</li>
 *   <li>{@link xhtml.impl.ThTypeImpl#getOnkeydown <em>Onkeydown</em>}</li>
 *   <li>{@link xhtml.impl.ThTypeImpl#getOnkeypress <em>Onkeypress</em>}</li>
 *   <li>{@link xhtml.impl.ThTypeImpl#getOnkeyup <em>Onkeyup</em>}</li>
 *   <li>{@link xhtml.impl.ThTypeImpl#getOnmousedown <em>Onmousedown</em>}</li>
 *   <li>{@link xhtml.impl.ThTypeImpl#getOnmousemove <em>Onmousemove</em>}</li>
 *   <li>{@link xhtml.impl.ThTypeImpl#getOnmouseout <em>Onmouseout</em>}</li>
 *   <li>{@link xhtml.impl.ThTypeImpl#getOnmouseover <em>Onmouseover</em>}</li>
 *   <li>{@link xhtml.impl.ThTypeImpl#getOnmouseup <em>Onmouseup</em>}</li>
 *   <li>{@link xhtml.impl.ThTypeImpl#getRowspan <em>Rowspan</em>}</li>
 *   <li>{@link xhtml.impl.ThTypeImpl#getScope <em>Scope</em>}</li>
 *   <li>{@link xhtml.impl.ThTypeImpl#getStyle <em>Style</em>}</li>
 *   <li>{@link xhtml.impl.ThTypeImpl#getTitle <em>Title</em>}</li>
 *   <li>{@link xhtml.impl.ThTypeImpl#getValign <em>Valign</em>}</li>
 * </ul>
 *
 * @generated
 */
