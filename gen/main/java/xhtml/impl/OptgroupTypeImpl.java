 ...
 * </p>
 * <ul>
 *   <li>{@link xhtml.impl.OptgroupTypeImpl#getOption <em>Option</em>}</li>
 *   <li>{@link xhtml.impl.OptgroupTypeImpl#getClass_ <em>Class</em>}</li>
 *   <li>{@link xhtml.impl.OptgroupTypeImpl#getDir <em>Dir</em>}</li>
 *   <li>{@link xhtml.impl.OptgroupTypeImpl#getDisabled <em>Disabled</em>}</li>
 *   <li>{@link xhtml.impl.OptgroupTypeImpl#getId <em>Id</em>}</li>
 *   <li>{@link xhtml.impl.OptgroupTypeImpl#getLabel <em>Label</em>}</li>
 *   <li>{@link xhtml.impl.OptgroupTypeImpl#getLang <em>Lang</em>}</li>
 *   <li>{@link xhtml.impl.OptgroupTypeImpl#getLang1 <em>Lang1</em>}</li>
 *   <li>{@link xhtml.impl.OptgroupTypeImpl#getOnclick <em>Onclick</em>}</li>
 *   <li>{@link xhtml.impl.OptgroupTypeImpl#getOndblclick <em>Ondblclick</em>}</li>
 *   <li>{@link xhtml.impl.OptgroupTypeImpl#getOnkeydown <em>Onkeydown</em>}</li>
 *   <li>{@link xhtml.impl.OptgroupTypeImpl#getOnkeypress <em>Onkeypress</em>}</li>
 *   <li>{@link xhtml.impl.OptgroupTypeImpl#getOnkeyup <em>Onkeyup</em>}</li>
 *   <li>{@link xhtml.impl.OptgroupTypeImpl#getOnmousedown <em>Onmousedown</em>}</li>
 *   <li>{@link xhtml.impl.OptgroupTypeImpl#getOnmousemove <em>Onmousemove</em>}</li>
 *   <li>{@link xhtml.impl.OptgroupTypeImpl#getOnmouseout <em>Onmouseout</em>}</li>
 *   <li>{@link xhtml.impl.OptgroupTypeImpl#getOnmouseover <em>Onmouseover</em>}</li>
 *   <li>{@link xhtml.impl.OptgroupTypeImpl#getOnmouseup <em>Onmouseup</em>}</li>
 *   <li>{@link xhtml.impl.OptgroupTypeImpl#getStyle <em>Style</em>}</li>
 *   <li>{@link xhtml.impl.OptgroupTypeImpl#getTitle <em>Title</em>}</li>
 * </ul>
 *
 * @generated
 */
