 ...
 * </p>
 * <ul>
 *   <li>{@link xhtml.impl.AContentImpl#getMixed <em>Mixed</em>}</li>
 *   <li>{@link xhtml.impl.AContentImpl#getGroup <em>Group</em>}</li>
 *   <li>{@link xhtml.impl.AContentImpl#getBr <em>Br</em>}</li>
 *   <li>{@link xhtml.impl.AContentImpl#getSpan <em>Span</em>}</li>
 *   <li>{@link xhtml.impl.AContentImpl#getBdo <em>Bdo</em>}</li>
 *   <li>{@link xhtml.impl.AContentImpl#getMap <em>Map</em>}</li>
 *   <li>{@link xhtml.impl.AContentImpl#getObject <em>Object</em>}</li>
 *   <li>{@link xhtml.impl.AContentImpl#getImg <em>Img</em>}</li>
 *   <li>{@link xhtml.impl.AContentImpl#getTt <em>Tt</em>}</li>
 *   <li>{@link xhtml.impl.AContentImpl#getI <em>I</em>}</li>
 *   <li>{@link xhtml.impl.AContentImpl#getB <em>B</em>}</li>
 *   <li>{@link xhtml.impl.AContentImpl#getBig <em>Big</em>}</li>
 *   <li>{@link xhtml.impl.AContentImpl#getSmall <em>Small</em>}</li>
 *   <li>{@link xhtml.impl.AContentImpl#getEm <em>Em</em>}</li>
 *   <li>{@link xhtml.impl.AContentImpl#getStrong <em>Strong</em>}</li>
 *   <li>{@link xhtml.impl.AContentImpl#getDfn <em>Dfn</em>}</li>
 *   <li>{@link xhtml.impl.AContentImpl#getCode <em>Code</em>}</li>
 *   <li>{@link xhtml.impl.AContentImpl#getQ <em>Q</em>}</li>
 *   <li>{@link xhtml.impl.AContentImpl#getSamp <em>Samp</em>}</li>
 *   <li>{@link xhtml.impl.AContentImpl#getKbd <em>Kbd</em>}</li>
 *   <li>{@link xhtml.impl.AContentImpl#getVar <em>Var</em>}</li>
 *   <li>{@link xhtml.impl.AContentImpl#getCite <em>Cite</em>}</li>
 *   <li>{@link xhtml.impl.AContentImpl#getAbbr <em>Abbr</em>}</li>
 *   <li>{@link xhtml.impl.AContentImpl#getAcronym <em>Acronym</em>}</li>
 *   <li>{@link xhtml.impl.AContentImpl#getSub <em>Sub</em>}</li>
 *   <li>{@link xhtml.impl.AContentImpl#getSup <em>Sup</em>}</li>
 *   <li>{@link xhtml.impl.AContentImpl#getInput <em>Input</em>}</li>
 *   <li>{@link xhtml.impl.AContentImpl#getSelect <em>Select</em>}</li>
 *   <li>{@link xhtml.impl.AContentImpl#getTextarea <em>Textarea</em>}</li>
 *   <li>{@link xhtml.impl.AContentImpl#getLabel <em>Label</em>}</li>
 *   <li>{@link xhtml.impl.AContentImpl#getButton <em>Button</em>}</li>
 *   <li>{@link xhtml.impl.AContentImpl#getIns <em>Ins</em>}</li>
 *   <li>{@link xhtml.impl.AContentImpl#getDel <em>Del</em>}</li>
 *   <li>{@link xhtml.impl.AContentImpl#getScript <em>Script</em>}</li>
 * </ul>
 *
 * @generated
 */
