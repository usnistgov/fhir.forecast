 ...
 * </p>
 * <ul>
 *   <li>{@link xhtml.impl.QTypeImpl#getCite1 <em>Cite1</em>}</li>
 *   <li>{@link xhtml.impl.QTypeImpl#getClass_ <em>Class</em>}</li>
 *   <li>{@link xhtml.impl.QTypeImpl#getDir <em>Dir</em>}</li>
 *   <li>{@link xhtml.impl.QTypeImpl#getId <em>Id</em>}</li>
 *   <li>{@link xhtml.impl.QTypeImpl#getLang <em>Lang</em>}</li>
 *   <li>{@link xhtml.impl.QTypeImpl#getLang1 <em>Lang1</em>}</li>
 *   <li>{@link xhtml.impl.QTypeImpl#getOnclick <em>Onclick</em>}</li>
 *   <li>{@link xhtml.impl.QTypeImpl#getOndblclick <em>Ondblclick</em>}</li>
 *   <li>{@link xhtml.impl.QTypeImpl#getOnkeydown <em>Onkeydown</em>}</li>
 *   <li>{@link xhtml.impl.QTypeImpl#getOnkeypress <em>Onkeypress</em>}</li>
 *   <li>{@link xhtml.impl.QTypeImpl#getOnkeyup <em>Onkeyup</em>}</li>
 *   <li>{@link xhtml.impl.QTypeImpl#getOnmousedown <em>Onmousedown</em>}</li>
 *   <li>{@link xhtml.impl.QTypeImpl#getOnmousemove <em>Onmousemove</em>}</li>
 *   <li>{@link xhtml.impl.QTypeImpl#getOnmouseout <em>Onmouseout</em>}</li>
 *   <li>{@link xhtml.impl.QTypeImpl#getOnmouseover <em>Onmouseover</em>}</li>
 *   <li>{@link xhtml.impl.QTypeImpl#getOnmouseup <em>Onmouseup</em>}</li>
 *   <li>{@link xhtml.impl.QTypeImpl#getStyle <em>Style</em>}</li>
 *   <li>{@link xhtml.impl.QTypeImpl#getTitle <em>Title</em>}</li>
 * </ul>
 *
 * @generated
 */
