 ...
 * </p>
 * <ul>
 *   <li>{@link xhtml.impl.ColgroupTypeImpl#getCol <em>Col</em>}</li>
 *   <li>{@link xhtml.impl.ColgroupTypeImpl#getAlign <em>Align</em>}</li>
 *   <li>{@link xhtml.impl.ColgroupTypeImpl#getChar <em>Char</em>}</li>
 *   <li>{@link xhtml.impl.ColgroupTypeImpl#getCharoff <em>Charoff</em>}</li>
 *   <li>{@link xhtml.impl.ColgroupTypeImpl#getClass_ <em>Class</em>}</li>
 *   <li>{@link xhtml.impl.ColgroupTypeImpl#getDir <em>Dir</em>}</li>
 *   <li>{@link xhtml.impl.ColgroupTypeImpl#getId <em>Id</em>}</li>
 *   <li>{@link xhtml.impl.ColgroupTypeImpl#getLang <em>Lang</em>}</li>
 *   <li>{@link xhtml.impl.ColgroupTypeImpl#getLang1 <em>Lang1</em>}</li>
 *   <li>{@link xhtml.impl.ColgroupTypeImpl#getOnclick <em>Onclick</em>}</li>
 *   <li>{@link xhtml.impl.ColgroupTypeImpl#getOndblclick <em>Ondblclick</em>}</li>
 *   <li>{@link xhtml.impl.ColgroupTypeImpl#getOnkeydown <em>Onkeydown</em>}</li>
 *   <li>{@link xhtml.impl.ColgroupTypeImpl#getOnkeypress <em>Onkeypress</em>}</li>
 *   <li>{@link xhtml.impl.ColgroupTypeImpl#getOnkeyup <em>Onkeyup</em>}</li>
 *   <li>{@link xhtml.impl.ColgroupTypeImpl#getOnmousedown <em>Onmousedown</em>}</li>
 *   <li>{@link xhtml.impl.ColgroupTypeImpl#getOnmousemove <em>Onmousemove</em>}</li>
 *   <li>{@link xhtml.impl.ColgroupTypeImpl#getOnmouseout <em>Onmouseout</em>}</li>
 *   <li>{@link xhtml.impl.ColgroupTypeImpl#getOnmouseover <em>Onmouseover</em>}</li>
 *   <li>{@link xhtml.impl.ColgroupTypeImpl#getOnmouseup <em>Onmouseup</em>}</li>
 *   <li>{@link xhtml.impl.ColgroupTypeImpl#getSpan <em>Span</em>}</li>
 *   <li>{@link xhtml.impl.ColgroupTypeImpl#getStyle <em>Style</em>}</li>
 *   <li>{@link xhtml.impl.ColgroupTypeImpl#getTitle <em>Title</em>}</li>
 *   <li>{@link xhtml.impl.ColgroupTypeImpl#getValign <em>Valign</em>}</li>
 *   <li>{@link xhtml.impl.ColgroupTypeImpl#getWidth <em>Width</em>}</li>
 * </ul>
 *
 * @generated
 */
